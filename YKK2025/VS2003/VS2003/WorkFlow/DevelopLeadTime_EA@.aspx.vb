...
Public Class DevelopLeadTime_EA_
...
#End Region
    ...
    Sub CreateWorkTable()
        ...
        SQL = SQL + "T_Step as Step, T_SeqNo as SeqNo, T_CompletedTime as CompletedTime, T_ReceiptTime as ReceiptTime, AWorkTime, "
        ...
        SQL = SQL + "  And T_AEndTime >= '" + wSDate + "' "
        SQL = SQL + "  And T_AEndTime <= '" + wEDate + "' "
        ...
        SQL = "SELECT No, FormNo, FormSno, SStep, EStep, Division, Buyer, Finished, Suppiler, SliderCode, Spec, Level, TotalTimeRange, SingleLeadTime, "
        SQL = SQL + "str(SStep)+' ~ '+ str(EStep) As Step, "
        SQL = SQL + "Case Sts When 0 Then '開發中' When 1 Then 'OK' When 2 Then 'NG' Else '取消' End As Sts, "

        SQL = SQL + "'DevelopLeadTime_EA@List.aspx?' + "
