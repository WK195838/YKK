<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ManufInOPSheet_02.aspx.vb" Inherits="SPD.OPContactSheet_02"%>
	...
	<body MS_POSITIONING="GridLayout">
		<FONT face="新細明體">
			<FORM id="Form1" method="post" runat="server">
				<FONT face="新細明體">
					<asp:textbox id="DLevel" style="Z-INDEX: 118; LEFT: 416px; POSITION: absolute; TOP: 158px" runat="server"
						Width="176px" Height="20px" ReadOnly="True" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove">DLevel</asp:textbox>
					<asp:textbox id="DMakeCAM" style="Z-INDEX: 121; LEFT: 496px; POSITION: absolute; TOP: 260px"
						runat="server" BorderStyle="Groove" ForeColor="Blue" BackColor="Yellow" ReadOnly="True" Height="20px"
						Width="97px">DMakeCAM</asp:textbox>
					<asp:textbox id="DSuppiler" style="Z-INDEX: 120; LEFT: 496px; POSITION: absolute; TOP: 192px"
						runat="server" BorderStyle="Groove" ForeColor="Blue" BackColor="Yellow" ReadOnly="True" Height="20px"
						Width="97px">DSuppiler</asp:textbox>
					<asp:hyperlink id="LNFormNo" style="Z-INDEX: 119; LEFT: 376px; POSITION: absolute; TOP: 228px"
					...
					<asp:hyperlink id="LOFormNo" style="Z-INDEX: 115; LEFT: 216px; POSITION: absolute; TOP: 228px"
						runat="server" Width="48px" Height="8px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">原委託</asp:hyperlink>
					<asp:hyperlink id="LMapNo" style="Z-INDEX: 114; LEFT: 304px; POSITION: absolute; TOP: 194px" runat="server"
						Width="40px" Height="8px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">連結</asp:hyperlink>
					<asp:textbox id="DNFormSno" style="Z-INDEX: 113; LEFT: 336px; POSITION: absolute; TOP: 226px"
						runat="server" Width="36px" Height="20px" AutoPostBack="True" ReadOnly="True" BackColor="Yellow"
						ForeColor="Blue" BorderStyle="Groove">DNFormSno</asp:textbox>
					<asp:textbox id="DNFormNo" style="Z-INDEX: 112; LEFT: 280px; POSITION: absolute; TOP: 226px"
						runat="server" Width="56px" Height="20px" AutoPostBack="True" ReadOnly="True" BackColor="Yellow"
					...
					<asp:textbox id="DTarget" style="Z-INDEX: 106; LEFT: 120px; POSITION: absolute; TOP: 260px" runat="server"
						Width="280px" Height="20px" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove" ReadOnly="True">DTarget</asp:textbox>
					<asp:textbox id="DOFormSno" style="Z-INDEX: 105; LEFT: 176px; POSITION: absolute; TOP: 226px"
						runat="server" Width="36px" Height="20px" AutoPostBack="True" ReadOnly="True" BackColor="Yellow"
					...
					<asp:textbox id="DDivision" style="Z-INDEX: 116; LEFT: 120px; POSITION: absolute; TOP: 124px"
					...
					<asp:textbox id="DPerson" style="Z-INDEX: 117; LEFT: 416px; POSITION: absolute; TOP: 124px" runat="server"
