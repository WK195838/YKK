...
Public Class IT_TroubleShooterSheet_01
...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "IT_TroubleShooterSheet_01.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_TroubleShooterSheet").Rows.Count > 0 Then
            ...
            SetFieldData("Priority", DBDataSet1.Tables("F_TroubleShooterSheet").Rows(0).Item("Priority"))
            ...
            SetFieldData("Engineer", DBDataSet1.Tables("F_TroubleShooterSheet").Rows(0).Item("Engineer"))
            SetFieldData("System", DBDataSet1.Tables("F_TroubleShooterSheet").Rows(0).Item("System"))
    ...
    Sub ShowSheetFunction()
        ...
        If wFormSno > 0 And wStep > 2 Then    '判斷是否[簽核]
            ...
            If DBDataSet1.Tables("T_WaitHandle").Rows.Count > 0 Then
                'Sheet顯示
                DTroubleShooterSheet1.Visible = True   '表單Sheet-1
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        '迫切性
        Select Case FindFieldInf("Priority")
            Case 0  '顯示
                DPriority.BackColor = Color.LightGray
                DPriority.Visible = True
            Case 1  '修改+檢查
                DPriority.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DPriorityRqd", "DPriority", "異常：需輸入迫切性")
                DPriority.Visible = True
            Case 2  '修改
                DPriority.BackColor = Color.Yellow
                DPriority.Visible = True
            Case Else   '隱藏
                DPriority.Visible = False
        End Select
        If pPost = "New" Then SetFieldData("Priority", "ZZZZZZ")
        '目的
    ...
    Sub SetFieldData(ByVal pFieldName As String, ByVal pName As String)
        ...
        If pFieldName = "Priority" Then
            ...
            If idx = 0 Then
                If pName <> "ZZZZZZ" Then
                    ...
                    DPriority.Items.Add(ListItem1)
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='1105' and DKey='PRIORITY' Order by Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
        ...
        If pFieldName = "Engineer" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='1105' and DKey='ENGINEER' Order by Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter1.Fill(DBDataSet1, "M_Referp")
                DBTable1 = DBDataSet1.Tables("M_Referp")
                For i = 0 To DBTable1.Rows.Count - 1
        ...
        If pFieldName = "System" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='1105' and DKey='SYSTEM' Order by Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter1.Fill(DBDataSet1, "M_Referp")
                DBTable1 = DBDataSet1.Tables("M_Referp")
                For i = 0 To DBTable1.Rows.Count - 1
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ...
                ErrCode = oCheckNo.CommissionNo("001105", wFormSno, wStep, DNo.Text)    '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(ConfigurationSettings.AppSettings.Get("TroubleShooterFilePath"))
        Dim UploadDateTime = CStr(DateTime.Now.Year) + CStr(DateTime.Now.Month) + CStr(DateTime.Now.Day) + _
                             CStr(DateTime.Now.Hour) + CStr(DateTime.Now.Minute) + CStr(DateTime.Now.Second)     '上傳日期
        ...
        SQl = "Insert into F_TroubleShooterSheet "
        SQl = SQl + "( "
        ...
        SQl = SQl + "BDays, Priority, Target, RefFile, "
        ...
        SQl = SQl + " '" + DBDays.Text + "', "
        SQl = SQl + " '" + DPriority.SelectedValue + "', "
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQl = "Update F_TroubleShooterSheet Set "
        If pFun <> "SAVE" Then
            SQl = SQl + " Sts = '" & pSts & "',"
        ...
        SQl = SQl + " Priority = '" & DPriority.SelectedItem.Text & "',"
