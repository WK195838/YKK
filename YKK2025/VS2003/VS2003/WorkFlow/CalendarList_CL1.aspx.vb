...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "CalendarList_CL1.aspx"
    ...
    Sub Cal_DayRender(ByVal sender As Object, ByVal e As DayRenderEventArgs)
        Dim SQL As String
        Dim objDb As New SqlConnection(ConfigurationSettings.AppSettings.Get("SqlConn1"))    'SQL連結設定xx
        ...
        objCom.Parameters.Add("@Depo", "CL1")
        objDb.Open()
