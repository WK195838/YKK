...
#End Region
    ...
    Sub DataList()
        ...
        If wFun = "Suface" Then
            ...
            SQL = SQL + "No, Convert(Varchar, Date,111) as DateDesc, Code, Buyer, Spec, "
            SQL = SQL + "'SufaceAppendSheet_02.aspx?' + "
            SQL = SQL + "'pFormNo='   + FormNo + "
            SQL = SQL + "'&pFormSno=' + str(FormSno,Len(FormSno)) "
            SQL = SQL + " As URL "
            SQL = SQL + "FROM F_SufaceAppendSheet "
