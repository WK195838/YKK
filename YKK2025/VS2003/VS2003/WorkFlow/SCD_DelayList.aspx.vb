...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents DDelay As System.Web.UI.WebControls.DropDownList
    Protected WithEvents DDecideName As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "SCD_DelayList.aspx"
    ...
    Sub DataList()
        ...
        DataGrid1.Columns.Item(2).HeaderText = "開發No"
        DataGrid1.Columns.Item(3).HeaderText = "Code"
        DataGrid1.Columns.Item(4).HeaderText = "Buyer"
        DataGrid1.Columns.Item(5).HeaderText = "申請者"
        DataGrid1.Columns.Item(6).HeaderText = "核定者"
        DataGrid1.Columns.Item(7).HeaderText = "申請日"
        DataGrid1.Columns.Item(8).HeaderText = "預定"
        ...
        SQL = SQL + "DevNo as Field3, "
        SQL = SQL + "CodeNo as Field4, "
        SQL = SQL + "Buyer as Field5, "
        SQL = SQL + "Division + '--' + ApplyName as Field6, "
        SQL = SQL + "DivName + '--' + DecideName as Field7, "
        SQL = SQL + "Convert(VarChar, ApplyTime, 111) as Field8, "
        SQL = SQL + "BStartTimeDesc + '~' + BEndTimeDesc as Field9, "
        ...
        '狀態
        If DDelay.SelectedValue <> "ALL" Then
            SQL = SQL + " And Delay = '" + DDelay.SelectedValue + "'"
        End If
        ...
        End If
        '待處理者
        If DDecideName.Text <> "待處理者" And DDecideName.Text <> "" Then
            SQL = SQL + " And DecideName Like '%" + DDecideName.Text + "%'"
        End If
        'No
    ...
    Sub Search_Item_Attribute()
        DNo.Text = "No."
        DName.Text = "申請者"
        DDecideName.Text = "待處理者"

        DNo.ReadOnly = False
        DName.ReadOnly = False
        DDecideName.ReadOnly = False
    End Sub
    ...
    Private Sub BExcel_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=DelayList.xls")     '程式別不同
