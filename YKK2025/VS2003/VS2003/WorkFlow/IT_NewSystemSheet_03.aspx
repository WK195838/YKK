<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IT_NewSystemSheet_03.aspx.vb" Inherits="SPD.IT_NewSystemSheet_03"%>
		...
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
			<FONT face="新細明體">
				...
				<asp:textbox id="DBDays" style="Z-INDEX: 137; LEFT: 608px; POSITION: absolute; TOP: 448px" runat="server"
					...
					Width="144px" Height="20px" ForeColor="Blue" BackColor="Yellow" BorderStyle="Groove" ReadOnly="True">DName</asp:textbox><asp:label id="DHistoryLabel" style="Z-INDEX: 119; LEFT: 8px; POSITION: absolute; TOP: 584px"
					runat="server" Width="64px" Height="16px" ForeColor="Blue" Font-Size="11pt" Font-Names="新細明體">核定履歷</asp:label><asp:datagrid id="DataGrid9" style="Z-INDEX: 109; LEFT: 8px; POSITION: absolute; TOP: 600px" runat="server"
					...
					Width="224px" Height="20px" ForeColor="Blue" BackColor="Yellow" BorderStyle="Groove" ReadOnly="True">DDate</asp:textbox><asp:image id="DNewSystemSheet1" style="Z-INDEX: 100; LEFT: 8px; POSITION: absolute; TOP: 8px"
					runat="server" Width="678px" Height="570px" ImageUrl="Images\IT_NewSystemSheet_001.jpg"></asp:image><asp:textbox id="DNo" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 9px" runat="server"
