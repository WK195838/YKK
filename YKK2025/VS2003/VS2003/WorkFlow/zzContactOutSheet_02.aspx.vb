...
Public Class ContactOutSheet_02
...
#End Region
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ContactOutSheet").Rows.Count > 0 Then
            ...
            DDivision.Text = DBDataSet1.Tables("F_ContactOutSheet").Rows(0).Item("Division")      '部門
            DPerson.Text = DBDataSet1.Tables("F_ContactOutSheet").Rows(0).Item("Person")          '擔當
            DSliderCode.Text = DBDataSet1.Tables("F_ContactOutSheet").Rows(0).Item("SliderCode")  'Slider Code
            DLevel.Text = DBDataSet1.Tables("F_ContactOutSheet").Rows(0).Item("Level")            '難易度
            ...
            If DNFormNo.Text <> "" And DNFormSno.Text <> "" Then
                LNFormNo.NavigateUrl = "ModManufOutSheet_02.aspx?pFormNo=" & DNFormNo.Text & "&pFormSno=" & CInt(DNFormSno.Text) & "&pOFormNo=" & DOFormNo.Text & "&pOFormSno=" & CInt(DOFormSno.Text) & "&pStep=" & wStep
            Else
