<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ManufOutOPSheet_02.aspx.vb" Inherits="SPD.ManufOutOPSheet_02"%>
		...
		<FONT face="新細明體">
			<FORM id="Form1" method="post" runat="server">
				<FONT face="新細明體">
					...
					<asp:hyperlink id="LMapNo1" style="Z-INDEX: 123; LEFT: 368px; POSITION: absolute; TOP: 194px" runat="server"
						Height="8px" Width="40px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">連結</asp:hyperlink>
					<asp:textbox id="DMapNo1" style="Z-INDEX: 122; LEFT: 264px; POSITION: absolute; TOP: 192px" runat="server"
						BorderStyle="Groove" ForeColor="Blue" BackColor="Yellow" ReadOnly="True" Height="20px" Width="104px">DMapNo</asp:textbox>
					<asp:textbox id="DSuppiler" style="Z-INDEX: 121; LEFT: 416px; POSITION: absolute; TOP: 192px"
						runat="server" BorderStyle="Groove" ForeColor="Blue" BackColor="Yellow" ReadOnly="True" Height="20px"
						Width="176px">DSuppiler</asp:textbox>
					...
					<asp:image id="DOPContactSheet" style="Z-INDEX: 100; LEFT: 8px; POSITION: absolute; TOP: 8px"
						runat="server" ImageUrl="Images\OPContactOutSheet_001.jpg" Width="593px" Height="454px"></asp:image>
					...
					<asp:hyperlink id="LMapNo" style="Z-INDEX: 114; LEFT: 224px; POSITION: absolute; TOP: 194px" runat="server"
					...
					<asp:textbox id="DMapNo" style="Z-INDEX: 104; LEFT: 120px; POSITION: absolute; TOP: 192px" runat="server"
						Width="104px" Height="20px" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove" ReadOnly="True">DMapNo</asp:textbox>
