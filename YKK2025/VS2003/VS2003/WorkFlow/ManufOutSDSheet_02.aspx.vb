...
#End Region
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ManufOutSDSheet").Rows.Count > 0 Then
            ...
            DDate.Text = DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("Date")         '日期
            DDivision.Text = DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("Division") '部門
            DPerson.Text = DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("Person")     '擔當
            DSliderGRCode.Text = DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("SliderGRCode")   'Slider Code
            DOFormNo.Text = DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("OFormNo")             '圖號
            DOFormSno.Text = DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("OFormSno")           '圖號
            ...
            End If
            If DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("SliderFile") <> "" Then          '圖檔1
            ...
            End If
            If DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("AttachFile") <> "" Then          '圖檔1
                '封存檔還原  20213/16  jessica
