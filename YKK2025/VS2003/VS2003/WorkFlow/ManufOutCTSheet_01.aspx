<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ManufOutCTSheet_01.aspx.vb" Inherits="SPD.ManufOutCTSheet_01" aspCompat="True"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">
				<asp:textbox id="DReady" style="Z-INDEX: 147; POSITION: absolute; TOP: 226px; LEFT: 496px" runat="server"
					Width="48px" Height="20px" ReadOnly="True" BorderStyle="Groove" ForeColor="Red" BackColor="GreenYellow"></asp:textbox>
				<asp:dropdownlist id="DTarget" style="Z-INDEX: 360; POSITION: absolute; TOP: 260px; LEFT: 120px" runat="server"
					BackColor="Yellow" ForeColor="Blue" Height="20px" Width="304px">
					<asp:ListItem Value="3">3</asp:ListItem>
				</asp:dropdownlist>
				<asp:textbox id="DLevel" style="Z-INDEX: 359; POSITION: absolute; TOP: 158px; LEFT: 416px" runat="server"
					BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove" Height="20px" Width="176px">DLevel</asp:textbox>
				<asp:textbox id="DOPReadyDesc" style="Z-INDEX: 358; POSITION: absolute; TOP: 616px; LEFT: 240px"
					runat="server" BackColor="White" ForeColor="Red" BorderStyle="None" Height="20px" Width="104px">需閱讀工程履歷</asp:textbox>
				<asp:textbox id="DOPReady" style="Z-INDEX: 153; POSITION: absolute; TOP: 616px; LEFT: 344px"
					runat="server" BackColor="GreenYellow" ForeColor="Red" BorderStyle="Groove" ReadOnly="True"
					Height="20px" Width="48px"></asp:textbox>
				...
				<asp:imagebutton id="BFlow" style="Z-INDEX: 144; POSITION: absolute; TOP: 32px; LEFT: 8px" runat="server"
					Height="16px" Width="16px" ImageUrl="Images\Flow-01.gif"></asp:imagebutton><asp:imagebutton id="BPrint" style="Z-INDEX: 143; POSITION: absolute; TOP: 8px; LEFT: 8px" runat="server"
					ImageUrl="Images\Print.gif" Width="16px" Height="16px"></asp:imagebutton><asp:hyperlink id="LNFormNo" style="Z-INDEX: 138; POSITION: absolute; TOP: 228px; LEFT: 424px"
					runat="server" Width="48px" Height="8px" Font-Size="12pt" NavigateUrl="BoardEdit.aspx" Target="_blank">新委託</asp:hyperlink><asp:button id="BModify" style="Z-INDEX: 137; POSITION: absolute; TOP: 226px; LEFT: 424px" runat="server"
					Width="56px" Height="20px" Text="新委託"></asp:button><asp:hyperlink id="LOFormNo" style="Z-INDEX: 136; POSITION: absolute; TOP: 228px; LEFT: 240px"
					runat="server" Width="48px" Height="8px" Font-Size="12pt" NavigateUrl="BoardEdit.aspx" Target="_blank">原委託</asp:hyperlink><asp:hyperlink id="LMapNo" style="Z-INDEX: 135; POSITION: absolute; TOP: 194px; LEFT: 346px" runat="server"
					Width="40px" Height="8px" Font-Size="12pt" NavigateUrl="BoardEdit.aspx" Target="_blank">連結</asp:hyperlink><asp:textbox id="DNFormSno" style="Z-INDEX: 134; POSITION: absolute; TOP: 226px; LEFT: 368px"
					runat="server" Width="50px" Height="20px" AutoPostBack="True" ReadOnly="True" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove">DNFormSno</asp:textbox><asp:textbox id="DNFormNo" style="Z-INDEX: 133; POSITION: absolute; TOP: 226px; LEFT: 304px"
					runat="server" Width="60px" Height="20px" AutoPostBack="True" ReadOnly="True" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove">DNFormNo</asp:textbox><asp:hyperlink id="LAttachFile" style="Z-INDEX: 132; POSITION: absolute; TOP: 436px; LEFT: 552px"
					...
					runat="server" Width="60px" Height="20px" AutoPostBack="True" ReadOnly="True" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove">DOFormNo</asp:textbox><asp:button id="BIn" style="Z-INDEX: 130; POSITION: absolute; TOP: 90px; LEFT: 272px" runat="server"
					...
					runat="server" Width="64px" Height="20px" AutoPostBack="True" BackColor="Gold" ForeColor="Blue" Visible="False">
					...
					runat="server" Width="152px" Height="20px" Font-Size="9pt" ReadOnly="True" BackColor="Gold" ForeColor="Blue" BorderStyle="Groove">DAEndTime</asp:textbox><asp:textbox id="DAStartTime" style="Z-INDEX: 124; POSITION: absolute; TOP: 582px; LEFT: 168px"
					runat="server" Width="152px" Height="20px" Font-Size="9pt" ReadOnly="True" BackColor="Gold" ForeColor="Blue" BorderStyle="Groove">DAStartTime</asp:textbox><asp:textbox id="DBEndTime" style="Z-INDEX: 123; POSITION: absolute; TOP: 548px; LEFT: 440px"
					runat="server" Width="152px" Height="20px" Font-Size="9pt" ReadOnly="True" BackColor="Gold" ForeColor="Blue" BorderStyle="Groove">DBEndTime</asp:textbox><asp:textbox id="DBStartTime" style="Z-INDEX: 122; POSITION: absolute; TOP: 548px; LEFT: 168px"
					runat="server" Width="152px" Height="20px" Font-Size="9pt" ReadOnly="True" BackColor="Gold" ForeColor="Blue" BorderStyle="Groove">DBStartTime</asp:textbox><asp:textbox id="DDecideDesc" style="Z-INDEX: 121; POSITION: absolute; TOP: 472px; LEFT: 56px"
				...
				<asp:textbox id="DDReason" style="Z-INDEX: 115; POSITION: absolute; TOP: 364px; LEFT: 120px"
					...
					runat="server" Width="472px" Height="56px" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove" TextMode="MultiLine">DContent</asp:textbox><asp:textbox id="DOFormSno" style="Z-INDEX: 112; POSITION: absolute; TOP: 226px; LEFT: 184px"
					runat="server" Width="50px" Height="20px" AutoPostBack="True" ReadOnly="True" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove">DOFormSno</asp:textbox><asp:textbox id="DMapNo" style="Z-INDEX: 111; POSITION: absolute; TOP: 192px; LEFT: 120px" runat="server"
					Width="176px" Height="20px" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove">DMapNo</asp:textbox><asp:button id="BOMapNo" style="Z-INDEX: 107; POSITION: absolute; TOP: 192px; LEFT: 296px" runat="server"
					Width="20px" Height="20px" Text="原"></asp:button><asp:button id="BMMapNo" style="Z-INDEX: 109; POSITION: absolute; TOP: 192px; LEFT: 318px" runat="server"
					...
					Width="152px" Height="20px" BackColor="Yellow" ForeColor="Blue" BorderStyle="Groove">DNo</asp:textbox><asp:textbox id="DDate" style="Z-INDEX: 103; POSITION: absolute; TOP: 90px; LEFT: 416px" runat="server"
