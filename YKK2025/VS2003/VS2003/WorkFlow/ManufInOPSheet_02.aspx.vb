...
Public Class OPContactSheet_02
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "ManufInOPSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ManufInOPSheet").Rows.Count > 0 Then
            ...
            DDivision.Text = DBDataSet1.Tables("F_ManufInOPSheet").Rows(0).Item("Division") '部門
            DPerson.Text = DBDataSet1.Tables("F_ManufInOPSheet").Rows(0).Item("Person")   '擔當
            ...
            DMakeCAM.Text = DBDataSet1.Tables("F_ManufInOPSheet").Rows(0).Item("MakeCAM")     '外注商
            ...
            DOFormNo.Text = DBDataSet1.Tables("F_ManufInOPSheet").Rows(0).Item("OFormNo")             '圖號
            DOFormSno.Text = DBDataSet1.Tables("F_ManufInOPSheet").Rows(0).Item("OFormSno")             '圖號
    ...
    Private Sub DOFormSno_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DOFormSno.TextChanged
