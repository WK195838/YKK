...
Public Class ManufOutCTSheet_01
...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "ManufOutCTSheet_01.aspx"
    ...
    '*****************************************************************
    Sub ShowFormData()
        Dim Path As String = ConfigurationSettings.AppSettings.Get("Http") & ConfigurationSettings.AppSettings.Get("ManufOutCTFilePath")
        ...
        SQL = "Select * From F_ManufOutCTSheet "
        SQL = SQL & " Where FormNo =  '" & wFormNo & "'"
        SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
        Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
        DBAdapter1.Fill(DBDataSet1, "F_ManufOutCTSheet")
        If DBDataSet1.Tables("F_ManufOutCTSheet").Rows.Count > 0 Then
            DNo.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("No")                       'No
            DDate.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Date")                   '日期
            SetFieldData("Division", DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Division"))  '部門
            SetFieldData("Person", DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Person"))      '擔當
            DSliderCode.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("SliderCode")       'Slider Code
            DLevel.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Level")                 '難易度
            DMapNo.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("MapNo")             '圖號
            If DMapNo.Text <> "" Then
            ...
            DOFormNo.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("OFormNo")             '圖號
            DOFormSno.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("OFormSno")             '圖號
            ...
            DNFormNo.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("NFormNo")             '圖號
            If DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("NFormSno") = 0 Then
                DNFormSno.Text = ""
            Else
                DNFormSno.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("NFormSno")             '圖號
            End If
            ...
            SetFieldData("Target", DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Target"))
            DContent.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Content")             '圖號
            DDReason.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Reason")             '圖號
            If DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("AttachFile") <> "" Then          '圖檔1
                LAttachFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("AttachFile")
            Else
    ...
    Sub SetPopupFunction()
        ...
        BIn.Attributes("onclick") = "DevNoPicker('Out','000009');"      '外製
        BOMapNo.Attributes("onclick") = "MapPicker('Ori','000009');"             '原始圖號
        BMMapNo.Attributes("onclick") = "MapPicker('Mod','000009');"             '修改圖號
    ...
    Sub SetFieldData(ByVal pFieldName As String, ByVal pName As String)
        ...
        If pFieldName = "Target" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='300' and DKey='TARGET' Order by DKey, Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("000009", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(ConfigurationSettings.AppSettings.Get("ManufOutCTFilePath"))
        ...
        SQl = "Insert into F_ManufOutCTSheet "
        SQl = SQl + "( "
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQl = "Update F_ManufOutCTSheet Set "
        If pFun <> "SAVE" Then
            SQl = SQl + " Sts = '" & pSts & "',"
