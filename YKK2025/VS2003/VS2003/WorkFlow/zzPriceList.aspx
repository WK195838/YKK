<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PriceList.aspx.vb" Inherits="SPD.PriceList"%>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">
				<asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
					BackColor="White" Height="300px" Width="200px" AutoGenerateColumns="False" CellPadding="4"
					...
					<Columns>
						...
						<asp:BoundColumn DataField="Price" ReadOnly="True" HeaderText="單價">
