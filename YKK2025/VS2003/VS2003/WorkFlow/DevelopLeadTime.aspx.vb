...
#End Region
    ...
    Sub CreateWorkTable()
        ...
        SQL = SQL + "Step, StepName, SeqNo, CompletedTime, ReceiptTime, ApplyTime, AWorkTime "
        ...
        SQL = SQL + "  And FCompletedTime >= '" + wSDate + "' "
        SQL = SQL + "  And FCompletedTime <= '" + wEDate + "' "
