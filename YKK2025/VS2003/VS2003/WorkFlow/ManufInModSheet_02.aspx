		...
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
			<FONT face="新細明體">
				...
				<asp:image id="DManuaInSheet1" style="Z-INDEX: 100; LEFT: 8px; POSITION: absolute; TOP: 8px"
					...
					runat="server" Height="8px" Width="128px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">品質分析依賴書</asp:hyperlink>
				<asp:hyperlink id="LQAttachFile1" style="Z-INDEX: 230; LEFT: 16px; POSITION: absolute; TOP: 772px"
					runat="server" Height="8px" Width="64px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">其他附件</asp:hyperlink>
				...
				<asp:textbox id="DFormSno" style="Z-INDEX: 228; LEFT: 8px; POSITION: absolute; TOP: 1032px" runat="server"
					Height="20px" Width="97px" BorderStyle="None" ForeColor="Blue" BackColor="White">單號：123</asp:textbox><asp:image id="Image1" style="Z-INDEX: 227; LEFT: 8px; POSITION: absolute; TOP: 1032px" runat="server"
				...
				<asp:hyperlink id="LMapNo" style="Z-INDEX: 210; LEFT: 312px; POSITION: absolute; TOP: 296px" runat="server"
					Height="8px" Width="232px" Target="_blank" NavigateUrl="BoardEdit.aspx">圖號文件</asp:hyperlink><asp:textbox id="DFQAA3" style="Z-INDEX: 208; LEFT: 136px; POSITION: absolute; TOP: 824px" runat="server"
					...
					runat="server" Height="8px" Width="50px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">切結書</asp:hyperlink>
				<asp:hyperlink id="LRefFile" style="Z-INDEX: 132; LEFT: 120px; POSITION: absolute; TOP: 934px"
					runat="server" Height="8px" Width="64px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">其他文件</asp:hyperlink><asp:hyperlink id="LQAFile" style="Z-INDEX: 131; LEFT: 496px; POSITION: absolute; TOP: 934px" runat="server"
					Height="8px" Width="64px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">測試報告</asp:hyperlink><asp:textbox id="DPriceA3" style="Z-INDEX: 130; LEFT: 224px; POSITION: absolute; TOP: 568px"
					...
					runat="server" Height="8px" Width="50px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">樣品圖</asp:hyperlink><asp:dropdownlist id="DPerson" style="Z-INDEX: 124; LEFT: 520px; POSITION: absolute; TOP: 226px" runat="server"
					...
					runat="server" Height="8px" Width="50px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">授權書</asp:hyperlink>
				<asp:hyperlink id="LConfirmFile" style="Z-INDEX: 115; LEFT: 120px; POSITION: absolute; TOP: 968px"
					runat="server" Height="8px" Width="50px" Target="_blank" NavigateUrl="BoardEdit.aspx" Font-Size="12pt">確認書</asp:hyperlink>
