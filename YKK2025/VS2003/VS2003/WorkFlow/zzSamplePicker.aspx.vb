...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    End Sub
    Protected WithEvents DPriceSheet As System.Web.UI.WebControls.Image
...
#End Region
    ...
    Private Sub BDown_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BDown.Click
        Dim str As String = "[" & Dsize.SelectedValue & "," & DChainType.SelectedValue & "," & DBody.SelectedValue & "," & _
                                  DColor.Text & "," & DQty.Text & "]"
    ...
    Private Sub BClose_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BClose.Click
        Response.Write(String.Format("<script>window.opener.document.{0}.value = '{1:d}'; window.close();</script>", "Form1.DSample", DContent.Text))
