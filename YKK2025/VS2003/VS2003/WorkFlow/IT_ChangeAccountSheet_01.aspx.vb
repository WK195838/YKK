...
Public Class IT_ChangeAccountSheet_01
...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "IT_ChangeAccountSheet_01.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ChangeAccountSheet").Rows.Count > 0 Then
            ...
            SetFieldData("Fun1", DBDataSet1.Tables("F_ChangeAccountSheet").Rows(0).Item("Fun1"))
            SetFieldData("Fun2", DBDataSet1.Tables("F_ChangeAccountSheet").Rows(0).Item("Fun2"))
            SetFieldData("Fun3", DBDataSet1.Tables("F_ChangeAccountSheet").Rows(0).Item("Fun3"))
            SetFieldData("Fun4", DBDataSet1.Tables("F_ChangeAccountSheet").Rows(0).Item("Fun4"))
            ...
            SetFieldData("Engineer", DBDataSet1.Tables("F_ChangeAccountSheet").Rows(0).Item("Engineer"))
            SetFieldData("System", DBDataSet1.Tables("F_ChangeAccountSheet").Rows(0).Item("System"))
    ...
    Sub ShowSheetFunction()
        ...
        If wFormSno > 0 And wStep > 2 Then    '判斷是否[簽核]
            ...
            If DBDataSet1.Tables("T_WaitHandle").Rows.Count > 0 Then
                'Sheet顯示
                DChangeAccountSheet1.Visible = True   '表單Sheet-1
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        'Fun1
        Select Case FindFieldInf("Fun1")
            Case 0  '顯示
                DFun1.BackColor = Color.LightGray
                DFun1.Visible = True
            Case 1  '修改+檢查
                DFun1.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DFun1Rqd", "DFun1", "異常：需輸入變更機能")
                DFun1.Visible = True
            Case 2  '修改
                DFun1.BackColor = Color.Yellow
                DFun1.Visible = True
            Case Else   '隱藏
                DFun1.Visible = False
        End Select
        If pPost = "New" Then SetFieldData("Fun1", "ZZZZZZ")
        'Fun2
        Select Case FindFieldInf("Fun2")
            Case 0  '顯示
                DFun2.BackColor = Color.LightGray
                DFun2.Visible = True
            Case 1  '修改+檢查
                DFun2.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DFun2Rqd", "DFun2", "異常：需輸入變更機能")
                DFun2.Visible = True
            Case 2  '修改
                DFun2.BackColor = Color.Yellow
                DFun2.Visible = True
            Case Else   '隱藏
                DFun2.Visible = False
        End Select
        If pPost = "New" Then SetFieldData("Fun2", "ZZZZZZ")
        'Fun3
        Select Case FindFieldInf("Fun3")
            Case 0  '顯示
                DFun3.BackColor = Color.LightGray
                DFun3.Visible = True
            Case 1  '修改+檢查
                DFun3.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DFun3Rqd", "DFun3", "異常：需輸入變更機能")
                DFun3.Visible = True
            Case 2  '修改
                DFun3.BackColor = Color.Yellow
                DFun3.Visible = True
            Case Else   '隱藏
                DFun3.Visible = False
        End Select
        If pPost = "New" Then SetFieldData("Fun3", "ZZZZZZ")
        'Fun4
        Select Case FindFieldInf("Fun4")
            Case 0  '顯示
                DFun4.BackColor = Color.LightGray
                DFun4.Visible = True
            Case 1  '修改+檢查
                DFun4.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DFun4Rqd", "DFun4", "異常：需輸入變更機能")
                DFun4.Visible = True
            Case 2  '修改
                DFun4.BackColor = Color.Yellow
                DFun4.Visible = True
            Case Else   '隱藏
                DFun4.Visible = False
        End Select
        If pPost = "New" Then SetFieldData("Fun4", "ZZZZZZ")
        'Account1
        Select Case FindFieldInf("Account1")
            Case 0  '顯示
                DAccount1.BackColor = Color.LightGray
                DAccount1.ReadOnly = True
                DAccount1.Visible = True
            Case 1  '修改+檢查
                DAccount1.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DAccount1Rqd", "DAccount1", "異常：需輸入變更內容")
                DAccount1.Visible = True
            Case 2  '修改
                DAccount1.BackColor = Color.Yellow
                DAccount1.Visible = True
            Case Else   '隱藏
                DAccount1.Visible = False
        End Select
        If pPost = "New" Then DAccount1.Text = ""
        'Account2
        Select Case FindFieldInf("Account2")
            Case 0  '顯示
                DAccount2.BackColor = Color.LightGray
                DAccount2.ReadOnly = True
                DAccount2.Visible = True
            Case 1  '修改+檢查
                DAccount2.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DAccount2Rqd", "DAccount2", "異常：需輸入變更內容")
                DAccount2.Visible = True
            Case 2  '修改
                DAccount2.BackColor = Color.Yellow
                DAccount2.Visible = True
            Case Else   '隱藏
                DAccount2.Visible = False
        End Select
        If pPost = "New" Then DAccount2.Text = ""
        'Account3
        Select Case FindFieldInf("Account3")
            Case 0  '顯示
                DAccount3.BackColor = Color.LightGray
                DAccount3.ReadOnly = True
                DAccount3.Visible = True
            Case 1  '修改+檢查
                DAccount3.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DAccount3Rqd", "DAccount3", "異常：需輸入變更內容")
                DAccount3.Visible = True
            Case 2  '修改
                DAccount3.BackColor = Color.Yellow
                DAccount3.Visible = True
            Case Else   '隱藏
                DAccount3.Visible = False
        End Select
        If pPost = "New" Then DAccount3.Text = ""
        'Account4
        Select Case FindFieldInf("Account4")
            Case 0  '顯示
                DAccount4.BackColor = Color.LightGray
                DAccount4.ReadOnly = True
                DAccount4.Visible = True
            Case 1  '修改+檢查
                DAccount4.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DAccount4Rqd", "DAccount4", "異常：需輸入變更內容")
                DAccount4.Visible = True
            Case 2  '修改
                DAccount4.BackColor = Color.Yellow
                DAccount4.Visible = True
            Case Else   '隱藏
                DAccount4.Visible = False
        End Select
        If pPost = "New" Then DAccount4.Text = ""
        '預定開始日
    ...
    Sub SetFieldData(ByVal pFieldName As String, ByVal pName As String)
        ...
        If pFieldName = "Fun1" Then
            ...
            If idx = 0 Then
                If pName <> "ZZZZZZ" Then
                    ...
                    DFun1.Items.Add(ListItem1)
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='1106' and DKey='FUN' Order by Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
        ...
        If pFieldName = "Engineer" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='1106' and DKey='ENGINEER' Order by Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter1.Fill(DBDataSet1, "M_Referp")
                DBTable1 = DBDataSet1.Tables("M_Referp")
                For i = 0 To DBTable1.Rows.Count - 1
        ...
        If pFieldName = "System" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='1106' and DKey='SYSTEM' Order by Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter1.Fill(DBDataSet1, "M_Referp")
                DBTable1 = DBDataSet1.Tables("M_Referp")
                For i = 0 To DBTable1.Rows.Count - 1
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ...
                ErrCode = oCheckNo.CommissionNo("001106", wFormSno, wStep, DNo.Text)    '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(ConfigurationSettings.AppSettings.Get("ChangeAccountFilePath"))
        Dim UploadDateTime = CStr(DateTime.Now.Year) + CStr(DateTime.Now.Month) + CStr(DateTime.Now.Day) + _
                             CStr(DateTime.Now.Hour) + CStr(DateTime.Now.Minute) + CStr(DateTime.Now.Second)     '上傳日期
        ...
        SQl = "Insert into F_ChangeAccountSheet "
        SQl = SQl + "( "
        ...
        SQl = SQl + "FinishDate, BDays, Fun1, Fun2, Fun3, Fun4, Account1, Account2, Account3, Account4, "
        ...
        SQl = SQl + " '" + DBDays.Text + "', "
        SQl = SQl + " '" + DFun1.SelectedValue + "', "
        SQl = SQl + " '" + DFun2.SelectedValue + "', "
        SQl = SQl + " '" + DFun3.SelectedValue + "', "
        SQl = SQl + " '" + DFun4.SelectedValue + "', "
        SQl = SQl + " '" + DAccount1.Text + "', "
        SQl = SQl + " '" + DAccount2.Text + "', "
        SQl = SQl + " '" + DAccount3.Text + "', "
        SQl = SQl + " '" + DAccount4.Text + "', "
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQl = "Update F_ChangeAccountSheet Set "
        If pFun <> "SAVE" Then
            SQl = SQl + " Sts = '" & pSts & "',"
        ...
        SQl = SQl + " Fun1 = '" & DFun1.SelectedValue & "',"
        SQl = SQl + " Fun2 = '" & DFun2.SelectedValue & "',"
        SQl = SQl + " Fun3 = '" & DFun3.SelectedValue & "',"
        SQl = SQl + " Fun4 = '" & DFun4.SelectedValue & "',"
        SQl = SQl + " Account1 = '" & DAccount1.Text & "',"
        SQl = SQl + " Account2 = '" & DAccount2.Text & "',"
        SQl = SQl + " Account3 = '" & DAccount3.Text & "',"
        SQl = SQl + " Account4 = '" & DAccount4.Text & "',"
