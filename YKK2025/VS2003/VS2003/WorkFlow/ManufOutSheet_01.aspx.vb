...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents DWorkTime As System.Web.UI.WebControls.TextBox
    Protected WithEvents DCYCLETIME As System.Web.UI.WebControls.TextBox
    Protected WithEvents DAssembler1 As System.Web.UI.WebControls.DropDownList
...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "ManufOutSheet_01.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ManufOutSheet").Rows.Count > 0 Then
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo") <> "" Then                 '圖號
                ...
                Else
                    LMapNo.NavigateUrl = "MapModSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno"))
                End If
            Else
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo1") <> "" Then                 '圖號
                ...
                Else
                    LMapNo1.NavigateUrl = "MapModSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo1") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno1"))
                End If
            Else
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile2") <> "" Then       '樣品2-其他附件
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AssemblerFile") <> "" Then       '組立判定書 
                LAssemblerFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AssemblerFile")
            Else
                LAssemblerFile.Visible = False
            End If


            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("RefFile") <> "" Then          '其他附件 
            ...
            SetFieldData("Assembler1", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Assembler1"))                '難易度
            DAssembler.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Assembler")                 '組立
            DCYCLETIME.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Cycletime")                 'CYCLETIME
            DWorkTime.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Worktime")                 '稼動時間
            DLOSS.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("LOSS")                           'LOSS
            ...
            SetFieldData("Buyer", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Buyer"))  'Buyer
            ...
            DManufFlow.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ManufFlow")     '生產流程說明
            ...
            SetFieldData("Suppiler", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Suppiler"))    '外注商
    ...
    Sub ShowSheetFunction()
        ...
        If wFormSno > 0 And wStep > 2 Then      '判斷是否[簽核]
            ...
            If DBDataSet1.Tables("T_WaitHandle").Rows.Count > 0 Then
                ...
                LAssemblerFile.Visible = True    '組立判定書
        ...
        Else
            ...
            LAssemblerFile.Visible = False    '組立判定書 
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        '組立判定1
        Select Case FindFieldInf("Assembler1")
            Case 0  '顯示
                DAssembler1.BackColor = Color.LightGray
                DAssembler1.Visible = True
            Case 1  '修改+檢查
                DAssembler1.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DAssembler1Rqd", "DAssembler1", "異常：需輸入組立判定")
                DAssembler1.Visible = True
            Case 2  '修改
                DAssembler1.BackColor = Color.Yellow
                DAssembler1.Visible = True
            Case Else   '隱藏
                DAssembler1.Visible = False
        End Select
        If pPost = "New" Then SetFieldData("Assembler1", "ZZZZZZ")
        ...
        'Cycletime 
        Select Case FindFieldInf("CYCLETIME")
            Case 0  '顯示
                DCYCLETIME.BackColor = Color.LightGray
                DCYCLETIME.ReadOnly = True
                DCYCLETIME.Visible = True
            Case 1  '修改+檢查
                DCYCLETIME.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DCYCLETIMERqd", "DCYCLETIME", "異常：需輸入CYCLE TIME")
                DCYCLETIME.Visible = True
            Case 2  '修改
                DCYCLETIME.BackColor = Color.Yellow
                DCYCLETIME.Visible = True
            Case Else   '隱藏
                DCYCLETIME.Visible = False
        End Select

        'WorkTime 稼動時間
        Select Case FindFieldInf("WorkTime")
            Case 0  '顯示
                DWorkTime.BackColor = Color.LightGray
                DWorkTime.ReadOnly = True
                DWorkTime.Visible = True
            Case 1  '修改+檢查
                DWorkTime.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DWorkTimeRqd", "DWorkTime", "異常：需輸入稼動時間/日")
                DWorkTime.Visible = True
            Case 2  '修改
                DWorkTime.BackColor = Color.Yellow
                DWorkTime.Visible = True
            Case Else   '隱藏
                DWorkTime.Visible = False
        End Select
        ...
        Select Case FindFieldInf("ManufFlow")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DManufFlowRqd", "DManufFlow", "異常：需輸入生產流程說明")
                DManufFlow.Visible = True
            Case 2  '修改
        ...
        '組立判定書
        Select Case FindFieldInf("Quality2") '欄位不夠跟著 Quality2
            Case 0  '顯示
                DAssemblerFile.Visible = False
                DAssemblerFile.Style.Add("BACKGROUND-COLOR", "LightGrey")
            Case 1  '修改+檢查
                ShowRequiredFieldValidator("DAssemblerFileRqd", "DAssemblerFile", "異常：需輸入組立判定書")
        ...
        Select Case FindFieldInf("HalfList")
            ...
            Case 2  '修改
                ...
                'Modify-Start by 090505 by Joy
                If wStep = 156 Or wStep = 160 Or wStep = 165 Or wStep = 170 Then
                    DHAA5.BackColor = Color.GreenYellow
                    DHAA6.BackColor = Color.GreenYellow
                    ShowRequiredFieldValidator("DHAA5Rqd", "DHAA5", "異常：需輸入半成品資訊-1日產能")
                    ShowRequiredFieldValidator("DHAA6Rqd", "DHAA6", "異常：需輸入半成品資訊-基準日程")
                Else
    ...
    Sub SetFieldData(ByVal pFieldName As String, ByVal pName As String)
        ...
        If pFieldName = "Level" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='007' and (DKey like 'Out%' or DKey = '')  Order by DKey, Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter1.Fill(DBDataSet1, "M_Referp")
                DBTable1 = DBDataSet1.Tables("M_Referp")
                For i = 0 To DBTable1.Rows.Count - 1
        ...
        '組立判定1
        If pFieldName = "Assembler1" Then
            DAssembler1.Items.Clear()
            If idx = 0 Then
                If pName <> "ZZZZZZ" Then
                    Dim ListItem1 As New ListItem
                    ListItem1.Text = pName
                    ListItem1.Value = pName
                    DAssembler1.Items.Add(ListItem1)
                End If
            Else
        ...
        If pFieldName = "DQAA15" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DQAA15.Items.Count - 1
                    If DQAA15.Items(i).Value = pName Then
                        DQAA15.Items(i).Selected = True
                    Else
                        DQAA15.Items(i).Selected = False
                    End If
                Next
            End If
        End If
        ...
        If pFieldName = "DQAB15" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DQAB15.Items.Count - 1
                    If DQAB15.Items(i).Value = pName Then
                        DQAB15.Items(i).Selected = True
                    Else
                        DQAB15.Items(i).Selected = False
                    End If
                Next
            End If
        End If
        ...
        If pFieldName = "DQAC15" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DQAC15.Items.Count - 1
                    If DQAC15.Items(i).Value = pName Then
                        DQAC15.Items(i).Selected = True
                    Else
                        DQAC15.Items(i).Selected = False
                    End If
                Next
            End If
        End If
        ...
        If pFieldName = "DQAD15" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DQAD15.Items.Count - 1
                    If DQAD15.Items(i).Value = pName Then
                        DQAD15.Items(i).Selected = True
                    Else
                        DQAD15.Items(i).Selected = False
                    End If
                Next
            End If
        End If
        ...
        If pFieldName = "DFQAA2" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DFQAA2.Items.Count - 1
                    If DFQAA2.Items(i).Value = pName Then
                        DFQAA2.Items(i).Selected = True
                    Else
                        DFQAA2.Items(i).Selected = False
                    End If
                Next
            End If
        End If
        ...
        If pFieldName = "DFQAB2" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DFQAB2.Items.Count - 1
                    If DFQAB2.Items(i).Value = pName Then
                        DFQAB2.Items(i).Selected = True
                    Else
                        DFQAB2.Items(i).Selected = False
                    End If
                Next
            End If
        End If
        ...
        If pFieldName = "DFQAC2" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DFQAC2.Items.Count - 1
                    If DFQAC2.Items(i).Value = pName Then
                        DFQAC2.Items(i).Selected = True
                    Else
                        DFQAC2.Items(i).Selected = False
                    End If
                Next
            End If
        End If
        ...
        If pFieldName = "DFQAD2" Then
            If idx = 0 Then
                ...
                End If
            Else
                For i = 0 To DFQAD2.Items.Count - 1
                    If DFQAD2.Items(i).Value = pName Then
                        DFQAD2.Items(i).Selected = True
                    Else
                        DFQAD2.Items(i).Selected = False
                    End If
                Next
            End If
    ...
    Private Sub BSAVE_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BSAVE.ServerClick
        If Request.Cookies("RunBSAVE").Value = True Then
            If InputCheck() = 0 Then
                ...
                If ErrCode = 0 Then
                    If DAssemblerFile.Visible Then
                        If DAssemblerFile.PostedFile.FileName <> "" Then  '判斷有檔案上傳
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        ' 判斷拉片品名要存在M_PullerColor 20240119 JESSCIA 20240904修改在M_REFERP 增加MATERIAL     
        If ErrCode = 0 Then
            If wFormSno = 0 And wStep < 3 Then      '判斷是否起單
                ...
                SQL = SQL + " and dkey = 'ISIP'"
                SQL = SQL + " and charindex(data,'" + DMaterial.SelectedValue + " ') >0"
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter1.Fill(DBData, "M_referp")
                If DBData.Tables("M_referp").Rows.Count > 0 Then
                    '
                    Dim DBDataSet1 As New DataSet
                    Dim DBDataSet2 As New DataSet
                    Dim DBDataSet3 As New DataSet
                    '
                    ' ADD-START BY JOY 20250325
                    SQL = " Select SliderGrCode,Status from V_SPDPullerList "
                    SQL = SQL + " WHERE SliderGrCode = '" + DSliderGRCode.Text + "'"
                    Dim DBAdapter2 As New OleDbDataAdapter(SQL, OleDbConnection1)
                    DBAdapter2.Fill(DBDataSet1, "SPDPullerList")
                    If DBDataSet1.Tables("SPDPullerList").Rows.Count > 0 Then
                        If DBDataSet1.Tables("SPDPullerList").Rows(0).Item("Status") <> "OK" Then
                            ErrCode = 8020
                        End If
                    Else
                        ' 判斷拉片品名要存在M_PullerColor 20240308 JOYJOY
                        SQL = " Select Puller, COLOR, Createtime from M_PullerColor"
                        SQL = SQL + "  WHERE Puller+COLOR='" + DSliderGRCode.Text + "'"
                        SQL = SQL + "  OR    '" + DSliderGRCode.Text + "' LIKE Puller+COLOR+'-%' "
                        Dim DBAdapter3 As New OleDbDataAdapter(SQL, OleDbConnection1)
                        DBAdapter3.Fill(DBDataSet2, "PullerColor")
                        If DBDataSet2.Tables("PullerColor").Rows.Count = 0 Then
                            ErrCode = 8010
                        Else
                            SQL = " Select Puller, RegisterTime from V_PullerRegister "
                            SQL = SQL + " WHERE Puller = '" + DBDataSet2.Tables("PullerColor").Rows(0).Item("Puller") + "' "
                            SQL = SQL + " Order by RegisterTime "
                            Dim DBAdapter4 As New OleDbDataAdapter(SQL, OleDbConnection1)
                            DBAdapter4.Fill(DBDataSet3, "FirstPuller")
                            If DBDataSet3.Tables("FirstPuller").Rows.Count > 0 Then
                                '
                                If DBDataSet2.Tables("PullerColor").Rows(0).Item("Createtime") <> DBDataSet3.Tables("FirstPuller").Rows(0).Item("RegisterTime") Then
                                    ErrCode = 8030
                                End If
                            End If
                        End If
        ...
        'Check半成品-一日產能及基準日程
        If ErrCode = 0 Then
            If DHAA5.Visible Then
                If wStep = 156 Or wStep = 160 Or wStep = 165 Or wStep = 170 Then
                    If DHAA5.Text = "" Or DHAA6.Text = "" Then    '判斷是否為空白
                        ErrCode = 9070
                    End If
                End If
            End If
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("000007", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
        ...
        If ErrCode = 0 Then
            ...
            While Run = True
                ...
                If ErrCode = 0 And pRunNextStep = 1 Then
                    ...
                    Dim xMakeMap As String = ""
                    Dim OleDbConnection1 As New OleDbConnection
                    OleDbConnection1.ConnectionString = ConfigurationSettings.AppSettings.Get("SqlConn")  'SQL連結設定

                    OleDbConnection1.Open()
                    '製圖者(2010/4/12修正,2010/6/3修正, EA雅玲)
                    If (wStep = 60) Or (wStep = 170) Or (wStep = 540) Then     '客戶NG/自主NG=需再開發
                        '取得製圖者姓名
                        DBDataSet1.Clear()
                        If DOFormNo.Text = "000001" Then
                            SQL = "Select MakeMap From F_MapSheet "
                        Else
                            SQL = "Select MakeMap From F_MapModSheet "
                        End If
                        SQL = SQL + " Where FormNo  =  '" & DOFormNo.Text & "'"
                        SQL = SQL + "   And FormSno =  '" & DOFormSno.Text & "'"
                        Dim DBAdapter2 As New OleDbDataAdapter(SQL, OleDbConnection1)
                        DBAdapter2.Fill(DBDataSet1, "MapInf")
                        If DBDataSet1.Tables("MapInf").Rows.Count > 0 Then xMakeMap = DBDataSet1.Tables("MapInf").Rows(0).Item("MakeMap")
                        '取得製圖者ID
                        DBDataSet1.Clear()
                        SQL = "Select UserID From M_Users "
                        SQL = SQL & " Where Active = 1 "
                        SQL = SQL & "   And UserName =  '" & xMakeMap & "'"
                        Dim DBAdapter3 As New OleDbDataAdapter(SQL, OleDbConnection1)
        ...
        Else
            ...
            If ErrCode = 9070 Then Message = "需輸入一日產能及基準日程!"
            If ErrCode = 8010 Then Message = "ISIP CODE MASTER不存在!"
            If ErrCode = 8020 Then Message = "SPD拉片品名存在多個或非A!"
            If ErrCode = 8030 Then Message = "SPD拉片品名與原有SPD不符或非ISIP第一筆登錄!"
            '
            Response.Write(YKK.ShowMessage(Message))
        End If      '上傳檔案ErrCode=0
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        OleDbConnection1.Open()
        SQl = "Insert into F_ManufOutSheet "
        SQl = SQl + "( "
        ...
        SQl = SQl + "Level,Assembler1, Assembler,CYCLETIME,WorkTime, LOSS, SliderType1, SliderType2, ManufPlace, "      '15~19
        ...
        SQl = SQl + "SAttachFile, QAttachFile1, QAttachFile2,AssemblerFile, QCLT, "               '39~42
        ...
        SQl = SQl + " '" + DLogo.SelectedValue + "', "      'Logo
        ...
        SQl = SQl + " '" + YKK.ReplaceString(DMapNo1.Text) + "', "              '圖號
        ...
        SQl = SQl + " '" + DAssembler1.SelectedValue + "', "           '組立判定1
        SQl = SQl + " N'" + YKK.ReplaceString(DAssembler.Text) + "', "         '組立判定
        SQl = SQl + " N'" + YKK.ReplaceString(DCYCLETIME.Text) + "', "              'Cycletime
        SQl = SQl + " N'" + YKK.ReplaceString(DWorkTime.Text) + "', "              '稼動時間
        SQl = SQl + " N'" + YKK.ReplaceString(DLOSS.Text) + "', "              'LOSS
        ...
        SQl = SQl + " N'" + YKK.ReplaceString(DCustomerCode.Text) + "', "             'Customer Code
        ...
        SQl = SQl + " N'" + YKK.ReplaceString(DManufFlow.Text) + "', "          '生產流程說明
        ...
        SQl = SQl + " '" + YKK.ReplaceString(DPullerPrice1.Text) + "', "        '引手購入單價
        ...
        SQl = SQl + " '" + DOFormNo1.Text + "', "         '表單
        SQl = SQl + " '" + DOFormSno1.Text + "', "        '單號

        If DHAA1.Text <> "" Then                          '半成品List
            SQl = SQl + " '1', "
        Else
            SQl = SQl + " '0', "
        End If
        SQl = SQl + " N'" + YKK.ReplaceString(DHADesc.Text) + "', "           '半成品說明
        ...
        FileName = ""
        If DAssemblerFile.Visible Then                      '組立判定書
            If DAssemblerFile.PostedFile.FileName <> "" Then     '判斷有檔案上傳
                '*** IE8對應-Start 2011/1/4
                'FileName = CStr(NewFormSno) & "-" & "AssemblerFile" & "-" & UploadDateTime & "-" & Right(DAssemblerFile.PostedFile.FileName, InStr(StrReverse(DAssemblerFile.PostedFile.FileName), "\") - 1)
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQl = SQl + " Assembler1 = '" & DAssembler1.SelectedValue & "',"
        SQl = SQl + " Assembler = N'" & YKK.ReplaceString(DAssembler.Text) & "',"
        SQl = SQl + " CYCLETIME = N'" & YKK.ReplaceString(DCYCLETIME.Text) & "',"
        SQl = SQl + " WORKTIME = N'" & YKK.ReplaceString(DWorkTime.Text) & "',"
        SQl = SQl + " LOSS = N'" & YKK.ReplaceString(DLOSS.Text) & "',"
        ...
        If DAssemblerFile.Visible Then
            If DAssemblerFile.PostedFile.FileName <> "" Then  '判斷有檔案上傳
                '*** IE8對應-Start 2011/1/4
                'FileName = CStr(wFormSno) & "-" & "AssemblerFile" & "-" & UploadDateTime & "-" & Right(DAssemblerFile.PostedFile.FileName, InStr(StrReverse(DAssemblerFile.PostedFile.FileName), "\") - 1)
            ...
            If DBDataSet1.Tables("F_ManufCOQA1").Rows.Count > 0 Then
                ...
                Select Case i
                    Case Is = 1
                        ...
                        SQl = SQl + " EDX = '" + DQAA15.SelectedValue + "', "
                    Case Is = 2
                        ...
                        SQl = SQl + " EDX = '" + DQAB15.SelectedValue + "', "
                    Case Is = 3
                        ...
                        SQl = SQl + " EDX = '" + DQAC15.SelectedValue + "', "
                    Case Is = 4
                        ...
                        SQl = SQl + " EDX = '" + DQAD15.SelectedValue + "', "
                End Select
                SQl = SQl + " CompletedTime = '" & NowDateTime & "',"
                SQl = SQl + " ModifyUser = '" & Request.QueryString("pUserID") & "',"
                SQl = SQl + " ModifyTime = '" & NowDateTime & "' "
        ...
        For i = 1 To 4
            ...
            SQl = SQl + "   And SeqNo   =  '" & CStr(i) & "'"
            Dim DBAdapter1 As New OleDbDataAdapter(SQl, OleDbConnection1)
            DBAdapter1.Fill(DBDataSet1, "F_ManufCOHalf")
            If DBDataSet1.Tables("F_ManufCOHalf").Rows.Count > 0 Then
                SQl = "Update F_ManufCOHalf Set "
                Select Case i
                    Case Is = 1
                        SQl = SQl + " Code1 = '" + YKK.ReplaceString(DHAA1.Text) + "', "
                        SQl = SQl + " Code2 = '" + YKK.ReplaceString(DHAA2.Text) + "', "
                        SQl = SQl + " Code3 = '" + YKK.ReplaceString(DHAA3.Text) + "', "
                        SQl = SQl + " Code4 = '" + YKK.ReplaceString(DHAA4.Text) + "', "
                        SQl = SQl + " Cap = '" + YKK.ReplaceString(DHAA5.Text) + "', "
                        SQl = SQl + " Schedule = '" + YKK.ReplaceString(DHAA6.Text) + "', "
                        SQl = SQl + " ORNo = '" + YKK.ReplaceString(DHAA7.Text) + "', "
                        SQl = SQl + " BCompletedTime = '" + YKK.ReplaceString(DHAA8.Text) + "', "
                        SQl = SQl + " Remark = '" + YKK.ReplaceString(DHAA9.Text) + "', "
                    Case Is = 2
                        SQl = SQl + " Code1 = '" + YKK.ReplaceString(DHAB1.Text) + "', "
                        SQl = SQl + " Code2 = '" + YKK.ReplaceString(DHAB2.Text) + "', "
                        SQl = SQl + " Code3 = '" + YKK.ReplaceString(DHAB3.Text) + "', "
                        SQl = SQl + " Code4 = '" + YKK.ReplaceString(DHAB4.Text) + "', "
                        SQl = SQl + " Cap = '" + YKK.ReplaceString(DHAB5.Text) + "', "
                        SQl = SQl + " Schedule = '" + YKK.ReplaceString(DHAB6.Text) + "', "
                        SQl = SQl + " ORNo = '" + YKK.ReplaceString(DHAB7.Text) + "', "
                        SQl = SQl + " BCompletedTime = '" + YKK.ReplaceString(DHAB8.Text) + "', "
                        SQl = SQl + " Remark = '" + YKK.ReplaceString(DHAB9.Text) + "', "
                    Case Is = 3
                        SQl = SQl + " Code1 = '" + YKK.ReplaceString(DHAC1.Text) + "', "
                        SQl = SQl + " Code2 = '" + YKK.ReplaceString(DHAC2.Text) + "', "
                        SQl = SQl + " Code3 = '" + YKK.ReplaceString(DHAC3.Text) + "', "
                        SQl = SQl + " Code4 = '" + YKK.ReplaceString(DHAC4.Text) + "', "
                        SQl = SQl + " Cap = '" + YKK.ReplaceString(DHAC5.Text) + "', "
                        SQl = SQl + " Schedule = '" + YKK.ReplaceString(DHAC6.Text) + "', "
                        SQl = SQl + " ORNo = '" + YKK.ReplaceString(DHAC7.Text) + "', "
                        SQl = SQl + " BCompletedTime = '" + YKK.ReplaceString(DHAC8.Text) + "', "
                        SQl = SQl + " Remark = '" + YKK.ReplaceString(DHAC9.Text) + "', "
                    Case Is = 4
                        SQl = SQl + " Code1 = '" + YKK.ReplaceString(DHAD1.Text) + "', "
                        SQl = SQl + " Code2 = '" + YKK.ReplaceString(DHAD2.Text) + "', "
                        SQl = SQl + " Code3 = '" + YKK.ReplaceString(DHAD3.Text) + "', "
                        SQl = SQl + " Code4 = '" + YKK.ReplaceString(DHAD4.Text) + "', "
                        SQl = SQl + " Cap = '" + YKK.ReplaceString(DHAD5.Text) + "', "
                        SQl = SQl + " Schedule = '" + YKK.ReplaceString(DHAD6.Text) + "', "
                        SQl = SQl + " ORNo = '" + YKK.ReplaceString(DHAD7.Text) + "', "
                        SQl = SQl + " BCompletedTime = '" + YKK.ReplaceString(DHAD8.Text) + "', "
                        SQl = SQl + " Remark = '" + YKK.ReplaceString(DHAD9.Text) + "', "
                End Select
                SQl = SQl + " CompletedTime = '" & NowDateTime & "',"
                SQl = SQl + " ModifyUser = '" & Request.QueryString("pUserID") & "',"
                SQl = SQl + " ModifyTime = '" & NowDateTime & "' "
    ...
    Function InputCheck() As Integer
        ...
        'LOGO
        If InputCheck = 0 Then
            If FindFieldInf("Logo") = 1 Then
                If DLogo.SelectedValue = "" Then InputCheck = 1
            End If
        End If
        'Slider Group Code
        If InputCheck = 0 Then
        ...
        '圖號-1
        If InputCheck = 0 Then
            If FindFieldInf("MapNo1") = 1 Then
                If DMapNo1.Text = "" Then InputCheck = 1
            End If
        End If
        '原始表單號碼
        If InputCheck = 0 Then
        ...
        '原始表單號碼-1
        If InputCheck = 0 Then
            If FindFieldInf("OFormNo1") = 1 Then
                If DOFormNo1.Text = "" Then InputCheck = 1
            End If
        End If
        '原始單號-1
        If InputCheck = 0 Then
            If FindFieldInf("OFormSno1") = 1 Then
                If DOFormSno1.Text = "" Then InputCheck = 1
            End If
        End If
        '難易度
        If InputCheck = 0 Then
        ...
        '組立判定1
        If InputCheck = 0 Then
            If FindFieldInf("Assembler1") = 1 Then
                If DAssembler1.SelectedValue = "" Then InputCheck = 1
            End If
        End If
        ...
        'CYCLETIME
        If InputCheck = 0 Then
            If FindFieldInf("CYCLETIME") = 1 Then
                If DCYCLETIME.Text = "" Then InputCheck = 1
            End If
        End If
        'WORKTIME
        If InputCheck = 0 Then
            If FindFieldInf("WORKTIME") = 1 Then
                If DWorkTime.Text = "" Then InputCheck = 1
            End If
        End If
        ...
        'Customer Code
        If InputCheck = 0 Then
            If FindFieldInf("CustomerCode") = 1 Then
                If DCustomerCode.Text = "" Then InputCheck = 1
            End If
        End If
        'QC-L/T
        If InputCheck = 0 Then
        ...
        '引手購入單價1
        If InputCheck = 0 Then
            If FindFieldInf("PullerPrice1") = 1 Then
                If DPullerPrice1.Text = "" Then InputCheck = 1
            End If
        End If
        '外注商
        If InputCheck = 0 Then
        ...
        If InputCheck = 0 Then
            If FindFieldInf("Quality1") = 1 Then
                ...
                If DQAA15.SelectedValue = "" Then InputCheck = 1
                ...
                If DQAB15.SelectedValue = "" Then InputCheck = 1
                ...
                If DQAC15.SelectedValue = "" Then InputCheck = 1
                ...
                If DQAD15.SelectedValue = "" Then InputCheck = 1
            End If
        End If
        'Quality2
        If InputCheck = 0 Then
        ...
        '半成品
        If InputCheck = 0 Then
            If FindFieldInf("HalfList") = 1 Then
                If DHAA1.Text = "" Then InputCheck = 1
                If DHAA2.Text = "" Then InputCheck = 1
                If DHAA3.Text = "" Then InputCheck = 1
                If DHAA4.Text = "" Then InputCheck = 1
                If DHAA5.Text = "" Then InputCheck = 1
                If DHAA6.Text = "" Then InputCheck = 1
                If DHAA7.Text = "" Then InputCheck = 1
                If DHAA8.Text = "" Then InputCheck = 1
                If DHAA9.Text = "" Then InputCheck = 1
                If DHAB1.Text = "" Then InputCheck = 1
                If DHAB2.Text = "" Then InputCheck = 1
                If DHAB3.Text = "" Then InputCheck = 1
                If DHAB4.Text = "" Then InputCheck = 1
                If DHAB5.Text = "" Then InputCheck = 1
                If DHAB6.Text = "" Then InputCheck = 1
                If DHAB7.Text = "" Then InputCheck = 1
                If DHAB8.Text = "" Then InputCheck = 1
                If DHAB9.Text = "" Then InputCheck = 1
                If DHAC1.Text = "" Then InputCheck = 1
                If DHAC2.Text = "" Then InputCheck = 1
                If DHAC3.Text = "" Then InputCheck = 1
                If DHAC4.Text = "" Then InputCheck = 1
                If DHAC5.Text = "" Then InputCheck = 1
                If DHAC6.Text = "" Then InputCheck = 1
                If DHAC7.Text = "" Then InputCheck = 1
                If DHAC8.Text = "" Then InputCheck = 1
                If DHAC9.Text = "" Then InputCheck = 1
                If DHAD1.Text = "" Then InputCheck = 1
                If DHAD2.Text = "" Then InputCheck = 1
                If DHAD3.Text = "" Then InputCheck = 1
                If DHAD4.Text = "" Then InputCheck = 1
                If DHAD5.Text = "" Then InputCheck = 1
                If DHAD6.Text = "" Then InputCheck = 1
                If DHAD7.Text = "" Then InputCheck = 1
                If DHAD8.Text = "" Then InputCheck = 1
                If DHAD9.Text = "" Then InputCheck = 1
            End If
            If FindFieldInf("HalfList") = 2 Then
                If wStep = 156 Or wStep = 160 Or wStep = 165 Or wStep = 170 Then
                    If DHAA5.Text = "" Then InputCheck = 1
                    If DHAA6.Text = "" Then InputCheck = 1
                End If
        ...
        '半成品說明
        If InputCheck = 0 Then
            If FindFieldInf("HADesc") = 1 Then
                If DHADesc.Text = "" Then InputCheck = 1
            End If
        End If
