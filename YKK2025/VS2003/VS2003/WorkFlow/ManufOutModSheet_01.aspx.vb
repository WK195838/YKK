...
Public Class ManufOutModSheet_01
...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents DHAD9 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD8 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD7 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD6 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD5 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD4 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD3 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD2 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAD1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC9 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC8 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC7 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC6 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC5 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC4 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC3 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC2 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAC1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB9 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB8 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB7 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB6 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB5 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB4 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB3 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB2 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAB1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA9 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA8 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA7 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA6 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA5 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA4 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA3 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA2 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHAA1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DHADesc As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents DOFormSno1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DOFormNo1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents BMMapNo1 As System.Web.UI.WebControls.Button
    Protected WithEvents BOMapNo1 As System.Web.UI.WebControls.Button
    Protected WithEvents LMapNo1 As System.Web.UI.WebControls.HyperLink
    Protected WithEvents DMapNo1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents DManufFlow As System.Web.UI.WebControls.TextBox
    Protected WithEvents DPullerPrice1 As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("MapNo1").Value = ""       '圖號, MapPicker使用

        Response.Cookies("PGM").Value = "ManufOutModSheet_01.aspx"
    ...
    '*****************************************************************
    Sub ShowFormData()
        Dim Path As String = ConfigurationSettings.AppSettings.Get("Http") & ConfigurationSettings.AppSettings.Get("ManufOutFilePath")
        ...
        SQL = "Select * From F_ManufOutModSheet "
        SQL = SQL & " Where FormNo =  '" & wFormNo & "'"
        SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
        Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
        DBAdapter1.Fill(DBDataSet1, "F_ManufOutModSheet")
        If DBDataSet1.Tables("F_ManufOutModSheet").Rows.Count > 0 Then
            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapFile") <> "" Then          '圖樣
                LMapFile.ImageUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapFile")
            Else
                LMapFile.Visible = False
            End If

            DNo.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("No")                       'No
            DDate.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Date")                   '日期
            SetFieldData("Division", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Division"))  '部門
            SetFieldData("Person", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Person"))      '擔當
            SetFieldData("Cpsc", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Cpsc"))          'Cpsc
            SetFieldData("Logo", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Logo"))          'Logo

            DSliderCode.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderCode")       'Slider Code
            DSliderGRCode.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderGRCode")   'Slider Group Code
            DSpec.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Spec")                   '規格
            DMapNo.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo")                 '圖號
            DMapNo1.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo1")                 '圖號
            DOFormNo.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo")             '原表單
            DOFormSno.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno")           '原單號
            DOFormNo1.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo1")             '原表單
            DOFormSno1.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno1")           '原單號

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo") <> "" Then                 '圖號
                LMapNo.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo")
                If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo") = "000001" Then
                    LMapNo.NavigateUrl = "MapSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno"))
                Else
                    LMapNo.NavigateUrl = "MapSheetMod_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno"))
                End If
            Else
            ...
            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo1") <> "" Then                 '圖號
                LMapNo1.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo1")
                If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo1") = "000001" Then
                    LMapNo1.NavigateUrl = "MapSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo1") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno1"))
                Else
                    LMapNo1.NavigateUrl = "MapSheetMod_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo1") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno1"))
                End If
            Else
                LMapNo1.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SAttachFile") <> "" Then       '樣品-其他附件
                LSAttachFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SAttachFile")
            Else
                LSAttachFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAttachFile1") <> "" Then      '品質1-其他附件
                LQAttachFile1.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAttachFile1")
            Else
                LQAttachFile1.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAttachFile2") <> "" Then       '樣品2-其他附件
                LQAttachFile2.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAttachFile2")
            Else
                LQAttachFile2.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("RefFile") <> "" Then          '其他附件 
                LRefFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("RefFile")
            Else
                LRefFile.Visible = False
            End If

            SetFieldData("Level", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Level"))                '難易度
            DAssembler.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Assembler")                 '組立
            SetFieldData("SliderType1", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderType1"))    '拉頭種類1
            SetFieldData("SliderType2", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderType2"))    '拉頭種類2
            SetFieldData("ManufPlace", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ManufPlace"))      '生產地
            SetFieldData("Material", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Material"))              '材質
            DBuyer.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Buyer")             'Buyer
            DSellVendor.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SellVendor")   '委託廠商
            DCustomerCode.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("CustomerCode")   'Customer Code

            DQCLT.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QCLT")               'QC-L/T

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ConfirmFile") <> "" Then       '確認書
                LConfirmFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ConfirmFile")
            Else
                LConfirmFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("AuthorizeFile") <> "" Then     '授權書
                LAuthorizeFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("AuthorizeFile")
            Else
                LAuthorizeFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ForCastFile") <> "" Then     '報價單
                LForCastFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ForCastFile")
            Else
                LForCastFile.Visible = False
            End If

            DDevReason.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("DevReason")     '開發理由
            DManufFlow.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ManufFlow")     '

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Sample") = 1 Then              '樣品
            ...
            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SampleFile") <> "" Then        '樣品檔
                LSampleFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SampleFile")
            Else
                LSampleFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Price") = 1 Then               '單價
                Dim DBTable1 As DataTable
            ...
            DArMoldFee.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ArMoldFee")     '應收模具費
            DPurMold.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("PurMold")         '模具購入費
            DPullerPrice.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("PullerPrice") '引手購入價
            DPullerPrice1.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("PullerPrice1") '引手購入價

            DSuppiler.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Suppiler")       '外注商
            DMoldQty.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MoldQty")         '模型
            DMoldPoint.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MoldPoint")     '穴取

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Quality1") = 1 Then            '品質1
                Dim DBTable1 As DataTable
            ...
            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Quality2") = 1 Then            '品質2
                Dim DBTable1 As DataTable
            ...
            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("HalfList") = 1 Then            '半成品
                Dim DBTable1 As DataTable
                SQL = "Select * From F_ManufCOHalf "
                SQL = SQL & " Where FormNo =  '" & wFormNo & "'"
                SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
                SQL = SQL & " Order by Seqno"
                Dim DBAdapter3 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter3.Fill(DBDataSet1, "ManufCOHalf")
                DBTable1 = DBDataSet1.Tables("ManufCOHalf")
                For i = 0 To DBTable1.Rows.Count - 1
                    Select Case DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Seqno")
                        Case 1
                            DHAA1.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code1")
                            DHAA2.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code2")
                            DHAA3.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code3")
                            DHAA4.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code4")
                            DHAA5.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Cap")
                            DHAA6.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Schedule")
                            DHAA7.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("ORNo")
                            DHAA8.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("BCompletedTime")
                            DHAA9.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Remark")
                        Case 2
                            DHAB1.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code1")
                            DHAB2.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code2")
                            DHAB3.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code3")
                            DHAB4.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code4")
                            DHAB5.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Cap")
                            DHAB6.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Schedule")
                            DHAB7.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("ORNo")
                            DHAB8.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("BCompletedTime")
                            DHAB9.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Remark")
                        Case 3
                            DHAC1.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code1")
                            DHAC2.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code2")
                            DHAC3.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code3")
                            DHAC4.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code4")
                            DHAC5.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Cap")
                            DHAC6.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Schedule")
                            DHAC7.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("ORNo")
                            DHAC8.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("BCompletedTime")
                            DHAC9.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Remark")
                        Case Else
                            DHAD1.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code1")
                            DHAD2.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code2")
                            DHAD3.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code3")
                            DHAD4.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Code4")
                            DHAD5.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Cap")
                            DHAD6.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Schedule")
                            DHAD7.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("ORNo")
                            DHAD8.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("BCompletedTime")
                            DHAD9.Text = DBDataSet1.Tables("ManufCOHalf").Rows(i).Item("Remark")
                    End Select
                Next
            End If
            DHADesc.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("HADesc")     '半成品說明

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAFile") <> "" Then      '測試報告
                LQAFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAFile")
            Else
                LQAFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ContactFile") <> "" Then      '切結書
                LContactFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ContactFile")
            Else
                LContactFile.Visible = False
            End If

            DFormSno.Text = "單號：" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("FormSno")       '單號
        End If
        'DB連結關閉
    ...
    Sub ShowOriFormData()
        ...
        If DBDataSet1.Tables("F_ManufOutSheet").Rows.Count > 0 Then
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapFile") <> "" Then          '圖樣
                LMapFile.ImageUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapFile")
            Else
                LMapFile.Visible = False
            End If

            DNo.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("No")                       'No
            SetFieldData("Division", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Division"))  '部門
            SetFieldData("Person", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Person"))      '擔當
            SetFieldData("Cpsc", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Cpsc"))          'Cpsc
            SetFieldData("Logo", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Logo"))          'Logo

            DSliderCode.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderCode")       'Slider Code
            DSliderGRCode.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderGRCode")   'Slider Group Code
            DSpec.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Spec")                   '規格
            DMapNo.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo")                 '圖號
            DMapNo1.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo1")                 '圖號
            DOFormNo.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo")             '原表單
            DOFormSno.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno")           '原單號
            DOFormNo1.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo1")             '原表單
            DOFormSno1.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno1")           '原單號

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo") <> "" Then                 '圖號
                LMapNo.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo")
                If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo") = "000001" Then
                    LMapNo.NavigateUrl = "MapSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno"))
                Else
                    LMapNo.NavigateUrl = "MapSheetMod_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno"))
                End If
            Else
                LMapNo.Visible = False
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo1") <> "" Then                 '圖號
                LMapNo1.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo1")
                If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo1") = "000001" Then
                    LMapNo1.NavigateUrl = "MapSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo1") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno1"))
                Else
                    LMapNo1.NavigateUrl = "MapSheetMod_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo1") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno1"))
                End If
            Else
                LMapNo1.Visible = False
            ...
            DBuyer.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Buyer")             'Buyer
            DSellVendor.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SellVendor")   '委託廠商
            DCustomerCode.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("CustomerCode")   'Customer Code

            DQCLT.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QCLT")               'QC-L/T

            SetFieldData("Level", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Level"))                '難易度
            DAssembler.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Assembler")                 '組立
            SetFieldData("SliderType1", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderType1"))    '拉頭種類1
            SetFieldData("SliderType2", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderType2"))    '拉頭種類2
            SetFieldData("ManufPlace", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ManufPlace"))      '生產地
            SetFieldData("Material", DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Material"))              '材質
            DSuppiler.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Suppiler")       '外注商

            '----------------------------------------------------------------------------
            'DDate.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Date")                   '日期
            DDate.Text = CStr(DateTime.Now.Today)

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SAttachFile") <> "" Then       '樣品-其他附件
                LSAttachFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SAttachFile")
            Else
                LSAttachFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile1") <> "" Then      '品質1-其他附件
                LQAttachFile1.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile1")
            Else
                LQAttachFile1.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile2") <> "" Then       '樣品2-品質分析依賴書
                LQAttachFile2.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile2")
            Else
                LQAttachFile2.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("RefFile") <> "" Then          '生產條件 
                LRefFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("RefFile")
            Else
                LRefFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ConfirmFile") <> "" Then       '確認書
                LConfirmFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ConfirmFile")
            Else
                LConfirmFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AuthorizeFile") <> "" Then     '授權書
                LAuthorizeFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AuthorizeFile")
            Else
                LAuthorizeFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ForCastFile") <> "" Then     '報價單
                LForCastFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ForCastFile")
            Else
                LForCastFile.Visible = False
            End If

            DDevReason.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("DevReason")     '開發理由
            DManufFlow.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ManufFlow")     '

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Sample") = 1 Then              '樣品
                Dim DBTable1 As DataTable
                SQL = "Select * From F_ManufCOSample "
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SampleFile") <> "" Then        '樣品檔
                LSampleFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SampleFile")
            Else
                LSampleFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Price") = 1 Then               '單價
                Dim DBTable1 As DataTable
                SQL = "Select * From F_ManufCOPrice "
                SQL = SQL & " Where FormNo =  '" & wOFormNo & "'"
                SQL = SQL & "   And FormSno =  '" & CStr(wOFormSno) & "'"
            ...
            DArMoldFee.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ArMoldFee")     '應收模具費
            DPurMold.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("PurMold")         '模具購入費
            DPullerPrice.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("PullerPrice") '引手購入價
            DPullerPrice1.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("PullerPrice1") '引手購入價

            DSuppiler.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Suppiler")       '外注商
            DMoldQty.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MoldQty")         '模型
            DMoldPoint.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MoldPoint")     '穴取

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Quality1") = 1 Then            '品質1
                Dim DBTable1 As DataTable
                SQL = "Select * From F_ManufCOQA1 "
                SQL = SQL & " Where FormNo =  '" & wOFormNo & "'"
                SQL = SQL & "   And FormSno =  '" & CStr(wOFormSno) & "'"
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Quality2") = 1 Then            '品質2
                Dim DBTable1 As DataTable
                SQL = "Select * From F_ManufCOQA2 "
                SQL = SQL & " Where FormNo =  '" & wOFormNo & "'"
                SQL = SQL & "   And FormSno =  '" & CStr(wOFormSno) & "'"
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("HalfList") = 1 Then            '半成品
                Dim DBTable1 As DataTable
                SQL = "Select * From F_ManufCOHalf "
                SQL = SQL & " Where FormNo =  '" & wOFormNo & "'"
                SQL = SQL & "   And FormSno =  '" & CStr(wOFormSno) & "'"
                ...
                Next
            End If
            DHADesc.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("HADesc")     '半成品說明

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAFile") <> "" Then      '測試報告
                LQAFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAFile")
            Else
                LQAFile.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ContactFile") <> "" Then      '切結書
                LContactFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ContactFile")
            Else
                LContactFile.Visible = False
            End If
    ...
    Sub SetPopupFunction()
        ...
        BOMapNo1.Attributes("onclick") = "MapPicker('Ori1');"             '原始圖號
        BMMapNo1.Attributes("onclick") = "MapPicker('Mod1');"             '修改圖號
    End Sub
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        '圖號
        Select Case FindFieldInf("MapNo1")
            Case 0  '顯示
                DMapNo1.BackColor = Color.LightGray
                DMapNo1.ReadOnly = True
                DMapNo1.Visible = False
                BOMapNo1.Visible = False
                BMMapNo1.Visible = False
            Case 1  '修改+檢查
                DMapNo1.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DMapNo1Rqd", "DMapNo1", "異常：需輸入圖號")
                DMapNo1.Visible = True
                BOMapNo1.Visible = True
                BMMapNo1.Visible = True
            Case 2  '修改
                DMapNo1.BackColor = Color.Yellow
                DMapNo1.Visible = True
                BOMapNo1.Visible = True
                BMMapNo1.Visible = True
            Case Else   '隱藏
                ...
                BMMapNo1.Visible = False
        End Select
        If pPost = "New" Then DMapNo1.Text = ""
        ...
        '原始表單號碼
        Select Case FindFieldInf("OFormNo1")
            Case 0  '顯示
                DOFormNo1.BackColor = Color.LightGray
                DOFormNo1.ReadOnly = True
                DOFormNo1.Visible = True
            Case 1  '修改+檢查
                DOFormNo1.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DOFormNo1Rqd", "DOFormNo1", "異常：需輸入圖號")
                DOFormNo1.Visible = True
            Case 2  '修改
                DOFormNo1.BackColor = Color.Yellow
                DOFormNo1.Visible = True
            Case Else   '隱藏
                DOFormNo1.Visible = False
        End Select
        If pPost = "New" Then DOFormNo1.Text = ""
        '原始單號
        Select Case FindFieldInf("OFormSno1")
            Case 0  '顯示
                DOFormSno1.BackColor = Color.LightGray
                DOFormSno1.ReadOnly = True
                DOFormSno1.Visible = True
            Case 1  '修改+檢查
                DOFormSno1.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DOFormSno1Rqd", "DOFormSno1", "異常：需輸入圖號")
                DOFormSno1.Visible = True
            Case 2  '修改
                DOFormSno1.BackColor = Color.Yellow
                DOFormSno1.Visible = True
            Case Else   '隱藏
                DOFormSno1.Visible = False
        End Select
        If pPost = "New" Then DOFormSno1.Text = ""
        ...
        '引手購入單價
        Select Case FindFieldInf("PullerPrice1")
            Case 0  '顯示
                DPullerPrice1.BackColor = Color.LightGray
                DPullerPrice1.ReadOnly = True
                DPullerPrice1.Visible = True
            Case 1  '修改+檢查
                DPullerPrice1.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DPullerPrice1Rqd", "DPullerPrice1", "異常：需輸入引手購入單價")
                DPullerPrice1.Visible = True
            Case 2  '修改
                DPullerPrice1.BackColor = Color.Yellow
                DPullerPrice1.Visible = True
            Case Else   '隱藏
                DPullerPrice1.Visible = False
        End Select
        If pPost = "New" Then DPullerPrice1.Text = ""
        '外注商
        ...
        '半成品
        Select Case FindFieldInf("HalfList")
            Case 0  '顯示
                DHAA1.BackColor = Color.LightGray
                DHAA2.BackColor = Color.LightGray
                DHAA3.BackColor = Color.LightGray
                DHAA4.BackColor = Color.LightGray
                DHAA5.BackColor = Color.LightGray
                DHAA6.BackColor = Color.LightGray
                DHAA7.BackColor = Color.LightGray
                DHAA8.BackColor = Color.LightGray
                DHAA9.BackColor = Color.LightGray
                DHAB1.BackColor = Color.LightGray
                DHAB2.BackColor = Color.LightGray
                DHAB3.BackColor = Color.LightGray
                DHAB4.BackColor = Color.LightGray
                DHAB5.BackColor = Color.LightGray
                DHAB6.BackColor = Color.LightGray
                DHAB7.BackColor = Color.LightGray
                DHAB8.BackColor = Color.LightGray
                DHAB9.BackColor = Color.LightGray
                DHAC1.BackColor = Color.LightGray
                DHAC2.BackColor = Color.LightGray
                DHAC3.BackColor = Color.LightGray
                DHAC4.BackColor = Color.LightGray
                DHAC5.BackColor = Color.LightGray
                DHAC6.BackColor = Color.LightGray
                DHAC7.BackColor = Color.LightGray
                DHAC8.BackColor = Color.LightGray
                DHAC9.BackColor = Color.LightGray
                DHAD1.BackColor = Color.LightGray
                DHAD2.BackColor = Color.LightGray
                DHAD3.BackColor = Color.LightGray
                DHAD4.BackColor = Color.LightGray
                DHAD5.BackColor = Color.LightGray
                DHAD6.BackColor = Color.LightGray
                DHAD7.BackColor = Color.LightGray
                DHAD8.BackColor = Color.LightGray
                DHAD9.BackColor = Color.LightGray
                DHAA1.ReadOnly = True
                DHAA2.ReadOnly = True
                DHAA3.ReadOnly = True
                DHAA4.ReadOnly = True
                ...
                DHAD9.Visible = True
            Case 1  '修改+檢查
                DHAA1.BackColor = Color.GreenYellow
                DHAA2.BackColor = Color.GreenYellow
                DHAA3.BackColor = Color.GreenYellow
                DHAA4.BackColor = Color.GreenYellow
                DHAA5.BackColor = Color.GreenYellow
                DHAA6.BackColor = Color.GreenYellow
                DHAA7.BackColor = Color.GreenYellow
                DHAA8.BackColor = Color.GreenYellow
                DHAA9.BackColor = Color.GreenYellow
                DHAB1.BackColor = Color.GreenYellow
                DHAB2.BackColor = Color.GreenYellow
                DHAB3.BackColor = Color.GreenYellow
                DHAB4.BackColor = Color.GreenYellow
                DHAB5.BackColor = Color.GreenYellow
                DHAB6.BackColor = Color.GreenYellow
                DHAB7.BackColor = Color.GreenYellow
                DHAB8.BackColor = Color.GreenYellow
                DHAB9.BackColor = Color.GreenYellow
                DHAC1.BackColor = Color.GreenYellow
                DHAC2.BackColor = Color.GreenYellow
                DHAC3.BackColor = Color.GreenYellow
                DHAC4.BackColor = Color.GreenYellow
                DHAC5.BackColor = Color.GreenYellow
                DHAC6.BackColor = Color.GreenYellow
                DHAC7.BackColor = Color.GreenYellow
                DHAC8.BackColor = Color.GreenYellow
                DHAC9.BackColor = Color.GreenYellow
                DHAD1.BackColor = Color.GreenYellow
                DHAD2.BackColor = Color.GreenYellow
                DHAD3.BackColor = Color.GreenYellow
                DHAD4.BackColor = Color.GreenYellow
                DHAD5.BackColor = Color.GreenYellow
                DHAD6.BackColor = Color.GreenYellow
                DHAD7.BackColor = Color.GreenYellow
                DHAD8.BackColor = Color.GreenYellow
                DHAD9.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DHAA1Rqd", "DHAA1", "異常：需輸入半成品資訊(A1)")
                ShowRequiredFieldValidator("DHAA2Rqd", "DHAA2", "異常：需輸入半成品資訊(A2)")
                ShowRequiredFieldValidator("DHAA3Rqd", "DHAA3", "異常：需輸入半成品資訊(A3)")
                ShowRequiredFieldValidator("DHAA4Rqd", "DHAA4", "異常：需輸入半成品資訊(A4)")
                ShowRequiredFieldValidator("DHAA5Rqd", "DHAA5", "異常：需輸入半成品資訊(A5)")
                ShowRequiredFieldValidator("DHAA6Rqd", "DHAA6", "異常：需輸入半成品資訊(A6)")
                ShowRequiredFieldValidator("DHAA7Rqd", "DHAA7", "異常：需輸入半成品資訊(A7)")
                ShowRequiredFieldValidator("DHAA8Rqd", "DHAA8", "異常：需輸入半成品資訊(A8)")
                ShowRequiredFieldValidator("DHAA9Rqd", "DHAA9", "異常：需輸入半成品資訊(A9)")
                ShowRequiredFieldValidator("DHAB1Rqd", "DHAB1", "異常：需輸入半成品資訊(B1)")
                ShowRequiredFieldValidator("DHAB2Rqd", "DHAB2", "異常：需輸入半成品資訊(B2)")
                ShowRequiredFieldValidator("DHAB3Rqd", "DHAB3", "異常：需輸入半成品資訊(B3)")
                ShowRequiredFieldValidator("DHAB4Rqd", "DHAB4", "異常：需輸入半成品資訊(B4)")
                ShowRequiredFieldValidator("DHAB5Rqd", "DHAB5", "異常：需輸入半成品資訊(B5)")
                ShowRequiredFieldValidator("DHAB6Rqd", "DHAB6", "異常：需輸入半成品資訊(B6)")
                ShowRequiredFieldValidator("DHAB7Rqd", "DHAB7", "異常：需輸入半成品資訊(B7)")
                ShowRequiredFieldValidator("DHAB8Rqd", "DHAB8", "異常：需輸入半成品資訊(B8)")
                ShowRequiredFieldValidator("DHAB9Rqd", "DHAB9", "異常：需輸入半成品資訊(B9)")
                ShowRequiredFieldValidator("DHAC1Rqd", "DHAC1", "異常：需輸入半成品資訊(C1)")
                ShowRequiredFieldValidator("DHAC2Rqd", "DHAC2", "異常：需輸入半成品資訊(C2)")
                ShowRequiredFieldValidator("DHAC3Rqd", "DHAC3", "異常：需輸入半成品資訊(C3)")
                ShowRequiredFieldValidator("DHAC4Rqd", "DHAC4", "異常：需輸入半成品資訊(C4)")
                ShowRequiredFieldValidator("DHAC5Rqd", "DHAC5", "異常：需輸入半成品資訊(C5)")
                ShowRequiredFieldValidator("DHAC6Rqd", "DHAC6", "異常：需輸入半成品資訊(C6)")
                ShowRequiredFieldValidator("DHAC7Rqd", "DHAC7", "異常：需輸入半成品資訊(C7)")
                ShowRequiredFieldValidator("DHAC8Rqd", "DHAC8", "異常：需輸入半成品資訊(C8)")
                ShowRequiredFieldValidator("DHAC9Rqd", "DHAC9", "異常：需輸入半成品資訊(C9)")
                ShowRequiredFieldValidator("DHAD1Rqd", "DHAD1", "異常：需輸入半成品資訊(D1)")
                ShowRequiredFieldValidator("DHAD2Rqd", "DHAD2", "異常：需輸入半成品資訊(D2)")
                ShowRequiredFieldValidator("DHAD3Rqd", "DHAD3", "異常：需輸入半成品資訊(D3)")
                ShowRequiredFieldValidator("DHAD4Rqd", "DHAD4", "異常：需輸入半成品資訊(D4)")
                ShowRequiredFieldValidator("DHAD5Rqd", "DHAD5", "異常：需輸入半成品資訊(D5)")
                ShowRequiredFieldValidator("DHAD6Rqd", "DHAD6", "異常：需輸入半成品資訊(D6)")
                ShowRequiredFieldValidator("DHAD7Rqd", "DHAD7", "異常：需輸入半成品資訊(D7)")
                ShowRequiredFieldValidator("DHAD8Rqd", "DHAD8", "異常：需輸入半成品資訊(D8)")
                ShowRequiredFieldValidator("DHAD9Rqd", "DHAD9", "異常：需輸入半成品資訊(D9)")
                DHAA1.Visible = True
                DHAA2.Visible = True
                DHAA3.Visible = True
                DHAA4.Visible = True
                ...
                DHAD9.Visible = True
            Case 2  '修改
                DHAA1.BackColor = Color.Yellow
                DHAA2.BackColor = Color.Yellow
                DHAA3.BackColor = Color.Yellow
                DHAA4.BackColor = Color.Yellow
                DHAA5.BackColor = Color.Yellow
                DHAA6.BackColor = Color.Yellow
                DHAA7.BackColor = Color.Yellow
                DHAA8.BackColor = Color.Yellow
                DHAA9.BackColor = Color.Yellow
                DHAB1.BackColor = Color.Yellow
                DHAB2.BackColor = Color.Yellow
                DHAB3.BackColor = Color.Yellow
                DHAB4.BackColor = Color.Yellow
                DHAB5.BackColor = Color.Yellow
                DHAB6.BackColor = Color.Yellow
                DHAB7.BackColor = Color.Yellow
                DHAB8.BackColor = Color.Yellow
                DHAB9.BackColor = Color.Yellow
                DHAC1.BackColor = Color.Yellow
                DHAC2.BackColor = Color.Yellow
                DHAC3.BackColor = Color.Yellow
                DHAC4.BackColor = Color.Yellow
                DHAC5.BackColor = Color.Yellow
                DHAC6.BackColor = Color.Yellow
                DHAC7.BackColor = Color.Yellow
                DHAC8.BackColor = Color.Yellow
                DHAC9.BackColor = Color.Yellow
                DHAD1.BackColor = Color.Yellow
                DHAD2.BackColor = Color.Yellow
                DHAD3.BackColor = Color.Yellow
                DHAD4.BackColor = Color.Yellow
                DHAD5.BackColor = Color.Yellow
                DHAD6.BackColor = Color.Yellow
                DHAD7.BackColor = Color.Yellow
                DHAD8.BackColor = Color.Yellow
                DHAD9.BackColor = Color.Yellow
                DHAA1.Visible = True
                DHAA2.Visible = True
                DHAA3.Visible = True
                DHAA4.Visible = True
        ...
        End If
        '半成品說明
        Select Case FindFieldInf("HADesc")
            Case 0  '顯示
                DHADesc.BackColor = Color.LightGray
                DHADesc.ReadOnly = True
                DHADesc.Visible = True
            Case 1  '修改+檢查
                DHADesc.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DHADescRqd", "DHADesc", "異常：需輸入半成品說明")
                DHADesc.Visible = True
            Case 2  '修改
                DHADesc.BackColor = Color.Yellow
                DHADesc.Visible = True
            Case Else   '隱藏
                DHADesc.Visible = False
        End Select
        If pPost = "New" Then DHADesc.Text = ""
    ...
    Sub SetFieldData(ByVal pFieldName As String, ByVal pName As String)
        ...
        If pFieldName = "SliderType1" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='300' and DKey='SLIDERTYPE1' Order by Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter1.Fill(DBDataSet1, "M_Referp")
                DBTable1 = DBDataSet1.Tables("M_Referp")
                For i = 0 To DBTable1.Rows.Count - 1
        ...
        'DQAA3.Items.Item(i).Selected = False
        'If DQAA3.Items.Item(i).Text = pName Then DQAA3.Items.Item(i).Selected = True
        'Next
        'End If
        'DQAA3
        If pFieldName = "DQAA3" Then
    ...
    Private Sub BSAVE_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BSAVE.ServerClick
        If Request.Cookies("RunBSAVE").Value = True Then
            ...
            If ErrCode = 0 Then
                'If wFormSno > 0 And wStep > 2 Then      '判斷是否[簽核]
                If wFormSno > 0 Then       '判斷是否[簽核]
                    If wFormNo = "900003" Then
                        Response.Write(String.Format("<script>window.opener.document.{0}.value = '{1:d}'; window.opener.document.{2}.value = '{3:d}'; window.opener.document.{4}.value = '{5:d}'; window.opener.document.{6}.value = '{7:d}'; window.opener.document.{8}.value = '{9:d}'; window.opener.document.{10}.value = '{11:d}'; window.opener.document.{12}.value = '{13:d}'; window.close();</script>", "Form1.DReady", "已閱讀", "Form1.DLevel", DLevel.SelectedValue, "Form1.DSliderCode", DSliderCode.Text, "Form1.DSuppiler", DSuppiler.Text, "Form1.DMapNo", DMapNo.Text, "Form1.DMapNo1", DMapNo1.Text, "Form1.DQCLT", DQCLT.Text))
                    Else
                ...
                Else
                    ...
                    SQL = "Select FormNo, FormSno From F_ManufOutModSheet "
                    SQL = SQL & " Where Sts = 0 "
                    SQL = SQL & "   And FormNo =  '" & wFormNo & "'"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(ConfigurationSettings.AppSettings.Get("ManufOutFilePath"))
        Dim DBDataSet1 As New DataSet
        Dim DBDataSet2 As New DataSet
        Dim SQL As String
        'DB連結設定
        ...
        If DBDataSet1.Tables("F_ManufOutSheet").Rows.Count > 0 Then
            ...
            SQL = SQL + "ConfirmFile, AuthorizeFile, ForCastFile, DevReason, ManufFlow, Sample, Price, "        '25~29
            SQL = SQL + "ArMoldFee, PurMold, PullerPrice, PullerPrice1, Suppiler, MoldQty, "          '29~33
            SQL = SQL + "MoldPoint, Quality1, Quality2, QAFile, SampleFile,  "    '34~38
            SQL = SQL + "ContactFile, OFormNo, OFormSno, OFormNo1, OFormSno1, HalfList, HADesc, "    '34~38
            SQL = SQL + "SAttachFile, QAttachFile1, QAttachFile2,  QCLT, "               '39~42
            ...
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("No") + "', "        'NO
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Date") + "', "      '日期
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Division") + "', "  '部門
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Person") + "', "    '擔當
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Cpsc") + "', "      'Cpsc
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Logo") + "', "      'Logo

            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderCode") + "', "     'Slider Code(顯示用)
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderGRCode") + "', "   'Slider Group Code
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Spec") + "', "      '規格
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo") + "', "     '圖號
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapNo1") + "', "     '圖號
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapFile") + "', "   '圖檔1
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("RefFile") + "', "   '圖檔2
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Level") + "', "     '難易度
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Assembler") + "', "    '組立判定
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderType1") + "', "  '拉頭種類-1
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderType2") + "', "  '拉頭種類-2
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ManufPlace") + "', "   '生產地
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Material") + "', "     '材質
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MaterialOther") + "', "    '材質其他說明
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SellVendor") + "', "       '委託廠商
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("CustomerCode") + "', "       'Customer Code

            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Buyer") + "', "            'Buyer
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ConfirmFile") + "', "
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AuthorizeFile") + "', "
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ForCastFile") + "', "
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("DevReason") + "', "    '開發理由
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ManufFlow") + "', "    '
            SQL = SQL + " '" + CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Sample")) + "', "  'Sample(顯示用)
            SQL = SQL + " '" + CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Price")) + "', "   'Price(顯示用)
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ArMoldFee") + "', "    '應收模具費
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("PurMold") + "', "        '模具購入費
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("PullerPrice") + "', "    '引手購入單價
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("PullerPrice1") + "', "    '引手購入單價

            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Suppiler") + "', "       '外注商
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MoldQty") + "', "        '模型數
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MoldPoint") + "', "      '穴取數
            SQL = SQL + " '" + CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Quality1")) + "', "   '品質分析-1(顯示用)
            SQL = SQL + " '" + CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Quality2")) + "', "   '品質分析-2(顯示用)
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAFile") + "', "      '品質分析附件
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SampleFile") + "', "  '樣品圖檔
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ContactFile") + "', " '切結書
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo") + "', "   '表單
            SQL = SQL + " '" + CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno")) + "', "  '單號
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormNo1") + "', "   '表單
            SQL = SQL + " '" + CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OFormSno1")) + "', "  '單號
            'SQL = SQL + " '" + wOFormNo + "', "           '原表單
            'SQL = SQL + " '" + CStr(wOFormSno) + "', "    '原單號

            SQL = SQL + " '" + CStr(DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("HalfList")) + "', "   '半成品(顯示用)
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("HADesc") + "', "    '半成品備註

            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SAttachFile") + "', "   '樣品-其他附件
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile1") + "', "  '品質1-其他附件
            SQL = SQL + " '" + DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile2") + "', "  '品質2-其他附件
            SQL = SQL + " '" + "" + "', "                 'QC-L/T
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pFormSno As Integer)
        ...
        OleDbConnection1.Open()
        SQL = "Update F_ManufOutModSheet Set "
        ...
        SQL = SQL + " MapNo1 = '" & YKK.ReplaceString(DMapNo1.Text) & "',"
        SQL = SQL + " OFormNo = '" & DOFormNo.Text & "',"
        SQL = SQL + " OFormSno = '" & DOFormSno.Text & "',"
        SQL = SQL + " OFormNo1 = '" & DOFormNo1.Text & "',"
        SQL = SQL + " OFormSno1 = '" & DOFormSno1.Text & "',"
        ...
        If DForCastFile.Visible Then
            If DForCastFile.PostedFile.FileName <> "" Then  '判斷有檔案上傳
                '*** IE8對應-Start 2011/1/4
                'FileName = CStr(pFormSno) & "-" & "ForCast" & "-" & UploadDateTime & "-" & Right(DForCastFile.PostedFile.FileName, InStr(StrReverse(DForCastFile.PostedFile.FileName), "\") - 1)
                FileName = CStr(pFormSno) & "-" & "ForCast" & "-" & UploadDateTime & "-" & IO.Path.GetFileName(DForCastFile.PostedFile.FileName)
                '*** IE8對應-End
                Try    '上傳圖檔
        ...
        SQL = SQL + " PullerPrice1 = '" & YKK.ReplaceString(DPullerPrice1.Text) & "',"
        ...
        Else
            SQL = SQL + " HalfList = '" & "0" & "',"
        End If
        SQL = SQL + " HADesc = N'" & YKK.ReplaceString(DHADesc.Text) & "',"
        ...
        'Half Table處理
        For i = 1 To 4
            SQL = "Insert into F_ManufCOHalf "
            SQL = SQL + "( "
            SQL = SQL + "Sts, CompletedTime, FormNo, FormSNo, SeqNo, "
            SQL = SQL + "Code1, Code2, Code3, Code4, Cap, Schedule, ORNo, BCompletedTime, Remark, "
            SQL = SQL + "CreateUser, CreateTime, ModifyUser, ModifyTime "
            SQL = SQL + ")  "
            SQL = SQL + "VALUES( "
            SQL = SQL + " '0', "
            ...
            Select Case i
                Case Is = 1
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA1.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA2.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA3.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA4.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA5.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA6.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA7.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA8.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAA9.Text) + "', "
                Case Is = 2
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB1.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB2.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB3.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB4.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB5.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB6.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB7.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB8.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAB9.Text) + "', "
                Case Is = 3
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC1.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC2.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC3.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC4.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC5.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC6.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC7.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC8.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAC9.Text) + "', "
                Case Is = 4
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD1.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD2.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD3.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD4.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD5.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD6.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD7.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD8.Text) + "', "
                    SQL = SQL + " '" + YKK.ReplaceString(DHAD9.Text) + "', "
            End Select
            SQL = SQL + " '" + Request.QueryString("pUserID") + "', "     '作成者
            SQL = SQL + " '" + NowDateTime + "', "       '作成時間
            SQL = SQL + " '" + "" + "', "                       '修改者
