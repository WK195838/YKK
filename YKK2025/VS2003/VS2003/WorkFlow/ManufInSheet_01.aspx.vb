...
#End Region
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ManufInSheet").Rows.Count > 0 Then
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("AssemblerFile") <> "" Then       '組立判定
            ...
            SetFieldData("Assembler1", DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Assembler1"))                '組立判定
            ...
            DCustomerCode.Text = DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("CustomerCode")   '客戶代碼
    ...
    Sub ShowSheetFunction()
        ...
        If wFormSno > 0 And wStep > 2 Then    '判斷是否[簽核]
            ...
            If DBDataSet1.Tables("T_WaitHandle").Rows.Count > 0 Then
                ...
                LAssemblerFile.Visible = True    '組立判定
        ...
        Else
            ...
            LAssemblerFile.Visible = False    '組立判定
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        Select Case FindFieldInf("Assembler1")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAssembler1Rqd", "DAssembler1", "異常：需輸入立判定")
                DAssembler1.Visible = True
            Case 2  '修改
        ...
        '引手原單位
        Select Case FindFieldInf("OriginalDep")
            Case 0  '顯示
                DOriginalDep.BackColor = Color.LightGray
                DOriginalDep.ReadOnly = True
                DOriginalDep.Visible = True
            Case 1  '修改+檢查
                DOriginalDep.BackColor = Color.GreenYellow
                ShowRequiredFieldValidator("DOriginalDepRqd", "DOriginalDep", "異常：需輸入引手原單位")
                DOriginalDep.Visible = True
            Case 2  '修改
                DOriginalDep.BackColor = Color.Yellow
                DOriginalDep.Visible = True
            Case Else   '隱藏
                DOriginalDep.Visible = False
        End Select
        If pPost = "New" Then DOriginalDep.Text = ""
        ...
        Select Case FindFieldInf("AssemblerFile")
            ...
            Case 1  '修改+檢查
                ShowRequiredFieldValidator("DAssemblerFileRqd", "DAssemblerFile", "異常：需輸入組立判定")
        ...
        If ErrCode = 0 Then
            ...
            While Run = True
                ...
                If ErrCode = 0 And pRunNextStep = 1 Then
                    ...
                    If (wStep = 30) Or (wStep = 170) Or (wStep = 570) Then     '客戶NG/自主NG=需再開發
                        '取得製圖者姓名
                        DBDataSet1.Clear()
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        SQl = SQl + "SliderGRCode, Spec, Cpsc, Logo, MapNo, MapFile, RefFile, "               '10~14
        SQl = SQl + "Level,Assembler1, Assembler, SliderType1, SliderType2, ManufPlace, "      '15~19
        ...
        SQl = SQl + "ArMoldFee, PurMold,OriginalDep, PullerPrice, Suppiler, MakeCAM, MoldQty, "          '29~33
        SQl = SQl + "MoldPoint, Quality1, Quality2, QAFile, SampleFile,  "    '34~38
        SQl = SQl + "ContactFile, OFormNo, OFormSno, QCLT, "    '34~38
        SQl = SQl + "SAttachFile, QAttachFile1, QAttachFile2,AssemblerFile, "               '39~42
        ...
        SQl = SQl + " N'" + YKK.ReplaceString(DManufFlow.Text) + "', "          '
        ...
        SQl = SQl + " '" + YKK.ReplaceString(DOriginalDep.Text) + "', "            '引手原單位
        ...
        FileName = ""
        If DAssemblerFile.Visible Then                      '組立判定
            If DAssemblerFile.PostedFile.FileName <> "" Then     '判斷有檔案上傳
                '*** IE8對應-Start 2011/1/4
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQl = SQl + " Logo = '" + DLogo.SelectedValue + "', "            'Logo
        ...
        SQl = SQl + " OriginalDep = '" & YKK.ReplaceString(DOriginalDep.Text) & "',"
    ...
    Function InputCheck() As Integer
        ...
        '引手原單位
        If InputCheck = 0 Then
            If FindFieldInf("OriginalDep") = 1 Then
                If DOriginalDep.Text = "" Then InputCheck = 1
            End If
        End If
