...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents DOriginalDep As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "ManufInSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        Dim PathOld2 As String = ConfigurationSettings.AppSettings.Get("ManufInFilePath")
        ...
        If DBDataSet1.Tables("F_ManufInSheet").Rows.Count > 0 Then
            '模具廢除狀態
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("MMSSts") = 1 Then
                DMMSSts.Visible = True
            Else
                DMMSSts.Visible = False
            End If
            '
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("OPSts") = 1 Or _
               DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("CTSts") = 1 Or _
               DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("SDSts") = 1 Or _
               DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("SFSts") = 1 Or _
               DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("CASts") = 1 Then          '修改工程狀態
            ...
            End If
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("OPContact") = 1 Then       '工程連絡單
            ...
            End If
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Contact") = 1 Then         '業務連絡單
                LContact.NavigateUrl = "ManufInList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno & "&pFun=CT"
                LContact.Visible = True
            Else
                LContact.Visible = False
            End If
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("SliderDetail") = 1 Then       '拉頭細目
                LSliderDetail.NavigateUrl = "ManufInList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno & "&pFun=SD"
                LSliderDetail.Visible = True
            Else
                LSliderDetail.Visible = False
            End If
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Surface") = 1 Then       '表面處理
            ...
            End If
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("ColorAppend") = 1 Then         '外注色番
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("YKKGroupCopy") = 1 Then       '姐妹社圖面履歷
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("MapFile") <> "" Then          '圖樣
                ...
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("MapFile"))
            ...
            SetFieldData("Division", DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Division"))  '擔當
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("SAttachFile") <> "" Then       '樣品-其他附件
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("SAttachFile"))
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("QAttachFile1") <> "" Then      '品質1-其他附件
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("QAttachFile1"))
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("QAttachFile2") <> "" Then       '樣品2-其他附件
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("QAttachFile2"))
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("AssemblerFile") <> "" Then       '組立判定書
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("AssemblerFile"))

                LAssemblerFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("AssemblerFile")
            Else
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("RefFile") <> "" Then          '其他附件 
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("RefFile"))
            ...
            DAssembler1.Text = DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Assembler1")                '組立1
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("ConfirmFile") <> "" Then       '確認書
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("ConfirmFile"))
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("AuthorizeFile") <> "" Then     '授權書
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("AuthorizeFile"))
            ...
            DQCLT.Text = DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("QCLT")    'QCLT
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Sample") = 1 Then              '樣品
                ...
                DBAdapter3.Fill(DBDataSet2, "ManufCOSample")
                DBTable1 = DBDataSet2.Tables("ManufCOSample")
                For i = 0 To DBTable1.Rows.Count - 1
                    Select Case DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Seqno")
                        Case 1
                            DSampleA1.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Spec")   'Spec
                            DSampleA2.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Color")  'Color
                            DSampleA3.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Qty")    'Qty
                        Case 2
                            DSampleB1.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Spec")   'Spec
                            DSampleB2.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Color")  'Color
                            DSampleB3.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Qty")    'Qty
                        Case Else
                            DSampleC1.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Spec")   'Spec
                            DSampleC2.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Color")  'Color
                            DSampleC3.Text = DBDataSet2.Tables("ManufCOSample").Rows(i).Item("Qty")    'Qty
                    End Select
                Next
            End If
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("SampleFile") <> "" Then        '樣品檔
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("SampleFile"))
            ...
            DOriginalDep.Text = DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("OriginalDep")         '引手原單位
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Quality1") = 1 Then            '品質1
                ...
                SQL = SQL & " Order by Seqno"
                Dim DBAdapter3 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter3.Fill(DBDataSet2, "ManufCOQA1")
                DBTable1 = DBDataSet2.Tables("ManufCOQA1")
                For i = 0 To DBTable1.Rows.Count - 1
                    Select Case DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Seqno")
                        Case 1
                            DQAA1.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Date")
                            DQAA2.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Spec")
                            SetFieldData("DQAA3", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Assembler"))
                            DQAA4.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Surface")
                            DQAA5.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("GenTani")
                            SetFieldData("DQAA6", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kyoudo"))
                            SetFieldData("DQAA7", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Nyuryoku"))
                            SetFieldData("DQAA8", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kensin"))
                            SetFieldData("DQAA9", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Water"))
                            SetFieldData("DQAA10", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Dry"))
                            SetFieldData("DQAA11", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Yellow"))
                            SetFieldData("DQAA12", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku1"))
                            SetFieldData("DQAA13", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku2"))
                            SetFieldData("DQAA14", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("CPSC"))
                            SetFieldData("DQAA15", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("EDX"))
                        Case 2
                            DQAB1.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Date")
                            DQAB2.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Spec")
                            SetFieldData("DQAB3", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Assembler"))
                            DQAB4.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Surface")
                            DQAB5.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("GenTani")
                            SetFieldData("DQAB6", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kyoudo"))
                            SetFieldData("DQAB7", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Nyuryoku"))
                            SetFieldData("DQAB8", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kensin"))
                            SetFieldData("DQAB9", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Water"))
                            SetFieldData("DQAB10", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Dry"))
                            SetFieldData("DQAB11", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Yellow"))
                            SetFieldData("DQAB12", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku1"))
                            SetFieldData("DQAB13", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku2"))
                            SetFieldData("DQAB14", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("CPSC"))
                            SetFieldData("DQAB15", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("EDX"))
                        Case 3
                            DQAC1.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Date")
                            DQAC2.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Spec")
                            SetFieldData("DQAC3", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Assembler"))
                            DQAC4.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Surface")
                            DQAC5.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("GenTani")
                            SetFieldData("DQAC6", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kyoudo"))
                            SetFieldData("DQAC7", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Nyuryoku"))
                            SetFieldData("DQAC8", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kensin"))
                            SetFieldData("DQAC9", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Water"))
                            SetFieldData("DQAC10", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Dry"))
                            SetFieldData("DQAC11", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Yellow"))
                            SetFieldData("DQAC12", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku1"))
                            SetFieldData("DQAC13", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku2"))
                            SetFieldData("DQAC14", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("CPSC"))
                            SetFieldData("DQAC15", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("EDX"))
                        Case Else
                            DQAD1.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Date")
                            DQAD2.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Spec")
                            SetFieldData("DQAD3", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Assembler"))
                            DQAD4.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Surface")
                            DQAD5.Text = DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("GenTani")
                            SetFieldData("DQAD6", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kyoudo"))
                            SetFieldData("DQAD7", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Nyuryoku"))
                            SetFieldData("DQAD8", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Kensin"))
                            SetFieldData("DQAD9", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Water"))
                            SetFieldData("DQAD10", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Dry"))
                            SetFieldData("DQAD11", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Yellow"))
                            SetFieldData("DQAD12", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku1"))
                            SetFieldData("DQAD13", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("Mityaku2"))
                            SetFieldData("DQAD14", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("CPSC"))
                            SetFieldData("DQAD15", DBDataSet2.Tables("ManufCOQA1").Rows(i).Item("EDX"))
                    End Select
                Next
            End If
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("Quality2") = 1 Then            '品質2
                ...
                SQL = SQL & " Order by Seqno"
                Dim DBAdapter3 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter3.Fill(DBDataSet2, "ManufCOQA2")
                DBTable1 = DBDataSet2.Tables("ManufCOQA2")
                For i = 0 To DBTable1.Rows.Count - 1
                    Select Case DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Seqno")
                        Case 1
                            DFQAA1.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Date")
                            SetFieldData("DFQAA2", DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("QACheck"))
                            DFQAA3.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Remark")
                        Case 2
                            DFQAB1.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Date")
                            SetFieldData("DFQAB2", DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("QACheck"))
                            DFQAB3.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Remark")
                        Case 3
                            DFQAC1.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Date")
                            SetFieldData("DFQAC2", DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("QACheck"))
                            DFQAC3.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Remark")
                        Case Else
                            DFQAD1.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Date")
                            SetFieldData("DFQAD2", DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("QACheck"))
                            DFQAD3.Text = DBDataSet2.Tables("ManufCOQA2").Rows(i).Item("Remark")
                    End Select
                Next
            End If
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("QAFile") <> "" Then      '測試報告
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("QAFile"))
            ...
            If DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("ContactFile") <> "" Then      '切結書
                '封存檔還原  20213/16  jessica
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufInSheet").Rows(0).Item("ContactFile"))
    ...
    Private Sub DPriceA2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
