...
#End Region
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_AddWorkSheet").Rows.Count > 0 Then
            ...
            SetFieldData("Name", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("Name"))          '姓名
            ...
            SetFieldData("WStartH", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("WStartH").ToString)   '缺勤開始-時
            SetFieldData("WStartM", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("WStartM").ToString)   '缺勤開始-分
            SetFieldData("WEndH", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("WEndH").ToString)       '缺勤終止-時
            SetFieldData("WEndM", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("WEndM").ToString)       '缺勤終止-分
            ...
            SetFieldData("AStartH", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("AStartH").ToString)   '補工開始-時
            SetFieldData("AStartM", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("AStartM").ToString)   '補工開始-分
            SetFieldData("AEndH", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("AEndH").ToString)       '補工終止-時
            SetFieldData("AEndM", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("AEndM").ToString)       '補工終止-分
            ...
            SetFieldData("AddWorkType", DBDataSet1.Tables("F_AddWorkSheet").Rows(0).Item("AddWorkType"))    '補工類別
            '交易資料
            DBDataSet1.Clear()
    ...
    Sub ShowSheetFunction()
        ...
        If wFormSno > 0 And wStep > 2 Then    '判斷是否[簽核]
            ...
            If DBDataSet1.Tables("T_WaitHandle").Rows.Count > 0 Then
                'Sheet顯示
                DAddWorkSheet1.Visible = True    '表單Sheet-1
    ...
    Sub SetPopupFunction()
        'Modify-Start by Joy 2009/11/20(2010行事曆對應)
        'BWorkDate.Attributes("onclick") = "CalendarPicker('" + wDepo + "', 'Form1.DWorkDate', 'Form1.DSalaryYM');"  '缺勤日期
        'BAWorkDate.Attributes("onclick") = "CalendarPicker('" + wDepo + "', 'Form1.DAWorkDate', '');"               '補工日期
        '
        BWorkDate.Attributes("onclick") = "CalendarPicker('" + wApplyCalendar + "', 'Form1.DWorkDate', 'Form1.DSalaryYM');"  '缺勤日期
        BAWorkDate.Attributes("onclick") = "CalendarPicker('" + wApplyCalendar + "', 'Form1.DAWorkDate', '');"               '補工日期
        'Modify-End
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        Select Case FindFieldInf("AddWorkType")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAddWorkTypeRqd", "DAddWorkType", "異常：需輸入補工類別")
                DAddWorkType.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("WorkDate")
            ...
            Case 1  '修改+檢查
                ...
                DWorkDate.ReadOnly = True
                ShowRequiredFieldValidator("DWorkDateRqd", "DWorkDate", "異常：需輸入缺勤日期")
                DWorkDate.Visible = True
        ...
        Select Case FindFieldInf("WStartH")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DWStartHRqd", "DWStartH", "異常：需輸入缺勤開始-時")
                DWStartH.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("WStartM")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DWStartMRqd", "DWStartM", "異常：需輸入缺勤開始-分")
                DWStartM.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("WEndH")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DWEndHRqd", "DWEndH", "異常：需輸入缺勤終止-時")
                DWEndH.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("WEndM")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DWEndMRqd", "DWEndM", "異常：需輸入缺勤終止-分")
                DWEndM.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("WH")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DWHRqd", "DWH", "異常：需輸入缺勤計算-時")
                DWH.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("WM")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DWMRqd", "DWM", "異常：需輸入缺勤計算-分")
                DWM.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("AWorkDate")
            ...
            Case 1  '修改+檢查
                ...
                DAWorkDate.ReadOnly = True
                ShowRequiredFieldValidator("DAWorkDateRqd", "DAWorkDate", "異常：需輸入補工日期")
                DAWorkDate.Visible = True
        ...
        Select Case FindFieldInf("AStartH")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAStartHRqd", "DAStartH", "異常：需輸入補工開始-時")
                DAStartH.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("AStartM")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAStartMRqd", "DAStartM", "異常：需輸入補工開始-分")
                DAStartM.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("AEndH")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAEndHRqd", "DAEndH", "異常：需輸入補工終止-時")
                DAEndH.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("AEndM")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAEndMRqd", "DAEndM", "異常：需輸入補工終止-分")
                DAEndM.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("AH")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAHRqd", "DAH", "異常：需輸入補工計算-時")
                DAH.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("AM")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DAMRqd", "DAM", "異常：需輸入補工計算-分")
                DAM.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("FReason")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DFReasonRqd", "DFReason", "異常：需輸入補工理由")
                DFReason.Visible = True
            Case 2  '修改
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ...
                ErrCode = oCommon.CommissionNo("001004", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
        ...
        Else
            ...
            If ErrCode = 9050 Then Message = "缺勤時間需填寫,請確認!"
            If ErrCode = 9051 Then Message = "補工時間需填寫,請確認!"
            If ErrCode = 9052 Then Message = "缺勤日期與補工日期不可跨月,請確認!"
            If ErrCode = 9053 Then Message = "缺勤與補工所結算之時數不一致,請確認!"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        '16~22
        SQl = SQl + " '" + DWorkDate.Text + "', "                         '缺勤日期
        SQl = SQl + " '" + CStr(CInt(DWStartH.SelectedValue)) + "', "     '缺勤開始-時
        SQl = SQl + " '" + CStr(CInt(DWStartM.SelectedValue)) + "', "     '缺勤開始-分
        SQl = SQl + " '" + CStr(CInt(DWEndH.SelectedValue)) + "', "       '缺勤終止-時
        SQl = SQl + " '" + CStr(CInt(DWEndM.SelectedValue)) + "', "       '缺勤終止-分
        SQl = SQl + " '" + CStr(CInt(DWH.Text)) + "', "                   '缺勤計算-時
        SQl = SQl + " '" + CStr(CInt(DWM.Text)) + "', "                   '缺勤計算-分
        '23~29
        SQl = SQl + " '" + DAWorkDate.Text + "', "                        '補工日期
        SQl = SQl + " '" + CStr(CInt(DAStartH.SelectedValue)) + "', "     '補工開始-時
        SQl = SQl + " '" + CStr(CInt(DAStartM.SelectedValue)) + "', "     '補工開始-分
        SQl = SQl + " '" + CStr(CInt(DAEndH.SelectedValue)) + "', "       '補工終止-時
        SQl = SQl + " '" + CStr(CInt(DAEndM.SelectedValue)) + "', "       '補工終止-分
        SQl = SQl + " '" + CStr(CInt(DAH.Text)) + "', "                   '補工計算-時
        SQl = SQl + " '" + CStr(CInt(DAM.Text)) + "', "                   '補工計算-分
        '31~32
        SQl = SQl + " N'" + YKK.ReplaceString(DFReason.Text) + "', "      '理由
        SQl = SQl + " N'" + DAddWorkType.SelectedItem.Text + "', "        '補工類別
        '--------------------------------------------
