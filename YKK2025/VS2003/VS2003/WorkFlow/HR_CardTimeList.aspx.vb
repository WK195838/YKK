...
#End Region
    ...
    '*****************************************************************
    Sub SetParameter()
        wWorkDate = Request.QueryString("pWorkDate")    '工作日
    ...
    Sub CardData()
        ...
        'Response.Write(YKK.ShowMessage("[" + wEmpID + "]"))
    End Sub
