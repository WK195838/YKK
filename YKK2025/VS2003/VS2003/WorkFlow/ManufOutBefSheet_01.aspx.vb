...
Public Class ManufOutBefSheet_01
...
#End Region
            ...
            While Run = True
                ...
                If ErrCode = 0 Then
                    If wFormSno = 0 And wStep < 3 Then      '判斷是否起單
                        ...
                        Else
                            '申請流程資料建置
                            'Modify-Start by Joy 2009/11/20(2010行事曆對應)
                            'oFlow.NewFlow("000007", NewFormSno, wStep, 1, wDepo, Request.QueryString("pUserID"), wApplyID)
                            '
                            oFlow.NewFlow("000007", NewFormSno, wStep, 1, wDecideCalendar, Request.QueryString("pUserID"), wApplyID)
                ...
                If ErrCode = 0 And pRunNextStep = 1 Then
                    ...
                    Else
                        ...
                        'RtnCode = oFlow.EndFlow("000007", NewFormSno, pNextStep, 1, wDepo, Request.QueryString("pUserID"), wApplyID)
                        '
                        RtnCode = oFlow.EndFlow("000007", NewFormSno, pNextStep, 1, wDecideCalendar, Request.QueryString("pUserID"), wApplyID)
                        '表單號碼,表單流水號,工程關卡號碼,序號,行事曆,簽核者, 申請者
                        'Modify-End
                ...
                If ErrCode = 0 Then
                    If wFormSno = 0 And wStep < 3 Then      '判斷是否起單
                        If NewFormSno <> 0 Then
                            ...
                            AddCommissionNo("000007", NewFormSno)
                        End If  'pSeqno <> 0
                    Else    '判斷是否起單
                        ...
                        End If
                        AddCommissionNo("000007", wFormSno)
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        SQl = SQl + "No, Date, Division, Person, Cpsc, SliderCode, "                      '5~9
        ...
        SQl = SQl + "ArMoldFee, PurMold, PullerPrice, Suppiler, MoldQty, "          '29~33
    ...
    '**
    '*****************************************************************
    Sub PutQA2(ByVal pFormNo As String, ByVal pFormSno As Integer)
        Dim SQl As String
        ...
        If DFQAA1.Text <> "" Then
            SQl = "Insert into F_ManufCOQA2 "
            SQl = SQl + "( "
            SQl = SQl + "Sts, CompletedTime, FormNo, FormSNo, SeqNo, "       '1~5
            SQl = SQl + "Date, QACheck, Remark, "                            '6~8
            SQl = SQl + "CreateUser, CreateTime, ModifyUser, ModifyTime "    '9~12
            SQl = SQl + ")  "
            SQl = SQl + "VALUES( "
            SQl = SQl + " '0', "                                '狀態(0:未結,1:已結NG,2:已結OK)
            SQl = SQl + " '" + NowDateTime + "', "              '結案日
            SQl = SQl + " '" + pFormNo + "', "                  '表單代號
            SQl = SQl + " '" + CStr(pFormSno) + "', "           '表單流水號
            SQl = SQl + " '" + CStr(wSeqNo) + "', "             '流水號
            SQl = SQl + " '" + YKK.ReplaceString(DFQAA1.Text) + "', "              '日期
            SQl = SQl + " '" + DFQAA2.SelectedValue + "', "     'QACheck
            SQl = SQl + " N'" + YKK.ReplaceString(DFQAA3.Text) + "', "             'Remark
            SQl = SQl + " '" + Request.QueryString("pUserID") + "', "   '作成者
            SQl = SQl + " '" + NowDateTime + "', "                       '作成時間
            SQl = SQl + " '" + "" + "', "                                '修改者
            SQl = SQl + " '" + NowDateTime + "' "                        '修改時間
        ...
        If DFQAB1.Text <> "" Then
            ...
            SQl = SQl + " '" + CStr(pFormSno) + "', "           '表單流水號
            SQl = SQl + " '" + CStr(wSeqNo) + "', "             '流水號
            SQl = SQl + " '" + YKK.ReplaceString(DFQAB1.Text) + "', "              '日期
            SQl = SQl + " '" + DFQAB2.SelectedValue + "', "     'QACheck
            SQl = SQl + " N'" + YKK.ReplaceString(DFQAB3.Text) + "', "             'Remark
            SQl = SQl + " '" + Request.QueryString("pUserID") + "', "   '作成者
            SQl = SQl + " '" + NowDateTime + "', "                       '作成時間
            SQl = SQl + " '" + "" + "', "                                '修改者
            SQl = SQl + " '" + NowDateTime + "' "                        '修改時間
        ...
        If DFQAC1.Text <> "" Then
            ...
            SQl = SQl + " '" + CStr(pFormSno) + "', "           '表單流水號
            SQl = SQl + " '" + CStr(wSeqNo) + "', "             '流水號
            SQl = SQl + " '" + YKK.ReplaceString(DFQAC1.Text) + "', "              '日期
            SQl = SQl + " '" + DFQAC2.SelectedValue + "', "     'QACheck
            SQl = SQl + " N'" + YKK.ReplaceString(DFQAC3.Text) + "', "             'Remark
            SQl = SQl + " '" + Request.QueryString("pUserID") + "', "   '作成者
            SQl = SQl + " '" + NowDateTime + "', "                       '作成時間
            SQl = SQl + " '" + "" + "', "                                '修改者
            SQl = SQl + " '" + NowDateTime + "' "                        '修改時間
        ...
        If DFQAD1.Text <> "" Then
            ...
            SQl = SQl + " '" + CStr(pFormSno) + "', "           '表單流水號
            SQl = SQl + " '" + CStr(wSeqNo) + "', "             '流水號
            SQl = SQl + " '" + YKK.ReplaceString(DFQAD1.Text) + "', "              '日期
            SQl = SQl + " '" + DFQAD2.SelectedValue + "', "     'QACheck
            SQl = SQl + " N'" + YKK.ReplaceString(DFQAD3.Text) + "', "             'Remark
            SQl = SQl + " '" + Request.QueryString("pUserID") + "', "   '作成者
            SQl = SQl + " '" + NowDateTime + "', "                       '作成時間
            SQl = SQl + " '" + "" + "', "                                '修改者
            SQl = SQl + " '" + NowDateTime + "' "                        '修改時間
