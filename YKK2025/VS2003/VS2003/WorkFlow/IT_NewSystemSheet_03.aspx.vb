...
Public Class IT_NewSystemSheet_03
...
#End Region
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_NewSystemSheet").Rows.Count > 0 Then
            ...
            'Key
            wFormNo = DBDataSet1.Tables("F_NewSystemSheet").Rows(0).Item("FormNo")
            wFormSno = DBDataSet1.Tables("F_NewSystemSheet").Rows(0).Item("FormSno")
        End If
        '核定履歷資料
        SQL = "SELECT "
