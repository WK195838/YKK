...
Public Class ManufOutSheet_021
...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents DMMSSts As System.Web.UI.WebControls.Image
    ...
    Protected WithEvents DAssembler1 As System.Web.UI.WebControls.TextBox
    Protected WithEvents LYKKGroupCopy As System.Web.UI.WebControls.HyperLink
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "ManufOutSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        Dim PathOld2 As String = ConfigurationSettings.AppSettings.Get("ManufOutFilePath")
        Dim i As Integer
        Dim SQL As String
        ...
        If DBDataSet1.Tables("F_ManufOutSheet").Rows.Count > 0 Then
            '模具廢除狀態
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MMSSts") = 1 Then
                DMMSSts.Visible = True
            Else
                DMMSSts.Visible = False
            End If
            '
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OPSts") = 1 Or _
               DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("CTSts") = 1 Or _
               DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SDSts") = 1 Or _
               DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SFSts") = 1 Or _
               DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("CASts") = 1 Then          '修改工程狀態
            ...
            End If
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("OPContact") = 1 Then       '工程連絡單
                LOPContact.NavigateUrl = "ManufOutList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno & "&pFun=OP"
                LOPContact.Visible = True
            Else
                LOPContact.Visible = False
            End If
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Contact") = 1 Then         '業務連絡單
                LContact.NavigateUrl = "ManufOutList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno & "&pFun=CT"
                LContact.Visible = True
            Else
                LContact.Visible = False
            End If
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderDetail") = 1 Then       '拉頭細目
                LSliderDetail.NavigateUrl = "ManufOutList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno & "&pCode=" & DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SliderGRCode") & "&pFun=SD"
                LSliderDetail.Visible = True
            Else
                LSliderDetail.Visible = False
            End If
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Surface") = 1 Then       '表面處理
                LSurface.NavigateUrl = "ManufOutList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno & "&pFun=SF"
                LSurface.Visible = True
            Else
                LSurface.Visible = False
            End If
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ColorAppend") = 1 Then         '外注色番
                LColorAppend.NavigateUrl = "ManufOutList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno & "&pFun=CA"
                LColorAppend.Visible = True
            Else
                LColorAppend.Visible = False
            End If

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("YKKGroupCopy") = 1 Then       '姐妹社圖面履歷
                LYKKGroupCopy.NavigateUrl = "http://10.245.1.6//SPDSub/YKKGroupCopyList.aspx?pFormNo=" & wFormNo & "&pFormSno=" & wFormSno
                LYKKGroupCopy.Visible = True
            Else
                LYKKGroupCopy.Visible = False
            End If
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapFile") <> "" Then          '圖樣
                ...
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("MapFile"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SAttachFile") <> "" Then       '樣品-其他附件
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SAttachFile"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile1") <> "" Then      '品質1-其他附件
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile1"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile2") <> "" Then       '樣品2-其他附件
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAttachFile2"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AssemblerFile") <> "" Then       '組立判定書
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AssemblerFile"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("RefFile") <> "" Then          '其他附件 
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("RefFile"))
            ...
            DAssembler1.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("Assembler1")                 '組立
            ...
            DCustomerCode.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("CustomerCode")   'CustomerCode

            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ConfirmFile") <> "" Then       '確認書
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ConfirmFile"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AuthorizeFile") <> "" Then     '授權書
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("AuthorizeFile"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ForCastFile") <> "" Then       '報價單
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ForCastFile"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SampleFile") <> "" Then        '樣品檔
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("SampleFile"))
            ...
            DQCLT.Text = DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QCLT")     'QC/LT
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAFile") <> "" Then      '測試報告
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("QAFile"))
            ...
            If DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ContactFile") <> "" Then      '切結書
                RtnCode = oCommon.RecoveryArchiveFile(PathOld1, PathOld2, DBDataSet1.Tables("F_ManufOutSheet").Rows(0).Item("ContactFile"))
