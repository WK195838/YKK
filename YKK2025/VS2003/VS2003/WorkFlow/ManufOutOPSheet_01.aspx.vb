...
Public Class ManufOutOPSheet_01
...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "ManufOutOPSheet_01.aspx"
    ...
    Sub UpdateTranFile()
        ...
        oUpdateFlow.UpdateFlow(Request.QueryString("pUserID"))
    End Sub
    ...
    '*****************************************************************
    Sub ShowFormData()
        Dim Path As String = ConfigurationSettings.AppSettings.Get("Http") & ConfigurationSettings.AppSettings.Get("ManufOutOPFilePath")
        ...
        SQL = "Select * From F_ManufOutOPSheet "
        SQL = SQL & " Where FormNo =  '" & wFormNo & "'"
        SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
        Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
        DBAdapter1.Fill(DBDataSet1, "F_ManufOutOPSheet")
        If DBDataSet1.Tables("F_ManufOutOPSheet").Rows.Count > 0 Then
            DNo.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("No")                       'No
            DDate.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Date")                   '日期
            SetFieldData("Division", DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Division"))  '部門
            SetFieldData("Person", DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Person"))      '擔當
            DSliderCode.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("SliderCode")       'Slider Code
            DLevel.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Level")                 '難易度
            DMapNo.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("MapNo")             '圖號
            DMapNo1.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("MapNo1")             '圖號
            ...
            If DMapNo.Text <> "" Then
                ...
                DBAdapter3.Fill(DBDataSet2, "MapSheet")
                If DBDataSet2.Tables("MapSheet").Rows.Count > 0 Then
                    'LMapNo.Text = DMapNo.Text
                    LMapNo.NavigateUrl = "MapSheet_02.aspx?pFormNo=" & DBDataSet2.Tables("MapSheet").Rows(0).Item("FormNo") & _
                                                         "&pFormSno=" & DBDataSet2.Tables("MapSheet").Rows(0).Item("FormSno")
                Else
                    SQL = "Select FormNo, FormSno From F_MapModSheet "
                    SQL = SQL & " Where Sts = 1 "
                    SQL = SQL & "   And MapNo =  '" & DMapNo.Text & "'"
                    Dim DBAdapter4 As New OleDbDataAdapter(SQL, OleDbConnection1)
                    DBAdapter4.Fill(DBDataSet2, "MapModSheet")
                    If DBDataSet2.Tables("MapModSheet").Rows.Count > 0 Then
                        'LMapNo.Text = DMapNo.Text
                        LMapNo.NavigateUrl = "MapModSheet_02.aspx?pFormNo=" & DBDataSet2.Tables("MapModSheet").Rows(0).Item("FormNo") & _
                                                                "&pFormSno=" & DBDataSet2.Tables("MapModSheet").Rows(0).Item("FormSno")
                    End If
                End If
            Else
            ...
            If DMapNo1.Text <> "" Then
                DBDataSet2.Clear()
                SQL = "Select FormNo, FormSno From F_MapSheet "
                SQL = SQL & " Where Sts = 1 "
                SQL = SQL & "   And MapNo =  '" & DMapNo1.Text & "'"
                Dim DBAdapter3 As New OleDbDataAdapter(SQL, OleDbConnection1)
                DBAdapter3.Fill(DBDataSet2, "MapSheet")
                If DBDataSet2.Tables("MapSheet").Rows.Count > 0 Then
                    'LMapNo1.Text = DMapNo1.Text
                    LMapNo1.NavigateUrl = "MapSheet_02.aspx?pFormNo=" & DBDataSet2.Tables("MapSheet").Rows(0).Item("FormNo") & _
                                                         "&pFormSno=" & DBDataSet2.Tables("MapSheet").Rows(0).Item("FormSno")
                Else
                    SQL = "Select FormNo, FormSno From F_MapModSheet "
                    SQL = SQL & " Where Sts = 1 "
                    ...
                    If DBDataSet2.Tables("MapModSheet").Rows.Count > 0 Then
                        'LMapNo1.Text = DMapNo1.Text
                        LMapNo1.NavigateUrl = "MapModSheet_02.aspx?pFormNo=" & DBDataSet2.Tables("MapModSheet").Rows(0).Item("FormNo") & _
                                                                "&pFormSno=" & DBDataSet2.Tables("MapModSheet").Rows(0).Item("FormSno")
                    End If
                End If
            Else
            ...
            DOFormNo.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("OFormNo")             '圖號
            If DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("OFormSno") = 0 Then
                DOFormSno.Text = ""
            Else
                DOFormSno.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("OFormSno")             '圖號
            End If
            ...
            DNFormNo.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("NFormNo")             '圖號
            If DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("NFormSno") = 0 Then
                DNFormSno.Text = ""
            Else
                DNFormSno.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("NFormSno")             '圖號
            End If

            If DNFormNo.Text <> "" And DNFormSno.Text <> "" Then
                LNFormNo.NavigateUrl = "ManufOutModSheet_01.aspx?pFormNo=" & DNFormNo.Text & "&pFormSno=" & CInt(DNFormSno.Text) & "&pOFormNo=" & DOFormNo.Text & "&pOFormSno=" & CInt(DOFormSno.Text) & "&pStep=" & wStep
            ...
            DSuppiler.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Suppiler")           '外注商
            DQCLT.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("QCLT")                   'QC-L/T

            DTarget.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Target")             '圖號
            DContent.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Content")             '圖號
            DDReason.Text = DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("Reason")             '圖號
            If DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("AttachFile") <> "" Then          '圖檔1
                LAttachFile.NavigateUrl = Path & DBDataSet1.Tables("F_ManufOutOPSheet").Rows(0).Item("AttachFile")
            Else
    ...
    Sub SetPopupFunction()
        ...
        BIn.Attributes("onclick") = "DevNoPicker('Out','000008');"      '外製
        BOMapNo.Attributes("onclick") = "MapPicker('Ori','000008');"             '原始圖號
        BMMapNo.Attributes("onclick") = "MapPicker('Mod','000008');"             '修改圖號
        BOMapNo1.Attributes("onclick") = "MapPicker('Ori1','000008');"             '原始圖號
        BMMapNo1.Attributes("onclick") = "MapPicker('Mod1','000008');"             '修改圖號
    ...
    Sub TopPosition()
        ...
        OleDbConnection1.Open()
        '按鈕及RequestedField的Top位置
        If wFormSno > 0 And wStep > 2 And wStep > 2 Then      '判斷是否[簽核]
            SQL = "Select * From T_WaitHandle "
            SQL = SQL & " Where Active = 1 "
            SQL = SQL & "   And FormNo =  '" & wFormNo & "'"
            SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ...
                ErrCode = oCheckNo.CommissionNo("000008", wFormSno, wStep, DNo.Text)    '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9070
                End If
            End If
        ...
        If ErrCode = 0 Then
            ...
            While Run = True
                ...
                If ErrCode = 0 Then
                    If wFormSno = 0 And wStep < 3 Then      '判斷是否起單
                        ...
                        Else
                            ...
                            RtnCode = oNextFlow.NewFlow(Request.QueryString("pUserID"), wApplyID)   '建置者, 申請者
                        End If
                        pRunNextStep = 1
                    Else
                        If RepeatRun = False Then   '不是通知的重覆執行
                            ...
                            oNextFlow.pStep = wStep       '工程關卡號碼
                            RtnCode = oNextFlow.CheckFlow(Request.QueryString("pUserID"), pRunNextStep)   '建置者, 流程結束否(會簽)
                ...
                If ErrCode = 0 And pRunNextStep = 1 Then
                    ...
                    oNextGate.pUserID = Request.QueryString("pUserID")       '簽核者ID
                ...
                If ErrCode = 0 And pRunNextStep = 1 Then
                    If pNextStep <> 999 Then
                        ...
                        For i = 1 To pCount
                            ...
                            RtnCode = oNextFlow.NextFlow(Request.QueryString("pUserID"), pNextGate(i), pAgentGate(i), wApplyID, pStartTime, pEndTime, 0)   '建置者, 簽核者, 被代理者, 申請者, 預定開始日, 預定完成日, 重要性
                            If RtnCode <> 0 Then
                                ErrCode = 9150
                                Exit For
                            End If
                    ...
                    Else
                        ...
                        oNextFlow.pStep = pNextStep       '工程關卡號碼
                        oNextFlow.pSeqNo = 1              '序號
                        RtnCode = oNextFlow.EndFlow(Request.QueryString("pUserID"), wApplyID)   '建置者, 申請者
                ...
                If ErrCode = 0 Then
                    If RepeatRun = False Then
                        ...
                        RtnCode = oSchedule.AdjustSchedule(Request.QueryString("pUserID"), wFormNo, wFormSno, wStep, wSeqNo, NowDateTime, wLevel)
                    End If
                End If
                '儲存表單資料
                If ErrCode = 0 Then
                    If wFormSno = 0 And wStep < 3 Then      '判斷是否起單
                        If NewFormSno <> 0 Then
                            ...
                            ModifyManufOutData(pFun, 1, 1)   '更新原表單狀態
                        End If  'pSeqno <> 0
                    Else    '判斷是否起單
                        If pNextStep = 999 Then     '工程結束嗎?
                            ...
                            ModifyManufOutData(pFun, 0, 1)   '更新原表單狀態

                            'If DNFormNo.Text <> "" And DNFormSno.Text <> "" Then
                            'ReplaceManufOutData()            '覆蓋原表單及更新狀態
                            'Else
                            'ModifyManufOutData(pFun, 0, 1)   '更新原表單狀態
                            'End If
                        Else
                    ...
                    If pNextStep <> 999 Then
                        For i = 1 To pCount
                            ...
                            oMail.Send(Request.QueryString("pUserID"), pNextGate(i), wApplyID, wFormNo, NewFormSno, pNextStep, "FLOW")
                            '送件者, 收件者, 申請者, 表單號碼, 表單流水號, 工程關卡號碼
                        Next i
                    Else
                        oMail = Server.CreateObject("SendMail.WFMail")
                        oMail.Send(Request.QueryString("pUserID"), wApplyID, wApplyID, wFormNo, NewFormSno, pNextStep, "END")
                        '送件者, 收件者, 申請者, 表單號碼, 表單流水號, 工程關卡號碼
                    End If
        ...
        Else
            ...
            If ErrCode = 9060 Then Message = "QC L/T需為有效數字,請確認!"
            If ErrCode = 9070 Then Message = "委託書No.重覆,請確認委託書No.!"
            Response.Write(YKK.ShowMessage(Message))
        End If      '上傳檔案ErrCode=0
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(ConfigurationSettings.AppSettings.Get("ManufOutOPFilePath"))
        ...
        SQl = "Insert into F_ManufOutOPSheet "
        SQl = SQl + "( "
        SQl = SQl + "Sts, CompletedTime, FormNo, FormSNo, "          '1~4
        SQl = SQl + "No, Date, Division, Person, SliderCode, "       '5~9
        SQl = SQl + "Level, MapNo, MapNo1, OFormNo, OFormSno, NFormNo, NFormSno, Suppiler, QCLT, "  '10~14
        ...
        SQl = SQl + " N'" + YKK.ReplaceString(DSuppiler.Text) + "', "          '外注商
        SQl = SQl + " '" + DQCLT.Text + "', "                                  'QC-L/T
        SQl = SQl + " N'" + YKK.ReplaceString(DTarget.Text) + "', "             '目的
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQl = "Update F_ManufOutOPSheet Set "
        If pFun <> "SAVE" Then
            SQl = SQl + " Sts = '" & pSts & "',"
    ...
    Sub ReplaceManufOutData()
        ...
        If DBDataSet1.Tables("F_ManufOutModSheet").Rows.Count > 0 Then
            ...
            SQl = SQl + " No = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("No") & "',"
            SQl = SQl + " Date = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Date") & "',"
            SQl = SQl + " Division = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Division") & "',"
            SQl = SQl + " Person = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Person") & "',"
            SQl = SQl + " SliderCode = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderCode") & "',"
            SQl = SQl + " SliderGRCode = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderGRCode") & "',"
            SQl = SQl + " Spec = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Spec") & "',"
            SQl = SQl + " MapNo = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo") & "',"
            SQl = SQl + " MapNo1 = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo1") & "',"
            SQl = SQl + " OFormNo = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo") & "',"
            SQl = SQl + " OFormSno = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno") & "',"
            SQl = SQl + " OFormNo1 = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo1") & "',"
            SQl = SQl + " OFormSno1 = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno1") & "',"
            SQl = SQl + " MapFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapFile") & "',"
            SQl = SQl + " RefFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("RefFile") & "',"
            SQl = SQl + " Level = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Level") & "',"
            SQl = SQl + " Assembler = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Assembler") & "',"
            SQl = SQl + " SliderType1 = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderType1") & "',"
            SQl = SQl + " SliderType2 = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SliderType2") & "',"
            SQl = SQl + " ManufPlace = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ManufPlace") & "',"
            SQl = SQl + " Material = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Material") & "',"
            SQl = SQl + " MaterialOther = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MaterialOther") & "',"
            SQl = SQl + " SellVendor = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SellVendor") & "',"
            SQl = SQl + " Buyer = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Buyer") & "',"
            SQl = SQl + " ConfirmFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ConfirmFile") & "',"
            SQl = SQl + " AuthorizeFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("AuthorizeFile") & "',"
            SQl = SQl + " DevReason = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("DevReason") & "',"
            SQl = SQl + " Sample = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Sample") & "',"
            SQl = SQl + " Price = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Price") & "',"
            SQl = SQl + " ArMoldFee = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ArMoldFee") & "',"
            SQl = SQl + " PurMold = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("PurMold") & "',"
            SQl = SQl + " PullerPrice = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("PullerPrice") & "',"
            SQl = SQl + " Suppiler = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Suppiler") & "',"
            SQl = SQl + " QCLT = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QCLT") & "',"

            SQl = SQl + " MoldQty = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MoldQty") & "',"
            SQl = SQl + " MoldPoint = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MoldQty") & "',"
            SQl = SQl + " Quality1 = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Quality1") & "',"
            SQl = SQl + " Quality2 = '" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Quality2") & "',"
            SQl = SQl + " QAFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAFile") & "',"
            SQl = SQl + " SampleFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SampleFile") & "',"
            SQl = SQl + " ContactFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ContactFile") & "',"

            SQl = SQl + " SAttachFile = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("SAttachFile") & "',"
            SQl = SQl + " QAttachFile1 = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAttachFile1") & "',"
            SQl = SQl + " QAttachFile2 = N'" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("QAttachFile2") & "',"
            ...
            RtnCode = oPutSubFile.Transfer(DNFormNo.Text, DNFormSno.Text, DOFormNo.Text, DOFormSno.Text, Request.QueryString("pUserID"))
        End If
    End Sub
