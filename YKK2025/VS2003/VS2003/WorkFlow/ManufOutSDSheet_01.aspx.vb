...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("SliderGRCode").Value = "" 'Slider Group Code, SliderGRCodePicker使用
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ManufOutSDSheet").Rows.Count > 0 Then
            ...
            SetFieldData("Division", DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("Division"))  '部門
            SetFieldData("Person", DBDataSet1.Tables("F_ManufOutSDSheet").Rows(0).Item("Person"))      '擔當
    ...
    Sub ShowSheetFunction()
        ...
        If wFormSno > 0 And wStep > 2 Then      '判斷是否[簽核]
            ...
            If DBDataSet1.Tables("T_WaitHandle").Rows.Count > 0 Then
                'Sheet顯示
                DManufOutSDSheet.Visible = True   '表單Sheet-1
    ...
    Sub SetPopupFunction()
        ...
        BOut.Attributes("onclick") = "DevNoPicker('Out','000010');"         '內製
        BImport.Attributes("onclick") = "DevNoPicker('Import','000010');"     '進口/客供拉頭委託書-No
    End Sub
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        Select Case FindFieldInf("Content")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DContentRqd", "DContent", "異常：需輸入說明內容")
                DContent.Visible = True
            Case 2  '修改
        ...
        Select Case FindFieldInf("SliderFile")
            ...
            Case 1  '修改+檢查
                ShowRequiredFieldValidator("DSliderFileRqd", "DSliderFile", "異常：需輸入拉頭細目表")
    ...
    Private Sub BSAVE_ServerClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BSAVE.ServerClick
        If Request.Cookies("RunBSAVE").Value = True Then
            If InputCheck() = 0 Then
                ...
                If ErrCode = 0 Then
                    If DSliderFile.Visible Then
                        If DSliderFile.PostedFile.FileName <> "" Then  '判斷有檔案上傳
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("000010", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        End If
        SQl = SQl + " N'" + YKK.ReplaceString(DContent.Text) + "', "            '說明內容

        FileName = ""
        If DSliderFile.Visible Then                         '附件
            If DSliderFile.PostedFile.FileName <> "" Then     '判斷有檔案上傳
