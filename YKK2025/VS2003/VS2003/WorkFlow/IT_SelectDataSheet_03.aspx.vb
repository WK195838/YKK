...
Public Class IT_SelectDataSheet_03
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "IT_SelectDataSheet_03.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_SelectDataSheet").Rows.Count > 0 Then
            ...
            ListItem1.Text = DBDataSet1.Tables("F_SelectDataSheet").Rows(0).Item("Engineer")
            ListItem1.Value = DBDataSet1.Tables("F_SelectDataSheet").Rows(0).Item("Engineer")
            DEngineer.Items.Add(ListItem1)

            Dim ListItem3 As New ListItem
            ListItem3.Text = DBDataSet1.Tables("F_SelectDataSheet").Rows(0).Item("System")
            ListItem3.Value = DBDataSet1.Tables("F_SelectDataSheet").Rows(0).Item("System")
            DSystem.Items.Add(ListItem3)

            DRemark.Text = DBDataSet1.Tables("F_SelectDataSheet").Rows(0).Item("Remark")
            'Key
            wFormNo = DBDataSet1.Tables("F_SelectDataSheet").Rows(0).Item("FormNo")
            wFormSno = DBDataSet1.Tables("F_SelectDataSheet").Rows(0).Item("FormSno")
        End If
        '核定履歷資料
        SQL = "SELECT "
