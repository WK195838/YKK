...
#End Region
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_AppendSpecSheet").Rows.Count > 0 Then
            ...
            SetFieldData("Assembler", DBDataSet1.Tables("F_AppendSpecSheet").Rows(0).Item("Assembler"))      '組立判定
            ...
            If DBDataSet1.Tables("F_AppendSpecSheet").Rows(0).Item("AssemblerFile") <> "" Then          '組立判定
    ...
    Sub SetPopupFunction()
        ...
        BIn.Attributes("onclick") = "DevNoPicker('In','000012');"       '內製委託書-No
        BOut.Attributes("onclick") = "DevNoPicker('Out','000012');"     '外注委託書-No
        BImport.Attributes("onclick") = "DevNoPicker('Import','000012');"     '外注委託書-No
    End Sub
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        Select Case FindFieldInf("Description")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DDescriptionRqd", "DDescription", "異常：需輸入說明")
                DDescription.Visible = True
            Case 2  '修改
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("000012", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        SQl = SQl + " '" + DAssembler.SelectedValue + "', "       '組立判定
        ...
        SQl = SQl + " N'" + YKK.ReplaceString(DDescription.Text) + "', "  'EA說明
