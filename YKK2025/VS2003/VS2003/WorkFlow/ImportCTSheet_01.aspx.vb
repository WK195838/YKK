...
#End Region
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "ImportCTSheet_01.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ImportCTSheet").Rows.Count > 0 Then
            ...
            SetFieldData("Division", DBDataSet1.Tables("F_ImportCTSheet").Rows(0).Item("Division"))  '部門
            SetFieldData("Person", DBDataSet1.Tables("F_ImportCTSheet").Rows(0).Item("Person"))      '擔當
            ...
            If DNFormNo.Text <> "" And DNFormSno.Text <> "" Then
                LNFormNo.NavigateUrl = "ImportModSheet_01.aspx?pFormNo=" & DNFormNo.Text & "&pFormSno=" & CInt(DNFormSno.Text) & "&pOFormNo=" & DOFormNo.Text & "&pOFormSno=" & CInt(DOFormSno.Text) & "&pStep=" & wStep
            ...
            SetFieldData("Target", DBDataSet1.Tables("F_ImportCTSheet").Rows(0).Item("Target"))
    ...
    Sub SetPopupFunction()
        ...
        BIn.Attributes("onclick") = "DevNoPicker('Import','000013');"       '進口/客供拉頭
    ...
    Sub SetFieldData(ByVal pFieldName As String, ByVal pName As String)
        ...
        If pFieldName = "Target" Then
            ...
            If idx = 0 Then
                ...
                End If
            Else
                SQL = "Select * From M_Referp Where Cat='225' and DKey='TARGET' Order by DKey, Data "
                Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("000013", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(ConfigurationSettings.AppSettings.Get("ImportCTFilePath"))
        ...
        SQl = "Insert into F_ImportCTSheet "
        SQl = SQl + "( "
        SQl = SQl + "Sts, CompletedTime, FormNo, FormSNo, "          '1~4
        SQl = SQl + "No, Date, Division, Person, SliderCode, "       '5~9
        SQl = SQl + "OFormNo, OFormSno, NFormNo, NFormSno, Suppiler, "  '10~14
        SQl = SQl + "Target,Spec, Content, Reason, AttachFile, "          '15~18
        ...
        SQl = SQl + " N'" + YKK.ReplaceString(DSpec.Text) + "', "              '目的
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQl = "Update F_ImportCTSheet Set "
        If pFun <> "SAVE" Then
            SQl = SQl + " Sts = '" & pSts & "',"
