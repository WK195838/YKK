<%@ Page Language="vb" AutoEventWireup="false" Codebehind="zzContactOutSheet_01.aspx.vb" Inherits="SPD.ContactOutSheet" aspCompat="True"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>ContactOutSheet</title>
		...
		<script language="javascript" type="text/javascript">
			...
			function ModifySheet()
			{
				if (document.Form1.DOFormNo.value != "" && document.Form1.DOFormSno.value != "") {
					...
					alert(wStep);
					window.open('ModManufOutSheet_02.aspx?pFormNo=' + wNFormNo + '&pFormSno=' + wNFormSno + '&pOFormNo=' + document.Form1.DOFormNo.value + '&pOFormSno=' + document.Form1.DOFormSno.value + '&pStep=' + wStep,'ModifySheet','width=620,height=580,scrollbars=yes,resizable=yes');
				}
			}
		</script>
	</HEAD>
		...
		<FORM id="Form1" method="post" runat="server">
			<FONT face="新細明體">
				...
				<asp:button id="BModify" style="Z-INDEX: 141; LEFT: 496px; POSITION: absolute; TOP: 228px" runat="server"
					Width="56px" Height="20px" Text="新委託"></asp:button>
				...
				<asp:hyperlink id="LBefOP" style="Z-INDEX: 128; LEFT: 168px; POSITION: absolute; TOP: 618px" runat="server"
					Width="144px" Height="8px" Font-Size="12pt" NavigateUrl="BoardEdit.aspx" Target="_blank">工程履歷</asp:hyperlink>
