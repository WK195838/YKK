<%@ Page Language="vb" AutoEventWireup="false" Codebehind="zzOPContactOutList.aspx.vb" Inherits="SPD.OPContactOutList"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>OPContactOutList</title>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">
				<asp:datagrid id="DataGrid1" style="Z-INDEX: 113; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
					...
					AutoGenerateColumns="False" BorderStyle="None" BackColor="White" Width="580px" Height="300px">
