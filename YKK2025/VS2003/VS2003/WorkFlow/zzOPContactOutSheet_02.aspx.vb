...
Public Class OPContactOutSheet_02
...
#End Region
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_OPContactOutSheet").Rows.Count > 0 Then
            ...
            DDivision.Text = DBDataSet1.Tables("F_OPContactOutSheet").Rows(0).Item("Division") '部門
            DPerson.Text = DBDataSet1.Tables("F_OPContactOutSheet").Rows(0).Item("Person")   '擔當
            DSliderCode.Text = DBDataSet1.Tables("F_OPContactOutSheet").Rows(0).Item("SliderCode")       'Slider Code
            DLevel.Text = DBDataSet1.Tables("F_OPContactOutSheet").Rows(0).Item("Level")              '難易度
