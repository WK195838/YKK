...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents DStartStep As System.Web.UI.WebControls.TextBox
    Protected WithEvents DEndStep As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "Developing_List.aspx"
    ...
    Sub SetSearchItem()
        ...
        '表單
        SQL = "SELECT FormNo, FormName FROM W_Developing "
        ...
        DBAdapter1.Fill(DBDataSet1, "W_Developing")
        ...
        '部門
        DBDataSet1.Clear()
        SQL = "SELECT WDivision FROM W_Developing "
        ...
        DStartStep.Text = "Start-工程No"
        DEndStep.Text = "End-工程No"
        DApplyName.Text = "依賴者"
        DBuyer.Text = "Buyer"
    ...
    Sub DataList()
        ...
        SQL = "SELECT "
        SQL = SQL + "FormNo, FormSno, FormName, SeqNo, Progress, ApplyID, ApplyName, ApplyTime, Step,Buyer ,SliderCode, "
        SQL = SQL + "StepName+'('+str(Step)+')' as StepName, DecideID, DecideName, BStartTime, BEndTime, ViewURL, "
        ...
        'Start~End Step
        If DStartStep.Text <> "" And DStartStep.Text <> "Start-工程No" And _
           DEndStep.Text <> "" And DEndStep.Text <> "End-工程No" Then
            SQL = SQL + " And Step >= '" + DStartStep.Text + "'"
            SQL = SQL + " And Step <= '" + DEndStep.Text + "'"
        End If
        '依賴者
    ...
    Private Sub BExcel_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=Developing_List.xls")     '程式別不同
