...
Public Class _3S_InqCommission
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "3S_InqCommission.aspx"
    ...
    Sub DataList()
        ...
        If wTableName <> "" Then
            ...
            SQL = SQL + "Case " + wTableName + ".Sts When '0' Then '審理中' When '1' Then '審理完成' Else '審理取消' End As Field2, "
            SQL = SQL + wTableName + ".Division + '--' + " + wTableName + ".Name As Field3, "
            SQL = SQL + "Convert(VARCHAR(10), V_WaitHandle_01.ApplyTime, 111) as Field4, "

            SQL = SQL + wTableName + ".Remark As Field5, "
            '審理中
            SQL = SQL + "( "
            SQL = SQL + " select a.StepName + ' (' + a.decidename +')' from v_waithandle_01 a "
            SQL = SQL + " where a.formno=V_WaitHandle_01.formno and a.formsno=V_WaitHandle_01.formsno and a.active=1 and a.flowtype<>0 "
            SQL = SQL + ") as Field6, "
            ...
            End If
            'No
            If DNo.Text <> "案件No." And DNo.Text <> "" Then
            ...
            End If
            '依賴人
            If DPerson.Text <> "委託者" And DPerson.Text <> "" Then
                SQL = SQL + " And " + wTableName + ".Name Like '%" + DPerson.Text + "%'"
            End If
            '完成日
