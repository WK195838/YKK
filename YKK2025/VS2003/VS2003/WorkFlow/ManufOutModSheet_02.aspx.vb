...
Public Class ManufOutModSheet_02
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "ManufOutModSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ManufOutModSheet").Rows.Count > 0 Then
            ...
            SetFieldData("Division", DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("Division"))  '擔當
            ...
            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo") <> "" Then                 '圖號
                ...
                Else
                    LMapNo.NavigateUrl = "MapModSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno"))
                End If
            Else
            ...
            If DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("MapNo1") <> "" Then                 '圖號
                ...
                Else
                    LMapNo1.NavigateUrl = "MapModSheet_02.aspx?pFormNo=" & DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormNo1") & _
                                                          "&pFormSno=" & CStr(DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("OFormSno1"))
                End If
            Else
            ...
            DManufFlow.Text = DBDataSet1.Tables("F_ManufOutModSheet").Rows(0).Item("ManufFlow")     '開發理由
