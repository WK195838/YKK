<%@ Page Language="vb" AutoEventWireup="false" Codebehind="zzModManufOutSheet_02.aspx.vb" Inherits="SPD.ModManufOutSheet_02" aspCompat="True"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>ModManufOutSheet_02</title>
		...
		<FORM id="Form1" method="post" encType="multipart/form-data" runat="server">
			<FONT face="新細明體">
				<asp:image id="DManuaInSheet1" style="Z-INDEX: 100; LEFT: 8px; POSITION: absolute; TOP: 8px"
					runat="server" ImageUrl="Images\ManufOutSheet_001.jpg" Width="593px" Height="670px"></asp:image>
