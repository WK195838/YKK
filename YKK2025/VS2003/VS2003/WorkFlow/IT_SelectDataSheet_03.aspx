<%@ Page Language="vb" AutoEventWireup="false" Codebehind="IT_SelectDataSheet_03.aspx.vb" Inherits="SPD.IT_SelectDataSheet_03"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
			<FONT face="新細明體">
				...
				<asp:label id="DHistoryLabel" style="Z-INDEX: 139; LEFT: 8px; POSITION: absolute; TOP: 488px"
					runat="server" ForeColor="Blue" Width="64px" Height="16px" Font-Size="11pt" Font-Names="新細明體">核定履歷</asp:label>
				<asp:datagrid id="DataGrid9" style="Z-INDEX: 109; LEFT: 8px; POSITION: absolute; TOP: 504px" runat="server"
				...
				<asp:textbox id="DBDays" style="Z-INDEX: 137; LEFT: 608px; POSITION: absolute; TOP: 352px" runat="server"
					...
					Width="80px" Height="20px" ForeColor="Blue" BackColor="Yellow" BorderStyle="Groove" ReadOnly="True">DEmpID</asp:textbox><asp:textbox id="DBEndDate" style="Z-INDEX: 131; LEFT: 336px; POSITION: absolute; TOP: 352px"
					runat="server" Width="176px" Height="20px" ForeColor="Blue" BackColor="Yellow" BorderStyle="Groove">DBEndDate</asp:textbox><asp:textbox id="DBStartDate" style="Z-INDEX: 129; LEFT: 120px; POSITION: absolute; TOP: 352px"
					runat="server" Width="184px" Height="20px" ForeColor="Blue" BackColor="Yellow" BorderStyle="Groove">DBStartDate</asp:textbox><asp:textbox id="DRemark" style="Z-INDEX: 128; LEFT: 120px; POSITION: absolute; TOP: 382px" runat="server"
					...
					runat="server" Width="72px" Height="8px" Font-Size="12pt" Target="_blank" NavigateUrl="BoardEdit.aspx">參考附件</asp:hyperlink><asp:textbox id="DTarget" style="Z-INDEX: 123; LEFT: 120px; POSITION: absolute; TOP: 184px" runat="server"
					...
					Width="144px" Height="20px" ForeColor="Blue" BackColor="Yellow" BorderStyle="Groove" ReadOnly="True">DName</asp:textbox><asp:dropdownlist id="DEngineer" style="Z-INDEX: 108; LEFT: 120px; POSITION: absolute; TOP: 318px"
