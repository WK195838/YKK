<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ManufInList.aspx.vb" Inherits="SPD.OPContractList"%>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">
				<asp:datagrid id="DataGrid1" style="Z-INDEX: 113; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
					...
					BorderStyle="None" BackColor="White" Width="800px" Height="300px">
