...
Public Class ManufOutCTSheet_02
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "ManufOutCTSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        If DBDataSet1.Tables("F_ManufOutCTSheet").Rows.Count > 0 Then
            ...
            DDivision.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Division") '部門
            DPerson.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Person")   '擔當
            ...
            DTarget.Text = DBDataSet1.Tables("F_ManufOutCTSheet").Rows(0).Item("Target")             '圖號
