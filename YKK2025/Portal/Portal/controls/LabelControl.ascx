<%@ Control Language="vb" AutoEventWireup="false" Codebehind="LabelControl.ascx.vb" Inherits="DotNetNuke.UI.UserControls.LabelControl" targetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
