...
<table cellSpacing="0" cellPadding="0" border="0">
	...
	<TR id="FileRow" runat="server">
		<td noWrap><asp:label id="lblFolder" runat="server" enableviewstate="False" resourcekey="Folder" CssClass="NormalBold"></asp:label><asp:dropdownlist id="cboFolders" runat="server" AutoPostBack="True" cssclass="NormalTextBox" Width="300"></asp:dropdownlist><br>
