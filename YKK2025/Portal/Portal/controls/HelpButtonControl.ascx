<%@ Control Language="vb" AutoEventWireup="false" Codebehind="HelpButtonControl.ascx.vb" Inherits="DotNetNuke.UI.UserControls.HelpButtonControl" targetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
