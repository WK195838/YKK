...
<TABLE WIDTH="100%" BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
	<TR>
	  <TD HEIGHT=12 colspan="3"><img src="<%= SkinPath %>spacer.gif" width="1" height="12"></TD>
  </TR>
	<TR>
		<TD WIDTH=8 rowspan="4" align="right" background="<%= SkinPath %>03_04b2.gif"><img src="<%= SkinPath %>spacer.gif" width="1" height="1"></TD>
		<TD BACKGROUND="<%= SkinPath %>03_04.jpg" HEIGHT=19 ALIGN=LEFT VALIGN=TOP></TD>
		<TD width="8" rowspan="4" ALIGN=LEFT VALIGN=top background="<%= SkinPath %>03_04b.gif"></TD>
	</TR>
	<TR>
