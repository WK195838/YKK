...
<TABLE BGCOLOR="#FFFFFF" BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" HEIGHT="100%">
  <TR> 
    ...
    <TD ALIGN="RIGHT" ROWSPAN="1" WIDTH="100%" HEIGHT="20">&nbsp;</TD>
    <TD ALIGN="RIGHT" ROWSPAN="1" COLSPAN="1" WIDTH="100%" HEIGHT="20" nowrap><FONT Style="FONT-SIZE:8pt" FACE="Verdana" COLOR="#000000"><dnn:LOGIN runat="server" id="dnnLOGIN" /> 
      / <dnn:USER runat="server" id="dnnUSER" /></FONT></TD>
  </TR>
  <TR> 
    <TD VALIGN="TOP" ROWSPAN="1" HEIGHT="41" noWrap><IMG SRC="<%= SkinPath %>Image42x1.png" WIDTH="716" HEIGHT="41" BORDER="0"></TD>
    <TD VALIGN="TOP" ALIGN="CENTER" ROWSPAN="1" HEIGHT="41"><FONT Style="FONT-SIZE:8pt" FACE="Verdana" COLOR="#000000"></FONT></TD>
    <TD VALIGN="TOP" ALIGN="RIGHT" ROWSPAN="1" HEIGHT="41"><FONT Style="FONT-SIZE:8pt" FACE="Verdana" COLOR="#000000"><dnn:HELP runat="server" id="dnnHELP" /></FONT></TD>
  </TR>
  <TR> 
    <TD VALIGN="TOP" ROWSPAN="1" COLSPAN="3" HEIGHT="18"> 
      <TABLE WIDTH="100%" HEIGHT="100%" BORDER="0" VALIGN="TOP">
        <TR VALIGN="TOP"> 
          <TD WIDTH="300" HEIGHT="13"><FONT Style="FONT-SIZE:8pt" FACE="Verdana" COLOR="#000000"></FONT></TD>
          <TD COLSPAN="2" Align=Left><FONT STYLE="FONT-SIZE:8pt" FACE="Verdana" COLOR="#000000"><dnn:MENU runat="server" id="dnnMENU" /></FONT></TD>
        </TR>
        <TR VALIGN="TOP"> 
          <TD WIDTH="300" HEIGHT="18"><FONT Style="FONT-SIZE:8pt" FACE="Verdana" COLOR="#000000"><dnn:CURRENTDATE runat="server" id="dnnCURRENTDATE" /></FONT></TD>
          <TD WIDTH="50" HEIGHT="18">&nbsp;</TD>
          <TD HEIGHT="18" Align=Right><FONT Style="FONT-SIZE:8pt" FACE="Verdana" COLOR="#000000"><dnn:LOGO runat="server" id="dnnLOGO" /></FONT></TD>
        </TR>
      </TABLE>
    </TD>
  </TR>
  ...
  <TR> 
    ...
    <TD style="BORDER-TOP: blue 1px solid" vAlign="top" HEIGHT="20px" ROWSPAN="1" COLSPAN="4"> 
      <TABLE WIDTH="100%" HEIGHT="20px" BORDER="0">
        ...
        <TR> 
          <TD vAlign="top" Align="Center" noWrap><FONT Style="FONT-SIZE:7pt" FACE="Verdana" COLOR="#000000"><dnn:TERMS runat="server" id="dnnTERMS" />|<dnn:PRIVACY runat="server" id="dnnPRIVACY" /></FONT></TD>
        </TR>
      </TABLE>
    </TD>
  </TR>
