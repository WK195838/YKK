...
<table width="100%" border=0 cellpadding=0 cellspacing=0>
	<tr>
		<td class="Normal" rowspan="2" width="139" align="center" valign="middle"><img src="images/logo.gif" skinattribute="src" width="133" height="45" runat="server" ></td>
	...
	<tr>
		...
		<td><img src="images/Speerio-Connected-Home_14.gif" skinattribute="src" runat="server" width=274 height=18 /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td id="RightPane" runat="server" rowspan="3" bgcolor="#CAEBEB" width="257" height="1000" align="left" valign="top" style="padding:10px"></td>
	</tr>
	<tr>
	...
	<tr>
		<td id="LeftPane" runat="server" colspan="3" bgcolor="#CAEBEB" width="257" height="1000" align="left" valign="top" style="padding:10px"></td>
	</tr>
</table>
