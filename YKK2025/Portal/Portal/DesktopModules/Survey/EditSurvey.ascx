...
<%@ Control Inherits="DotNetNuke.Modules.Survey.EditSurvey" CodeBehind="EditSurvey.ascx.vb" language="vb" AutoEventWireup="false" Explicit="True" %>
...
<table class="Settings" cellspacing="0" cellpadding="2" border="0">
	...
	<tr>
		...
		<td><asp:textbox id="txtViewOrder" runat="server" cssclass="NormalTextBox" maxlength="128" width="300"></asp:textbox></td>
	</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
	</tr>
