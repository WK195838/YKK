...
<%@ Control Inherits="DotNetNuke.Modules.Admin.PortalManagement.SiteSettings" CodeBehind="SiteSettings.ascx.vb" language="vb" AutoEventWireup="false" Explicit="True" enableViewState="True" targetSchema="http://schemas.microsoft.com/intellisense/ie5" debug="False"%>
<!-- Settings Tables -->
						...
						<TD vAlign="top" width="475">
							...
							<TABLE id="tblHost" cellSpacing="2" cellPadding="2" summary="Host Settings Design Table"
								...
								<TR>
									...
									<TD class="NormalTextBox" width="325">
										<asp:textbox id="txtHostSpace" cssclass="NormalTextBox" runat="server" width="300" maxlength="3"></asp:textbox></TD>
								</TR>
								<TR>
									<TD class="SubHead" width="150">
