<%@ Control Inherits="DotNetNuke.Modules.Admin.PortalManagement.SiteWizard" CodeBehind="SiteWizard.ascx.vb" language="vb" AutoEventWireup="false" Explicit="True" enableViewState="True" targetSchema="http://schemas.microsoft.com/intellisense/ie5" debug="False" %>
