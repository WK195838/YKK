<%@ Control language="vb" CodeBehind="Portals.ascx.vb" AutoEventWireup="false" Explicit="True" Inherits="DotNetNuke.Modules.Admin.Portals.Portals" %>
...
<ItemTemplate>
				<asp:HyperLink NavigateUrl='<%# GetEditURL(DataBinder.Eval(Container.DataItem,"PortalID")) %>' runat="server" ID="lnkEdit">
