...
<%@ Control CodeBehind="ModuleSettings.ascx.vb" language="vb" AutoEventWireup="false" Explicit="True" Inherits="DotNetNuke.Modules.Admin.Modules.ModuleSettingsPage" %>
							...
							<tr>
								...
								<td>
									<table border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td><dnn:modulepermissionsgrid id="dgPermissions" runat="server" BackColor="Transparent">
													<HeaderStyle Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" BackColor="Transparent"></HeaderStyle>
													<FooterStyle BackColor="White"></FooterStyle>
												</dnn:modulepermissionsgrid></td>
										</tr>
										<tr>
