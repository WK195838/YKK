<%@ Control language="vb" CodeBehind="EditModuleControl.ascx.vb" AutoEventWireup="false" Explicit="True" Inherits="DotNetNuke.Modules.Admin.ModuleDefinitions.EditModuleControl" %>
