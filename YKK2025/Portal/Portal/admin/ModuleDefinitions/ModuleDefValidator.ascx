<%@ Control Language="vb" AutoEventWireup="false" Explicit="True" Codebehind="ModuleDefValidator.ascx.vb" Inherits="DotNetNuke.Modules.Admin.ModuleDefinitions.ModuleDefValidator"%>
