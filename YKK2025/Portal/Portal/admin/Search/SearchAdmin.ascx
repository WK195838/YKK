<%@ Control Language="vb" AutoEventWireup="false" Codebehind="SearchAdmin.ascx.vb" Inherits="DotNetNuke.Modules.Admin.Search.SearchAdmin" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
