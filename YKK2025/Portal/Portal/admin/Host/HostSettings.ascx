<%@ Control Inherits="DotNetNuke.Modules.Admin.Host.HostSettingsModule" CodeBehind="HostSettings.ascx.vb" language="vb" AutoEventWireup="false" Explicit="True" %>
				...
				<tr>
					...
					<td valign="top" width="475">
						...
						<table id="tblOther" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							...
							<tr>
								<td class="SubHead" width="150"><dnn:label id="plUseFriendlyUrls" text="Use Friendly Urls?" controlname="chkUseFriendlyUrls"
										runat="server" /></td>
								<td valign="top"><asp:checkbox id="chkUseFriendlyUrls" cssclass="NormalTextBox" runat="server"></asp:checkbox></td>
							</tr>
							<tr>
