<%@ Control Language="vb" AutoEventWireup="false" Codebehind="Success.ascx.vb" Inherits="DotNetNuke.Services.Wizards.WizardSuccess" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
