<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FASBYFlow.aspx.vb" Inherits="FASBYFlow" %>
...
<!-- ++  底圖                                                                                ++ -->
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <img src="iMages/FAS_BYMain.png" style="z-index: 1; left: 0px; position: absolute;top: 34px; width: 996px; height: 420px;"/>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<!-- ++  各Action按鈕                                                                              ++ -->
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <asp:ImageButton ID="BStatusList" runat="server" style="z-index: 1; left: 2px; position: absolute;top: 0px;" ImageUrl="iMages/BStatus.png" Height="35px" Width="86px" />
        <asp:ImageButton ID="BCheckSum" runat="server" style="z-index: 1; left: 89px; position: absolute;top: 0px;" ImageUrl="iMages/summary-icon.gif" Height="35px" Width="86px" />
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<!-- ++  各按鈕                                                                              ++ -->
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <!-- 1列  -->
        <asp:ImageButton ID="BReset" runat="server" style="z-index: 1; left: 162px; position: absolute;top: 77px; width: 50px; height: 50px;" ImageUrl="iMages/Reset.jpg" />
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <!-- BY FCT格式轉換  -->
        <asp:CheckBox ID="AtGoImport" runat="server" style="z-index: 174; left: 258px; position: absolute; top: 82px" Font-Size="9pt" Text="至準備BYFCT資料" Width="130px" />
        <asp:CheckBox ID="AtGoReport" runat="server" style="z-index: 174; left: 258px; position: absolute; top: 107px" Font-Size="9pt" Text="至報表列出" Width="130px" />
        <!-- 準備 BY FCT資料  -->
