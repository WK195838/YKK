<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AutoMaterialExpansion.aspx.vb" Inherits="AutoMaterialExpansion" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>自動材料展開(FAS)</title>
</head>
<body>
    ...
    <div>
        <asp:TextBox ID="DSProgressBar" runat="server" AutoPostBack="True" BackColor="#FFFF80"
            ...
            Width="849px">批次自動材料展開中..........</asp:TextBox>
        <asp:TextBox ID="DEProgressBar" runat="server" AutoPostBack="True" BackColor="#FFFF80"
            ...
            text-align: left" Width="849px">批次自動材料處理中..........</asp:TextBox>
