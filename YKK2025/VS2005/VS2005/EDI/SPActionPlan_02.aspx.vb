...
Partial Class SPActionPlan_02
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "SPActionPlan_02.aspx"   '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        '
        SQL = SQL & "case when SPRemark='' then substring(SPNo,3,8) + char(13) + SPNo "
        SQL = SQL & "     else substring(SPNo,3,8) + char(13) + SPNo + char(13) + SPRemark "
        SQL = SQL & "end As SPNo, "
        SQL = SQL & "SPNo As wSPNo, "
        '
        SQL = SQL & "'http://10.245.0.205/EDI/SPHttp2File.aspx?pFun=SPNO&pSPNo=' + SPNo As SPNoURL, "
        '
        SQL = SQL & "ActionName, "
        ...
        '
        SQL = SQL & "from V_SPBuybackMaterial_0801 "
        'SQL = SQL & "from V_LFSPActionPlan01 "
        ...
        ' SPNo
        If DKSPNo.Text <> "" Then
            SQL = SQL & "and ltrim(rtrim(SPNo)) Like '%" & UCase(DKSPNo.Text.Trim) & "%' "
        End If
        '
        ...
        SQL = SQL & "SPRemark "
        '
        SQL = SQL & "Order by Item, Color, Keep, SPNo Desc, Action "
        '
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        ...
        If (e.Row.RowType = DataControlRowType.Header) Then
            ...
            H3tc8.Text = "FC/Demand"
            H3tc8.RowSpan = 2
            H3tc8.BackColor = Color.Black
                ...
                If CInt(mySingleRow.RowIndex) > 0 Then      'Gridview Data Record > 0
                    ...
                    If mergeColumns(MergeIdx) <> 99 Then    '有效合併儲存格                    '    '
                        ...
                        If xSPNo = ySPNo Then
                            '
                            '合併處理
                            If mergeColumns(MergeIdx) < 7 Then  '是否合併欄位
    ...
    Protected Sub GridView1_RowEditing(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewEditEventArgs) Handles GridView1.RowEditing
        ...
        'Dim lnk As HyperLink = GridView1.SelectedRow.Cells(4).Controls(0)
        'Dim xSPNo As String = Replace(lnk.Text, "&nbsp;", "")
        Dim xSPNo As String = Replace(GridView1.Rows(e.NewEditIndex).Cells(24).Text, "&nbsp;", "")
        '
        If InStr(xSPNo, "SP") > 0 Then
            xSPNo = Mid(xSPNo, InStr(xSPNo, "SP"), 99)
        End If
