...
Partial Class InfF_FCTACTAnalysis_01
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "InfF_FCTACTAnalysis_01.aspx"  '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowItemDataList()
        ...
        ' 篩選資料
        sql = "SELECT "
        sql &= "a.CustCode As CustCode, b.CustName + '(' + a.CustCode + ')' As Customer, a.Buyer, a.Season, a.CustItem, "
        ...
        sql &= "Group by a.CustCode, b.CustName, a.Buyer, a.Season, a.CustItem "
        sql &= "Order by a.CustCode, b.CustName, a.Buyer, a.Season, a.CustItem "
        '
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            For i As Integer = 1 To 4
                If Month(i) <> "" Then
                    ...
                    sql &= "Group by  Buyer, CustCode, CustItem, Version "
                    sql &= "Order by  Buyer, CustCode, CustItem, Version Desc "
                    '
