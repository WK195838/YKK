...
Partial Class InfF_FCTACTVDPAnalysis_02a
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "InfF_FCTACTVDPAnalysis_02a.aspx"  '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Protected Sub ITEMGridView_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles ITEMGridView.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            Dim URLACT As String = "InfF_FCTACTVDPAnalysis_03.aspx?" + _
                                   "pBuyer=" + gBuyer + _
            ...
            Dim URLFCT As String = "InfF_FCTACTVDPAnalysis_03.aspx?" + _
                                   "pBuyer=" + gBuyer + _
                                   "&pCustCode=" + DataBinder.Eval(e.Row.DataItem, "CustCode") + _
                                   "&pSeason=" + gSeason + _
                                   "&pMonth=" + gMonth + _
