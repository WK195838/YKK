<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FASBYCheckPlanQty.aspx.vb" Inherits="FASBYCheckPlanQty" %>
...
<body>
    ...
    <div>
        <asp:TextBox ID="DMessage" runat="server" BackColor="White" BorderStyle="None" ForeColor="Red"
            Height="39px" Style="z-index: 103; left: 9px; position: absolute; top: 8px" Width="818px" Font-Bold="False" Font-Size="Large">cccccc</asp:TextBox>

<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<!-- ++  GridView                                                                            ++ -->
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Style="z-index: 103; left: 8px; position: absolute; top: 58px" CellPadding="3" Font-Size="9pt" GridLines="Vertical" PageSize="20" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" >
            <Columns>
