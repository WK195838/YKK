<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SP_MaterialMenu_Excel.aspx.vb" Inherits="SP_MaterialMenu_Excel" %>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <!-- ------------------------------------------------------------------------------------ -->
        <!-- Control  -->
        <asp:TextBox ID="DExcel" runat="server" Height="16px" Style="z-index: 318; left: 24px;
            position: absolute; top: 16px;font-size:10px;background:transparent" Width="116px"   BorderStyle="Solid" Text="EXCEL" Font-Bold="True" ForeColor="Red" Font-Size="XX-Large"></asp:TextBox>
