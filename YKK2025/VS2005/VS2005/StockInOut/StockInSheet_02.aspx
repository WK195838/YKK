<%@ Page Language="vb" AutoEventWireup="false" Inherits="StockInSheet_02" aspCompat="True" EnableEventValidation = "false"  CodeFile="StockInSheet_02.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               <img src="images/StockIn_01.jpg" style="z-index: 1; left: 8px; position: absolute;
                   top: 16px" />
               <asp:HyperLink ID="LAttachfile" runat="server" Style="z-index: 138; left: 224px;
                   position: absolute; top: 248px">附檔</asp:HyperLink>
               <asp:TextBox ID="DType" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   top: 160px; text-align: left" Width="140px"></asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               ...
               <asp:TextBox ID="DDate" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   ...
                   top: 96px; text-align: left" Width="140px"></asp:TextBox>
               &nbsp; &nbsp;&nbsp;
               <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 480px; position: absolute; top: 104px" Width="136px">DNo</asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp;&nbsp;
           ...
           <asp:TextBox ID="DStockNo" runat="server"    BackColor="#C0FFFF" BorderStyle="None"
               ForeColor="Black" Height="40px" Style="z-index: 126; left: 224px; TEXT-TRANSFORM:   uppercase; 
               position: absolute; top: 200px; text-align: left" Width="304px" Font-Size="X-Large" ></asp:TextBox>
