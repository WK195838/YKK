...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               <img src="images/StockOut_02.jpg" style="z-index: 1; left: 16px; position: absolute;
                   top: 16px" />
               <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   Height="20px" Style="z-index: 126; left: 232px; position: absolute; top: 296px;
                   text-align: left" Width="376px"></asp:TextBox>
           ...
           <asp:Panel ID="Panel2" runat="server" BorderWidth="1px" Height="328px" ScrollBars="Auto"
               Style="left: 24px; position: absolute; top: 368px" Width="632px">
               &nbsp; &nbsp;&nbsp;
