...
Partial Class Commission_Sheet
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Response.Cookies("PGM").Value = "Commission_Sheet.aspx"
    ...
    Sub SetLastUpdateTime()
        ...
        SQL = "SELECT CreateTime From W_CommissionSheet "
    ...
    Function GetDataTable() As Integer
        ...
        SQL = "SELECT NoteId, ParnetId, sText, sValue, sURL, sTarget FROM W_CommissionSheet "
        SQL = SQL & "Where ( "
        SQL = SQL & "       ParnetID = '0' "
        '表單
        ...
        SQL = SQL & "Group by NoteId, ParnetId, sText, sValue, sURL, sTarget "

        OleDbConnection1.Open()
        Dim DBAdapter1 As New OleDbDataAdapter(SQL, OleDbConnection1)
        DBAdapter1.Fill(DBDataSet1, "Sheet")
        DBTable1 = DBDataSet1.Tables("Sheet")
        If DBTable1.Rows.Count > 1 Then
            If DBTable1.Rows.Count > 100 Then
                GetDataTable = 2
            Else
