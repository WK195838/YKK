...
Partial Class HR_OverTimeReport02
    ...
    Dim wDivision As String         '指定部門
    Dim wEmpID As String = ""       '指定人
    Dim wYear As String = ""        '指定年
    Dim wMonth As String = ""       '指定月
    Dim wUserID As String = ""      'UserID

    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Response.Cookies("PGM").Value = "HR_OverTimeReport02.aspx"
        SetParameter()          '設定共用參數
    ...
    Sub SetParameter()
        ...
        wDivision = Request.QueryString("pDivision")   '指定部門
        wLevel = Request.QueryString("pLevel")        '篩選Level
        wEmpID = Request.QueryString("pEmpID")        '指定人
        wYear = Request.QueryString("pYear")          '指定年
        wMonth = Request.QueryString("pMonth")        '指定月
    ...
    Sub DataList()
        ...
        '篩選條件Joo
        SQL = SQL + "Where Sts = '1' "
        SQL = SQL + "  And SalaryYM = '" + wYear + "/" + wMonth + "' "
        SQL = SQL + "  And HRWDivID = '" + wDivision + "'"
    ...
    Protected Sub BRefresh_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BRefresh.Click
        Dim URL As String = "HR_OverTimeReport01.aspx?pUserID=" & wUserID
    ...
    Private Sub BExcel_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        Response.AppendHeader("Content-Disposition", "attachment;filename=HR_OverTimeReport_Personal.xls")     '程式別不同
