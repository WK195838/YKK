...
<head runat="server">
    ...
    body { font-size:12px;}
		...
		<script language="javascript" type="text/javascript">
            ...
            {
                window.open('http://10.245.1.6/SCD/DatePicker.aspx?field1='+xField+'&pDepo='+xDepo,'','status=0,toolbar=0,width=300,height=200');
            }
		</script>
</head>
<body>
    ...
    <div>
        <!-- 表單Image -->
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Agent_01.PNG"
