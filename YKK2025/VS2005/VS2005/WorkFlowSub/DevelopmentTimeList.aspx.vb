...
Partial Class DevelopmentTimeList
    ...
    Sub SetParameter()
        ...
        WorkTable = "Temp_DevelopmentTimeList_" & wUserID   'Temp Table
    End Sub
    '---------------------------------------------------------------------------------------------------
    '*****************************************************************
    '**
    ...
    Sub CreateWorkFile()
        ...
        SQL = SQL + "( "
        SQL = SQL + "MNo, Buyer, MapNo, MLevel, MapCreateTime, MapFinishTime, MapModTime, MapModCount, MapSts, "
        ...
        SQL = SQL + " '" + fMapFinishTime + "', "
        If fMapCreateTime <> "" And fMapFinishTime <> "" Then
            SQL = SQL + " '" + FormatNumber(GetTime(CDate(fMapCreateTime), CDate(fMapFinishTime)) / 60, 0) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        If fMapModCount > 0 Then
            SQL = SQL + " '" + CStr(fMapModCount) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        SQL = SQL + " '" + fMapSts + "', "
        SQL = SQL + " '" + fManufInCreateTime + "', "
        SQL = SQL + " '" + fManufInURL + "', "
        SQL = SQL + " '" + fManufInFinishTime + "', "
        If fManufInCreateTime <> "" And fManufInFinishTime <> "" Then
            SQL = SQL + " '" + FormatNumber(GetTime(CDate(fManufInCreateTime), CDate(fManufInFinishTime)) / 60, 0) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        If fManufInModCount > 0 Then
            SQL = SQL + " '" + CStr(fManufInModCount) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        SQL = SQL + " '" + fManufInSts + "', "
        If fMapCreateTime <> "" And fManufInFinishTime <> "" Then
            SQL = SQL + " '" + FormatNumber(GetTime(CDate(fMapCreateTime), CDate(fManufInFinishTime)) / 60, 0) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        SQL = SQL + " '" + fManufOutCreateTime + "', "
        SQL = SQL + " '" + fManufOutURL + "', "
        SQL = SQL + " '" + fManufOutFinishTime + "', "
        If fManufOutCreateTime <> "" And fManufOutFinishTime <> "" Then
            SQL = SQL + " '" + FormatNumber(GetTime(CDate(fManufOutCreateTime), CDate(fManufOutFinishTime)) / 60, 0) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        If fManufOutModCount > 0 Then
            SQL = SQL + " '" + CStr(fManufOutModCount) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        SQL = SQL + " '" + fManufOutSts + "', "
        If fMapCreateTime <> "" And fManufOutFinishTime <> "" Then
            SQL = SQL + " '" + FormatNumber(GetTime(CDate(fMapCreateTime), CDate(fManufOutFinishTime)) / 60, 0) + "', "
        Else
            SQL = SQL + " '" + "" + "', "
        End If
        SQL = SQL + " '" + wUserID + "', "     '作成者
    ...
    Private Sub BExcel_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        Response.AppendHeader("Content-Disposition", "attachment;filename=DevelopmentTimeList.xls")     '程式別不同
