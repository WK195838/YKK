<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_WorkTime_01.aspx.vb" Inherits="HR_WorkTime_01" %>
			...
			<FONT face="新細明體">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#CC9966"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="WTBase" HeaderText="基本" ReadOnly="True" >
                        </asp:BoundField>
                        <asp:BoundField DataField="WTOverTime" HeaderText="加班" ReadOnly="True" >
                        </asp:BoundField>
                        <asp:BoundField DataField="WTTimeOff" HeaderText="年休" ReadOnly="True" >
                        </asp:BoundField>
                        <asp:BoundField DataField="WTMin" HeaderText="工時(分)" ReadOnly="True" >
                        </asp:BoundField>
                        <asp:BoundField DataField="WTPer" HeaderText="工時(率)" ReadOnly="True" >
                        </asp:BoundField>

                        <asp:BoundField DataField="DepoID" HeaderText="Depo" ReadOnly="True" >
                        </asp:BoundField>
                        <asp:BoundField DataField="HRWDivID" HeaderText="DivID" ReadOnly="True" >
                        </asp:BoundField>
