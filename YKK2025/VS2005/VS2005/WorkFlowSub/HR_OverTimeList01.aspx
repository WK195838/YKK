<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HR_OverTimeList01.aspx.vb" Inherits="HR_OverTimeList01" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#CC9966"
            ...
            <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" /><Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="OverTimeURL" DataNavigateUrlFormatString="{0}"
                    DataTextField="OverTimeDateDesc" HeaderText="加班日" Target="_blank">
                    <FooterStyle HorizontalAlign="Center" />
                    <HeaderStyle Width="60px" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:HyperLinkField>
                
                <asp:BoundField DataField="No" HeaderText="加班單No." ReadOnly="True">
                    <FooterStyle HorizontalAlign="Center" />
        ...
        <asp:Button ID="BOK" runat="server" Height="20px" Style="z-index: 103; left: 156px;
            position: absolute; top: 6px" Text="選取完成" Width="80px" />
    </div>
    </form>
</body>
</html>
