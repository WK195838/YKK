...
<body>
    ...
    <div>
        FormNo:<asp:DropDownList ID="DropDownList1" runat="server">
            <asp:ListItem  Value="000017">Item登錄單</asp:ListItem>
        ...
        <br />
        <asp:Button ID="ItemRegister1" runat="server" Text="SPD姐妹社" />
        <asp:Button ID="ItemRegister2" runat="server" Text="SPD姐妹社02" />
        ...
        <br />
        <asp:Button ID="Button18" runat="server" Style="position: relative" Text="單價計算01" />
        <asp:Button ID="Button19" runat="server" Style="position: relative" Text="單價計算02" /><br />
        <asp:Button ID="Inq_Commission" runat="server" Text="調閱資料" />
        <br />
        <asp:Button ID="CaseReviewSheet_01" runat="server" Text="案件委託_01" /><asp:Button ID="CaseReviewSheet_02"
