...
Partial Class _Default
    ...
    '  Item Register
    '--------------------------------------------------------------------------------------------------
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ItemRegister1.Click
        Response.Cookies("UserID").Value = TextBox6.Text
        Response.Redirect("SPD_YKKGroupCopySheet_01.aspx?pFormNo=007001" & "&pFormSno=" & TextBox2.Text.Trim & "&pStep=" & TextBox3.Text.Trim & "&pSeqNo=" & TextBox4.Text.Trim & "&pApplyID=" & TextBox5.Text.Trim & "&pUserID=" & TextBox5.Text.Trim)
    End Sub

    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ItemRegister2.Click
        Response.Cookies("UserID").Value = TextBox6.Text
        Response.Redirect("SPD_YKKGroupCopySheet_02.aspx?pFormNo=007001" & "&pFormSno=" & TextBox2.Text.Trim)
    End Sub
