<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CopyQA.aspx.vb" Inherits="CopyQA" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Label ID="Label1" runat="server" style="z-index: 100; left: 12px; position: absolute; top: 13px" Height="10px" Width="95px" Text="NO/型別組"></asp:Label>
        <asp:TextBox ID="DData" runat="server" style="z-index: 101; left: 100px; position: absolute; top: 13px" Height="17px" Width="244px"></asp:TextBox><asp:Button ID="Button1" runat="server" Text="查詢" style="z-index: 101; left: 360px; position: absolute; top: 15px" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DData"
            ErrorMessage="請輸入No/型別組" Style="left: 400px; position: relative; top: 3px; z-index: 102;" Width="293px"></asp:RequiredFieldValidator>&nbsp;<br />
        <br />
...
<asp:BoundField DataField="NO" HeaderText="No"></asp:BoundField>
    ...
    <asp:BoundField DataField="Type" HeaderText="型別組" />
</Columns>
