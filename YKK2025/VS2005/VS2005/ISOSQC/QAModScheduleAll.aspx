<%@ Page Language="vb" AutoEventWireup="false" Inherits="QAModScheduleAll" aspCompat="True" EnableEventValidation = "false"  CodeFile="QAModScheduleAll.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 16px; POSITION: absolute; TOP: 16px" runat="server"
           ...
           <asp:Panel ID="Panel1" runat="server" Height="832px" ScrollBars="Vertical" Style="z-index: 105;
               left: -6px; position: absolute; top: 48px" Width="1320px">
