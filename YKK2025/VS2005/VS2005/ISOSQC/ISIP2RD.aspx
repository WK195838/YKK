<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ISIP2RD.aspx.vb" Inherits="ISIP2RD" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Magement-ISIP-RD</title>
</head>
<body>
    ...
    <div>
        ...
        <!-- ++  底圖                                                                                ++ -->
        <!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <img src="iMages/ISIP2RD.png" style="z-index: 1; left: 16px; position: absolute;top: 8px; width: 135px; height: 45px;" />
		<!-- ****************************************************************************************** -->
		<!-- **                                                                             -->
		<!-- ****************************************************************************************** -->
        <asp:CheckBox ID="AtALL" runat="server" AutoPostBack="True" Font-Bold="true" Font-Size="9pt"
            Style="z-index: 174; left: 736px; position: absolute; top: 8px" Text="ALL"
            Width="56px" Checked="True" />
        <asp:CheckBox ID="AtISOS" runat="server" AutoPostBack="True" Font-Bold="true" Font-Size="9pt"
            Style="z-index: 174; left: 736px; position: absolute; top: 32px" Text="ISOS"
            Width="56px" />
        <asp:CheckBox ID="AtISIP" runat="server" AutoPostBack="True" Font-Bold="true" Font-Size="9pt"
            Style="z-index: 174; left: 736px; position: absolute; top: 56px" Text="ISIP"
            Width="56px" />
        <asp:CheckBox ID="AtGroup" runat="server" Font-Bold="true" Font-Size="9pt"
            Style="z-index: 174; left: 800px; position: absolute; top: 56px" Text="Puller Group"
            Width="96px" Checked="True" Height="24px" />
		...
		<!-- **                                                                             -->
		<!-- ****************************************************************************************** -->
        <asp:Button ID="BFind" runat="server" Height="25px" Style="z-index: 104; left: 904px;
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Style="z-index: 103; left: 48px; position: absolute; top: 88px" CellPadding="3" Font-Size="10pt" GridLines="Vertical"  ForeColor="Black" BackColor="White" >
            <Columns>
                ...
                <asp:BoundField DataField="RD_NO"  />            
		...
		<!-- **                                                                             -->
		<!-- ****************************************************************************************** -->
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Style="z-index: 103; left: 48px; position: absolute; top: 88px" CellPadding="3" Font-Size="10pt" GridLines="Vertical"  ForeColor="Black" BackColor="White" >
            <Columns>
                <asp:BoundField DataField="RD_NO"  />            
