...
Partial Class ManySupplier
    ...
    Sub ShowData()
        ...
        '
        SQL = SQL & "where (RD_YOBI1 > '1' OR EDX_YOBI1 > '1') "
        ' Puller
        ...
        If AtRD.Checked = True Then
            SQL = SQL & "and RD_YOBI1 > '1' "
        End If
        ' AtEDX
        If AtEDX.Checked = True Then
            SQL = SQL & "and EDX_YOBI1 > '1' "
        End If
        '
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        ...
        If (e.Row.RowType = DataControlRowType.Header) Then
            ...
            tcl.Add(New TableHeaderCell())
            tcl(7).Text = "R&D" & "<BR>" & "Supplier"
            tcl(7).BackColor = Color.Blue
            tcl.Add(New TableHeaderCell())
            tcl(8).Text = "EDX" & "<BR>" & "Supplier"
