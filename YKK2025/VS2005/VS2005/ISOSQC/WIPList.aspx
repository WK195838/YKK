<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WIPList.aspx.vb" Inherits="WIPList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Magement-WIP Information</title>
</head>
<body>
    ...
    <div>
        ...
        <!-- ++  底圖                                                                                ++ -->
        <!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <img src="iMages/WIPlIST.png" style="z-index: 1; left: 16px; position: absolute;top: 8px; width: 135px; height: 45px;" />
        ...
        <asp:CheckBox ID="AtRD" runat="server" AutoPostBack="false" Font-Bold="true" Font-Size="9pt"
            ...
            Width="56px" />
        <asp:CheckBox ID="AtDTM" runat="server" AutoPostBack="false" Font-Bold="true" Font-Size="9pt"
            Style="z-index: 174; left: 736px; position: absolute; top: 56px" Text="DTM"
            Width="56px" />
        <asp:CheckBox ID="AtEDX" runat="server" AutoPostBack="false" Font-Bold="true" Font-Size="9pt"
            Style="z-index: 174; left: 800px; position: absolute; top: 32px" Text="EDX"
            Width="56px" />
        <asp:CheckBox ID="AtIRW" runat="server" AutoPostBack="false" Font-Bold="true" Font-Size="9pt"
            Style="z-index: 174; left: 800px; position: absolute; top: 56px" Text="IRW"
            Width="56px" />
		<!-- ****************************************************************************************** -->
		<!-- **                                                                             -->
		<!-- ****************************************************************************************** -->
		...
		<!-- **                                                                             -->
		<!-- ****************************************************************************************** -->
        <asp:Button ID="BFind" runat="server" Height="25px" Style="z-index: 104; left: 864px;
