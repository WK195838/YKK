...
Partial Class _Default
    ...
    Protected Sub Button7_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button7.Click
        ...
        Response.Redirect("QASheet_02.aspx?pFormNo=008002" & "&pFormSno=" & TextBox2.Text.Trim & "&pStep=" & TextBox3.Text.Trim & "&pSeqNo=" & TextBox4.Text.Trim & "&pApplyID=" & TextBox5.Text.Trim & "&pUserID=" & TextBox6.Text.Trim)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Response.Cookies("UserID").Value = TextBox6.Text
        Response.Redirect("QASheet_01.aspx?pFormNo=008002" & "&pFormSno=" & TextBox2.Text.Trim & "&pStep=" & TextBox3.Text.Trim & "&pSeqNo=" & TextBox4.Text.Trim & "&pApplyID=" & TextBox5.Text.Trim & "&pUserID=" & TextBox6.Text.Trim)
        'Response.Redirect("BusinessTripSheet_01.aspx?pFormNo=003114&pFormSno=0&pStep=1&pSeqNo=1&pApplyID=sl014&pUserID=sl014")
    ...
    Protected Sub Button2_Click1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        Response.Cookies("UserID").Value = TextBox6.Text
        Response.Redirect("QASchedule.aspx?pUserID=" & TextBox6.Text.Trim)
        'Response.Redirect("BusinessTripSheet_01.aspx?pFormNo=003114&pFormSno=0&pStep=1&pSeqNo=1&pApplyID=sl014&pUserID=sl014")
