<%@ Page Language="vb" AutoEventWireup="false" Inherits="QAModSheet_01" aspCompat="True" EnableEventValidation = "false"  CodeFile="QAModSheet_01.aspx.vb" %>
...
function CopyQA(No)
{
    ...
    window.open('CopyQA.aspx?formno=008002','','status=0,toolbar=0,width=700,height=650,top=10,resizable=yes');
  	 ...
  	 <div>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
            <img src="images/ModQAHead_01.jpg" style="z-index: 2; left: 16px; position: absolute;
               ...
               <asp:TextBox ID="IContent" runat="server" BackColor="#C0FFFF" BorderStyle="Groove"
                   ...
                   top: 410px; text-align: left" Width="540px" TextMode="MultiLine" Enabled="false"></asp:TextBox>
               <img src="images/QAHead_02.jpg" style="z-index: 1; left: 16px; position: absolute;
                   top: 530px" id="IMG1" />
               ...
               <asp:Button ID="DAttachFile2" runat="server" CausesValidation="False" Style="z-index: 274;
                   left: 160px; position: absolute; top: 1130px" Text="開啟附件" Width="72px" />
               &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
           ...
           <input id="BFinishDate" runat="server" style="z-index: 152; left: 664px; width: 24px; position: absolute;
               ...
               <input id="BBuyer" runat="server" style="z-index: 202; left: 664px; width: 24px;
                   position: absolute; top: 842px" type="button" value="..." />
               ...
               <input id="BCustomer" runat="server" style="z-index: 201; left: 664px; width: 24px;
                   position: absolute; top: 770px" type="button" value="..." />
               ...
               <asp:TextBox ID="DDepName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   top: 112px; text-align: left" Width="210px"></asp:TextBox>
               &nbsp;
               ...
               <asp:TextBox ID="DDate" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   ...
                   top: 78px; text-align: left" Width="210px"></asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
               ...
               <asp:TextBox ID="DName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   position: absolute; top: 111px; text-align: left" Width="180px"></asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
               ...
               <asp:DropDownList ID="DCheckUser" runat="server" BackColor="#C0FFFF"
                   ForeColor="Black" Height="20px" Style="z-index: 126; left: 140px; position: absolute;
               ...
               <img id="DDelay" runat="server" src="images/Sheet_Delay.jpg" style="z-index: 1; left: 12px;
                   position: absolute; top: 1564px" visible="false" />
               <asp:TextBox ID="DDecideDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
                   Height="56px" Style="z-index: 132; left: 59px; position: absolute; top: 1495px"
               ...
               <img id="DDescSheet" runat="server" src="images/Sheet_Remark.jpg" style="z-index: 1;
                   left: 13px; position: absolute; top: 1489px" />
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
               <!--************************************************************ 
            ** 防止重覆按 [BUTTON 2 次]                               **     
            ************************************************************ -->
           ...
           <asp:TextBox ID="DNO1" runat="server" BackColor="#C0FFFF" BorderStyle="None"
               ...
               top: 145px; text-align: left" Width="180px"></asp:TextBox>
           ...
           <input id="BCopySheet" runat="server" style="z-index: 131; left: 666px; width: 24px;
               position: absolute; top: 141px" type="button" value="..." visible="true" />
