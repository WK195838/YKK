...
Partial Class StatusRebuild
    ...
    Protected Sub GridView1_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridView1.RowCommand
        '
        If UCase(Trim(e.CommandName)) = "REBUILD" Then
            ...
            If xPuller <> "" Then
                Dim Conn As New SqlClient.SqlConnection("Data Source=" & "10.245.1.20" & ";" & _
                                                        "Initial Catalog=" & "WORKFLOW" & ";" & _
                                                        "User ID=" & "sa" & ";" & _
                                                        "Password=;")
                ...
                cmd.Parameters.Add(New SqlParameter("@Puller", xPuller))
                cmd.Parameters.Add(New SqlParameter("@Color", xColor))
                cmd.CommandText = "sp_ISOS2Puller_Manual"
                cmd.ExecuteNonQuery()
                Conn.Close()
                '
            Else
