...
Partial Class CombineList
    ...
    Sub SetParameter()
        ...
        pHSCode = Request.QueryString("pHSCode")
    ...
    Sub ShowData()
        ...
        SQL = SQL & "FROM L_PullerCombine "
        '
        SQL = SQL & "where HSCode <> '12345678901234' "
        SQL = SQL & "and HSCode = '" & pHSCode & "' "
        SQL = SQL & "and puller = '" & pPuller & "' "
