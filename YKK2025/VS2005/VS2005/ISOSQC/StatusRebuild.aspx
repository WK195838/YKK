<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StatusRebuild.aspx.vb" Inherits="StatusRebuild" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Magement-Rebuild Progress Status</title>
</head>
<body>
    ...
    <div>
        ...
        <!-- ++  底圖                                                                                ++ -->
        <!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <img src="iMages/StatusRebuild.png" style="z-index: 1; left: 16px; position: absolute;top: 8px; width: 135px; height: 45px;" />
		<!-- ****************************************************************************************** -->
		<!-- **                                                                             -->
		<!-- ****************************************************************************************** -->
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Style="z-index: 103; left: 48px; position: absolute; top: 88px" CellPadding="3" Font-Size="10pt" GridLines="Vertical"  ForeColor="Black" BackColor="White" >
            <Columns>
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        <asp:LinkButton ID="BRebuild" runat="server" CausesValidation="False" CommandName="Rebuild"
                            Text="Rebuild" onclientclick="javascript:return confirm('確定重建？');" CommandArgument='<%# Container.DataItemIndex%>' >                           
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:TextBox ID="DOther" runat="server" BackColor="white" BorderStyle="None" Height="18px"
            ...
            text-align: left" Width="312px">重整[Progress Status]需處理時間...</asp:TextBox>
    </div>
    </form>
</body>
</html>
