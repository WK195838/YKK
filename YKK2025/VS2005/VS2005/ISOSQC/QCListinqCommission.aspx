<%@ Page Language="vb" AutoEventWireup="false" Inherits="QCListinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="QCListinqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>品質分析依賴調閱資料</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 840px; POSITION: absolute; TOP: 104px" runat="server"
				ImageUrl="~/Images/msexcel.gif" Height="21px" Width="21px"></asp:imagebutton>
				<asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 16px; POSITION: absolute; TOP: 144px" runat="server"
				...
				<Columns>
                    ...
                    <asp:BoundColumn DataField="Field11"></asp:BoundColumn>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 792px; POSITION: absolute; TOP: 104px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/QAing_01.jpg" Style="z-index: 99;
               left: 0px; position: absolute; top: 16px" />
           <asp:TextBox ID="DSPEC" runat="server" BackColor="#FFFF80" BorderStyle="Groove"
               ForeColor="Black" Height="24px" Style="z-index: 110; left: 656px; position: absolute;
               top: 104px" Width="112px"></asp:TextBox>
           <asp:DropDownList ID="DSTS" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
               Style="z-index: 255; left: 656px; position: absolute; top: 72px" Width="120px">
           ...
           <asp:TextBox ID="DNo" runat="server" BackColor="#FFFF80" BorderStyle="None" ForeColor="Black"
               Height="20px" Style="z-index: 126; left: 656px; position: absolute; top: 40px;
               text-align: left" Width="112px"></asp:TextBox>
           <input id="BQCDate" runat="server" style="z-index: 152; left: 496px; width: 24px;
               position: absolute; top: 104px" type="button" value="..." />
           <asp:TextBox ID="DQCDate" runat="server" BackColor="#FFFF80" BorderStyle="None" ForeColor="Black"
               Height="20px" Style="z-index: 126; left: 408px; position: absolute; top: 104px;
               text-align: left" Width="80px"></asp:TextBox>
           <asp:TextBox ID="DQCNo" runat="server" BackColor="#FFFF80" BorderStyle="None" ForeColor="Black"
               Height="20px" Style="z-index: 126; left: 152px; position: absolute; top: 104px;
               text-align: left" Width="112px"></asp:TextBox>
           <asp:TextBox ID="DBuyer" runat="server" BackColor="#FFFF80" BorderStyle="Groove"
               ForeColor="Black" Height="24px" Style="z-index: 110; left: 408px; position: absolute;
               top: 72px" Width="112px"></asp:TextBox>
           &nbsp;&nbsp;
           <asp:TextBox ID="DCustomer" runat="server" BackColor="#FFFF80" BorderStyle="Groove"
               ForeColor="Black" Height="24px" Style="z-index: 112; left: 152px; position: absolute;
               top: 72px" Width="112px"></asp:TextBox>
           <asp:TextBox ID="DName" runat="server" BackColor="#FFFF80" BorderStyle="None" ForeColor="Black"
               Height="20px" Style="z-index: 126; left: 408px; position: absolute; top: 40px;
               text-align: left" Width="112px"></asp:TextBox>
           <input id="BADate" runat="server" style="z-index: 152; left: 248px; width: 24px;
               position: absolute; top: 40px" type="button" value="..." />
           <asp:TextBox ID="DADate" runat="server" BackColor="#FFFF80" BorderStyle="None" ForeColor="Black"
               Height="20px" Style="z-index: 126; left: 152px; position: absolute; top: 40px;
