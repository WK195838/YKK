...
Partial Class DeplicatPuller
    ...
    Sub ShowData()
        ...
        '
        SQL = SQL & "'http://10.245.1.6/ISOSQC/PC_ReleaseNewcolor.aspx?pUserID='+'" & UserID & "'+'&pBuyer='+'&pSlider='+Puller+Color+'&pSource=ISIP' as PullerURL, "
        '
        ...
        '
        SQL = SQL & "where CREATEUSEr not in ('SP_DRR','SP_Combine') "
        ...
        '
        SQL = SQL & "and ( "
        SQL = SQL & "  puller+color in ( Select PULLER + Color FROM M_PullerColor GROUP BY PULLER+COLOR HAVING count(*) > 1 ) "
        SQL = SQL & ") "
        '
