...
Partial Class BodyList
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "BodyList.aspx"   '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        SQL = SQL & "[Body], [YOBI1], convert(varchar, CreateTime, 111) as CreateTime "
        SQL = SQL & "FROM M_EDXBodyList "
        '
        SQL = SQL & "where active <> 9 "
        ' BODY
        If DKBody.Text <> "" Then
            SQL = SQL & "and body = '" & DKBody.Text & "' "
        End If
        ' Other
        If DKOther.Text <> "" Then
            SQL = SQL & "and [Body]+[YOBI1] like '%" & DKOther.Text & "%' "
        End If
        ' AtOPEN
    ...
    Protected Sub GridView1_RowCreated(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        ...
        If (e.Row.RowType = DataControlRowType.Header) Then
            ...
            tcl.Add(New TableHeaderCell())
            tcl(3).Text = "Body" & "<BR>" & "Group"
            tcl(3).BackColor = Color.Blue
            tcl.Add(New TableHeaderCell())
            tcl(4).Text = "Create" & "<BR>" & "Time"
