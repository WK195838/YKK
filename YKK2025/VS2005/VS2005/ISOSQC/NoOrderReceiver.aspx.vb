...
Partial Class NoOrderReceiver
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "NoOrderReceiver.aspx"   '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        SQL = SQL & "[RD],[DTM],[EDX],[IRW],[ORDERS], OR_NO, "
        ...
        '
        SQL = SQL & "where (ORDERS NOT IN ('OK','WIP') OR OR_NO='') "
