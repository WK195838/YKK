<%@ Page Language="VB" AutoEventWireup="false" CodeFile="NewAdvencedImages.aspx.vb" Inherits="NewAdvencedImages" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>New Advenced Images</title>
</head>
<body>
    ...
    <div>
       ...
       <!-- Vendor Find -->
      <asp:Button ID="BFindSupplier" runat="server" Height="64px" Style="z-index: 104; left: 424px;
                    position: absolute; top: 16px" Text="Supplier" Width="96px" Font-Bold="True" Font-Size="Larger" />
        <!-- Wings Find -->
                <asp:Button ID="BFindWings" runat="server" Height="64px" Style="z-index: 104; left: 544px;
						...
						<asp:Table Width="100%" GridLines="Both" Font-Size="8pt" Runat="server" ID="Table2">
							...
							<asp:TableRow>
								<asp:TableCell HorizontalAlign="Left" BorderWidth="1" BorderStyle="Solid" BorderColor="Black"
                                    ...
                                    <asp:HyperLink ID="HyperLink1" Text='<%# Container.DataItem("No")%>' NavigateUrl='<%# Container.DataItem("NoURL")%>'  runat="server" Target="_blank" ForeColor="red"></asp:HyperLink>
		...
		<!-- ** DataList                                                                          -->
		<!-- ****************************************************************************************** -->
			<asp:datalist id="DataList2" style="Z-INDEX: 105; POSITION: absolute; TOP: 88px; LEFT: 8px" runat="server"
					Width="10px" Height="93px" CellSpacing="2" RepeatColumns="10" RepeatDirection="Horizontal" BorderColor="Black" BorderStyle="Groove" BorderWidth="3">
					<ItemTemplate>
						<asp:Table Width="100%" GridLines="Both" Font-Size="8pt" Runat="server" ID="Table2">
							<asp:TableRow>
							...
							<asp:TableRow>
								<asp:TableCell HorizontalAlign="right" BorderWidth="1" BorderStyle="Solid" BorderColor="Black"
									Font-Size="10" BackColor="White">
                                    <asp:HyperLink ID="HyperLink2" Text='<%# Container.DataItem("IMGResize")%>' NavigateUrl='<%# Container.DataItem("IMGResizeURL")%>'  runat="server" Target="_blank" ForeColor="Blue">></asp:HyperLink>
