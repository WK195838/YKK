...
Partial Class ISIP2IRW
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "ISIP2EDX.aspx"   '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        SQL = SQL & "[RD],[DTM],[EDX],[IRW],[ORDERS], IRW_NO, "
        ...
        '
        SQL = SQL & "where (IRW NOT IN ('OK','WIP') OR IRW_NO='') "
