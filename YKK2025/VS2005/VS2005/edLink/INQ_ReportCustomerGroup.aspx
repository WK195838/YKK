<%@ Page Language="VB" AutoEventWireup="false" CodeFile="INQ_ReportCustomerGroup.aspx.vb" Inherits="INQ_ReportCustomerGroup" %>
...
<!-- ++  顧客資料                                                                                ++ -->
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <asp:GridView ID="DGridView1" runat="server" AutoGenerateColumns="False" Style="z-index: 103; left: 15px; position: absolute; top: 100px" CellPadding="3" Font-Size="9pt" GridLines="Vertical" PageSize="20" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" Width="2200px" >
            <Columns>
                ...
                <asp:BoundField DataField="DIPActive" HeaderText="DIP.啟用" />
                <asp:BoundField DataField="DIPSendActive" HeaderText="DIP.郵件" />
                <asp:BoundField DataField="DIPRptType" HeaderText="DIP.報表" />
