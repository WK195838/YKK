<%@ Page Language="vb" AutoEventWireup="false" Inherits="EApprovalRDinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="EApprovalRDinqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>製造仕樣申請表調閱資料</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 648px; POSITION: absolute; TOP: 155px" runat="server"
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 599px; POSITION: absolute; TOP: 154px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/EApprovalinq.jpg" Style="z-index: 99;
               left: 5px; position: absolute; top: 16px" />
           <asp:DropDownList ID="DDepName" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 257; left: 123px; position: absolute; top: 54px"
               Width="200px">
           </asp:DropDownList>        
           &nbsp;
           <asp:TextBox ID="DASDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 123px; position: absolute;
               top: 80px" Width="75px"></asp:TextBox>
           &nbsp; &nbsp; &nbsp;
           <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 228px; position: absolute; top: 82px; text-align: center" Text="~" Width="6px"></asp:Label>
           <asp:DropDownList ID="DProcess" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 256; left: 123px; position: absolute; top: 28px"
               Width="216px">
               </asp:DropDownList>
           ...
           <asp:Button ID="BASDate" runat="server" Height="26px" Style="z-index: 111; left: 200px;
               position: absolute; top: 77px" Text="..." Width="25px" />
           &nbsp;&nbsp;
           <asp:Button ID="BAEDate" runat="server" Height="26px" Style="z-index: 112; left: 317px;
               position: absolute; top: 77px" Text="..." Width="25px" />
           &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp;
           &nbsp; &nbsp;&nbsp;&nbsp;
           <asp:DropDownList ID="DSTS" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 458px; position: absolute; top: 27px"
               Width="200px">
           ...
           <asp:TextBox ID="DAppName" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 458px; position: absolute;
               top: 53px" Width="200px"></asp:TextBox>
           <asp:TextBox ID="DFormNo" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 458px; position: absolute;
               top: 79px" Width="200px"></asp:TextBox>
           <asp:Label ID="DCount" runat="server" Height="20px" Style="z-index: 114; left: 600px; position: absolute;
               top: 117px" Width="200px" ForeColor="Red"></asp:Label></div>
    </form>
</body>
</html>
