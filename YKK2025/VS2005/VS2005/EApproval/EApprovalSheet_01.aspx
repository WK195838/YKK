<%@ Page Language="vb" AutoEventWireup="false" Inherits="EApprovalSheet_01" aspCompat="True" EnableEventValidation = "false"  CodeFile="EApprovalSheet_01.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               <img src="images/EApprovalSheet_01.jpg" style="z-index: 99; left: 8px; position: absolute;
                   top: 16px" />
               &nbsp;
                <asp:TextBox ID="DDate" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   Height="20px" MaxLength="7" Style="z-index: 118; left: 129px; position: absolute;
                   top: 92px; text-align: left" Width="220px"></asp:TextBox>&nbsp; &nbsp;&nbsp;
               <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 462px; position: absolute; top: 93px"></asp:TextBox>
               <asp:TextBox ID="DDepID" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="24px" MaxLength="7" Style="z-index: 126; left: 129px;
                   position: absolute; top: 125px; text-align: left" Width="80px"></asp:TextBox>
               &nbsp;               
               <asp:TextBox ID="DDepName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="24px" MaxLength="7" Style="z-index: 126; left: 248px;
                   position: absolute; top: 124px; text-align: left" Width="72px"></asp:TextBox>
               &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp;
               &nbsp;
               <asp:TextBox ID="DAppName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" MaxLength="7" Style="z-index: 121; left: 463px;
                   position: absolute; top: 126px; text-align: left" Width="108px"></asp:TextBox>
               &nbsp;
               &nbsp;
               &nbsp;
               &nbsp;    
               ...
               <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="50px" MaxLength="255" Style="z-index: 101; left: 129px;
                   position: absolute; top: 195px; text-align: left" TextMode="MultiLine" Width="550px"></asp:TextBox>
               &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
               <asp:FileUpload ID="DAttachfile" runat="server" Height="24px" Style="z-index: 100;
                   left: 130px; position: absolute; top: 158px;" Width="512px" />
               &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           <asp:HyperLink ID="LAttachfile" runat="server" Style="z-index: 138; left: 138px;
               position: absolute; top: 161px">附檔</asp:HyperLink>
