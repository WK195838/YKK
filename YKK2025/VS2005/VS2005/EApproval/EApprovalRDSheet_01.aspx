<%@ Page Language="vb" AutoEventWireup="false" Inherits="EApprovalRDSheet_01" aspCompat="True" EnableEventValidation = "false"  CodeFile="EApprovalRDSheet_01.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>&nbsp;<asp:Image ID="Image1" runat="server" ImageUrl="~/images/EApprovalSheetRD_01.jpg" />
           <asp:DropDownList ID="DWF4" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 776px; position: absolute; top: 160px"
               Width="96px">
           </asp:DropDownList>
           <asp:DropDownList ID="DSTS" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
               Style="z-index: 255; left: 360px; position: absolute; top: 160px" Width="88px">
               <asp:ListItem></asp:ListItem>
               <asp:ListItem Value="0">核定中</asp:ListItem>
               <asp:ListItem Value="1">完成</asp:ListItem>
               <asp:ListItem Value="2">取消</asp:ListItem>
           </asp:DropDownList>
           <asp:DropDownList ID="DWF3" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 568px; position: absolute; top: 160px"
               Width="96px">
           </asp:DropDownList>
           <asp:DropDownList ID="DropDownList4" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 360px; position: absolute; top: 160px"
               Width="88px">
               <asp:ListItem></asp:ListItem>
               <asp:ListItem Value="0">核定中</asp:ListItem>
               <asp:ListItem Value="1">完成</asp:ListItem>
           ...
           <asp:DropDownList ID="DWF2" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 352px; position: absolute; top: 160px"
               Width="96px">
           </asp:DropDownList><asp:DropDownList ID="DWF1" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 144px; position: absolute; top: 160px"
               Width="96px">
           </asp:DropDownList>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               &nbsp;&nbsp;
                <asp:TextBox ID="DDate" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   Height="20px" MaxLength="7" Style="z-index: 118; left: 144px; position: absolute;
                   top: 96px; text-align: left" Width="304px"></asp:TextBox>&nbsp; &nbsp;&nbsp;
               <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 568px; position: absolute; top: 96px"></asp:TextBox>
               <asp:TextBox ID="DDepID" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" MaxLength="7" Style="z-index: 126; left: 144px;
                   position: absolute; top: 128px; text-align: left" Width="144px"></asp:TextBox>
               &nbsp;               
               <asp:TextBox ID="DDepName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" MaxLength="7" Style="z-index: 126; left: 296px;
                   position: absolute; top: 128px; text-align: left" Width="152px"></asp:TextBox>
               &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp;
               &nbsp;
               <asp:TextBox ID="DAppName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" MaxLength="7" Style="z-index: 121; left: 568px;
                   position: absolute; top: 128px; text-align: left" Width="304px"></asp:TextBox>
               &nbsp;
               &nbsp;
               &nbsp;
               &nbsp;    
               ...
               <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="50px" MaxLength="255" Style="z-index: 101; left: 144px;
                   position: absolute; top: 224px; text-align: left" TextMode="MultiLine" Width="720px"></asp:TextBox>
               &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
               <asp:FileUpload ID="DAttachfile" runat="server" Height="24px" Style="z-index: 100;
                   left: 144px; position: absolute; top: 192px;" Width="728px" />
               &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           <asp:HyperLink ID="LAttachfile" runat="server" Style="z-index: 138; left: 160px;
               position: absolute; top: 200px">附檔</asp:HyperLink>
