<%@ Page Language="vb" AutoEventWireup="false" Inherits="EApprovalSheet_02" aspCompat="True" EnableEventValidation = "false"  CodeFile="EApprovalSheet_02.aspx.vb" %>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               ...
               &nbsp;
                <asp:TextBox ID="DDate" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   ...
                   top: 92px; text-align: left" Width="201px"></asp:TextBox>&nbsp; &nbsp;&nbsp;
               <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 472px; position: absolute; top: 93px">DNo</asp:TextBox>
               <asp:TextBox ID="DDepID" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   position: absolute; top: 124px; text-align: left" Width="80px"></asp:TextBox>
               &nbsp;               
               <asp:TextBox ID="DDepName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   position: absolute; top: 125px; text-align: left" Width="72px"></asp:TextBox>
               &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp;
               &nbsp;
               <asp:TextBox ID="DAppName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   position: absolute; top: 127px; text-align: left" Width="108px"></asp:TextBox> 
               <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   position: absolute; top: 193px; text-align: left" TextMode="MultiLine" Width="530px"></asp:TextBox>
               &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
