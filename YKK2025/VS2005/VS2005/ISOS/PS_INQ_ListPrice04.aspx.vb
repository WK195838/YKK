...
Partial Class PS_INQ_ListPrice04
    ...
    Sub SetParameter()
        ...
        LZLength.ReadOnly = True
        LZBase.ReadOnly = True
        LZInchBase.ReadOnly = True
        LPBase.ReadOnly = True
        LFBase.ReadOnly = True
        LFBase1.ReadOnly = True
        '
        HBuyerCode.Style("left") = -500 & "px"
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Dim xLength As String = Trim(GridView1.SelectedRow.Cells(4).Text.ToUpper)
        Dim xbase As String = Trim(GridView1.SelectedRow.Cells(5).Text.ToUpper)
        Dim xinchbase As String = Trim(GridView1.SelectedRow.Cells(6).Text.ToUpper)
        Dim RtnCode As String
        '
        RtnCode = GetItemKey(xCat, xItem, "")
        If RtnCode <> "1" Then
            DPKEY.Text = RtnCode
            DFKEY.Text = ""
            DKEY1.Text = ""
            DKEY2.Text = ""
            DZLength.Text = xLength
            DZBase.Text = xbase
            DZInchBase.Text = xinchbase
            '
            ShowData()
    ...
    Protected Sub GridView2_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView2.SelectedIndexChanged
        ...
        Dim xbase As String = Trim(GridView2.SelectedRow.Cells(4).Text.ToUpper)
        Dim RtnCode As String
        '
    ...
    Protected Sub GridView3_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView3.SelectedIndexChanged
        ...
        Dim xfinish As String = Trim(GridView3.SelectedRow.Cells(3).Text.ToUpper) & " / " & Trim(GridView3.SelectedRow.Cells(2).Text.ToUpper)
        Dim xbase As String = Trim(GridView3.SelectedRow.Cells(4).Text.ToUpper)
        Dim RtnCode As String
        '
        If pBuyer = "000151" Then
            RtnCode = GetItemKey(xCat, xItem, "")
            If RtnCode <> "1" Then
                LFBase1.Text = xfinish
                DFBase.Text = xbase
                ShowData()
                If DItemKey1.Text <> "" Or DItemKey2.Text <> "" Or DItemKey3.Text <> "" Then
                    BGetItem_Click(sender, e)
                End If
            End If
        End If
...
LBL_End:
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If pBuyer = "000151" Then
            ...
            If (e.Row.RowType = DataControlRowType.Header) Then
                ...
                tcl.Add(New TableHeaderCell())
                tcl(1).Text = "E1" & "<BR>" & "Length"
                tcl.Add(New TableHeaderCell())
                tcl(2).Text = "F1" & "<BR>" & "Base"
            ...
            If (e.Row.RowType = DataControlRowType.DataRow) Then
                ...
                For i = 0 To 27
                    ...
                    e.Row.Cells(i).Text = Replace(e.Row.Cells(i).Text, "<br>", Chr(10))
                Next
                '
                For i = 0 To 2
    ...
    Protected Sub GridView3_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView3.RowDataBound
        ...
        If pBuyer = "000151" Then
            ...
            If (e.Row.RowType = DataControlRowType.Header) Then
                ...
                '添加新的表头第一行
                tcl.Add(New TableHeaderCell())
                tcl(0).Text = "C1" & "<BR>" & "Code"
                tcl(0).BackColor = Color.Blue
                tcl.Add(New TableHeaderCell())
                tcl(1).Text = "D1" & "<BR>" & "Size"
                tcl(1).BackColor = Color.Blue
                tcl.Add(New TableHeaderCell())
                tcl(2).Text = "E1" & "<BR>" & "Base"
                tcl(2).BackColor = Color.Green
    ...
    Sub ShowData()
        ...
        If pBuyer = "000151" Then
            ...
            sql &= "'Ｓ' as Mark, "
            sql &= "'' as URL, "
            sql &= "A1, B1, C1, M1 + ' !' + D1 AS D1, F1 AS E1, "
            sql &= "F1, G1, H1, I1, J1, "
            sql &= "K1, L1, M1, N1, O1, P1, Q1, R1, S1, T1, "
            sql &= "U1, V1, W1, X1, Y1, Z1, "
            '
            ...
            If DFKEY.Text <> "" Then
                ...
                sql &= "And (" & GetSearchField(DFKEY.Text, _
                                               "A1/B1/C1/D1/E1/F1/G1/H1/I1/J1/K1/L1/M1/N1/O1/P1/Q1/R1/S1/T1/U1/V1/W1/X1/Y1/Z1", _
                                               "A1/B1/C1/D1/E1/E1/G1/H1/I1/J1/K1/L1/M1/N1/O1/P1/Q1/R1/S1/T1/U1/V1/W1/X1/Y1/Z1") & ") "
            End If
            If DKEY1.Text <> "" Then sql &= " And A1+B1+C1+D1+E1+F1+G1+H1+I1+J1+K1+L1+M1+N1+O1+P1+Q1+R1+S1+T1+U1+V1+W1+X1+Y1+Z1 Like '%" & DKEY1.Text & "%' "
            If DKEY2.Text <> "" Then sql &= " And A1+B1+C1+D1+E1+F1+G1+H1+I1+J1+K1+L1+M1+N1+O1+P1+Q1+R1+S1+T1+U1+V1+W1+X1+Y1+Z1 Like '%" & DKEY2.Text & "%' "
            '
            ...
            If DFKEY.Text <> "" Then
                ...
                sql &= "And (" & GetSearchField(DFKEY.Text, _
                                               "A1/B1/C1/D1/E1/F1/G1/H1/I1/J1/K1/L1/M1/N1/O1/P1/Q1/R1/S1/T1/U1/V1/W1/X1/Y1/Z1", _
                                               "A1/B1/C1/D1/F1/F1/G1/H1/I1/J1/K1/L1/M1/N1/O1/P1/Q1/R1/S1/T1/U1/V1/W1/X1/Y1/Z1") & ") "
            End If
            If DKEY1.Text <> "" Then sql &= " And A1+B1+C1+D1+E1+F1+G1+H1+I1+J1+K1+L1+M1+N1+O1+P1+Q1+R1+S1+T1+U1+V1+W1+X1+Y1+Z1 Like '%" & DKEY1.Text & "%' "
            If DKEY2.Text <> "" Then sql &= " And A1+B1+C1+D1+E1+F1+G1+H1+I1+J1+K1+L1+M1+N1+O1+P1+Q1+R1+S1+T1+U1+V1+W1+X1+Y1+Z1 Like '%" & DKEY2.Text & "%' "
            '
