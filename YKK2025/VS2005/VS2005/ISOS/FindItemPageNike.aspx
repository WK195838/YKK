<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FindItemPageNike.aspx.vb" Inherits="FindItemPageNike" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="BCURL" DataNavigateUrlFormatString="{0}" 
                DataTextField="BC" HeaderText="" Target="_blank">
                </asp:HyperLinkField>
