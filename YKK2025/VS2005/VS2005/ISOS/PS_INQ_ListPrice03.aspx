<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PS_INQ_ListPrice03.aspx.vb" Inherits="PS_INQ_ListPrice03" %>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
		...
		<asp:hyperlink id="Hyperlink1" style="Z-INDEX: 102; LEFT: 560px; POSITION: absolute; TOP: 16px" runat="server"
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        ...
        <asp:Label ID="Label5" runat="server" Style="z-index: 103; left: 32px; position: absolute; top: 152px"  Font-Size="10pt" Width="848px" >-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</asp:Label>

        <asp:Label ID="Label6" runat="server" Style="z-index: 103; left: 788px; position: absolute; top: 184px"  Font-Size="10pt" >L888(USD)(Exchange Rate=31.5)</asp:Label>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    	...
    	<asp:button id="BSPInq" runat="server" Height="56px" Width="96px" Style="z-index: 103; left: 656px; position: absolute; top: 8px" ForeColor="Black" BackColor="Silver" Text="特別篩選(B)" ></asp:button>

    	<asp:button id="BGetItem" runat="server" Height="40px" Width="750px" Style="z-index: 103; left: 24px; position: absolute; top: 112px" ForeColor="Black" BackColor="Silver" Text="搜尋ITEM" ></asp:button>
    	<asp:button id="BReset" runat="server" Height="40px" Width="104px" Style="z-index: 103; left: 776px; position: absolute; top: 112px" ForeColor="Black" BackColor="Silver" Text="RESET" ></asp:button>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        ...
        <asp:TextBox ID="LItemKey3" runat="server" BackColor="Black" BorderStyle="Groove"
                ForeColor="White" Height="14px"  Width="100px" Style="z-index: 103; left: 448px; position: absolute; top: 72px" Font-Size="10pt">F#</asp:TextBox>
        ...
        <asp:TextBox ID="LItemKey4" runat="server" BackColor="Black" BorderStyle="Groove"
                ForeColor="White" Height="14px"  Width="100px" Style="z-index: 103; left: 560px; position: absolute; top: 72px" Font-Size="10pt">T#</asp:TextBox>
        <asp:TextBox ID="DItemKey4" runat="server" BackColor="#80FFFF" BorderStyle="Groove"
                ForeColor="red" Height="14px"  Width="100px" Style="z-index: 103; left: 560px; position: absolute; top: 88px" Font-Size="10pt"></asp:TextBox>

        <asp:TextBox ID="LItemKey5" runat="server" BackColor="Black" BorderStyle="Groove"
                ForeColor="White" Height="14px"  Width="100px" Style="z-index: 103; left: 664px; position: absolute; top: 72px" Font-Size="10pt">OTHER</asp:TextBox>
        <asp:TextBox ID="DItemKey5" runat="server" BackColor="#80FFFF" BorderStyle="Groove"
                ForeColor="red" Height="14px"  Width="100px" Style="z-index: 103; left: 664px; position: absolute; top: 88px" Font-Size="10pt"></asp:TextBox>

        <asp:TextBox ID="LLeadTime" runat="server" BackColor="Black" BorderStyle="Groove"
                ForeColor="White" Height="14px"  Width="100px" Style="z-index: 103; left: 776px; position: absolute; top: 72px" Font-Size="10pt">L/T[Z#]</asp:TextBox>
        <asp:TextBox ID="DLeadTime" runat="server" BackColor="#80FFFF" BorderStyle="Groove"
                ForeColor="red" Height="14px"  Width="100px" Style="z-index: 103; left: 776px; position: absolute; top: 88px" Font-Size="10pt">0</asp:TextBox>
...
<!--            <SelectedRowStyle BackColor="#000099" Font-Bold="True" ForeColor="White" />  -->
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Width="300px" Style="z-index: 103; left: 334px; position: absolute; top: 200px" CellPadding="3" Font-Size="9pt" GridLines="Vertical" PageSize="20" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" >
            <Columns>
                <asp:BoundField DataField="A1" HeaderText=""  />
                <asp:BoundField DataField="B1" HeaderText=""  />
                <asp:BoundField DataField="C1" HeaderText=""  />
...
<!--            <SelectedRowStyle BackColor="#000099" Font-Bold="True" ForeColor="White" />  -->
        ...
        <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" Width="50px" Style="z-index: 103; left: 644px; position: absolute; top: 200px" CellPadding="3" Font-Size="9pt" GridLines="Vertical" PageSize="20" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" >
            <Columns>
                <asp:BoundField DataField="C1" HeaderText=""  />
                <asp:CommandField ShowSelectButton="True" SelectText="Ｓ" />
            </Columns>
...
<!--            <SelectedRowStyle BackColor="#000099" Font-Bold="True" ForeColor="White" />  -->
        ...
        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" Width="50px" Style="z-index: 103; left: 704px; position: absolute; top: 200px" CellPadding="3" Font-Size="9pt" GridLines="Vertical" PageSize="20" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" >
            <Columns>
                <asp:BoundField DataField="C1" HeaderText=""  />
                <asp:CommandField ShowSelectButton="True" SelectText="Ｓ" />
            </Columns>
...
<!--            <SelectedRowStyle BackColor="#000099" Font-Bold="True" ForeColor="White" />  -->
        ...
        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" Width="700px" Style="z-index: 103; left: 784px; position: absolute; top: 200px" CellPadding="3" Font-Size="9pt" GridLines="Vertical" PageSize="20" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" >
            <Columns>
