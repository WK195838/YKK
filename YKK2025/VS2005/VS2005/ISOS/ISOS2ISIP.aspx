<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ISOS2ISIP.aspx.vb" Inherits="ISOS2ISIP" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>ISOS Puller Information</title>
</head>
<body>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        ...
        <img src="iMages/ISOS2ISIP.png" style="z-index: 1; left: 800px; position: absolute;top: 8px; width: 135px; height: 45px;" />
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        ...
        <asp:TextBox ID="DBUYER" runat="server" BackColor="#80FF80" BorderStyle="Groove" 
                ForeColor="Blue" Height="20px"  Width="120px" Style="z-index: 103; left: 360px; position: absolute; top: 8px"></asp:TextBox>
        ...
        <asp:DropDownList ID="DColorType" runat="server" BackColor="Yellow" ForeColor="Blue"
            ...
            <asp:ListItem Value="PULLER" Selected="True">PULLER</asp:ListItem>
        </asp:DropDownList>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        ...
        <asp:Label ID="Label5" runat="server" Font-Size="10pt" Style="z-index: 103; left: 296px;
            position: absolute; top: 8px">BUYER</asp:Label>
        <asp:TextBox ID="DOther" runat="server" BackColor="white" BorderStyle="None" Height="18px"
            MaxLength="7" Style="z-index: 126; left: 776px; position: absolute; top: 80px;
            text-align: left" Width="312px">顯示300件(件數過多)，請使用篩選</asp:TextBox>
