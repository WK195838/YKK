...
Public Class ForProject
    ...
    '---------------------------------------------------------------------------------------------------
    '***********************************************************************************************
    '**([630]-GetBYFCTDataCheckFun)
    '**     取得BY FCT DataCheck Function Code
    '***********************************************************************************************
    'GetBYFCTDataCheckFun-Start
    Public Function GetBYFCTDataCheckFun(ByVal pBuyer As String, ByVal pFun As Integer) As String
        ...
        Try
            ...
            If dt_Referp.Rows.Count > 0 Then
                RtnString = Mid(dt_Referp.Rows(0).Item("Data").ToString, pFun, 1)
            End If
            '
        Catch ex As Exception
        End Try
