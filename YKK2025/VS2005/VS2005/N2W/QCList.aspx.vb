...
Partial Class QCList
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        js &= "window.opener.document.all.DQCNO.value = '" & GridView1.SelectedRow.Cells(3).Text.Replace("&amp;", "&") & "';"
        js &= "window.opener.document.all.DQCNO1.value = '" & GridView1.SelectedRow.Cells(1).Text.Replace("&amp;", "&") & "';"
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) <> (e.Row.RowType = DataControlRowType.Footer) Then
            ...
            ' 連結到客訴表單   
            h1.NavigateUrl = "ComplaintOutSheet_02.aspx?pFormNo=" + formno + "&pFormSno=" + formsno
            ' e.Row.Cells(3).Text = ""
