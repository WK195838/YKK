...
Partial Class NOList
    ...
    Sub GetData()
        ...
        SQL = "select  no,appname, FORMSNO, "
        SQL = SQL + " 'http://10.245.1.10/N2W/ComplaintOutSheet_03.aspx?pFormNo='+formno+'&pFormSno='+rtrim(convert(char,formsno))+'&pStep=600&pSeqNo=1&pApplyID='+createuser+'&pUserID='+createuser "

        'SQL = SQL + " 'http://localhost:57515/N2W/ComplaintOutSheet_03.aspx?pFormNo='+formno+'&pFormSno='+rtrim(convert(char,formsno))+'&pStep=600&pSeqNo=1&pApplyID='+createuser+'&pUserID='+createuser "

        SQL = SQL + "  as ViewURL,"
        SQL = SQL + " 'http://10.245.1.10/N2W/ComplaintOutSheet_02.aspx?pFormNo='+formno+'&pFormSno='+rtrim(convert(char,formsno))+'&pStep=600&pSeqNo=1&pApplyID='+createuser+'&pUserID='+createuser "
        'SQL = SQL + " 'http://localhost:57515/N2W/ComplaintOutSheet_02.aspx?pFormNo='+formno+'&pFormSno='+rtrim(convert(char,formsno))+'&pStep=600&pSeqNo=1&pApplyID='+createuser+'&pUserID='+createuser "
        SQL = SQL + "  as ViewURLNO "
        SQL = SQL + "   from F_ComplaintOutSheet  where no ='" + InputData + "'"
