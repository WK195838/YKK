...
Partial Class CustomerInfoCopy
    ...
    Sub GetData()
        ...
        SQL = SQL + " else '抽單' end as sts,no,appname as name,customercode,namech,FormNo,FormSno, "
        SQL = SQL + " 'http://10.245.1.10/N2W/CustomerInfoSheet_02.aspx?pFormNo='+formno+'&pFormSno='+convert(char,formsno) as ViewURL"
        SQL = SQL + " from F_CustomerInfoSheet where formno ='" + formno + "'"

        If InputData <> "" Then
            SQL = SQL + " and ( customercode like '%" + InputData + "%'"
            SQL = SQL + " or namech like '%" + InputData + "%'"
            SQL = SQL + " )"
