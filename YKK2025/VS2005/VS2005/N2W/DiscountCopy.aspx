<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DiscountCopy.aspx.vb" Inherits="DiscountCopy" %>
...
<body>
    <form id="form1" runat="server">
        <asp:TextBox ID="DData" runat="server" style="z-index: 100; left: 248px; position: absolute; top: 16px" Height="17px" Width="244px"></asp:TextBox><asp:Button ID="Button1" runat="server" Text="查詢" style="z-index: 101; left: 504px; position: absolute; top: 16px" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DData"
            ErrorMessage="請輸入NO/擔當者/ITEMCODE" Style="left: 568px; position: relative; top: 8px; z-index: 102;" Width="293px"></asp:RequiredFieldValidator>&nbsp;<br />
        <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="Blue" Style="z-index: 142;
            left: 16px; position: absolute; top: 16px" Text="請輸入NO/擔當者/ITEMCODE"></asp:Label>
        <br />
