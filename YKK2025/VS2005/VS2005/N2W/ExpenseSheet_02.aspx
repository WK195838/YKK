<%@ Page Language="vb" AutoEventWireup="false" Inherits="ExpenseSheet_02" aspCompat="True" EnableEventValidation = "false"  CodeFile="ExpenseSheet_02.aspx.vb" %>
  	 ...
  	 <div>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               ...
               <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 472px; position: absolute; top: 96px">DNo</asp:TextBox>
