...
Partial Class DivisionListCL
    ...
    Sub GetData()
        ...
        SQL = " Select  distinct CostID,CostName from  M_wfsempCL "
        SQL = SQL + "where 1 = 1 "
        If InputData <> "" Then
            SQL = SQL + " and ( DepName like '%" + InputData + "%' or DepID like '%" + InputData + "%')"
        End If

        SQL = SQL + " group by  CostID,CostName  "
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        js &= "window.opener.document.all.CDivision3.checked = false;"
