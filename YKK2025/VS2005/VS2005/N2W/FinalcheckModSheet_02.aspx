<%@ Page Language="vb" AutoEventWireup="false" Inherits="FinalcheckModSheet_02" aspCompat="True" EnableEventValidation = "false"  CodeFile="FinalcheckModSheet_02.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               <img src="images/FinalcheckModSheet_01.jpg" style="z-index: 1; left: 8px; position: absolute;
               ...
               <asp:HyperLink ID="LComplete" runat="server" Height="1px" NavigateUrl="BoardEdit.aspx"
                   ...
                   Visible="False" Width="112px">修改前表單</asp:HyperLink>
               <asp:TextBox ID="DNO" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 232px; position: absolute; top: 56px">DNo</asp:TextBox>
               ...
               &nbsp;
               <asp:TextBox ID="DONO" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" Style="z-index: 113; left: 152px; position: absolute;
                   top: 88px" Width="208px"></asp:TextBox>
