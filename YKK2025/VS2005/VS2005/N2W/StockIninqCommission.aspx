<%@ Page Language="vb" AutoEventWireup="false" Inherits="StockIninqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="StockIninqCommission.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/StockInInq.jpg" Style="z-index: 99;
           ...
           <asp:TextBox ID="DNO" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 120px; position: absolute; top: 40px"
           ...
           <asp:TextBox ID="DPaleteNo" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 120px; position: absolute;
