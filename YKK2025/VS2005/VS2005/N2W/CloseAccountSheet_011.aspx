<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CloseAccountSheet_011.aspx.vb" Inherits="CloseAccountSheet_011" %>
         ...
         <div>
            ...
            <!-- ++  追加 /  ++ -->
             ...
             <asp:Image ID="Image1" runat="server" ImageUrl="~/images/CloseAccountSheet_011.jpg"
                 Style="z-index: 99; left: 8px; position: absolute; top: 8px" /><asp:Button ID="BAdd" runat="server" OnClick="BAdd1_Click" Style="z-index: 114;
             ...
             &nbsp;&nbsp;
             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DTripNo"
                 ErrorMessage="出差申請單號不可為空白" Style="z-index: 143; left: 480px; position: absolute;
                 top: 296px" Width="176px"></asp:RequiredFieldValidator>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DASDate"
                 ErrorMessage="開始及結束日期不可為空白" Style="z-index: 143; left: 672px; position: absolute;
                 top: 296px" Width="208px"></asp:RequiredFieldValidator>
             &nbsp; &nbsp; &nbsp; &nbsp;
             &nbsp;&nbsp;
             <asp:Button ID="BCheck" runat="server" OnClick="BAdd1_Click" Style="z-index: 114;
             ...
             <asp:HyperLink ID="LQCNo" runat="server" Style="z-index: 118; left: 1000px;
             ...
             <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                 ...
                 Style="z-index: 123; left: 712px; position: absolute; top: 112px"></asp:TextBox>
             &nbsp; &nbsp;
             &nbsp;
             &nbsp;&nbsp;
             ...
             <asp:Panel ID="Panel2" runat="server" BorderWidth="1px" Height="312px" ScrollBars="Auto"
                 ...
                 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="SumAmt" HeaderText="小計金額" />
             ...
             <asp:TextBox ID="DReason" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
                 Style="z-index: 139; left: 256px; position: absolute; top: 872px" Visible="False"
                 Width="352px"></asp:TextBox>
             <asp:DropDownList ID="DReasonCode" runat="server" BackColor="Yellow" Height="20px"
                 Style="z-index: 140; left: 184px; position: absolute; top: 872px" Visible="False"
                 Width="64px">
                 <asp:ListItem>01</asp:ListItem>
                 <asp:ListItem>02</asp:ListItem>
             </asp:DropDownList>
             <asp:TextBox ID="DReasonDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
                 Height="56px" Style="z-index: 141; left: 184px; position: absolute; top: 904px"
                 Visible="False" Width="424px"></asp:TextBox>
              
          <img id="DDelay" runat="server" src="images/Sheet_Delay.jpg" style="z-index: 145; left: 24px;
              position: absolute; top: 864px" visible="false" />
             &nbsp;<br />
  <asp:TextBox ID="DDecideDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
                   Height="56px" Style="z-index: 142; left: 72px; position: absolute; top: 792px"
                   TextMode="MultiLine" Width="536px"></asp:TextBox>
               <img id="DDescSheet" runat="server" src="images/Sheet_Remark.jpg" style="z-index: 144;
                   left: 24px; position: absolute; top: 784px" />
             &nbsp;&nbsp;&nbsp;<br />
