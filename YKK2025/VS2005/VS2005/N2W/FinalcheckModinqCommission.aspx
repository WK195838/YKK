<%@ Page Language="vb" AutoEventWireup="false" Inherits="FinalcheckModinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="FinalcheckModinqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>最終再檢驗處理報告書-修改</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 400px; POSITION: absolute; TOP: 112px" runat="server"
				...
				<Columns>
                    ...
                    <asp:BoundColumn DataField="Field12"></asp:BoundColumn>
                    <asp:BoundColumn DataField="Field13"></asp:BoundColumn>
                    <asp:BoundColumn DataField="Field14"></asp:BoundColumn>
                    <asp:BoundColumn DataField="Field15"></asp:BoundColumn>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 352px; POSITION: absolute; TOP: 112px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/Finalcheckinq.jpg" Style="z-index: 99;
               left: 0px; position: absolute; top: 16px" />
           <asp:TextBox ID="DTYPE" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 120px; position: absolute; top: 88px"
               Width="216px"></asp:TextBox>
           <asp:TextBox ID="DNO" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 120px; position: absolute; top: 64px"
               Width="216px"></asp:TextBox>
           &nbsp;
           ...
           <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 216px; position: absolute; top: 112px; text-align: center" Text="~" Width="6px"></asp:Label>
           ...
           &nbsp;
           <asp:DropDownList ID="DACCDEPNAME" runat="server" BackColor="Yellow" ForeColor="Blue"
