<%@ Page Language="vb" AutoEventWireup="false" Inherits="FundingSheetCL_01" aspCompat="True" EnableEventValidation = "false"  CodeFile="FundingSheetCL_01.aspx.vb" %>
    ...
    <title>經費申請單</title>
     ...
     function ConfirmMe(btn) {
       ...
       function GetEMP()
       {
            ...
            window.open('EMPListCL.aspx?pKey=' + Div,'EMPPopup','status=0,toolbar=0,width=620,height=650,top=10,resizable=yes');
       }
       ...
       function GetDivision()
       {
            ...
            window.open('DivisionListCL.aspx?pKey=' + Div,'DivisionPopup','status=0,toolbar=0,width=620,height=650,top=10,resizable=yes');
       }
  	 ...
  	 <div>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               ...
               <asp:TextBox ID="DDivision3" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ...
                   top: 152px" Width="120px" AutoPostBack="True"></asp:TextBox>
               ...
               <asp:TextBox ID="D2" runat="server" BackColor="Transparent" BorderStyle="None" ForeColor="White"
                   Height="24px" Style="z-index: 127; left: 1184px; position: absolute; top: 72px"
                   Width="190px" AutoPostBack="True"></asp:TextBox>
               <!--************************************************************ 
            ** 防止重覆按 [BUTTON 2 次]                               **     
            ************************************************************ -->
           ...
           <asp:TextBox ID="DHaveData" runat="server" BackColor="White" BorderStyle="None" ForeColor="White"
               Height="24px" Style="z-index: 101; left: 1184px; position: absolute; top: 224px"
               Width="142px"></asp:TextBox>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <asp:Button ID="DAttachfile1" runat="server" CausesValidation="False" Style="z-index: 136;
         ...
         <asp:TextBox ID="D3" runat="server" BackColor="Transparent" BorderStyle="None" ForeColor="White"
          ...
          <asp:Panel ID="Panel2" runat="server" Height="312px" Width="1688px"  ScrollBars="Auto"  BorderWidth="1px" style="left: 16px; position: absolute; top: 320px">
              &nbsp; &nbsp;
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="Black"
                  Font-Size="12pt" Style="z-index: 117; left: 8px; position: absolute; top: 24px"
                  Width="1600px">
                  <Columns>
          ...
          &nbsp; &nbsp;
          <asp:Button ID="BAdd1" runat="server" Height="40px"
                   Style="z-index: 132; left: 920px; position: absolute; top: 216px" Text="費用登錄"
                   UseSubmitBehavior="false" Width="96px" />
    </form>
</body>
</html>
