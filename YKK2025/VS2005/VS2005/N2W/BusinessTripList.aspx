<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BusinessTripList.aspx.vb" Inherits="BusinessTripList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>出差申請LIST</title>
</head>
<body>
...
<asp:BoundField DataField="empname1" HeaderText="申請者"></asp:BoundField>
    <asp:BoundField DataField="Object" HeaderText="目的" />
    <asp:BoundField DataField="Location" HeaderText="地區/訪問" />
