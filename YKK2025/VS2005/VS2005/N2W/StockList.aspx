...
<body>
    <form id="form1" runat="server">
        尋找<asp:TextBox ID="DData" runat="server" style="z-index: 100; left: 120px; position: absolute;;text-transform : uppercase; top: 16px" Height="17px" Width="64px"></asp:TextBox><asp:Button ID="Button1" runat="server" Text="查詢" style="z-index: 101; left: 368px; position: absolute; top: 16px" />
        <asp:Button ID="BAdd" runat="server" Text="加入" style="z-index: 102; left: 440px; position: absolute; top: 16px" Visible="False" />
        ItemCode &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        Color
