<%@ Page Language="vb" AutoEventWireup="false" Inherits="ISMSinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="ISMSinqCommission.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 416px; POSITION: absolute; TOP: 112px" runat="server"
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 368px; POSITION: absolute; TOP: 112px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/n2winq.jpg" Style="z-index: 99;
               left: 0px; position: absolute; top: 16px" />
           <asp:TextBox ID="DEDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 110; left: 248px; position: absolute;
               top: 118px" Width="64px"></asp:TextBox>
           <asp:Button ID="BSDate" runat="server" Height="26px" Style="z-index: 111; left: 192px;
               position: absolute; top: 112px" Text="....." Width="28px" />
           <asp:Button ID="BEDate" runat="server" Height="26px" Style="z-index: 112; left: 312px;
               position: absolute; top: 112px" Text="....." Width="28px" />
           <asp:TextBox ID="DSDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 120px; position: absolute;
               top: 118px" Width="72px"></asp:TextBox>
           <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 224px; position: absolute; top: 88px; text-align: center" Text="~" Width="6px"></asp:Label>
           ...
           <asp:TextBox ID="DAEDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 110; left: 248px; position: absolute;
               top: 90px" Width="64px"></asp:TextBox>
           ...
           <asp:TextBox ID="DASDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 120px; position: absolute;
               top: 90px" Width="72px"></asp:TextBox>
           <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 224px; position: absolute; top: 120px; text-align: center" Text="~" Width="6px"></asp:Label>
           &nbsp; &nbsp;&nbsp;&nbsp;
           ...
           <asp:DropDownList ID="DPlace" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 256; left: 120px; position: absolute; top: 62px"
               Width="216px">
           </asp:DropDownList>
           <asp:DropDownList ID="DITName" runat="server" BackColor="Yellow" ForeColor="Blue"
