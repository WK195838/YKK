    ...
    Private Sub SetMainMenu()
        ...
        For i As Integer = 0 To dtForm.Rows.Count - 1
            ...
            If dtForm.Rows(i)("FormNo") = "003101" Then
                LFun01.Enabled = True
                LFun01.NavigateUrl = "ISMSSheet_01.aspx?pFormNo=003101" & _
                                                                  "&pFormSno=0" & _
                                                                  "&pStep=" & xStep & _
                                                                  "&pSeqNo=0" & _
            ...
            If dtForm.Rows(i)("FormNo") = "003102" Then
                ...
                LFun02.Enabled = True
                LFun02.NavigateUrl = "DiscountSheet_01.aspx?pFormNo=003102" & _
                                                                  "&pFormSno=0" & _
                                                                  "&pStep=" & xStep & _
                                                                  "&pSeqNo=0" & _
                                                                  "&pUserID=" & Request.QueryString("pUserID") & _
                ...
                LFun06.Enabled = True
                LFun06.NavigateUrl = "DiscountSheet_01.aspx?pFormNo=003102" & _
                                                                  "&pFormSno=0" & _
                                                                  "&pStep=2" & _
                                                                  "&pSeqNo=0" & _
                                                                  "&pUserID=" & Request.QueryString("pUserID") & _
            ...
            If dtForm.Rows(i)("FormNo") = "003103" Then
                LFun03.Enabled = True
                LFun03.NavigateUrl = "CustomerInfoSheet_01.aspx?pFormNo=003103" & _
                                                                  "&pFormSno=0" & _
                                                                  "&pStep=" & xStep & _
                                                                  "&pSeqNo=0" & _
                                                                  "&pUserID=" & Request.QueryString("pUserID") & _
            ...
            If dtForm.Rows(i)("FormNo") = "003104" Then
                LFun04.Enabled = True
                LFun04.NavigateUrl = "CustomerInfoModSheet_01.aspx?pFormNo=003104" & _
                                                                  "&pFormSno=0" & _
                                                                  "&pStep=" & xStep & _
                                                                  "&pSeqNo=0" & _
                                                                  "&pUserID=" & Request.QueryString("pUserID") & _
