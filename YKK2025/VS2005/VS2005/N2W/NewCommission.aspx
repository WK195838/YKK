		...
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">
                ...
                <asp:HyperLink ID="LFun06" runat="server" Enabled="False" Font-Size="12pt" Height="16px"
                    NavigateUrl="DiscountSheet_01.aspx" Style="z-index: 102; left: 56px; position: absolute;
                    top: 176px" Target="_self" Width="224px">03. 顧客折扣單價（營業五課）</asp:HyperLink>
                &nbsp; &nbsp;&nbsp;
                <asp:HyperLink ID="LFun04" runat="server" Enabled="False" Font-Size="12pt" Height="16px"
                    NavigateUrl="FinalcheckModSheet_01.aspx" Style="z-index: 102; left: 56px; position: absolute;
                    top: 224px" Target="_self" Width="224px">05.顧客變更</asp:HyperLink>
                ...
                <asp:HyperLink ID="LFun03" runat="server" Enabled="False" Font-Size="12pt" Height="16px"
                    NavigateUrl="CustomerInfoSheet_01.aspx" Style="z-index: 102; left: 56px; position: absolute;
                    top: 200px" Target="_self" Width="224px">04.顧客建檔</asp:HyperLink>
                &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp;&nbsp;
                <asp:HyperLink ID="LFun01" runat="server" Enabled="False" Font-Size="12pt" Height="16px"
                    NavigateUrl="ISMSSheet_01.aspx.aspx" Style="z-index: 102; left: 56px; position: absolute;
                    top: 128px" Target="_self" Width="224px">01. ISMS資訊工作日誌申請單</asp:HyperLink>
                &nbsp;
                &nbsp;&nbsp;
				...
				<asp:Label id="DSystemTitle" style="Z-INDEX: 101; LEFT: 16px; POSITION: absolute; TOP: 24px"
					runat="server" ForeColor="Navy" Font-Bold="True" Font-Size="16pt" Width="260px">Notes To Web 各項申請</asp:Label></FONT></form>
	</body>
</HTML>