<%@ Page Language="vb" AutoEventWireup="false" Inherits="ComplaintOutSheet_02" aspCompat="True" EnableEventValidation = "false"  CodeFile="ComplaintOutSheet_02.aspx.vb" %>
 	 ...
 	 <div>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               ...
               <asp:TextBox ID="DTYPE1" runat="server" AutoPostBack="True" BackColor="#C0FFFF"
                   BorderStyle="None" ForeColor="Black" Height="20px" Style="z-index: 101; left: 336px;
                   position: absolute; top: 864px" Width="176px"></asp:TextBox>
               <asp:DropDownList ID="DSCORE1" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 102;
               left: 256px; position: absolute; top: 1768px" Width="112px">
               </asp:DropDownList>
               <asp:DropDownList ID="DMANUREASON1" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 103; left: 504px; position: absolute;
                   top: 1200px" Width="192px">
                   </asp:DropDownList>
               &nbsp;&nbsp;
               ...
               <asp:Label ID="DHistoryLabel" runat="server" Font-Size="11pt" ForeColor="Blue" Height="20px"
                   Style="z-index: 135; left: 16px; position: absolute; top: 1976px" Text="核定履歷"></asp:Label>
               <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White"
                   BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="100px"
                   Style="z-index: 136; left: 16px; position: absolute; top: 2000px" Width="780px">
           ...
           <asp:DropDownList ID="DRESPONS" runat="server" BackColor="#C0FFFF" Height="20px"
               Style="z-index: 146; left: 168px; position: absolute; top: 1232px"
               Width="216px">
           </asp:DropDownList><asp:DropDownList ID="DHappen" runat="server" BackColor="#C0FFFF" Height="20px"
               Style="z-index: 146; left: 40px; position: absolute; top: 1304px"
               Width="216px">
           </asp:DropDownList>
          &nbsp;
           ...
           <asp:DropDownList ID="DREMARK" runat="server" BackColor="#C0FFFF" Height="20px"
               Style="z-index: 148; left: 504px; position: absolute; top: 1504px"
               Width="168px">
           </asp:DropDownList>
           ...
           <asp:DropDownList ID="DPOINT1" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 155;
               left: 144px; position: absolute; top: 1664px" Width="88px" AutoPostBack="True">
           </asp:DropDownList>
           &nbsp;
          ...
          &nbsp;
           ...
           <asp:TextBox ID="DYFGCDATE" runat="server" BackColor="#C0FFFF" BorderStyle="None"
               ...
               top: 1800px" Width="96px"></asp:TextBox><asp:DropDownList ID="DTYPE" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 174; left: 168px; position: absolute;
                   top: 864px" Width="136px" AutoPostBack="True">
               </asp:DropDownList>
          ...
          &nbsp;&nbsp;
           ...
           <asp:DropDownList ID="DACCDEP12" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 109; left: 336px; position: absolute;
                   top: 1000px" Width="176px" AutoPostBack="True">
               </asp:DropDownList>
           <asp:DropDownList ID="DACCDEP13" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 109; left: 544px; position: absolute;
                   top: 1000px" Width="160px">
           </asp:DropDownList>
           ...
           <asp:TextBox ID="DQCEDESC" runat="server" BackColor="#C0FFFF" BorderStyle="None"
               ...
               position: absolute; top: 928px" TextMode="MultiLine" Width="288px"></asp:TextBox><img src="images/ComplaintOutSheet_QC.jpg" style="z-index: 99; left: 16px; position: absolute;
                   top: 824px" id="Img2" onclick="return IMG1_onclick()" />
          <asp:DropDownList ID="DTYPE2" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 115;
              left: 544px; position: absolute; top: 864px" Width="160px">
          </asp:DropDownList>
          <input id="BQCACCDATE" runat="server" style="z-index: 196; left: 672px; width: 24px;
          ...
          &nbsp;
           ...
           <asp:TextBox ID="DQCACCDATE" runat="server" BackColor="#C0FFFF" BorderStyle="None"
               ...
               top: 832px" Width="128px"></asp:TextBox><asp:DropDownList ID="DSAMPLE" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 124;
                   left: 512px; position: absolute; top: 336px" Width="192px">
          ...
          <asp:TextBox ID="DFINALDATE" runat="server" BackColor="#C0FFFF" BorderStyle="None"
              ...
              top: 1832px" Width="64px"></asp:TextBox>
          <asp:CheckBox ID="DChkData6" runat="server" Style="z-index: 186;
