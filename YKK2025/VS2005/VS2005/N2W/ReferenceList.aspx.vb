...
Partial Class ReferenceList
    ...
    Sub GetData()
        ...
        SQL = " Select  top 100  ExpCat+'--'+ExpItem as ExpItem,convert(char(10),Adate,111) Adate,TaxType,NetAmt,TaxAmt,Amt,Content,Remark,ACID from F_FundingSheetdt where 1=1 "
        If InputData <> "" Then
