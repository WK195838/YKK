<%@ Page Language="vb" AutoEventWireup="false" Inherits="ExpenseScheduleTC" aspCompat="True" EnableEventValidation = "false"  CodeFile="ExpenseScheduleTC.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           <asp:Label ID="Label1" runat="server" Style="z-index: 104; left: 288px; position: absolute;
               top: 8px" Text="交際費系統" Font-Size="XX-Large"></asp:Label>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
