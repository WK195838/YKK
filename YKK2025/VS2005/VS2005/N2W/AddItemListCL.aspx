<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddItemListCL.aspx.vb" Inherits="AddItemListCL" %>
...
<head runat="server">
    ...
    function GetExpItem(strField)
       {
            window.open('ExpItemListCL.aspx?field='+strField,'Popup','status=0,toolbar=0,width=580,height=350,top=10,resizable=yes');
       }
       		
		function GetRemark(strField,strField1)
		{
			window.open('RemarkListCL.aspx?field=' + strField +'&field1='+ strField1,'Popup','width=600,height=400,top=10,resizable=yes');
		}
        			
       function GetReference()
       {
            window.open('ReferenceListCL.aspx','Popup','status=0,toolbar=0,width=700,height=450,top=10,resizable=yes');
       }
