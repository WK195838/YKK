<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FinalcheckList.aspx.vb" Inherits="FinalcheckList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>最終檢驗處理報告表</title>
</head>
<body>
...
<Columns>
<asp:BoundField DataField="NO" HeaderText="單號"></asp:BoundField>
<asp:BoundField DataField="accdepname" HeaderText="被訴部門"></asp:BoundField>
    <asp:BoundField DataField="formsno" HeaderText="formsno" Visible="False" />
