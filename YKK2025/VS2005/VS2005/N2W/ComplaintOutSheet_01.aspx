<%@ Page Language="vb" AutoEventWireup="false" Inherits="ComplaintOutSheet_01" aspCompat="True" EnableEventValidation = "false"  CodeFile="ComplaintOutSheet_01.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               ...
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp;&nbsp;
               <img id="DDelay" runat="server" src="images/Sheet_Delay.jpg" style="z-index: 193; left: 16px;
                   position: absolute; top: 2064px" visible="false" />
               &nbsp;
               <asp:TextBox ID="DReason" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
                   Style="z-index: 132; left: 240px; position: absolute; top: 2072px" Visible="False"
                   Width="352px"></asp:TextBox>
               <asp:DropDownList ID="DReasonCode" runat="server" BackColor="Yellow" Height="20px"
                   Style="z-index: 133; left: 168px; position: absolute; top: 2072px" Visible="False"
                   Width="64px">
                   <asp:ListItem>01</asp:ListItem>
                   <asp:ListItem>02</asp:ListItem>
               </asp:DropDownList>
               <asp:TextBox ID="DReasonDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
                   Height="56px" Style="z-index: 134; left: 168px; position: absolute; top: 2080px"
                   Visible="False" Width="424px"></asp:TextBox>
               <asp:Label ID="DHistoryLabel" runat="server" Font-Size="11pt" ForeColor="Blue" Height="20px"
                   Style="z-index: 135; left: 16px; position: absolute; top: 2336px" Text="核定履歷"></asp:Label>
               <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White"
                   BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="100px"
                   Style="z-index: 136; left: 16px; position: absolute; top: 2360px" Width="780px">
            ...
            ************************************************************ -->
               ...
               <asp:Button ID="BSAVE" runat="server" Height="24px" OnClientClick="return ConfirmMe(this)"
                   Style="z-index: 140; left: 360px; position: absolute; top: 2304px" Text="儲存"
                   UseSubmitBehavior="false" Width="80px" />
               <asp:Button ID="BNG2" runat="server" Height="24px" OnClientClick="return ConfirmMe(this)"
                   Style="z-index: 141; left: 448px; position: absolute; top: 2304px" Text="NG2"
                   UseSubmitBehavior="false" Width="80px" />
               <asp:Button ID="BNG1" runat="server" Height="24px" OnClientClick="return ConfirmMe(this)"
                   Style="z-index: 142; left: 544px; position: absolute; top: 2304px" Text="NG1"
                   UseSubmitBehavior="false" Width="80px" />
               <asp:Button ID="BOK" runat="server" Height="24px" OnClientClick="return ConfirmMe(this)"
                   Style="z-index: 143; left: 632px; position: absolute; top: 2304px" Text="OK"
                   UseSubmitBehavior="false" Width="80px" />
           </div>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           </asp:DropDownList><input id="BSAMPLEDATE" runat="server" style="z-index: 200; left: 248px; width: 24px;
               position: absolute; top: 1440px" type="button" value="..." />
           ...
           <asp:TextBox ID="DMACHNO" runat="server" BackColor="LightGray" BorderStyle="None" ForeColor="Black"
           ...
           </asp:DropDownList><asp:DropDownList ID="DTYPE1" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 115; left: 336px; position: absolute;
                   top: 864px" Width="176px">
           </asp:DropDownList>
           <asp:DropDownList ID="DTYPE2" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 115; left: 544px; position: absolute;
                   top: 864px" Width="160px" Visible="False">
           </asp:DropDownList>
           ...
           <asp:TextBox ID="DFIRSTDATE" runat="server" BackColor="#C0FFFF" BorderStyle="None"
               ForeColor="Black" Height="20px" Style="z-index: 126; left: 200px; position: absolute;
               top: 1832px" Width="64px"></asp:TextBox>
           <asp:TextBox ID="DFINALDATE" runat="server" BackColor="#C0FFFF" BorderStyle="None"
               ForeColor="Black" Height="20px" Style="z-index: 126; left: 304px; position: absolute;
               top: 1832px" Width="64px"></asp:TextBox>
           ...
           <asp:TextBox ID="DQCACCDATE" runat="server" BackColor="#C0FFFF" BorderStyle="None"
               ...
               </asp:DropDownList><asp:DropDownList ID="DQCDESCTYPE" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 115; left: 528px; position: absolute;
           ...
           <img src="images/ComplaintOutSheet_Manu.jpg" style="z-index: 99; left: 16px; position: absolute;
                   top: 1128px" id="Img3" onclick="return IMG1_onclick()" /><input id="BMFGDATE" runat="server" style="z-index: 200; left: 368px; width: 24px;
           ...
           <asp:Label ID="Label2" runat="server" Style="z-index: 140; left: 224px; position: absolute;
               top: 1400px" Text="生產日期"></asp:Label>
           &nbsp;&nbsp;
           <img src="images/ComplaintOutSheet_QC3.jpg" style="z-index: 99; left: 16px; position: absolute;
                   top: 1432px" id="Img4" onclick="return IMG1_onclick()" /><input id="BFINALDATE" runat="server" style="z-index: 199; left: 368px; width: 24px;
               position: absolute; top: 1832px" type="button" value="..." /><input id="BCARDATE" runat="server" style="z-index: 200; left: 288px; width: 24px;
               position: absolute; top: 1472px" type="button" value="..." /><input id="BMIDDATE" runat="server" style="z-index: 199; left: 656px; width: 24px;
               position: absolute; top: 1832px" type="button" value="..." /><input id="BFIRSTDATE" runat="server" style="z-index: 199; left: 272px; width: 24px;
