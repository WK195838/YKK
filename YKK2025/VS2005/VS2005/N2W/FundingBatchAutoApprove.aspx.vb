...
Partial Class FundingBatchAutoApprove
    ...
    Sub FlowControl()
        ...
        For i As Integer = 0 To dtFlow.Rows.Count - 1
            ...
            wIP = dtFlow.Rows(i)("UserIP").ToString
            wSeqNo = "1"
            ...
            SQL = SQL + " where    DecideID = '" + xDecideID + "'"
            ...
            If dtWaitHandle.Rows.Count > 0 Then
                ...
                SQL = "INSERT INTO L_FinishAutoApprove( " & _
                      "FormNo, FormSno,ApplyId,DecideId,Step,SeqNo,NextDecideID,UserIP," & _
