...
{      
 ...
 //  var executableFullPath = 'D:\\db\\SalePrint.exe ';
   //  var executableFullPath ='\\\\10.245.1.61\\mis\\DTMWTOOLS\\DTMW_AutoPrint1.exe ';
    var executableFullPath ='\\\\10.245.1.10\\www$\\N2W\\MIS\\STOCK\\N2W_STOCKIN.exe ';
    try
    {
...
{      
 ...
 //  var executableFullPath = 'D:\\db\\SalePrint.exe ';
   //  var executableFullPath ='\\\\10.245.1.61\\mis\\DTMWTOOLS\\DTMW_AutoPrint1.exe ';
    var executableFullPath ='\\\\10.245.1.10\\www$\\N2W\\MIS\\STOCK\\N2W_STOCKOUT.exe ';
    try
    {
        var shellActiveXObject = new ActiveXObject("WScript.Shell");
...
{      
 ...
 //  var executableFullPath = 'D:\\db\\SalePrint.exe ';
   //  var executableFullPath ='\\\\10.245.1.61\\mis\\DTMWTOOLS\\DTMW_AutoPrint1.exe ';
    var executableFullPath ='\\\\10.245.1.10\\www$\\N2W\\MIS\\STOCK\\N2W_STOCKCHECK.exe ';
    try
    {
        var shellActiveXObject = new ActiveXObject("WScript.Shell");
...
{      
 ...
 //  var executableFullPath = 'D:\\db\\SalePrint.exe ';
   //  var executableFullPath ='\\\\10.245.1.61\\mis\\DTMWTOOLS\\DTMW_AutoPrint1.exe ';
    var executableFullPath ='\\\\10.245.1.10\\www$\\N2W\\MIS\\Stock\\Stock_AutoPrint.exe ';
    try
    {
        var shellActiveXObject = new ActiveXObject("WScript.Shell");
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                ...
                <asp:Button ID="BPrint" runat="server" Style="z-index: 104; left: 160px; position: absolute;
                    top: 112px" Text="列印出庫單" Width="104px" BackColor="#FFE0C0" /><asp:Button ID="BStockIn" runat="server" Style="z-index: 104; left: 376px; position: absolute;
