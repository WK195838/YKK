<%@ Page Language="vb" AutoEventWireup="false" Inherits="BusinessTripCheckList" aspCompat="True" EnableEventValidation = "false"  CodeFile="BusinessTripCheckList.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>出差及清算追蹤檢核表</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 752px; POSITION: absolute; TOP: 104px" runat="server"
           ...
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/BusinessTripChecklist_01.jpg"
               Style="z-index: 99; left: 0px; position: absolute; top: 16px" />
           <asp:TextBox ID="DObject" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ...
               top: 104px" Width="176px"></asp:TextBox>
           ...
           <asp:TextBox ID="DNO" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 472px; position: absolute; top: 40px"
           ...
           <asp:TextBox ID="DASDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 472px; position: absolute;
               top: 72px" Width="64px"></asp:TextBox>
           <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 568px; position: absolute; top: 72px; text-align: center" Text="~" Width="6px"></asp:Label>
           ...
           <asp:DropDownList ID="DSTS" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
               Style="z-index: 255; left: 152px; position: absolute; top: 40px" Width="176px">
           ...
           <asp:Button ID="Go" runat="server" BackColor="Aqua" ForeColor="Blue" Height="24px"
               Style="z-index: 121; left: 704px; position: absolute; top: 104px" Text="Go" Width="40px" />
           <input id="BSDate" runat="server" style="z-index: 148; left: 536px; width: 24px;
               position: absolute; top: 72px" type="button" value="..." visible="true" />
           <input id="BEDate" runat="server" style="z-index: 150; left: 656px; width: 24px;
               position: absolute; top: 72px" type="button" value="..." visible="true" />
