	   ...
	   function GetSPEC()
{
   ...
   function GetSPEC1(strField,strField1,strField2)
{
        
    window.open('StockList.aspx?pStep=10&field=' + strField+'&field1='+strField1+'&field2='+strField2,'','status=0,toolbar=0,width=850,height=650,top=10,resizable=yes');
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               <img src="images/StockOut_01.jpg" style="z-index: 1; left: 8px; position: absolute;
                   top: 0px" />
               <asp:TextBox ID="DType" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   top: 184px; text-align: left" Width="140px"></asp:TextBox>
               <input id="BSPEC" runat="server" style="z-index: 152; left: 328px; width: 24px; position: absolute;
                   top: 216px" type="button" value="..." />
               &nbsp;&nbsp;&nbsp;&nbsp;
               <asp:TextBox ID="DItemCode" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" Style="z-index: 126; left: 224px; position: absolute;
                   top: 216px; text-align: left" Width="96px"></asp:TextBox>
               <asp:TextBox ID="DColor" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" Style="z-index: 126; left: 480px; position: absolute;
                   top: 216px; text-align: left" Width="120px"></asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
               ...
               <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 480px; position: absolute; top: 120px" Width="120px">DNo</asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp;&nbsp;
               <asp:TextBox ID="DName" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="20px" Style="z-index: 126; left: 472px;
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:TextBox ID="DQty" runat="server"  onkeyup="if(isNaN(value))execCommand('undo')"  BackColor="GreenYellow" BorderStyle="None"
               ForeColor="Black" Height="20px" Style="z-index: 126; left: 224px;
               position: absolute; top: 248px; text-align: left" Width="56px" Visible="False"></asp:TextBox>
           <asp:TextBox ID="DDepName" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
               Height="20px" Style="z-index: 126; left: 224px; position: absolute;
               top: 152px; text-align: left" Width="140px"></asp:TextBox>
           &nbsp;
           ...
           <asp:Panel ID="Panel2" runat="server" BorderWidth="1px" Height="328px" ScrollBars="Auto"
               Style="left: 8px; position: absolute; top: 296px" Width="632px">
               &nbsp; &nbsp;&nbsp;
