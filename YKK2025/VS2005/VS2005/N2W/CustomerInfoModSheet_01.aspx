<%@ Page Language="vb" AutoEventWireup="false" Inherits="CustomerInfoModSheet_01" aspCompat="True" EnableEventValidation = "false"  CodeFile="CustomerInfoModSheet_01.aspx.vb" %>
  	 ...
  	 <div>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               ...
               <asp:TextBox ID="DCUSTOMER" runat="server" BackColor="#C0FFFF" BorderStyle="Groove"
                   ForeColor="Black" Height="24px" Style="z-index: 112; left: 224px; position: absolute;
                   top: 184px" Width="136px"></asp:TextBox>
               <input id="BCustomer" runat="server" style="z-index: 201; left: 200px; width: 24px;
               ...
               <input id="BCopySheet" runat="server" style="z-index: 156; left: 32px; width: 40px;
                   position: absolute; top: 48px" type="button" value="複製" visible="true" />
               &nbsp;&nbsp;
               ...
               &nbsp;&nbsp;
               <input id="BAddress2" runat="server" style="z-index: 144; left: 672px; width: 24px;
                   position: absolute; top: 424px" type="button" value="..." />
               &nbsp;
               <asp:FileUpload ID="DAttachfile" runat="server" Height="24px" Style="z-index: 100;
                   left: 136px; position: absolute; top: 704px; background-color: #c0ffff" Width="288px" />
               ...
               <asp:DropDownList ID="DDelivery" runat="server" BackColor="#C0FFFF" Height="20px"
                   Style="z-index: 104; left: 136px; position: absolute; top: 312px" Visible="False"
                   Width="224px">
               </asp:DropDownList>
               &nbsp;
               ...
               <asp:TextBox ID="DCustomerCode" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ...
                   position: absolute; top: 184px; text-align: left" Width="64px"></asp:TextBox>
               &nbsp;
               <asp:DropDownList ID="DLocation" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 114;
                   left: 136px; position: absolute; top: 216px" Visible="False" Width="224px">
               </asp:DropDownList>
               ...
               <asp:TextBox ID="D1" runat="server" BackColor="Transparent" BorderStyle="None" ForeColor="White"
                   ...
                   left: 136px; position: absolute; top: 280px" Visible="False" Width="224px">
                   </asp:DropDownList>
               <asp:DropDownList ID="DGoods" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 130;
                   left: 472px; position: absolute; top: 280px" Visible="False" Width="224px">
               </asp:DropDownList>
           ...
           <input id="BAddress1" runat="server" style="z-index: 143; left: 664px; width: 24px;
               position: absolute; top: 512px" type="button" value="..." />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <img id="DDescSheet" runat="server" src="images/Sheet_Remark.jpg" style="z-index: 1;
               left: 24px; position: absolute; top: 952px" /><asp:DropDownList ID="DJob" runat="server" BackColor="#C0FFFF" Height="20px" Style="z-index: 130;
                   left: 136px; position: absolute; top: 152px" Visible="False" Width="560px">
               </asp:DropDownList>
