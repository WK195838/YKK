<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SpecList.aspx.vb" Inherits="SpecList" %>
...
<body>
    <form id="form1" runat="server">
        &nbsp; Item Code&nbsp;&nbsp;<asp:TextBox ID="DData" runat="server" style="z-index: 100; left: 104px; position: absolute; top: 8px;position: absolute;text-transform : uppercase;" Height="17px"></asp:TextBox><asp:Button ID="Button1" runat="server" Text="查詢" style="z-index: 101; left: 264px; position: absolute; top: 8px" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="DData"
            ErrorMessage="請輸入  Item Code  " Style="left: -5px; position: relative; top: 29px; z-index: 102;" Width="274px"></asp:RequiredFieldValidator>&nbsp;<br />
        <br />
