<%@ Page Language="vb" AutoEventWireup="false" Inherits="FundingSchedule" aspCompat="True" EnableEventValidation = "false"  CodeFile="FundingSchedule.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           <asp:HyperLink ID="LFun01" runat="server" Enabled="False" Font-Size="12pt" Height="16px" Style="z-index: 102; left: 856px; position: absolute;
               top: 88px" Target="_self" Width="224px">新委託</asp:HyperLink>
       </div>
    </form>
</body>
</html>
