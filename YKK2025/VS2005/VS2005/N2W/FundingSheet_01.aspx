<%@ Page Language="vb" AutoEventWireup="false" Inherits="FundingSheet_01" aspCompat="True" EnableEventValidation = "false"  CodeFile="FundingSheet_01.aspx.vb" %>
...
<head id="Head1" runat="server">
    <title>經費申請單</title>
     ...
     function ConfirmMe(btn) {
       ...
       function AddItem()
       {
            window.open('AddItemList.aspx','newwindow','_blank');
       }

	function AddItem1(strField)
		{
			window.open('AddItemList.aspx?pDTNo=' + strField,'newwindow','_blank');
		}
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               <img src="images/FundingSheet_01.jpg" style="z-index: 99; left: 8px; position: absolute;
                   top: 8px" />
               &nbsp;&nbsp;
               <asp:TextBox ID="DUpdate" runat="server" BackColor="White" BorderStyle="None" ForeColor="White"
                   Height="24px" Style="z-index: 101; left: 936px; position: absolute; top: 192px"
                   Width="142px"></asp:TextBox>
               &nbsp; &nbsp;&nbsp;
               <asp:TextBox ID="DTNo" runat="server" BackColor="White" BorderStyle="None" ForeColor="White"
                   Height="24px" Style="z-index: 102; left: 928px; position: absolute; top: 32px"
                   Width="142px"></asp:TextBox>
               <asp:TextBox ID="DApplyAmt" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 103; left: 24px; position: absolute;
                   top: 240px; text-align: right" Width="280px">0</asp:TextBox>
               <asp:TextBox ID="DDebitAmt" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 104; left: 312px; position: absolute;
                   top: 240px; text-align: right" Width="280px">0</asp:TextBox>
               <asp:TextBox ID="DSumAmt" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 105; left: 608px; position: absolute;
                   top: 240px; text-align: right" Width="280px">0</asp:TextBox>
               <asp:TextBox ID="DDate" runat="server" BackColor="#E0E0E0" BorderStyle="Groove" ForeColor="Blue"
                   Height="24px" ReadOnly="true" Style="z-index: 106; left: 144px; position: absolute;
                   top: 56px" Width="296px"></asp:TextBox>
               <asp:TextBox ID="DDivision1" runat="server" BackColor="#E0E0E0" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" ReadOnly="true" Style="z-index: 107; left: 168px;
                   position: absolute; top: 88px" Width="120px"></asp:TextBox>
               ...
               <asp:TextBox ID="DDivisionCode1" runat="server" BackColor="#E0E0E0" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" ReadOnly="true" Style="z-index: 109; left: 408px;
                   position: absolute; top: 88px" Width="120px"></asp:TextBox>
               <asp:TextBox ID="DEmpID1" runat="server" BackColor="#E0E0E0" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" ReadOnly="true" Style="z-index: 110; left: 528px;
                   position: absolute; top: 88px" Width="120px"></asp:TextBox>
               <asp:TextBox ID="DJobTitle1" runat="server" BackColor="#E0E0E0" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" ReadOnly="true" Style="z-index: 111; left: 656px;
                   position: absolute; top: 88px" Width="120px"></asp:TextBox>
               <asp:TextBox ID="DDivision2" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 112; left: 168px; position: absolute;
                   top: 120px" Width="120px"></asp:TextBox>
               ...
               <asp:TextBox ID="DDivisionCode2" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 114; left: 408px; position: absolute;
                   top: 120px" Width="120px"></asp:TextBox>
               <asp:TextBox ID="DEmpID2" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 115; left: 528px; position: absolute;
                   top: 120px" Width="120px"></asp:TextBox>
               <asp:TextBox ID="DJobTitle2" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 116; left: 656px; position: absolute;
                   top: 120px" Width="120px"></asp:TextBox>
               <asp:TextBox ID="DDivision3" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ForeColor="Blue" Height="24px" Style="z-index: 117; left: 168px; position: absolute;
                   top: 152px" Width="120px"></asp:TextBox>
               <asp:TextBox ID="DDivisionCode3" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
                   ...
                   top: 152px" Width="120px"></asp:TextBox>
               <input id="BDivision3" runat="server" style="z-index: 144; left: 408px; width: 24px;
                   position: absolute; top: 152px" type="button" value="..." />
               <input id="BDivision2" runat="server" style="z-index: 143; left: 784px; width: 24px;
                   position: absolute; top: 120px" type="button" value="..." />
               &nbsp;
               <input id="BADD" runat="server" style="z-index: 142; left: 912px; width: 100px; position: absolute;
                   top: 216px; height: 40px" type="button" value="費用登錄" />
               <input id="BRefresh" runat="server" style="z-index: 145; left: 1024px; width: 100px;
                   position: absolute; top: 216px; height: 40px" type="button" value="費用一覽" visible="false" />
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               ...
               <asp:TextBox ID="DNo" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
                   ...
                   left: 592px; position: absolute; top: 56px" Height="24px"></asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
               ...
               <asp:Label ID="DHistoryLabel" runat="server" Font-Size="11pt" ForeColor="Blue" Height="20px"
                   Style="z-index: 124; left: 16px; position: absolute; top: 944px" Text="核定履歷"></asp:Label>
               <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White"
                   BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="100px"
                   Style="z-index: 125; left: 16px; position: absolute; top: 968px" Width="780px">
               ...
               <asp:TextBox ID="D2" runat="server" BackColor="Transparent" BorderStyle="None" ForeColor="White"
                   Height="24px" Style="z-index: 127; left: 776px; position: absolute; top: 24px"
                   Width="190px"></asp:TextBox>
               <!--************************************************************ 
            ** 防止重覆按 [BUTTON 2 次]                               **     
            ************************************************************ -->
           ...
           <asp:TextBox ID="DNO1" runat="server" BackColor="White" BorderStyle="None" ForeColor="White"
               Height="24px" Style="z-index: 133; left: 952px; position: absolute; top: 120px"
               Width="142px"></asp:TextBox>
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <asp:CheckBox ID="CDivision2" runat="server" AutoPostBack="True" Style="z-index: 134;
               left: 144px; position: absolute; top: 120px" Width="40px" />
           <asp:CheckBox ID="CDivision3" runat="server" AutoPostBack="True" Style="z-index: 135;
               left: 144px; position: absolute; top: 160px" Width="40px" />
          
       </div>
        <asp:Button ID="DAttachfile1" runat="server" CausesValidation="False" Style="z-index: 136;
               left: 448px; position: absolute; top: 152px" Text="開啟附檔資料夾" Width="144px" />
         <asp:TextBox ID="D3" runat="server" BackColor="Transparent" BorderStyle="None" ForeColor="White"
               Height="24px" Style="z-index: 137; left: 784px; position: absolute; top: 80px"
               Width="190px"></asp:TextBox>
          &nbsp; &nbsp;
          
          <img id="DDelay" runat="server" src="images/Sheet_Delay.jpg" style="z-index: 1; left: 32px;
              position: absolute; top: 808px" visible="false" />
          <asp:TextBox ID="DReason" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
              Style="z-index: 133; left: 264px; position: absolute; top: 816px" Visible="False"
              Width="352px"></asp:TextBox>
          <asp:DropDownList ID="DReasonCode" runat="server" BackColor="Yellow" Height="20px"
              Style="z-index: 134; left: 192px; position: absolute; top: 816px" Visible="False"
              Width="64px">
              <asp:ListItem>01</asp:ListItem>
              <asp:ListItem>02</asp:ListItem>
          </asp:DropDownList>
          <asp:TextBox ID="DReasonDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
              Height="56px" Style="z-index: 135; left: 192px; position: absolute; top: 848px"
              Visible="False" Width="424px"></asp:TextBox>        &nbsp;
          <asp:Panel ID="Panel2" runat="server" Height="312px" Width="1632px"  ScrollBars="Auto"  BorderWidth="1px" style="left: 16px; position: absolute; top: 328px">
              &nbsp;
              <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="Black"
                  Font-Size="12pt" Style="z-index: 117; left: 8px; position: absolute; top: 24px" Width="1600px">
                  <Columns>
           ...
           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1"
               ErrorMessage="不可為空白" Width="96px"></asp:RequiredFieldValidator></asp:Panel>
