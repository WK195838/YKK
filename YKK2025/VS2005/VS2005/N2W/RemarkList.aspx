<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RemarkList.aspx.vb" Inherits="RemarkList" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox ID="DRemarkList" runat="server" BackColor="Yellow" BorderStyle="None" ForeColor="Black"
                ...
                top: 216px; text-align: left" TextMode="MultiLine" Width="568px" ReadOnly="True"></asp:TextBox>
            ...
            <asp:TextBox ID="DChk" runat="server" BackColor="White" BorderStyle="None" ForeColor="White"
                ...
                Width="142px"></asp:TextBox><asp:Button ID="BDEL" runat="server" Style="z-index: 101; left: 432px; position: absolute;
                top: 320px" Text="修改" Width="72px" ForeColor="Red" />
