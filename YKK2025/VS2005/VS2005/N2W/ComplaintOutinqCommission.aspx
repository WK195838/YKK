<%@ Page Language="vb" AutoEventWireup="false" Inherits="ComplaintOutinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="ComplaintOutinqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>客訴處理報告書調閱</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 408px; POSITION: absolute; TOP: 136px" runat="server"
				ImageUrl="~/Images/msexcel.gif" Height="21px" Width="21px"></asp:imagebutton>
				<asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 16px; POSITION: absolute; TOP: 192px" runat="server"
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 352px; POSITION: absolute; TOP: 136px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/ComplaintOutinq1.jpg" Style="z-index: 99;
               left: 0px; position: absolute; top: 16px" />
           <asp:DropDownList ID="DACCDEP1" runat="server" BackColor="#FFFF80" Height="20px"
               Style="z-index: 134; left: 120px; position: absolute; top: 88px" Width="232px">
           </asp:DropDownList>
           ...
           <asp:TextBox ID="DCUSTOMER" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 120px; position: absolute; top: 112px"
           ...
           <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 216px; position: absolute; top: 136px; text-align: center" Text="~" Width="6px"></asp:Label>
