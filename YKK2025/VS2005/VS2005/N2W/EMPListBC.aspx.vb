...
Partial Class EMPListBC
    ...
    Sub GetData()
        ...
        SQL = SQL + " order by DepName, DepID, empName "
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        If Request.QueryString("pFun") = "1" Then
            ...
            js &= "window.opener.document.all.CDivision2.checked = false;"
        Else
            js &= "window.opener.document.all.DDivision4.value = '" & GridView1.SelectedRow.Cells(1).Text.Replace("&amp;", "&") & "';"
            js &= "window.opener.document.all.DEmpName4.value = '" & GridView1.SelectedRow.Cells(2).Text & "';"
            js &= "window.opener.document.all.DDivisionCode4.value = '" & GridView1.SelectedRow.Cells(3).Text & "';"
            js &= "window.opener.document.all.DEmpID4.value = '" & GridView1.SelectedRow.Cells(4).Text & "';"
            js &= "window.opener.document.all.D4.value = '" & GridView1.SelectedRow.Cells(4).Text & "';"
            js &= "window.opener.document.all.DJobTitle4.value = '" & GridView1.SelectedRow.Cells(5).Text & "';"
