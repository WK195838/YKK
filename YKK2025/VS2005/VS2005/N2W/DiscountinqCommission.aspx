<%@ Page Language="vb" AutoEventWireup="false" Inherits="DiscountinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="DiscountinqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>顧客單價折扣調閱資料</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 720px; POSITION: absolute; TOP: 144px" runat="server"
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 672px; POSITION: absolute; TOP: 144px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/discountinq_01.jpg" Style="z-index: 99;
               left: 0px; position: absolute; top: 16px" />
           <asp:TextBox ID="DITEMCODE" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 464px; position: absolute; top: 144px"
               Width="88px"></asp:TextBox>
           <asp:Label ID="Label1" runat="server" Style="z-index: 142; left: 368px; position: absolute;
               top: 144px" Text="ITEMCODE"></asp:Label>
           <asp:TextBox ID="DNO" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 464px; position: absolute; top: 112px"
           ...
           <asp:Button ID="BASDate" runat="server" Height="26px" Style="z-index: 111; left: 192px;
               position: absolute; top: 136px" Text="....." Width="28px" />
           <asp:TextBox ID="DCustomer" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 120px; position: absolute;
               top: 88px" Width="216px"></asp:TextBox>
           <asp:Button ID="BAEDate" runat="server" Height="26px" Style="z-index: 112; left: 312px;
               position: absolute; top: 136px" Text="....." Width="28px" />
           <asp:TextBox ID="DVersion" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 120px; position: absolute;
               top: 112px" Width="216px"></asp:TextBox>
           &nbsp; &nbsp;
           &nbsp; &nbsp;&nbsp;&nbsp;
           ...
           <asp:DropDownList ID="DJob" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 257; left: 464px; position: absolute; top: 62px"
               Width="200px">
           </asp:DropDownList>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           <asp:DropDownList ID="DTable" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 568px; position: absolute; top: 144px"
               Width="80px">
               <asp:ListItem></asp:ListItem>
               <asp:ListItem Selected="True" Value="未封存">未封存</asp:ListItem>
