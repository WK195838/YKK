<%@ Page Language="vb" AutoEventWireup="false" Inherits="ComplaintIninqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="ComplaintIninqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>內部客訴調閱資料</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 408px; POSITION: absolute; TOP: 112px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/ComplaintIninq_01.jpg" Style="z-index: 99;
               left: 0px; position: absolute; top: 16px" />
           <asp:TextBox ID="DQCNO" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 456px; position: absolute;
               top: 88px" Width="200px"></asp:TextBox>
           <asp:DropDownList ID="DCOMDEPNAME" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 257; left: 120px; position: absolute; top: 64px"
               Width="216px">
               </asp:DropDownList>
           &nbsp; &nbsp; &nbsp;
           <asp:TextBox ID="DCOMNAME" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
           ...
           <asp:DropDownList ID="DSTS" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 456px; position: absolute; top: 32px"
               Width="200px">
           ...
           <asp:DropDownList ID="DACCDEPNAME" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 257; left: 456px; position: absolute; top: 64px"
               Width="200px">
           </asp:DropDownList>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
