<%@ Page Language="vb" AutoEventWireup="false" Inherits="CusteomerInfoModinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="CustomerInfoModinqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>顧客變更調閱資料</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 728px; POSITION: absolute; TOP: 120px" runat="server"
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 672px; POSITION: absolute; TOP: 120px" runat="server"
           ...
           <asp:DropDownList ID="DLocation" runat="server" BackColor="Yellow" ForeColor="Blue"
           ...
           <asp:TextBox ID="DASDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ...
               top: 116px" Width="64px"></asp:TextBox>
           &nbsp; &nbsp;&nbsp;
