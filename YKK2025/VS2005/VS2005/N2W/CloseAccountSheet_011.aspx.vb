...
Partial Class CloseAccountSheet_011
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '  BAdd1.Attributes("onclick") = "window.open('AddItemListACC.aspx?pUserID=" & Request.QueryString("pUserID") & "&pDTNo=" & DTNo.Text & "&pASDate=" & DASDate.Text & "&pAEDate=" & DAEDate.Text & "','','height=600,width=1200,menubar=no,location=no');"
        '  a = DASDate.Text
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        If InputData1 <> "" Then
            ...
            LTripNo.Text = "Link"
            LTripNo.NavigateUrl = "http://10.245.1.10/N2W/BusinessTripSheet_02.aspx?pFormNo=003114&pFormSno=1"
        ...
        '    Case 0  '顯示
        '        DDivision1.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DDivision2.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DEmpName1.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DEmpName2.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DDivisionCode1.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DDivisionCode2.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DDivisionCode3.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DJobTitle1.BackColor = Color.White
        ...
        '    Case 0  '顯示
        '        DJobTitle2.BackColor = Color.White
    ...
    Sub ShowFormData()
        ...
        '    SQL = "Select ExpCat+'--'+ExpItem ExpItem,ACID, ADate, TaxType, NetAmt, TaxAmt, Amt, Content, Remark  From F_BusinessTripSheetdt "
        '    SQL &= " Where FormNo =  '" & wFormNo & "'"
        '    SQL &= "   And FormSno =  '" & CStr(wFormSno) & "'"
    ...
    Sub SetPopupFunction()
        ...
        '  BAdd1.Attributes("onclick") = "window.open('AddItemListACC.aspx?pUserID=" & Request.QueryString("pUserID") & "&pDTNo=" & DTNo.Text & "&pASDate=" & DASDate.Text & "&pAEDate=" & DAEDate.Text & "','','height=600,width=1200,menubar=no,location=no');"
        'BAdd1.Attributes("onclick") = "window.open('AddItemListACC.aspx?pUserID=" & Request.QueryString("pUserID") & "&pDTNo=" & DTNo.Text & "&pDays=" & DDays.Text & "','','height=600,width=1200,menubar=no,location=no');"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        sql &= " PassDate,PreMoney,QCNO,QCNO1,chkPhone,PhoneNo,chkInsurance,InsurancePay,chkVisa,"
        sql &= " Object,Location,Sdate,Edate,Remark,"
        ...
        'sql = " delete from F_BusinessTripSheetdt"
        ...
        'sql = " insert into F_BusinessTripSheetdt (Sts,CompletedTime,Formno,FormSno,No,ExpCat,ExpItem,ACID,ADate,TaxType,NetAmt,TaxAmt,Amt,Content,Remark,CreateUser, CreateTime, ModifyUser, ModifyTime) "
        'sql = sql + " select 0,'" + NowDateTime + "','003114'," + " '" + CStr(NewFormSno) + "', " + " N'" + YKK.ReplaceString(DNo.Text) + "', "
        ...
        'sql = sql + "  from F_BusinessTripSheetdtTemp where DTNO = " + DTNo.Text
        'uDataBase.ExecuteNonQuery(sql)
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        'sql = "Select * From F_BusinessTripSheetdt "
        'sql &= " Where FormNo =  '" & wFormNo & "'"
        'sql &= "   And FormSno =  '" & CStr(wFormSno) & "'"
        'Dim dtData1 As DataTable = uDataBase.GetDataTable(sql)
        ...
        '    a = gvr.Cells(0).Text
        '    b = gvr.Cells(1).Text
        '    sql = " insert into F_BusinessTripSheetdt  (Sts,CompletedTime,No,ExpCat,ExpItem,ADate,TaxType,NetAmt,TaxAmt,Amt,Content,Remark,ACID,CreateUser, CreateTime, ModifyUser, ModifyTime) "
        '    sql = sql & " values ("
        '    sql = sql & " Set "
        '    If pFun <> "SAVE" Then
        '        sql = sql & " '" & pSts & "',"
        ...
        '    sql = sql + " select 0,'" + NowDateTime + "','003114'," + " '" + CStr(wFormSno) + "', " + " N'" + YKK.ReplaceString(DNo.Text) + "', "
        '    sql = sql + " ExpCat,ExpItem,ACID,ADate,TaxType,NetAmt,TaxAmt,Amt,Content,Remark,"
        '    sql = sql + " '" + Request.QueryString("pUserID") + "', "        '作成者
        '    sql = sql + " '" + NowDateTime + "', "                            '作成時間
        '    sql = sql + " '" + "" + "', "                                     '修改者
    ...
    Sub GetData()
        ...
        SQL = " select SUM(convert(decimal(9,0),money*days*rate)) as SumAmt from ("
        SQL = SQL + " select Unique_ID,type,typeno,currency,convert(char(10),sdate,111)sdate,pay,case when money = '' then '0' else  convert(decimal(9,2),money) end as money,"
        SQL = SQL + "  case when days='' then '0' else convert(decimal(9,0),days) end as days"
        SQL = SQL + " ,case when pay = '公司卡' then 0 when currency ='TWD' then 1 when Rate ='' then 1  else  convert(decimal(9,6),rate) end as rate,remark,expenseno"
        SQL = SQL + " from  F_CloseAccountSheetDTTemp "
    ...
    Protected Sub BAdd1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BCheck.Click
        GetDays()
