...
1:
        ...
        SQL = SQL + " where formno between '008001' and '008009'"
    ...
    Protected Sub BNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BNew.Click
        If DFormNo.SelectedValue = "008001" Then
            Response.Redirect("FASSheet_01.aspx?pFormNo=" & DFormNo.SelectedValue & "&pFormSno=0" & _
                                                             "&pStep=1" & _
                                                             "&pSeqNo=0" & _
