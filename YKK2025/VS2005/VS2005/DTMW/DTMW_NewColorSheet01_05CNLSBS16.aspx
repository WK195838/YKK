<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorSheet01_05CNLSBS16" aspCompat="True" CodeFile="DTMW_NewColorSheet01_05CNLSBS16.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
          <div>
              ...
              <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorSheet10.jpg"
                  Style="z-index: 100; left: 24px; position: absolute; top: 16px" />
