...
Partial Class DTMW_NewColorSheet01_03CFP12
    ...
    Sub SetParameter()
        ...
        If wStep = 10 Or wStep = 510 Or wStep = 20 Or wStep = 25 Or wStep = 520 Or wStep = 525 Then '指定徐慧芬
            Dim SQL As String
    ...
    Sub ShowFormData()
        ...
        SQL = "Select * From F_NewColor03CFP12 "
        SQL = SQL & " Where FormNo =  '" & wFormNo & "'"
        SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
        Dim DBAdapter1 As DataTable = uDataBase.GetDataTable(SQL)
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("005001", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
            ...
            If ErrCode = 0 Then
                ...
                Else
                    ...
                    If ((LastStep = 20 Or LastStep = 520 Or LastStep = 25 Or LastStep = 525 Or LastStep = 31) And pFun = "OK") Or ((LastStep = 25 Or LastStep = 520 Or LastStep = 525 Or LastStep = 31) And pFun = "NG2") Then '新色確認完成表按OK才進來
                        ...
                        SQL = " select  *  from F_NewColor03CFP12 a, F_NewColorComplete b"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        Dim SQl As String
        SQl = "Insert into F_NewColor03CFP12 "
        SQl = SQl + "( "
    ...
    Function SetNo(ByVal Seq As Integer) As String
        ...
        'Next
        'Str = Str + Str2
        Str = "A" + CStr(DateTime.Now.Year) + Str2
        '年
        'Set單號
        '當月份筆數有幾筆  20150414 Modify by Jessica
        SQL = " select   isnull(max(convert(int,substring(no,8,4))),0) cun from  f_Newcolor03cfp12"
    ...
    Function OK() As Boolean
        ...
        If wStep = 1 Or wStep = 500 Then
            If YKK.ReplaceString(DPANTONECode.Text) <> "" Then
                ...
                SQL = SQL + " and ColorLight1='" + YKK.ReplaceString(DColorLight1.SelectedValue) + "'"
                SQL = SQL + " and ColorLight2='" + YKK.ReplaceString(DColorLight2.SelectedValue) + "'"
    ...
    Sub CheckDuplicateNo()
        ...
        Dim SQL As String
        SQL = "select no,customer,customercode,buyer,buyercode,customercolor,customercolorcode,overseaykkcode,pantonecode devyear,devseason "
        SQL = SQL + " from F_NewColor03CFP12"
