...
Partial Class DTMW_NewColorSheet01_OverSeaYKK
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "DTMW_NewColorSheet01_OverSeaYKK.aspx"
    ...
    Sub ShowFormData()
        ...
        SQL = "Select * From F_NewColorOverSeaYKK "
        SQL = SQL & " Where FormNo =  '" & wFormNo & "'"
        SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
        Dim DBAdapter1 As DataTable = uDataBase.GetDataTable(SQL)
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        If wFormNo = "005006" Then
            LSheetName.Text = "海外YKK" '表單名稱"
        End If
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("005006", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
            ...
            If ErrCode = 0 Then
                ...
                Else
                    If ((LastStep = 20 Or LastStep = 520 Or LastStep = 25 Or LastStep = 525 Or LastStep = 31) And pFun = "OK") Or ((LastStep = 25 Or LastStep = 520 Or LastStep = 525 Or LastStep = 31) And pFun = "NG2") Then '新色確認完成表按OK才進來
                        ...
                        SQL = " select  *  from F_NewColorOverSeaYKK a, F_NewColorComplete b"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        Dim SQl As String
        SQl = "Insert into F_NewColorOverSeaYKK "
        SQl = SQl + "( "
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQL = " Update F_NewColorOverSeaYKK"
        SQL = SQL + " Set "
        If pFun <> "SAVE" Then
            SQL = SQL + " Sts = '" & pSts & "',"
    ...
    Function SetNo(ByVal Seq As Integer) As String
        ...
        'Next
        'Str = Str + Str2
        Str = "F" + CStr(DateTime.Now.Year) + Str2
        '年
        'Set單號
        '當月份筆數有幾筆  20150414 Modify by Jessica
        Dim sql As String
        sql = " select count(*)cun from  f_NewcolorOverSeaykk"
    ...
    Function OK() As Boolean
        ...
        If wStep = 20 Or wStep = 25 Or wStep = 520 Then
        ...
        If dt1.Rows.Count > 0 Then
            OverSeaYKK = 1
            If DFactoryCheck.Checked = False Then
                DVCACheck.Checked = False
                DCustomerCheck.Checked = False
                DFactoryCheck.Checked = True
                isOK = False
                Message = "異常：海外YKK表單限定勾選工廠自核!"
            End If
        ...
        If wStep = 1 Then
            ...
            If YKK.ReplaceString(DOverseaYKKCode.Text) <> "" Then
                SQL = "select no "
                SQL = SQL + " from F_NewColorOverSeaYKK"
                SQL = SQL + " where sts <> 2 and  overseaykkcode='" + YKK.ReplaceString(DOverseaYKKCode.Text) + "'"
