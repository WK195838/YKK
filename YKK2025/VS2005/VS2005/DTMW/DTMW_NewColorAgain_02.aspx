<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorAgain_02" aspCompat="True" CodeFile="DTMW_NewColorAgain_02.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorAgain.jpg" style="z-index: 100; left: 10px; position: absolute; top: 6px" />
           ...
           <asp:TextBox ID="DDyeTimes" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 119; left: 201px;
               position: absolute; top: 681px" Width="132px" MaxLength="2" onkeyup="return ValidateNumber(this,value)" ReadOnly="True"></asp:TextBox>
        ...
        <br />
           ...
           <asp:Label ID="LSheetName" runat="server" Font-Bold="True" Font-Size="Medium" Style="z-index: 160;
               left: 22px; position: absolute;TEXT-ALIGN: center; top: 69px" Text="Label" Width="665px"></asp:Label>
           &nbsp;&nbsp;&nbsp;<br />
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<br />
        <br />
        <br />
