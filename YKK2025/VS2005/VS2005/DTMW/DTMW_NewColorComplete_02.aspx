<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorComplete_02" aspCompat="True" CodeFile="DTMW_NewColorComplete_02.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           &nbsp; &nbsp;
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorComplete.jpg" style="z-index: 100; left: 10px; position: absolute; top: 6px" />
           <asp:DropDownList ID="DCheckType" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 101; left: 196px; position: absolute; top: 661px"
               Width="188px" AutoPostBack="True" Enabled="False">
           </asp:DropDownList><asp:DropDownList ID="DColor" runat="server" BackColor="Yellow" ForeColor="Blue"
           ...
           <asp:TextBox ID="DTMDays" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 121; left: 194px; position: absolute;
               top: 625px" Width="190px" ReadOnly="True"></asp:TextBox>
           &nbsp;
           <asp:TextBox ID="DCheckReason" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="57px" Style="z-index: 122; left: 192px; position: absolute;
               top: 692px" Width="487px" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
           <asp:TextBox ID="DColorTimes" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 123; left: 549px; position: absolute;
               top: 561px" Width="132px" MaxLength="2"  ReadOnly="True"></asp:TextBox>
               
                

           <asp:TextBox ID="DSampleTimes" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 124; left: 549px; position: absolute;
               top: 592px" Width="132px" MaxLength="2"  ReadOnly="True"></asp:TextBox>
        ...
        <br />
           ...
           <asp:Label ID="LSheetName" runat="server" Font-Bold="True" Font-Size="Medium" Style="z-index: 160;
               left: 18px; position: absolute;TEXT-ALIGN: center; top: 62px" Text="Label" Width="675px"></asp:Label>
           &nbsp;&nbsp;&nbsp;<br />
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<br />
        <br />
        <br />
