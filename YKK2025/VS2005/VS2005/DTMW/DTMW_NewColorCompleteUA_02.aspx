<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorCompleteUA_02" aspCompat="True" CodeFile="DTMW_NewColorCompleteUA_02.aspx.vb" %>
  	 ...
  	 <div>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorCompleteUA.jpg" style="z-index: 100; left: 10px; position: absolute; top: 6px" />
           ...
           <asp:TextBox ID="DCheckReason" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ...
               top: 725px" Width="487px" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>
        ...
        &nbsp;&nbsp;&nbsp;<br />
           <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="true"
               ShowSummary="false" Style="z-index: 136; left: 18px; position: absolute; top: 785px" />
