<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FormPicker.aspx.vb" Inherits="FormPicker" %>
...
<body>
    ...
    <div>
        ...
        <asp:ListBox ID="ListBox1" runat="server" BackColor="Yellow" Height="192px" Rows="3"
            SelectionMode="Multiple" Style="z-index: 101; left: 24px; position: absolute;
            top: 26px" Width="214px">
        </asp:ListBox>
        <asp:Button ID="BGo" runat="server" Style="z-index: 102; left: 245px; position: absolute;
            top: 29px" Text="Go" />
