<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorSheet01_03CFBP14" aspCompat="True" CodeFile="DTMW_NewColorSheet01_03CFBP14.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>新色依賴書拉鏈ZIPPER CHAIN (03 CF BP14)</title>
  	 ...
  	 <div>
           &nbsp;<div>
               ...
               <asp:TextBox ID="DSLDColor" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="5"
                   ...
                   Width="64px" ReadOnly="True"></asp:TextBox>
