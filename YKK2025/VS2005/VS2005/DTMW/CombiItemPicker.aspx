<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CombiItemPicker.aspx.vb" Inherits="CombiItemPicker" %>
...
<body>
    ...
    <div>
        ...
        <asp:ListBox ID="ListBox1" runat="server" BackColor="Yellow" Height="208px" Rows="3"
            SelectionMode="Multiple" Style="z-index: 101; left: 24px; position: absolute;
            top: 26px" Width="157px">
        </asp:ListBox>
        <asp:Button ID="BGo" runat="server" Style="z-index: 102; left: 189px; position: absolute;
            top: 30px" Text="Go" />
