...
Partial Class DTMW_NewColorSheet01_03CFPBR12
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "DTMW_NewColorSheet01_03CFPBR12.aspx"
    ...
    Sub ShowFormData()
        ...
        SQL = "Select * From F_NewColor03CFPBR12 "
        SQL = SQL & " Where FormNo =  '" & wFormNo & "'"
        SQL = SQL & "   And FormSno =  '" & CStr(wFormSno) & "'"
        Dim DBAdapter1 As DataTable = uDataBase.GetDataTable(SQL)
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        If wFormNo = "005004" Then
            LSheetName.Text = "拉鏈ZIPPER CHAIN (03 CF PBR12)" '表單名稱"
        End If
        ...
        Select Case FindFieldInf("Recolorcode")
            ...
            Case 1  '修改+檢查
                ...
                ShowRequiredFieldValidator("DRecolorcodeRqd", "DRecolorcode", "異常：需輸入回收紗對應KK色號")
                DRecolorcode.Visible = True
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("005004", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
            ...
            If ErrCode = 0 Then
                ...
                Else
                    If ((LastStep = 20 Or LastStep = 520 Or LastStep = 25 Or LastStep = 525 Or LastStep = 31) And pFun = "OK") Or ((LastStep = 25 Or LastStep = 520 Or LastStep = 525 Or LastStep = 31) And pFun = "NG2") Then '新色確認完成表按OK才進來
                        ...
                        SQL = " select  *  from F_NewColor03CFPBR12 a, F_NewColorComplete b"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        Dim SQl As String
        SQl = "Insert into F_NewColor03CFPBR12 "
        SQl = SQl + "( "
        ...
        SQl = SQl + "YKKColorType,YKKColorCode,Version,CheckNo,SLDColor," '31~35
        SQl = SQl + "VFCOLOR," '36
        ...
        SQl = SQl + " N'" + YKK.ReplaceString(DCustomerSample.SelectedValue.ToUpper) + "', "                ' 客戶樣品27
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        SQL = " Update F_NewColor03CFPBR12"
        SQL = SQL + " Set "
        If pFun <> "SAVE" Then
            SQL = SQL + " Sts = '" & pSts & "',"
        ...
        If wStep = 90 And DNewOldColor.SelectedValue = "新色" Then 'Master 建檔後轉資料到WINS COLOR STRUCTURE
            ...
            SQL = SQL + " where sts =1 and no = '" + DNo.Text + "' AND TYPE ='N1'"
            SQL = SQL + " )a"
            uDataBase.ExecuteNonQuery(SQL)
    ...
    Function SetNo(ByVal Seq As Integer) As String
        ...
        Dim sql As String
        sql = " select count(*)cun from  f_Newcolor03cfpbr12"
    ...
    Function OK() As Boolean
        ...
        If wStep = 1 Then
            ...
            SQL = SQL + " and Recolorcode='" + DRecolorcode.Text + "'"
            SQL = SQL + " and formno = '" + wFormNo + "'"
        ...
        If wStep = 1 Or wStep = 500 Then
            ...
            If Len(DRecolorcode.Text) <> 5 Then
                Message = "回收紗色號請填寫五碼T***R!"
                isOK = False
            End If
            If DRecolorcode.Text <> "" Then
                Dim NoStr As String = ""

                SQL = " select b.*,Recolorcode1 from ( "
                SQL = SQL + " select no,case when len(Recolorcode)=3 then 'T'+Recolorcode+'R' else Recolorcode end as Recolorcode1 from  v_newcolor"
                SQL = SQL + " where(sts <> 2)"
                SQL = SQL + " )a,v_newcolor b "
                SQL = SQL + " where a.no = b.no and  (Recolorcode1='" + DRecolorcode.Text + "' or  ykkcolorcode ='" + DRecolorcode.Text + "')"
                SQL = SQL + " and formno = '" + wFormNo + "'"
        ...
        If OverSeaYKK = 0 Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                If DVCACheck.Checked = False Then
                    ...
                    isOK = False
                    Message = Message + "異常：BUYER：Adidas/Reebok/Taylormade/Nike/Puma 限定勾選VCA!"
                End If
            End If
        End If
    ...
    Sub CheckDuplicateNo()
        ...
        Dim SQL As String
        SQL = "select no,customer,customercode,buyer,buyercode,customercolor,customercolorcode,overseaykkcode,pantonecode devyear,devseason "
        SQL = SQL + " from F_NewColor03CFPBR12"
