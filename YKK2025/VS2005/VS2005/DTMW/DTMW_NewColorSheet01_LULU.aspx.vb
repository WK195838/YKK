...
Partial Class DTMW_NewColorSheet01_LULU
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "DTMW_NewColorSheet01_LULU.aspx"
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        End Select
        If pPost = "New" Then DFactoryCheck.Checked = True
    ...
    Sub FlowControl(ByVal pFun As String, ByVal pAction As Integer, ByVal pSts As String)
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("005016", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9060
                End If
            End If
        ...
        If ErrCode = 0 Then
            ...
            While Run = True
                    ...
                    Else
                        If RepeatRun = False Then   '不是通知的重覆執行
                            ...
                            If wStep = 51 Then
                                ...
                                SQL1 = SQL1 + "    FormNo  = '005016'   And FormSno = '" + CStr(wFormSno) + "'   And Step = '52'   and  modifyuser <> 'Operation_02'  "
                            ...
                            If wStep = 52 Then
                                SQL1 = " Select step From T_WaitHandle Where  "
                                SQL1 = SQL1 + "    FormNo  = '005016'   And FormSno = '" + CStr(wFormSno) + "'   And Step = '51'  and  modifyuser <> 'Operation_02'  "
                                Dim dtFlow As DataTable = uDataBase.GetDataTable(SQL1)
                                If dtFlow.Rows.Count > 0 Then
                                    pRunNextStep = 1
                                Else
                ...
                If ErrCode = 0 And pRunNextStep = 1 Then
                    ...
                    '    Dim SQL1 As String
                    '    Dim DTNO As Integer
                    '    SQL1 = " select * from F_NewColorLULUDT"
            ...
            If ErrCode = 0 Then
                ...
                Else
                    ...
                    If ((wbStep = 20 Or wbStep = 520) And pFun = "OK") Or ((wbStep = 20 Or wbStep = 520) And pFun = "NG2") Then '新色確認完成表按OK才進來
                        Dim FormName As String
                        ...
                        SQL = " select  *  from F_NewColorLULU a, F_NewColorComplete b"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        ...
        Dim SQl As String
        SQl = "Insert into F_NewColorLULU "
        SQl = SQl + "( "
    ...
    Function SetNo(ByVal Seq As Integer) As String
        ...
        'Next
        'Str = Str + Str2
        Str = "O" + CStr(DateTime.Now.Year) + Str2
        '年
        'Set單號
        '當月份筆數有幾筆  20150414 Modify by Jessica
        SQL = " select   isnull(max(convert(int,substring(no,8,4))),0) cun from  F_NewColorLULU"
