...
Partial Class DTMW_NewColorAgain_02
    ...
    Sub ShowFormData()
        ...
        If DBAdapter2.Rows.Count > 0 Then
            ...
            DAgainSdate.Text = DBAdapter2.Rows(0).Item("AgainSdate")
            DAgainEDate.Text = DBAdapter2.Rows(0).Item("AgainEDate")
            DAgainDays.Text = DBAdapter2.Rows(0).Item("AgainDays")
            DDyeTimes.Text = DBAdapter2.Rows(0).Item("DyeTimes")
        End If
