<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorSheet02_03CFP12" aspCompat="True" CodeFile="DTMW_NewColorSheet02_03CFP12.aspx.vb" %>
  	 ...
  	 <div>
        ...
        <br />
           ...
           <asp:TextBox ID="D1" runat="server" BackColor="Transparent" BorderStyle="None"
               ForeColor="White" Height="24px" Style="z-index: 135; left: 768px; position: absolute;
