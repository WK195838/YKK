<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorSheet01_UAKIPLING" aspCompat="True" CodeFile="DTMW_NewColorSheet01_UAKIPLING.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           <asp:TextBox ID="DVFColor" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="5"
               onkeyup="return ValidateNumber1(this,value)" Style="z-index: 142; left: 472px;
               ime-mode: disabled; text-transform: uppercase; position: absolute; top: 992px"
               Width="111px"></asp:TextBox>
           <br />
