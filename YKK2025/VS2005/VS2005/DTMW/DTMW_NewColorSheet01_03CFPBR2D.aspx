<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorSheet01_03CFPBR2D" aspCompat="True" CodeFile="DTMW_NewColorSheet01_03CFPBR2D.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>新色依賴書拉鏈ZIPPER CHAIN (03 CF BR12)</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
          <div>
              &nbsp; &nbsp;
              <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorSheet10.jpg"
              ...
              <input id="BSLDColor" runat="server" style="z-index: 150; left: 528px; width: 24px;
                  position: absolute; top: 978px" type="button" value="..." />
              <asp:DropDownList ID="DAgain" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="20px" Style="z-index: 119; left: 560px; position: absolute; top: 980px"
                  Width="64px">
              </asp:DropDownList>
              &nbsp;&nbsp;
              ...
              <asp:DropDownList ID="DNewOldColor" runat="server" AutoPostBack="True" BackColor="Yellow"
                  ForeColor="Blue" Height="20px" Style="z-index: 102; left: 456px; position: absolute;
                  top: 880px" Width="117px">
              </asp:DropDownList>
              ...
              <input id="BCopySheet" runat="server" style="z-index: 158; left: 422px; width: 24px;
                  position: absolute; top: 184px" type="button" value="..." visible="true" />
              &nbsp;&nbsp;
              ...
              <asp:TextBox ID="DDepoName" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" Style="z-index: 108; left: 226px; position: absolute;
                  top: 218px" Width="219px"></asp:TextBox>
              <asp:TextBox ID="DCustomer" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" Style="z-index: 109; left: 226px; position: absolute;
                  top: 252px" Width="190px"></asp:TextBox>
              &nbsp;&nbsp;
              <asp:TextBox ID="DCustomerColor" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" MaxLength="25" Style="z-index: 110; left: 226px;
                  text-transform: uppercase; position: absolute; top: 318px" Width="219px"></asp:TextBox>
              ...
              <asp:TextBox ID="DBuyer" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
                  Height="24px" Style="z-index: 112; left: 226px; position: absolute; top: 285px"
                  Width="188px"></asp:TextBox>
              &nbsp; &nbsp;&nbsp;
              <asp:TextBox ID="DVersion" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" Style="z-index: 113; left: 508px; position: absolute;
                  top: 913px; text-align: center" Width="37px"></asp:TextBox>
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              <input id="DDeliveryDate" runat="server" name="DDeliveryDate" style="z-index: 154;
                  left: 604px; width: 91px; color: blue; border-top-style: groove; border-right-style: groove;
                  border-left-style: groove; position: absolute; top: 417px; background-color: yellow;
                  border-bottom-style: groove" type="text" />
              <input id="DPFBWire" runat="server" name="DDeliveryDate" style="z-index: 155; left: 456px;
                  width: 85px; color: blue; border-top-style: groove; border-right-style: groove;
                  border-left-style: groove; position: absolute; top: 748px; background-color: yellow;
                  border-bottom-style: groove" type="text" />
              <input id="DPFOpenParts" runat="server" name="DDeliveryDate" style="z-index: 156;
                  left: 456px; width: 85px; color: blue; border-top-style: groove; border-right-style: groove;
                  border-left-style: groove; position: absolute; top: 782px; background-color: yellow;
                  border-bottom-style: groove" type="text" />
              <input id="DYKKColorCode" runat="server" name="DDeliveryDate" style="z-index: 153;
                  left: 456px; width: 85px; color: blue; border-top-style: groove; border-right-style: groove;
                  border-left-style: groove; position: absolute; top: 847px; background-color: yellow;
                  border-bottom-style: groove" type="text" />
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
              <input id="BSAVE" runat="server" name="Button1" onclick="Button('SAVE');" style="z-index: 166;
                  left: 391px; width: 80px; position: absolute; top: 1121px; height: 28px" type="button"
                  value="儲存" />
              <input id="BNG2" runat="server" name="Button1" onclick="Button('NG2');" style="z-index: 165;
                  left: 559px; width: 80px; position: absolute; top: 1121px; height: 28px" type="button"
                  value="NG2" />
              <input id="BNG1" runat="server" name="Button1" onclick="Button('NG1');" style="z-index: 164;
                  left: 477px; width: 80px; position: absolute; top: 1121px; height: 28px" type="button"
                  value="NG1" />
              &nbsp;&nbsp;
              <input id="BOK" runat="server" name="BOK" onclick="Button('OK');" style="z-index: 163;
                  left: 642px; width: 80px; position: absolute; top: 1121px; height: 28px" type="button"
                  value="OK" />
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
              <input id="BCustomer" runat="server" style="z-index: 159; left: 420px; width: 24px;
                  position: absolute; top: 252px" type="button" value="..." />
              <input id="BBuyer" runat="server" style="z-index: 160; left: 420px; width: 24px;
              ...
              <asp:TextBox ID="DDate" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
                  Height="24px" Style="z-index: 114; left: 604px; position: absolute; top: 185px"
                  Width="115px"></asp:TextBox>
              <input id="BYKKColor" runat="server" style="z-index: 161; left: 548px; width: 24px;
                  position: absolute; top: 747px" type="button" value="..." />
              &nbsp;
              <input id="BYKKColorCode" runat="server" style="z-index: 157; left: 546px; width: 24px;
                  position: absolute; top: 845px" type="button" value="..." />
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              ...
              <asp:DropDownList ID="DDevSeason" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="20px" Style="z-index: 115; left: 336px; position: absolute; top: 417px"
                  Width="94px">
              </asp:DropDownList>
              <asp:DropDownList ID="DColorLight2" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="20px" Style="z-index: 116; left: 458px; position: absolute; top: 450px"
                  Width="124px">
              </asp:DropDownList>
              <asp:DropDownList ID="DColorLight1" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="20px" Style="z-index: 117; left: 226px; position: absolute; top: 450px"
                  Width="115px">
              </asp:DropDownList>
              ...
              <asp:DropDownList ID="DYKKColorType" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="20px" Style="z-index: 119; left: 456px; position: absolute; top: 814px"
                  Width="117px">
              </asp:DropDownList>
              <asp:DropDownList ID="DDevYear" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="20px" Style="z-index: 120; left: 226px; position: absolute; top: 417px"
                  Width="76px">
              </asp:DropDownList>
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              <asp:TextBox ID="DOverseaYKKCode" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" MaxLength="25" Style="z-index: 121; left: 226px;
              ...
              <asp:TextBox ID="DPANTONECode" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" MaxLength="25" Style="z-index: 122; left: 604px;
                  text-transform: uppercase; position: absolute; top: 365px" Width="117px"></asp:TextBox>
              &nbsp;
              <asp:TextBox ID="DCustomerColorCode" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" MaxLength="25" Style="z-index: 123; left: 604px;
                  text-transform: uppercase; position: absolute; top: 318px" Width="115px"></asp:TextBox>
              <asp:TextBox ID="DReceiveDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" Style="z-index: 124; left: 712px; position: absolute;
                  top: 488px" Width="70px"></asp:TextBox>
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
              <asp:TextBox ID="DName" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
                  Height="24px" Style="z-index: 125; left: 604px; position: absolute; top: 218px"
                  Width="115px"></asp:TextBox>
              <asp:TextBox ID="DCustomerCode" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" Style="z-index: 126; left: 604px; position: absolute;
                  top: 251px" Width="115px"></asp:TextBox>
              <asp:TextBox ID="DBuyerCode" runat="server" AutoCompleteType="Disabled" BackColor="Yellow"
                  BorderStyle="Groove" ForeColor="Blue" Height="24px" Style="z-index: 127; left: 604px;
                  position: absolute; top: 284px" Width="115px"></asp:TextBox>
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              <input id="BDate" runat="server" style="z-index: 162; left: 702px; width: 24px; position: absolute;
                  top: 415px" type="button" value="..." />
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp;&nbsp;
              <asp:TextBox ID="DNo" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
                  Height="24px" Style="z-index: 128; left: 226px; position: absolute; top: 185px"
              ...
              <asp:TextBox ID="DNOCCSReason" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="40px" MaxLength="255" Style="z-index: 130; left: 352px; position: absolute;
                  top: 480px" TextMode="MultiLine" Width="238px"></asp:TextBox>
              <asp:TextBox ID="DCustomerNGColor" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="25px" MaxLength="255" Style="z-index: 131; left: 226px; position: absolute;
                  top: 572px" TextMode="MultiLine" Width="580px"></asp:TextBox>
              <asp:TextBox ID="DRemark" runat="server" BackColor="Yellow" ForeColor="Blue" Height="41px"
                  MaxLength="255" Style="z-index: 132; left: 226px; position: absolute; top: 526px"
                  TextMode="MultiLine" Width="580px"></asp:TextBox>
              &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;<br />
              <img id="DDelay" runat="server" src="images/Sheet_Delay.jpg" style="z-index: 152;
              ...
              <asp:TextBox ID="DColorSystem" runat="server" BackColor="Yellow" ForeColor="Blue"
                  ...
                  left: 456px; ime-mode: disabled; text-transform: uppercase; position: absolute;
                  top: 715px" Width="78px"></asp:TextBox>
              &nbsp;
              <asp:TextBox ID="DCheckNo" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="2"
                  onkeyup="return ValidateNumber(this,value)" Style="z-index: 140; left: 456px;
              ...
              <asp:TextBox ID="DSLDColor" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="5"
                  onkeyup="return ValidateNumber1(this,value)" Style="z-index: 141; left: 456px;
                  ime-mode: disabled; text-transform: uppercase; position: absolute; top: 980px"
                  Width="64px"></asp:TextBox>
              <asp:TextBox ID="DVFColor" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="5"
                  onkeyup="return ValidateNumber1(this,value)" Style="z-index: 142; left: 456px;
                  ime-mode: disabled; text-transform: uppercase; position: absolute; top: 1013px"
                  Width="111px"></asp:TextBox>
              &nbsp;
              <br />
              <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="CustomValidator"
                  Style="z-index: 144; left: 41px; position: absolute; top: 1132px"></asp:CustomValidator>
              <br />
              <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 145; left: 571px;
              ...
              <asp:TextBox ID="DReason" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
                  Style="z-index: 146; left: 241px; position: absolute; top: 1357px" Visible="False"
                  Width="360px"></asp:TextBox>
              <asp:DropDownList ID="DReasonCode" runat="server" Height="20px" Style="z-index: 147;
              ...
              <asp:TextBox ID="DReasonDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
                  Height="56px" Style="z-index: 148; left: 175px; position: absolute; top: 1392px"
                  Visible="False" Width="432px"></asp:TextBox>
              &nbsp; &nbsp; &nbsp; &nbsp;<br />
              <asp:Label ID="LSheetName" runat="server" Font-Bold="True" Font-Size="Medium" Style="z-index: 149;
              ...
              <asp:TextBox ID="DRecolorcode" runat="server" BackColor="Yellow" BorderStyle="Groove"
                  ForeColor="Blue" Height="24px" MaxLength="5" Style="z-index: 150; left: 226px;
                  text-transform: uppercase; position: absolute; top: 385px" Width="219px"></asp:TextBox>
