<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorAgain_01" aspCompat="True" CodeFile="DTMW_NewColorAgain_01.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           &nbsp; &nbsp;
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorAgain.jpg" style="z-index: 100; left: 10px; position: absolute; top: 6px" />
           &nbsp;
           ...
           &nbsp; &nbsp; &nbsp;
           <asp:TextBox ID="DAgainDays" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 119; left: 201px; position: absolute;
               top: 649px" Width="132px" ReadOnly="True"></asp:TextBox>
           <asp:TextBox ID="DDyeTimes" runat="server" BackColor="GreenYellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 119; left: 201px;
               position: absolute; top: 681px" Width="132px" MaxLength="2" onkeyup="return ValidateNumber(this,value)"></asp:TextBox>
           <asp:TextBox ID="DAgainSdate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 120; left: 201px; position: absolute;
               top: 581px" Width="132px" ReadOnly="True"></asp:TextBox>
           <asp:TextBox ID="DAgainEDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 121; left: 201px; position: absolute;
               top: 616px" Width="132px" ReadOnly="True"></asp:TextBox>
           &nbsp; &nbsp; &nbsp;
           <asp:TextBox ID="DYKKColorType" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 125; left: 200px; position: absolute;
               top: 516px" Width="132px" ReadOnly="True"></asp:TextBox>
           <asp:TextBox ID="DYKKColorCode" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 126; left: 200px; position: absolute;
               top: 547px" Width="132px" ReadOnly="True"></asp:TextBox>
        ...
        <br />
           ...
           <asp:Label ID="LSheetName" runat="server" Font-Bold="True" Font-Size="Medium" Style="z-index: 160;
               left: 21px; position: absolute;TEXT-ALIGN: center; top: 66px" Text="Label" Width="667px"></asp:Label>
           &nbsp;&nbsp;<br />
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<br />
        <br />
        <br />
        ...
        <br />
           &nbsp; &nbsp;
        &nbsp;&nbsp;&nbsp;<br />
           <asp:Button ID="Button1" runat="server" Style="z-index: 135; left: 628px; position: absolute;
               top: 785px" Text="儲存" Width="53px" />
           <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="true"
               ShowSummary="false" Style="z-index: 136; left: 16px; position: absolute; top: 759px" />
