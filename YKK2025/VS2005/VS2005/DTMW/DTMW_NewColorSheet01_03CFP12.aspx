<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorSheet01_03CFP12" aspCompat="True" CodeFile="DTMW_NewColorSheet01_03CFP12.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           &nbsp; &nbsp;
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorSheet10.jpg" style="z-index: 100; left: 26px; position: absolute; top: 16px" />
           <input id="BSLDColor" runat="server" style="z-index: 150; left: 528px; width: 24px;
               position: absolute; top: 976px" type="button" value="..." />
           <asp:DropDownList ID="DAgain" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 119; left: 560px; position: absolute; top: 976px"
               Width="64px">
           </asp:DropDownList>
           ...
           &nbsp;&nbsp;
           <asp:CheckBox ID="DVCACheck" runat="server" Style="z-index: 105; left: 617px; position: absolute;
               top: 124px" Width="78px" Font-Size="Medium" Height="16px" Text="VCA" BorderStyle="None" Font-Bold="True" AutoPostBack="True" />
           <asp:CheckBox ID="DFactoryCheck" runat="server" Style="z-index: 106; left: 494px; position: absolute;
               top: 123px" Width="99px" Font-Size="Medium" Height="16px" Text="工廠自核" BorderStyle="None" Font-Bold="True" AutoPostBack="True" />
           <asp:CheckBox ID="DCustomerCheck" runat="server" Style="z-index: 107; left: 369px; position: absolute;
               top: 123px" Width="108px" Font-Size="Medium" Height="16px" Text="客戶自核" BorderStyle="None" Font-Bold="True" AutoPostBack="True" />
           ...
           <asp:TextBox ID="DCustomerColor" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 110; left: 218px; position: absolute;text-transform : uppercase;
               top: 320px" Width="219px" MaxLength="25"></asp:TextBox>
           <asp:CheckBox ID="DNOCCS" runat="server" Style="z-index: 111; left: 237px; position: absolute;
               top: 483px" Width="1px" Font-Size="Small" Height="1px" AutoPostBack="True" />
           <asp:TextBox ID="DBuyer" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 112; left: 218px; position: absolute;
               top: 287px" Width="188px"></asp:TextBox>
           &nbsp; &nbsp;&nbsp;
           <asp:TextBox ID="DVersion" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 113; left: 503px; position: absolute;TEXT-ALIGN: center;
               top: 916px" Width="37px"></asp:TextBox>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    
           <input id="DDeliveryDate" runat="server" style="z-index: 152; left: 600px; width: 91px;
            color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
            position: absolute; top: 417px; background-color: yellow; border-bottom-style: groove"
            type="text" name="DDeliveryDate" /><input id="DPFBWire" runat="server" style="z-index: 153; left: 453px; width: 85px;
            color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
            position: absolute; top: 747px; background-color: yellow; border-bottom-style: groove"
            type="text" name="DDeliveryDate" />
           <input id="DPFOpenParts" runat="server" style="z-index: 154; left: 453px; width: 85px;
            color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
            position: absolute; top: 778px; background-color: yellow; border-bottom-style: groove"
            type="text" name="DDeliveryDate" /><input id="DYKKColorCode" runat="server" style="z-index: 151; left: 453px; width: 85px;
            color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
            position: absolute; top: 843px; background-color: yellow; border-bottom-style: groove"
            type="text" name="DDeliveryDate" />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        ...
        <input id="BOK" runat="server" name="BOK" onclick="Button('OK');" style="z-index: 161;
           ...
           <input id="BCustomer" runat="server" style="z-index: 157; left: 414px; width: 24px;
            position: absolute; top: 252px" type="button" value="..." /><input id="BBuyer" runat="server" style="z-index: 158; left: 414px; width: 24px;
            position: absolute; top: 285px" type="button" value="..." />
           &nbsp;&nbsp;
           <asp:TextBox ID="DDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 114; left: 600px; position: absolute;
               top: 185px" Width="115px"></asp:TextBox>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:DropDownList ID="DDevSeason" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="20px" Style="z-index: 115; left: 325px; position: absolute;
            top: 416px" Width="94px">
           </asp:DropDownList>
           <asp:DropDownList ID="DColorLight2" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="20px" Style="z-index: 116; left: 458px; position: absolute;
            top: 449px" Width="124px">
           </asp:DropDownList>
           <asp:DropDownList ID="DColorLight1" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="20px" Style="z-index: 117; left: 218px; position: absolute;
            top: 450px" Width="115px">
           </asp:DropDownList><asp:DropDownList ID="DCustomerSample" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="25px" Style="z-index: 118; left: 65px; position: absolute;
            top: 749px" Width="221px">
           </asp:DropDownList>
           <asp:DropDownList ID="DYKKColorType" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="20px" Style="z-index: 119; left: 453px; position: absolute;
            top: 814px" Width="117px">
           </asp:DropDownList>
           <asp:DropDownList ID="DDevYear" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="20px" Style="z-index: 120; left: 218px; position: absolute;
            top: 416px" Width="76px">
           </asp:DropDownList>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <asp:TextBox ID="DReColorCode" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" MaxLength="5" Style="z-index: 121; left: 216px;
           ...
           <asp:TextBox ID="DPANTONECode" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 122; left: 600px; position: absolute;text-transform : uppercase;
               top: 366px" Width="117px" MaxLength="25"></asp:TextBox>
           &nbsp;
           <asp:TextBox ID="DCustomerColorCode" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 123; left: 599px; position: absolute;text-transform : uppercase;
               top: 315px" Width="115px" MaxLength="25"></asp:TextBox>
           ...
           &nbsp;
           &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           <input id="BDate" runat="server" style="z-index: 160; left: 692px; width: 24px;
            position: absolute; top: 414px" type="button" value="..." />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        ...
        <br />
           &nbsp;
           <asp:TextBox ID="DNOCCSReason" runat="server" BackColor="Yellow" ForeColor="Blue" Height="40px"
               Style="z-index: 130; left: 348px; position: absolute; top: 482px" TextMode="MultiLine"
               Width="238px" MaxLength="255"></asp:TextBox>
           <asp:TextBox ID="DCustomerNGColor" runat="server" BackColor="Yellow" ForeColor="Blue" Height="25px"
               Style="z-index: 131; left: 218px; position: absolute; top: 570px" TextMode="MultiLine"
               Width="580px" MaxLength="255"></asp:TextBox>
           <asp:TextBox ID="DRemark" runat="server" BackColor="Yellow" ForeColor="Blue" Height="41px"
               Style="z-index: 132; left: 218px; position: absolute; top: 524px" TextMode="MultiLine"
               Width="580px" MaxLength="255"></asp:TextBox>
           &nbsp;
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        ...
        <img id="DDelay" runat="server" src="images/Sheet_Delay.jpg" style="z-index: 150; left: 51px;
        ...
        <br />
        <br />
           &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="true" ShowSummary="false" style="z-index: 138; left: 42px; position: absolute; top: 1060px" />
           &nbsp;<br />
      
      <asp:TextBox ID="DColorSystem" runat="server" style="ime-mode:disabled; z-index: 139; left: 453px; text-transform : uppercase;position: absolute;top: 716px;" onkeyup="return ValidateNumber(this,value)" BackColor="Yellow" ForeColor="Blue" Width="78px" MaxLength="3" ></asp:TextBox>
           &nbsp;
               
           <asp:TextBox ID="DCheckNo" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="2" 
               onkeyup="return ValidateNumber(this,value)" Style="z-index: 140; left: 463px;text-transform : uppercase;
               ime-mode: disabled; position: absolute; top: 947px" Width="89px"></asp:TextBox>
           <asp:TextBox ID="DSLDColor" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="5"
               onkeyup="return ValidateNumber1(this,value)" Style="z-index: 141; left: 453px;text-transform : uppercase;
               ime-mode: disabled; position: absolute; top: 979px" Width="64px" ReadOnly="True"></asp:TextBox>
           <asp:TextBox ID="DVFColor" runat="server" BackColor="Yellow" ForeColor="Blue" MaxLength="5"
               onkeyup="return ValidateNumber1(this,value)" Style="z-index: 142; left: 453px;text-transform : uppercase;
               ime-mode: disabled; position: absolute; top: 1012px" Width="111px"></asp:TextBox>
                  
               
               
        <br />
         <asp:CustomValidator  ID="CustomValidator1" runat="server" ErrorMessage="CustomValidator" style="z-index: 143; left: 41px; position: absolute; top: 1132px"></asp:CustomValidator>
        <br />
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
           <asp:Label ID="LSheetName" runat="server" Font-Bold="True" Font-Size="Medium" Style="z-index: 148;
               left: 48px; position: absolute;TEXT-ALIGN: center; top: 90px" Text="Label" Width="753px"></asp:Label>
           &nbsp; &nbsp;&nbsp;&nbsp;
