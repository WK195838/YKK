<%@ Page Language="vb" AutoEventWireup="false" Inherits="DTMW_NewColorSheet01_TNF" aspCompat="True" CodeFile="DTMW_NewColorSheet01_TNF.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DTMW_NewColorSheetUA_06.jpg"
               Style="z-index: 100; left: 28px; position: absolute; top: 18px" /><input id="BSLDColor" runat="server" style="z-index: 150; left: 536px; width: 24px;
           ...
           <input id="BYKKColorCodeSLD" runat="server" style="z-index: 150; left: 568px; width: 24px;
