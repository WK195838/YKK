...
Partial Class IRWNOActivityCust02
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "IRWNOActivityCust02.aspx"     '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        '篩選資料
        Sql = "SELECT "
        Sql = Sql & "DepName + '-' + EmpName As DepName, CustName + '(' + CustCode + ')' As CustName, MM1_YES, MM1_NO, MM2_YES, MM2_NO, MM3_YES, MM3_NO, "
        ...
        Sql &= "'IRWNOActivityCust02.aspx?pUserID=" & UserID & "&pEmpID=' + EmpID as URL "
...
LBL_End:
    ...
    Protected Sub BExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=IRWNOActivityCustBuyerList02.xls")     '程式別不同
