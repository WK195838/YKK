...
Partial Class EMPList
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        js &= "window.opener.document.all.DDepName.value = '" & GridView1.SelectedRow.Cells(1).Text.Replace("&amp;", "&") & "';"
        js &= "window.opener.document.all.DAppName.value = '" & GridView1.SelectedRow.Cells(2).Text & "';"
        js &= "window.opener.document.all.DAppID.value = '" & GridView1.SelectedRow.Cells(4).Text & "';"
        '   js &= "window.opener.document.forms[0].submit();"
        js &= "window.close();"
