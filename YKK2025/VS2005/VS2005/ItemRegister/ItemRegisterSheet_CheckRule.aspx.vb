...
Partial Class ItemRegisterSheet_CheckRule
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            End If
            If wCust <> "" Then
                DCustomerCode.Text = wCust
                DCustomer.Text = "XXXXXX"
                DBuyerCode.Text = wBuyer
                DBuyer.Text = "XXXXXX"
            End If
    ...
    Sub SetParameter()
        ...
        wCust = Request.QueryString("pCust")        'Customer
        wBuyer = Request.QueryString("pBuyer")      'Buyer
    ...
    Public Function ItemNotProd(ByVal pCat As String) As Boolean
        ...
        If Not uError Then
            ...
            If dtRule.Rows.Count > 0 Then
                ...
                For i = 0 To dtRule.Rows.Count - 1
                    ...
                    End If
                    '
                    DRemark.Text = DRemark.Text & Chr(13) & dtRule.Rows(i)("cat") & "-" & dtRule.Rows(i)("rno") & "-" & dtRule.Rows(i)("subno")
                    '
                    If uRun Then
                        ...
                        If dtData.Rows(0)("result") = 0 Then
                            DRemark.Text = DRemark.Text & "→[Result]=[申請不可]" & "[" & dtRule.Rows(i)("MSG") & "]"
                            uError = True
                            Exit For
                        Else
                            DRemark.Text = DRemark.Text & "→[Result]=[申請可]" & "[符合限定ITEM/BUYER/CUSTIMER]"
                        End If
                    End If
                Next
            End If
        ...
        '
        If uError Then
            uJavaScript.PopMsg(Me, "申請=NG")
        Else
            uJavaScript.PopMsg(Me, "申請=OK")
        End If
        '
        Return uError
    End Function
    ...
    Public Function ErrorRule(ByVal pApply As String, ByVal pRule As String) As Boolean
        ...
        '    MsgBox("FALSE:[" & CheckMethod & ":" & pApply & "=" & pRule & "]")
        'Else
