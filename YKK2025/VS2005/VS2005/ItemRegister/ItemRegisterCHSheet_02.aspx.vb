...
Partial Class ItemRegisterCHSheet_02
    ...
    Sub SetParameter()
        ...
        '
        Response.Cookies("PGM").Value = "ItemRegisterCHSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        Dim PathOld2 As String = uCommon.GetAppSetting("ItemRegisterCHFilePath")
