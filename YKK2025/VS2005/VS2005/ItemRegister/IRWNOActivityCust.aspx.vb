...
Partial Class IRWNOActivityCust
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "IRWNOActivityCust.aspx"     '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        '
        Sql &= "'IRWNOActivityCust01.aspx?pUserID=" & UserID & "&pDataType=SALES" & "&pUID=' + LTRIM(RTRIM(STR([UNIQUE_ID]))) as URL "
        '
        Sql = Sql & "From V_IRWNOActivityCust_01 "
        Sql = Sql & "Where DataType = 'A' "
        Sql = Sql & "And DepName = 'SALES' "
...
LBL_End:
    ...
    Protected Sub GridView1_RowCreated1(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        If (e.Row.RowType = DataControlRowType.Header) Then
            ...
            If pTop10 = 1 Then
                If UCase(pFun) = "COUNT" Then
                    H4tc0.Text = "TOP-5 顧客　(NG件數排序)"
                Else
                    H4tc0.Text = "TOP-5 顧客　(NG% 排序)"
                End If
            Else
                H4tc0.Text = "ALL 顧客"
            End If
    ...
    Protected Sub BExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=IRWNOActivityCustList.xls")     '程式別不同
