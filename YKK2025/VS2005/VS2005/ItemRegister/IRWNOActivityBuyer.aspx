<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IRWNOActivityBuyer.aspx.vb" Inherits="IRWNOActivityBuyer" %>
...
<head id="Head1" runat="server">
    <title>ITEM No Activity Buyer</title>
</head>
<body>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    ...
    <asp:Label style="Z-INDEX: 103; LEFT: 468px; POSITION: absolute; TOP: 8px" id="Label3" runat="server" Font-Size="10pt" ForeColor="BLUE">% = NG比例 (標準15%)</asp:Label>

	<asp:hyperlink id="LViewAll" style="Z-INDEX: 102; LEFT: 52px; POSITION: absolute; TOP: 8px" runat="server"
				Width="88px" Height="16px" Font-Size="10pt" NavigateUrl="http://10.245.1.6/IRW/IRWNOActivityBuyer.aspx?pTop10=0" Target="_blank">全BUYER</asp:hyperlink>
