...
Partial Class IRWNOActivityBuyer
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "IRWNOActivityBuyer.aspx"     '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
        NowDateTime = Now.ToString("yyyy/MM/dd HH:mm:ss")   '現在日期時間
        UserID = Request.QueryString("pUserID")
        pTop10 = Request.QueryString("pTop10")
        ...
        Next
        '
        If UCase(pFun) = "COUNT" Then
            Label3.Text = "% = NG比例　(超過15%=紅字)"
        Else
            Label3.Text = "% = NG比例　(超過15%=紅字)"
        End If
    End Sub
    ...
    Sub ShowData()
        ...
        If pTop10 = 1 Then
            Sql = Sql & "Top 5 "
        End If
        Sql = Sql & "CustName, MM1_YES, MM1_NO, MM2_YES, MM2_NO, MM3_YES, MM3_NO, "
        ...
        Sql = Sql & "DepCode, DepName, "
        '
        Sql &= "'IRWNOActivityCust01.aspx?pUserID=" & UserID & "&pDataType=MKT" & "&pUID=' + LTRIM(RTRIM(STR([UNIQUE_ID]))) as URL "
        '
        Sql = Sql & "From V_IRWNOActivityCust_01 "
        Sql = Sql & "Where DataType = 'A' "
        Sql = Sql & "And DepName = 'MKT' "

        If UCase(pFun) = "COUNT" Then
            Sql = Sql & "Order By MM1_NO+MM2_NO+MM3_NO DESC "
        Else
...
LBL_End:
    ...
    Protected Sub GridView1_RowDataBound1(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            Next
            'JOY-ADD
            If InStr(e.Row.Cells(22).Text, "SALES") > 0 Then
                For i = 1 To 9
                ...
                Next
            End If
            If InStr(e.Row.Cells(22).Text, "MKT") > 0 Then
                For i = 1 To 9
    ...
    Protected Sub GridView1_RowCreated1(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowCreated
        If (e.Row.RowType = DataControlRowType.Header) Then
            ...
            If pTop10 = 1 Then
                If UCase(pFun) = "COUNT" Then
                    H4tc0.Text = "TOP-5 BUYER　(NG件數排序)"
                Else
                    H4tc0.Text = "TOP-5 BUYER　(NG% 排序)"
                End If
            Else
                H4tc0.Text = "ALL BUYER"
            End If
    ...
    Protected Sub BExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=IRWNOActivityBuyerList.xls")     '程式別不同
