<%@ Page Language="VB" AutoEventWireup="false" CodeFile="IRWNOActivityCust02.aspx.vb" Inherits="IRWNOActivityCust02" %>
...
<head id="Head1" runat="server">
    <title>ITEM No Activity Customer-02</title>
</head>
<body>
    ...
    <asp:Label style="Z-INDEX: 103; LEFT: 72px; POSITION: absolute; TOP: 8px" id="Label1" runat="server" Font-Size="10pt">YES = 有生產活動</asp:Label>
    <asp:Label style="Z-INDEX: 103; LEFT: 216px; POSITION: absolute; TOP: 8px" id="Label2" runat="server" Font-Size="10pt">NG = 無生產活動</asp:Label>
    <asp:Label style="Z-INDEX: 103; LEFT: 468px; POSITION: absolute; TOP: 8px" id="Label3" runat="server" Font-Size="10pt" ForeColor="Blue" Width="304px">% = NG比例　(排序=NG比例)(超過15%=紅字)</asp:Label>
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  Width="1200px" Style="z-index: 103; left: 0px; position: absolute; top: 25px" CellPadding="3" Font-Size="10pt" GridLines="Vertical" PageSize="200" ForeColor="Black" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" >
            <Columns>
                ...
                <asp:BoundField DataField="CustName" HeaderText="" ItemStyle-HorizontalAlign="Left"/> 
