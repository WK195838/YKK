<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OR2PRforVF.aspx.vb" Inherits="OR2PRforVF" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            PageSize="20" Style="z-index: 114; left: 16px; position: absolute; top: 56px"
            Width="800px">
