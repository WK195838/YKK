...
Partial Class IRWPriceUseRate01
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "IRWPriceUseRate01.aspx"     '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        Sql = Sql & "DepCode, "
        '
        Sql &= "'IRWPriceUseRate02.aspx?pUserID=" & UserID & "&pDepCode=' + DepCode as URL "
        '
...
LBL_End:
    ...
    Protected Sub BExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=IRWPriceUseRateList01.xls")     '程式別不同
