...
Partial Class ItemRegisterSLDSheet_02
    ...
    Sub SetParameter()
        ...
        '
        Response.Cookies("PGM").Value = "ItemRegisterSLDSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        'jessia 20220304 modify
        Dim PathOld1 As String = uCommon.GetAppSetting("HttpOld")
        Dim PathOld2 As String = uCommon.GetAppSetting("ItemRegisterSLDFilePath")
