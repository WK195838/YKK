...
Partial Class ItemRegisterSLDSheet_01
    ...
    '*****************************************************************
    Sub GetData()
        Dim xFormSno As Integer = wFormSno
        Dim SQL As String = ""
        If wFormSno > 0 And wStep > 3 Then    '判斷是否[簽核]
            SQL = "Select No From F_ItemRegisterSLDSheet "
        ...
        SQL = SQL & "Where Sts = 0 "
        SQL = SQL & "  And DTDataType  = '1' "
        SQL = SQL & "  And SLDApply = '1' "
    ...
    Sub SetParameter()
        ...
        '
        Response.Cookies("PGM").Value = "ItemRegisterSLDSheet_01.aspx"
    ...
    '*****************************************************************
    Sub ShowFormData()
        Dim Path As String = uCommon.GetAppSetting("Http") & uCommon.GetAppSetting("ItemRegisterSLDFilePath")
        Dim SQL As String
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(uCommon.GetAppSetting("ItemRegisterSLDFilePath"))
        ...
        Dim sql As String = ""
        sql = "INSERT INTO F_ItemRegisterSLDSheet ( " & _
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        sql = "Update F_ItemRegisterSLDSheet Set "
        If pFun <> "SAVE" Then
            sql &= " Sts = '" & pSts & "',"
    ...
    Function InputDataOK(ByVal pAction As Integer) As Boolean
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("001153", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9050
                End If
            End If
