<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ItemRegisterCHSheet_02.aspx.vb" Inherits="ItemRegisterCHSheet_02" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Wave's Item登錄申請單(CH)</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <img src="images/RegisterCHSheet_001.jpg" style="z-index: 1; left: 6px; position: absolute;top: 7px" />
        ...
        <img src="images/RegisterCHSheet_002.jpg" style="z-index: 1; left: 6px; position: absolute;top: 449px" id="DRemarkSheet" runat="server" />
        &nbsp;
        <asp:HyperLink ID="LAttachfile1" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="BoardEdit.aspx"
            Style="z-index: 124; left: 122px; position: absolute; top: 510px" Target="_blank"
        ...
        <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None"
            ...
            position: absolute; top: 456px; text-align: left" Width="583px" MaxLength="100" TextMode="MultiLine"></asp:TextBox>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#400040"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="DTItemName" HeaderText="ItemName(CH)" >
                </asp:BoundField>
            </Columns>
