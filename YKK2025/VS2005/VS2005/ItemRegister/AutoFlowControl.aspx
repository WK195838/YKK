<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AutoFlowControl.aspx.vb" Inherits="AutoFlowControl" %>
...
<body>
    ...
    <div>
        <asp:TextBox ID="DSProgressBar" runat="server" AutoPostBack="True" BackColor="#FFFF80"
            ...
            Width="849px">批次自動簽核處理中..........</asp:TextBox>
        <asp:TextBox ID="DEProgressBar" runat="server" AutoPostBack="True" BackColor="#FFFF80"
            ...
            text-align: left" Width="849px">批次自動簽核處理中..........</asp:TextBox>
