<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ItemRegisterFSLDSheet_01.aspx.vb" Inherits="ItemRegisterFSLDSheet_01" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="DDate" runat="server" AutoPostBack="True" BackColor="#C0FFFF" BorderStyle="None"
            ...
            position: absolute; top: 77px; text-align: left" Width="226px"></asp:TextBox>
        <asp:TextBox ID="DJobTitle" runat="server" AutoPostBack="True" BackColor="#C0FFFF"
            ...
            left: 116px; position: absolute; top: 104px; text-align: left" Width="226px"></asp:TextBox>
        ...
        <asp:FileUpload ID="DAttachfile1" runat="server" style="z-index: 121; left: 114px;
            width: 588px; position: absolute; top: 179px; height: 24px; background-color: #C0FFFF"/>
        ...
        <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None"
            ...
            position: absolute; top: 129px; text-align: left" Width="584px" MaxLength="100" TextMode="MultiLine"></asp:TextBox>
        ...
        <asp:TextBox ID="DReason" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
            Style="z-index: 133; left: 232px; position: absolute; top: 288px" Visible="False"
        ...
        </asp:DropDownList><span lang="EN-US" style="font-size: 12pt; color: black; font-family: 細明體;
            mso-bidi-font-family: 新細明體; mso-ansi-language: EN-US; mso-fareast-language: ZH-TW;
            mso-bidi-language: AR-SA">(</span><span style="font-size: 12pt; color: black; font-family: 細明體;
                mso-bidi-font-family: 新細明體; mso-ansi-language: EN-US; mso-fareast-language: ZH-TW;
                mso-bidi-language: AR-SA">拉鍊成品下階<asp:DropDownList ID="DTYPE" runat="server" Height="20px" Style="z-index: 134;
            left: 8px; position: absolute; top: 48px" Width="136px" BackColor="#C0FFFF" CausesValidation="True">
                </asp:DropDownList>
            </span>
