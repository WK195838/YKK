<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ItemRegisterZIPSheet_01.aspx.vb" Inherits="ItemRegisterZIPSheet_01" %>
...
<body>
    ...
    <div>
        ...
        <img src="images/RegisterZIPSheet_002.jpg" style="z-index: 1; left: 6px; position: absolute;top: 733px" id="DRemarkSheet" runat="server" />
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BorderColor="#400040"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SLD" HeaderText="SLD" >
                </asp:BoundField>
