<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ItemRegisterSheet_03.aspx.vb" Inherits="ItemRegisterSheet_03" %>
...
<head runat="server">
    <title>Wave's Item登錄申請單</title>
		...
		<script language="javascript" type="text/javascript">
            ...
            function SetCustUnd(){
                var res = document.getElementById("DCustUnd").checked;
                if (res) {
                    document.getElementById("DOrderDate").value="確認客戶了解";
                }
                else {
                    document.getElementById("DOrderDate").value="";
                }
            }
		</script>
...
<body>
    ...
    <div id="DIV1" >
        ...
        <asp:TextBox ID="DDivision" runat="server" AutoPostBack="True" BackColor="#C0FFFF"
            BorderStyle="None" ForeColor="Black" Height="20px" MaxLength="7" Style="z-index: 126;
            left: 452px; position: absolute; top: 100px; text-align: left" Width="100px"></asp:TextBox>
        ...
        <asp:HyperLink ID="LEDXLink1" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="BoardEdit.aspx"
            Style="z-index: 124; left: 808px; position: absolute; top: 112px" Target="_blank"
            Width="100px">EDX (Click)</asp:HyperLink>
        ...
        <asp:TextBox ID="DSRequest1" runat="server" BackColor="#C0FFFF" BorderStyle="None"
            ForeColor="Red" Height="20px" Style="z-index: 126; left: 410px;
            position: absolute; top: 499px; text-align: left" Width="289px" MaxLength="17"></asp:TextBox>
        ...
        <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None"
            ...
            position: absolute; top: 874px; text-align: left" Width="479px" MaxLength="100" TextMode="MultiLine"></asp:TextBox>
        ...
        <asp:Button ID="BOK" runat="server" Height="23px" Style="z-index: 131;
            left: 624px; position: absolute; top: 1176px" Text="OK" Width="80px" OnClientClick="return ConfirmMe(this)" UseSubmitBehavior="false"/>
        ...
        <asp:TextBox ID="DDecideDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
            Height="56px" Style="z-index: 132; left: 56px; position: absolute; top: 990px"
        ...
        <input id="DStatusItem" runat="server" name="Hidden2" style="z-index: 174; left: 57px;
            width: 31px; position: absolute; top: 46px" type="hidden" />
        <input id="DWarnMsg" runat="server" name="Hidden3" style="z-index: 174; left: 1200px;
            width: 31px; position: absolute; top: 46px" type="hidden" />
        &nbsp;
        ...
        <asp:TextBox ID="DBuyer" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
            Height="24px" Style="z-index: 108; left: 182px; position: absolute; top: 802px"
        ...
        <asp:DropDownList ID="DForUse" runat="server" Height="20px" Style="z-index: 134;
        ...
        <!--************************************************************ 
            ** 防止重覆按 [BUTTON 2 次]                               **     
            ************************************************************ -->
            <asp:TextBox ID="DPerformaceUp" runat="server" Style="z-index: 126; left: 712px;position: absolute; top: 216px; text-align: left" Width="64px" BackColor="#FFFFC0"></asp:TextBox>
        ...
        <asp:Button ID="BSUITABLE" runat="server" Height="22px" Style="z-index: 131;
            left: -706px; position: absolute; top: 136px" Text="販賣實績" Width="80px" Enabled="False" />
        ...
        <asp:Button ID="BSPDNO" runat="server" CausesValidation="False" Height="22px" Style="z-index: 131;
            left: 706px; position: absolute; top: 160px" Text="開發資料" Width="80px" />

        <asp:TextBox ID="DSPDNOUrl" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
            Font-Bold="False" Font-Size="Medium" ForeColor="Black" Height="120px" Style="z-index: 103;
            left: 804px; position: absolute; top: 136px" Width="700px" TextMode="MultiLine"></asp:TextBox>

        <asp:TextBox ID="DProdReady" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
            Font-Bold="True" Font-Names="Times New Roman" Font-Size="11pt" ForeColor="White"
            Style="z-index: 100; left: -500px; position: absolute; top: 48px" Width="352px">生產可行性</asp:TextBox>

        <asp:TextBox ID="DSPDNO" runat="server" BackColor="#C0FFFF" BorderStyle="None"
            ForeColor="Blue" Height="20px" Style="z-index: 105; left: 554px; position: absolute;
            top: 100px" Width="144px"></asp:TextBox>

        <asp:HyperLink ID="CkLimitedLink" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="CkLimitedPage.aspx"
            Style="z-index: 124; left: 715px; position: absolute; top: 188px" Target="_blank"
            Visible="False" Width="72px">限定檢查</asp:HyperLink>

        
        <input id="DCustUnd" type="checkbox" runat="server" style="z-index: 174; left: 370px; position: absolute; top: 136px" onclick="SetCustUnd()" disabled="disabled"/>
        <asp:TextBox ID="LOrderDate" runat="server" BorderStyle="None"
            Font-Bold="False" Font-Size="10pt" ForeColor="Black" Height="16px" Style="z-index: 103;
            left: 392px; position: absolute; top: 136px" Width="70px" ReadOnly="True">客戶了解</asp:TextBox>
       
        <asp:TextBox ID="DOrderDate" runat="server" BackColor="yellow" BorderColor="Black" BorderStyle="Solid"
            Font-Bold="False" Font-Size="Medium" ForeColor="Red" Height="17px" Style="z-index: 103;
            left: 464px; position: absolute; top: 135px" Width="104px"></asp:TextBox>

        <asp:TextBox ID="HOrderDate" runat="server" BackColor="yellow" BorderColor="Black" BorderStyle="Solid"
            Font-Bold="true" Font-Size="Medium" ForeColor="Red" Height="24px" Style="z-index: 103;
            left: 704px; position: absolute; top: 104px" Width="104px">2023/12/31</asp:TextBox>
       

        <asp:Button ID="BSpecialShort" runat="server" CausesValidation="False" Height="40px" Style="z-index: 131;
            left: 704px; position: absolute; top: 32px" Text="特別要求/拉頭品名縮寫" Width="152px" />

        <!--************************************************************ 
            **  EDX                         **     
            ************************************************************ -->               
        <asp:HyperLink ID="LEDXRegister" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="BoardEdit.aspx"
            Style="z-index: 124; left: 896px; position: absolute; top: 40px" Target="_blank"
            Width="100px">EDX登錄單</asp:HyperLink>  
            
        <asp:TextBox ID="DEDXComment1" runat="server" Height="32px" Style="z-index: 318; left: 1000px;
            position: absolute; top: 40px;font-size:14px;background:transparent" Width="500px"   BorderStyle="None" BorderWidth="0px" TextMode="MultiLine">無法開啟時請複製以下連結至其它BROWSER使用</asp:TextBox>
        <asp:TextBox ID="DEDXComment2" runat="server" Height="24px" Style="z-index: 318; left: 1000px;
            position: absolute; top: 80px;font-size:14px;background:transparent" Width="500px"   BorderStyle="None" BorderWidth="0px">https://forms.office.com/r/MDyLjRE2V2</asp:TextBox>

        <!--************************************************************ 
            **  限定                         **     
            ************************************************************ -->   
        <asp:TextBox ID="DLimitedItem" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
            Font-Bold="False" Font-Size="Medium" ForeColor="Black" Height="448px" Style="z-index: 103;
            left: 808px; position: absolute; top: 264px" Width="700px" TextMode="MultiLine"></asp:TextBox>
        <!--************************************************************ 
            **  上次 CUSTOMER & BUYER                         **     
            ************************************************************ -->               
        <asp:TextBox ID="HCustomer" runat="server" BackColor="White" BorderStyle="None"
            ForeColor="Blue" Height="24px" Style="z-index: 105; left: 704px; position: absolute;
            top: 776px" Width="104px"></asp:TextBox>
        <asp:TextBox ID="HBuyer" runat="server" BackColor="White" BorderStyle="None" ForeColor="Blue"
            Height="24px" Style="z-index: 108; left: 704px; position: absolute; top: 808px"
            Width="104px"></asp:TextBox>

        <asp:TextBox ID="HCustomerCode" runat="server" BackColor="White" BorderStyle="None"
            ForeColor="Blue" Height="24px" Style="z-index: 122; left: 816px; position: absolute;
            top: 776px" Width="72px"></asp:TextBox>

        <asp:TextBox ID="HBuyerCode" runat="server" AutoCompleteType="Disabled" BackColor="White"
            BorderStyle="None" ForeColor="Blue" Height="24px" Style="z-index: 123; left: 816px;
            position: absolute; top: 808px" Width="72px"></asp:TextBox>

        <asp:Button ID="BLoadCustomerBuyer" runat="server" CausesValidation="False" Height="56px" Style="z-index: 131;
            left: 654px; position: absolute; top: 773px" Text="還原" Width="48px" />
        ...
        <!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
        <!-- ItenInf  -->
        <asp:TextBox ID="DItemInf" runat="server" Height="16px" Style="z-index: 318; left: 816px;
            position: absolute; top: 848px;font-size:10px;background:transparent" Width="584px"   BorderStyle="None" BorderWidth="0px"></asp:TextBox>
        <!-- ItenInf  -->
        <asp:TextBox ID="DNewItemInf" runat="server" Height="16px" Style="z-index: 318; left: 816px;
            position: absolute; top: 872px;font-size:10px;background:transparent" Width="584px"   BorderStyle="None" BorderWidth="0px"></asp:TextBox>
