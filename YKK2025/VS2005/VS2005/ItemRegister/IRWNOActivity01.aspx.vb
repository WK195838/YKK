...
Partial Class IRWNOActivity01
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "IRWNOActivity01.aspx"     '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Sub ShowData()
        ...
        Sql &= "'IRWNOActivity02.aspx?pUserID=" & UserID & "&pEmpID=' + EmpID as URL "
...
LBL_End:
    ...
    Protected Sub BExcel_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles BExcel.Click
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=IRWNOActivityList01.xls")     '程式別不同
