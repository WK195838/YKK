...
Partial Class ItemRegisterFSLDSheet_02
    ...
    Sub SetParameter()
        ...
        '
        Response.Cookies("PGM").Value = "ItemRegisterFSLDSheet_02.aspx"
    ...
    Sub ShowFormData()
        ...
        Dim PathOld2 As String = uCommon.GetAppSetting("ItemRegisterFSLDFilePath")
        ...
        If dtItemRegisterSheet.Rows.Count > 0 Then
            ...
            DTYPE.Text = dtItemRegisterSheet.Rows(0).Item("TYPE")
