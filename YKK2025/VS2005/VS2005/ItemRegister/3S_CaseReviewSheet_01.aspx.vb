...
Partial Class _3S_CaseReviewSheet_01
    ...
    Sub SetParameter()
        ...
        '
        Response.Cookies("PGM").Value = "3S_CaseReviewSheet_01.aspx"
    ...
    Sub SetFieldAttribute(ByVal pPost As String)
        ...
        Select Case FindFieldInf("Attachfile1")
            ...
            Case 1  '修改+檢查
                ShowRequiredFieldValidator("DAttachfileRqd", "DAttachfile1", "異常：需輸入機能設計書")
    ...
    Sub ShowFormData()
        ...
        LDownloadPage.Style("left") = -500 & "px"
    ...
    Sub AppendData(ByVal pFun As String, ByVal NewFormSno As Integer)
        Dim Path As String = Server.MapPath(uCommon.GetAppSetting("CaseReviewFilePath"))
        ...
        Dim sql As String = ""
        sql = "INSERT INTO F_CaseReviewSheet ( " & _
    ...
    Sub ModifyData(ByVal pFun As String, ByVal pSts As String)
        ...
        sql = "Update F_CaseReviewSheet Set "
        If pFun <> "SAVE" Then
            sql &= " Sts = '" & pSts & "',"
    ...
    Function InputDataOK(ByVal pAction As Integer) As Boolean
        ...
        If ErrCode = 0 Then
            If DAttachfile1.Visible Then
                ...
                Else
                    If pAction = 0 And wStep <> 30 Then
                        ErrCode = 9010
                    End If
                End If
            End If
        ...
        If ErrCode = 0 Then
            If DNo.Text <> "" Then
                ErrCode = oCommon.CommissionNo("001101", wFormSno, wStep, DNo.Text) '表單號碼, 表單流水號, 工程, 委託書No
                If ErrCode <> 0 Then
                    ErrCode = 9050
                End If
            End If
        ...
        If ErrCode <> 0 Then
            If ErrCode = 9010 Then Message = "無機能設計書檔案,請確認!"
