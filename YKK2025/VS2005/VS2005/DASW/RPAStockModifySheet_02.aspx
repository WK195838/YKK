<%@ Page Language="vb" AutoEventWireup="false" Inherits="RPAStockModifySheet_02" aspCompat="True" EnableEventValidation = "false"  CodeFile="RPAStockModifySheet_02.aspx.vb" %>
  	 ...
  	 <div>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<div>
               <img src="Images/RPAStockModify_02.jpg" style="z-index: 99; left: 8px; position: absolute;
                   top: 16px" />
               <asp:HyperLink ID="LFileUploadFile" runat="server" Style="z-index: 138; left: 144px; position: absolute;
                   top: 168px">附檔</asp:HyperLink>
               &nbsp; &nbsp;&nbsp;
               <asp:HyperLink ID="LRPAFILE" runat="server" Style="z-index: 138; left: 616px;
                   position: absolute; top: 304px" Visible="False">RPA回傳檔</asp:HyperLink><asp:TextBox ID="DDate" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   Height="20px" MaxLength="7" Style="z-index: 118; left: 136px; position: absolute;
                   top: 96px; text-align: left" Width="220px"></asp:TextBox>
               <asp:TextBox ID="DDepID" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   Height="24px" MaxLength="7" Style="z-index: 126; left: 136px; position: absolute;
                   top: 128px; text-align: left" Width="80px"></asp:TextBox>
               ...
               <asp:TextBox ID="DRPAReason" runat="server" BackColor="#C0FFFF" BorderStyle="None"
                   ForeColor="Black" Height="24px" MaxLength="7" Style="z-index: 121; left: 136px;
                   position: absolute; top: 200px; text-align: left" Width="560px"></asp:TextBox>
               <asp:TextBox ID="DRemark" runat="server" BackColor="#C0FFFF" BorderStyle="None" ForeColor="Black"
                   Height="50px" MaxLength="255" Style="z-index: 101; left: 136px; position: absolute;
                   top: 232px; text-align: left" TextMode="MultiLine" Width="560px"></asp:TextBox>
               &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
