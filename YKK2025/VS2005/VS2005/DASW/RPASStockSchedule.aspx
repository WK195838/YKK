<%@ Page Language="vb" AutoEventWireup="false" Inherits="RPASStockSchedule" aspCompat="True" EnableEventValidation = "false"  CodeFile="RPASStockSchedule.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           <asp:Label ID="Label1" runat="server" Style="z-index: 104; left: 288px; position: absolute;
               top: 8px" Text="RPA在庫申請" Font-Size="XX-Large"></asp:Label>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <asp:HyperLink ID="LFun01" runat="server" Enabled="False" Font-Size="12pt" Height="16px"
               Style="z-index: 102; left: 856px; position: absolute; top: 80px" Target="_self"
