<%@ Page Language="vb" AutoEventWireup="false" Inherits="RPAStockinqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="RPAStockinqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>RPA在庫修正申請</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 632px; POSITION: absolute; TOP: 96px" runat="server"
				ImageUrl="~/Images/msexcel.gif" Height="21px" Width="21px" Visible="False"></asp:imagebutton>
				<asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 32px; POSITION: absolute; TOP: 128px" runat="server"
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 584px; POSITION: absolute; TOP: 96px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/RPAStockINQ_01.jpg" Style="z-index: 99;
               left: 8px; position: absolute; top: 16px" />
           <asp:TextBox ID="DAEDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 110; left: 624px; position: absolute;
               top: 64px" Width="85px"></asp:TextBox>
           <asp:Button ID="BASDate" runat="server" Height="26px" Style="z-index: 111; left: 560px;
               position: absolute; top: 64px" Text="....." Width="28px" />
           <asp:Button ID="BAEDate" runat="server" Height="26px" Style="z-index: 112; left: 712px;
               position: absolute; top: 64px" Text="....." Width="28px" />
           ...
           <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 600px; position: absolute; top: 72px; text-align: center" Text="~" Width="6px"></asp:Label>
           &nbsp; &nbsp;&nbsp;&nbsp;
           <asp:DropDownList ID="DSTS" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 136px; position: absolute; top: 32px"
               Width="224px">
           ...
           &nbsp; &nbsp;
           <asp:DropDownList ID="DRPAReason" runat="server" AutoPostBack="True" BackColor="Yellow"
               ForeColor="Blue" Height="20px" Style="z-index: 259; left: 136px; position: absolute;
               top: 96px" Width="448px">
           </asp:DropDownList>
           &nbsp;
           <asp:TextBox ID="DAppName" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 260; left: 136px; position: absolute;
               top: 64px" Width="224px"></asp:TextBox>
           <asp:TextBox ID="DNo" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="24px" Style="z-index: 261; left: 472px; position: absolute; top: 32px"
