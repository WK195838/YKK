<%@ Page Language="vb" AutoEventWireup="false" Inherits="DASW_DISPOSALSheet01" aspCompat="True" CodeFile="DASW_DISPOSALSheet01.aspx.vb"  enableEventValidation="false" %>
  	 ...
  	 <div>
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Disposal_05.jpg" style="z-index: 100; left: 34px; position: absolute; top: 18px" />
           ...
           <asp:TextBox ID="DDepoName" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ...
               position: absolute; top: 135px" Width="120px"></asp:TextBox>
           &nbsp;&nbsp;
           ...
           <asp:DropDownList ID="DPLACE" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 104; left: 584px; position: absolute; top: 184px"
               Width="224px">
           </asp:DropDownList>
           <asp:DropDownList ID="DDISPOSALREASON" runat="server" BackColor="Yellow"
               ...
               top: 159px" Width="199px" AutoPostBack="True">
           </asp:DropDownList>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
           ...
           </asp:DropDownList><asp:DropDownList ID="DPCNAME1" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="20px" Style="z-index: 166; left: 1024px; position: absolute;
            top: 1008px" Width="106px" Visible="False">
           </asp:DropDownList>
           ...
           <asp:TextBox ID="DDecideDesc" runat="server" BackColor="Yellow" ForeColor="Blue" Height="58px"
               Style="z-index: 254; left: 105px; position: absolute; top: 1191px" TextMode="MultiLine"
        ...
        <input id="BSAVE" runat="server" name="Button1" onclick="Button('SAVE');" style="z-index: 292;
            left: 484px; width: 80px; position: absolute; top: 1381px; height: 28px" type="button"
            value="儲存" />
        <input id="BNG2" runat="server" name="Button1" onclick="Button('NG2');" style="z-index: 291;
            left: 652px; width: 80px; position: absolute; top: 1381px; height: 28px" type="button"
            value="NG2" />
        <input id="BNG1" runat="server" name="Button1" onclick="Button('NG1');" style="z-index: 290;
            left: 570px; width: 80px; position: absolute; top: 1381px; height: 28px" type="button"
            value="NG1" />
        &nbsp;&nbsp;
        <input id="BOK" runat="server" name="BOK" onclick="Button('OK');" style="z-index: 289;
            left: 735px; width: 80px; position: absolute; top: 1381px; height: 28px" type="button"
            value="OK"  />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
           ...
           <asp:TextBox ID="DAppDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 258; left: 456px; position: absolute;
               top: 136px" Width="120px"></asp:TextBox>
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <asp:TextBox ID="DSignDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               Font-Bold="False" ForeColor="Blue" Height="24px" Style="z-index: 260; left: 712px;
               position: absolute; top: 110px" Width="96px"></asp:TextBox>
        ...
        <img id="DDelay" runat="server" src="images/Sheet_Delay.jpg" style="z-index: 288; left: 59px;
            width: 592px; position: absolute; top: 1260px; height: 112px" visible="false" />
        <asp:TextBox ID="DReason" runat="server" BackColor="Yellow" ForeColor="Blue" Height="20px"
            Style="z-index: 267; left: 272px; position: absolute; top: 1281px" Visible="False"
            Width="360px"></asp:TextBox>
        <asp:DropDownList ID="DReasonCode" runat="server" Height="20px" Style="z-index: 268;
            left: 208px; position: absolute; top: 1281px" Visible="False" Width="64px">
            <asp:ListItem>01</asp:ListItem>
            <asp:ListItem>02</asp:ListItem>
        </asp:DropDownList>
        <asp:TextBox ID="DReasonDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
            Height="56px" Style="z-index: 269; left: 206px; position: absolute; top: 1316px"
        ...
        <asp:Label ID="DHistoryLabel" runat="server" Font-Names="新細明體" Font-Size="11pt" ForeColor="Blue"
            Height="16px" Style="z-index: 270; left: 50px; position: absolute; top: 1390px"
            Width="64px">核定履歷</asp:Label>
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White"
            BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="100px"
            Style="z-index: 271; left: 50px; position: absolute; top: 1417px" Width="780px">
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp;<br /><asp:DropDownList ID="DSTYPE" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 104; left: 712px; position: absolute; top: 136px"
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
           &nbsp; &nbsp;
           <img id="DDescSheet" runat="server" src="images/MapSheet_004.jpg" style="z-index: 99; left: 57px;
           ...
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:ListItem Value="1" Text="需立會" Selected="True"></asp:ListItem>
           ...
           <asp:TextBox ID="DPCNAME" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="24px" Style="z-index: 262; left: 704px; position: absolute;
               top: 936px" Width="104px"></asp:TextBox>
