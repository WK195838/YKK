<%@ Page Language="vb" AutoEventWireup="false" Inherits="NoComminqCommission" aspCompat="True" EnableEventValidation = "false"  CodeFile="NoComminqCommission.aspx.vb" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>No Comm報告書調閱資料</title>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        	<FONT face="新細明體"></FONT>
			<asp:imagebutton id="BExcel" style="Z-INDEX: 100; LEFT: 744px; POSITION: absolute; TOP: 192px" runat="server"
				ImageUrl="~/Images/msexcel.gif" Height="21px" Width="21px"></asp:imagebutton>
				<asp:datagrid id="DataGrid1" style="Z-INDEX: 101; LEFT: 16px; POSITION: absolute; TOP: 224px" runat="server"
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
			<asp:button id="Go" style="Z-INDEX: 121; LEFT: 688px; POSITION: absolute; TOP: 192px" runat="server"
           ...
           &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:Image ID="Image1" runat="server" ImageUrl="~/images/Nocomminq.jpg" Style="z-index: 99;
               left: 5px; position: absolute; top: 16px" />
           <asp:DropDownList ID="DDivision" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 257; left: 128px; position: absolute; top: 120px"
               Width="200px">
           </asp:DropDownList>        
           &nbsp;
           <asp:TextBox ID="DASDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ...
               top: 88px" Width="72px"></asp:TextBox>
           &nbsp; &nbsp; &nbsp;
           <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Size="Small" Style="z-index: 160;
               left: 232px; position: absolute; top: 96px; text-align: center" Text="~" Width="6px"></asp:Label>
           <asp:DropDownList ID="DProcess" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 256; left: 128px; position: absolute; top: 56px"
               Width="216px">
               </asp:DropDownList>
           <asp:TextBox ID="DAEDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 110; left: 248px; position: absolute;
               top: 88px" Width="75px"></asp:TextBox>
           <asp:Button ID="BASDate" runat="server" Height="26px" Style="z-index: 111; left: 200px;
               position: absolute; top: 88px" Text="..." Width="25px" />
           &nbsp;&nbsp;
           <asp:Button ID="BAEDate" runat="server" Height="26px" Style="z-index: 112; left: 328px;
               position: absolute; top: 88px" Text="..." Width="25px" />
           &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp;
           &nbsp; &nbsp;&nbsp;&nbsp;
           <asp:DropDownList ID="DSTS" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="20px" Style="z-index: 255; left: 464px; position: absolute; top: 56px"
               Width="200px">
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:TextBox ID="DEmpName" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 464px; position: absolute;
               top: 120px" Width="200px"></asp:TextBox>
           <asp:TextBox ID="DFormNo" runat="server" BackColor="Yellow" BorderStyle="Groove"
               ForeColor="Blue" Height="20px" Style="z-index: 113; left: 464px; position: absolute;
               top: 88px" Width="200px"></asp:TextBox>
           <asp:TextBox ID="DCust" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 128px; position: absolute; top: 152px"
               Width="200px"></asp:TextBox>
           <asp:TextBox ID="DORNO" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 464px; position: absolute; top: 152px"
               Width="200px"></asp:TextBox>
           <asp:TextBox ID="DQCNO" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
               Height="20px" Style="z-index: 113; left: 128px; position: absolute; top: 184px"
               Width="200px"></asp:TextBox>
           <asp:DropDownList ID="DSReason" runat="server" BackColor="Yellow" ForeColor="Blue"
               Height="24px" Style="z-index: 255; left: 472px; position: absolute; top: 184px"
               Width="192px">
           </asp:DropDownList>
           </div>
    </form>
