<%@ Page Language="vb" AutoEventWireup="false" Inherits="PNoCommList" aspCompat="True" EnableEventValidation = "false"  CodeFile="PNoCommList.aspx.vb" %>
  	...
  	<form id="Form1" runat="server">
  	 <div>
           ...
           <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
               ...
               Style="z-index: 103; left: 16px; position: absolute; top: 32px" Width="1464px">
               <RowStyle BackColor="#FFFF99" HorizontalAlign="Center" />
               <Columns>
                   <asp:BoundField DataField="ORD DATE" HeaderText="ORD DATE" />
           ...
           <asp:ImageButton ID="BExcel" runat="server" Height="21px" ImageUrl="~/Images/msexcel.gif"
               Style="z-index: 100; left: 24px; position: absolute; top: 8px" Width="21px" />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
