<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CommissionSheet_02.aspx.vb" Inherits="CommissionSheet_02" %>
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" Style="left: 0px; position: relative; top: 0px" Width="694px">
          <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/DevelopmentCommission_Blank.jpg" CausesValidation="False" />
          <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/ManufactureCommission_Button.jpg" style="left: -6px; position: relative; top: 0px" CausesValidation="False" />
          <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/DevelopmentSample_Button.jpg" style="left: -14px; position: relative; top: 0px" CausesValidation="False" />
          <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Images/DevelopmentGentani_Button.jpg" style="left: -22px; position: relative; top: 0px" CausesValidation="False" />
          <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Images/SignHistory_Button.jpg" style="left: -30px; position: relative; top: 0px" CausesValidation="False" EnableTheming="True" />
        </asp:Panel>
        <asp:HyperLink ID="NorderLink" runat="server" ImageUrl="~/Images/noorder.jpg"
            Style="z-index: 100; left: 136px; position: absolute; top: 45px" Target="_blank">HyperLink</asp:HyperLink>
        &nbsp;
        <!-- Panel End -->
        <!-- -->
        <!--************************************************************ 
...
<table border="0" style="width: 300px; height: 100px; position: relative;" cellpadding="0" cellspacing="0">
          ...
          <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DevelopmentCommission_04.jpg"
             Style="z-index: 99; left: 2px; position: absolute; top: -1px" />
        <asp:HyperLink ID="LGenFILE1" runat="server" Font-Size="12pt" Height="8px" Style="z-index: 261;
            left: 520px; position: absolute; top: 1368px" Target="_blank" Width="62px">原單位</asp:HyperLink>
  
        <asp:HyperLink ID="LFORCASTFILE" runat="server" Font-Size="12pt" Height="8px" Style="z-index: 261;
            left: 626px; position: absolute; top: 1336px" Target="_blank" Width="55px">報價單</asp:HyperLink>
        <asp:TextBox ID="DMANUOUTPRICE" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 499px;
            position: absolute; top: 1333px; text-align: left" Width="61px"></asp:TextBox>
           
        <asp:HyperLink ID="LFORTYPEFILE" runat="server" Font-Size="12pt" Height="8px" NavigateUrl=""
            Style="z-index: 261; left: 128px; position: absolute; top: 1288px" Target="_blank"
            Width="104px">適用型別</asp:HyperLink>
        <asp:HyperLink ID="LSAMPLECONFIRMFILE" runat="server" Font-Size="12pt" Height="8px" NavigateUrl=""
            Style="z-index: 261; left: 504px; position: absolute; top: 1288px" Target="_blank"
            Width="104px">樣品確認</asp:HyperLink>
        <asp:HyperLink ID="LQCCHECKFILE" runat="server" Font-Size="12pt" Height="8px" NavigateUrl=""
            Style="z-index: 261; left: 128px; position: absolute; top: 1312px" Target="_blank"
            Width="104px">品質檢測項目</asp:HyperLink>

        <asp:HyperLink ID="LMANUFAUTHORITYFILE" runat="server" Font-Size="12pt" Height="8px" NavigateUrl=""
            Style="z-index: 261; left: 504px; position: absolute; top: 1312px" Target="_blank"
        ...
        <asp:DropDownList ID="DLEVEL" runat="server" BackColor="LightGray" ForeColor="Blue"
            Height="22px" Style="z-index: 266; left: 125px; position: absolute; top: 1196px"
            Width="266px">
            <asp:ListItem Value="3">3</asp:ListItem>
        </asp:DropDownList>
        <asp:DropDownList ID="DMAKEMAP" runat="server" BackColor="LightGray" ForeColor="Blue"
            Height="22px" Style="z-index: 266; left: 501px; position: absolute; top: 1169px"
            Width="266px">
            <asp:ListItem Value="3">3</asp:ListItem>
        </asp:DropDownList>
        <asp:TextBox ID="DMAPNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" Style="z-index: 126; left: 125px;
            position: absolute; top: 1169px; text-align: left" Width="264px" MaxLength="20"  ></asp:TextBox>
        ...
        <asp:TextBox ID="DGMLEN" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px"  Style="z-index: 126; left: 376px;
            position: absolute; top: 1005px; text-align: center" Width="58px" MaxLength="12"  ></asp:TextBox>
        <asp:TextBox ID="DGMYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px"   Style="z-index: 126; left: 648px;
            position: absolute; top: 1005px; text-align: left" Width="120px" MaxLength="12"  ></asp:TextBox>
        <asp:TextBox ID="DGMCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px"   Style="z-index: 126; left: 560px;
            position: absolute; top: 1005px; text-align: left" Width="86px" MaxLength="20"  ></asp:TextBox>
        <asp:DropDownList ID="DGMCOL" runat="server" BackColor="LightGray" ForeColor="Blue"
            Height="22px" Style="z-index: 266; left: 440px; position: absolute; top: 1005px"
            Width="120px">
            <asp:ListItem Value="3">3</asp:ListItem>
        </asp:DropDownList>
        ...
        <asp:TextBox ID="DCMLEN" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px"   Style="z-index: 126; left: 376px;
            position: absolute; top: 901px; text-align: center" Width="58px" MaxLength="12"  ></asp:TextBox>
        <asp:TextBox ID="DCMYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px"   Style="z-index: 126; left: 648px;
            position: absolute; top: 901px; text-align: left" Width="120px" MaxLength="12"  ></asp:TextBox>
        <asp:TextBox ID="DCMCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px"   Style="z-index: 126; left: 560px;
            position: absolute; top: 901px; text-align: left" Width="86px" MaxLength="20"  ></asp:TextBox>
        <asp:DropDownList ID="DCMCOL" runat="server" BackColor="LightGray" ForeColor="Blue"
            Height="22px" Style="z-index: 266; left: 440px; position: absolute; top: 901px"
            Width="120px">
            <asp:ListItem Value="3">3</asp:ListItem>
        </asp:DropDownList>
        ...
        <asp:TextBox ID="DTHRLOYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="12" Style="z-index: 126; left: 524px;
            position: absolute; top: 772px; text-align: left" Width="116px"></asp:TextBox>
        <asp:TextBox ID="DTHLLOYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="12" Style="z-index: 126; left: 272px;
            position: absolute; top: 772px; text-align: left" Width="116px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTHLOYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="12" Style="z-index: 126; left: 124px;
            position: absolute; top: 772px; text-align: left" Width="140px"></asp:TextBox>
        <asp:TextBox ID="DTHRLOCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 586px;
            position: absolute; top: 746px; text-align: left" Width="54px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTHLLOCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 336px;
            position: absolute; top: 746px; text-align: left" Width="54px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTHLOCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 192px;
            position: absolute; top: 746px; text-align: left" Width="72px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTHUPCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 192px;
            position: absolute; top: 696px; text-align: left" Width="72px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTARYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="12" Style="z-index: 126; left: 524px;
            position: absolute; top: 640px; text-align: left" Width="240px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTAYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="12" Style="z-index: 126; left: 124px;
            position: absolute; top: 642px; text-align: left" Width="140px"></asp:TextBox>
        <asp:TextBox ID="DTARCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 656px;
            position: absolute; top: 616px; text-align: left" Width="108px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTALCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 408px;
            position: absolute; top: 616px; text-align: left" Width="104px"></asp:TextBox>
        ...
        <asp:TextBox ID="DTACOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="20" Style="z-index: 126; left: 192px;
            position: absolute; top: 616px; text-align: left" Width="72px"></asp:TextBox>
...
<asp:TextBox ID="DQCLT" runat="server" Height="20px" Style="z-index: 318; left: 128px;
            position: absolute; top: 1256px; text-align: right" Width="69px"   BorderStyle="None" BorderWidth="0px"></asp:TextBox>

        <asp:HyperLink ID="LQCFILE1" runat="server" Font-Size="12pt" Height="8px" Style="z-index: 261;
            left: 24px; position: absolute; top: 1424px" Target="_blank" Width="62px">QC文件</asp:HyperLink>
        ...
        <asp:HyperLink ID="LQCFILE5" runat="server" Font-Size="12pt" Height="8px" Style="z-index: 261;
            left: 528px; position: absolute; top: 1424px" Target="_blank" Width="62px">QC文件</asp:HyperLink>
...
-->
        ...
        <asp:HyperLink ID="LOldCSheet" runat="server" Font-Size="12pt" Height="8px"
            Style="z-index: 261; left: 16px; position: absolute; top: 48px" Target="_blank"
        ...
        <asp:TextBox ID="DTHUPYCOLNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" MaxLength="12" Style="z-index: 126; left: 124px;
            position: absolute; top: 720px; text-align: left" Width="140px"></asp:TextBox>
            <asp:Image ID="Image5" runat="server" ImageUrl="~/Images/CommissionSheet_A.JPG" Style="z-index: 257;            
            left: 224px; position: absolute; top: 1453px" />  
       ...
       <asp:HyperLink ID="HOP1" runat="server" Font-Size="10pt" Height="100px" 
        ...
        <asp:HyperLink ID="LOldMSheet" runat="server" Font-Size="12pt" Height="8px"
            Style="z-index: 261; left: 18px; position: absolute; top: 51px" Target="_blank"
            Width="104px">舊-製造委託書</asp:HyperLink>
       <asp:Image ID="Image6" runat="server" ImageUrl="~/Images/ManufactureSheet_A.JPG" Style="z-index: 257;
            left: 226px; position: absolute; top: 1352px" />
            ...
            <!-- +++++++++++++++++++++++++++++++++++++++++++++
              ...
              <asp:View ID="View3" runat="server">
				...
				<asp:hyperlink id="L3QCFILE5" style="Z-INDEX: 178; POSITION: absolute; TOP: 781px; LEFT: 148px"
					...
					Font-Size="12px" Width="116px"> </asp:label>
					<asp:dropdownlist ID="D3WF7Name" style="Z-INDEX: 169; POSITION: absolute; TOP: 1080px; LEFT: 674px"
					...
					runat="server" Font-Size="9pt" Width="74px" Height="22px" ForeColor="Blue" BackColor="Yellow">
				</asp:dropdownlist><asp:hyperlink id="L3QCFILE1" style="Z-INDEX: 160; POSITION: absolute; TOP: 724px; LEFT: 147px"
					...
					Width="324px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3O2ITEM" style="Z-INDEX: 145; POSITION: absolute; TOP: 987px; LEFT: 295px" runat="server"
					Width="324px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3O1ITEM" style="Z-INDEX: 146; POSITION: absolute; TOP: 963px; LEFT: 295px" runat="server"
					Width="324px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3CDITEM" style="Z-INDEX: 144; POSITION: absolute; TOP: 939px; LEFT: 295px" runat="server"
					Width="324px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3CSITEM" style="Z-INDEX: 143; POSITION: absolute; TOP: 915px; LEFT: 295px" runat="server"
					Width="324px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TDRITEM" style="Z-INDEX: 142; POSITION: absolute; TOP: 867px; LEFT: 525px"
					runat="server" Width="94px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TSRITEM" style="Z-INDEX: 141; POSITION: absolute; TOP: 843px; LEFT: 525px"
					runat="server" Width="94px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TNRITEM" style="Z-INDEX: 140; POSITION: absolute; TOP: 819px; LEFT: 525px"
					runat="server" Width="94px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3CNITEM" style="Z-INDEX: 139; POSITION: absolute; TOP: 891px; LEFT: 295px" runat="server"
					Width="324px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TDLITEM" style="Z-INDEX: 138; POSITION: absolute; TOP: 867px; LEFT: 295px"
					runat="server" Width="92px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TSLITEM" style="Z-INDEX: 137; POSITION: absolute; TOP: 843px; LEFT: 295px"
					runat="server" Width="92px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TNLITEM" style="Z-INDEX: 136; POSITION: absolute; TOP: 819px; LEFT: 295px"
					runat="server" Width="92px" Height="16px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox>
				<asp:hyperlink id="L3QCFILE2" style="Z-INDEX: 161; POSITION: absolute; TOP: 724px; LEFT: 524px"
					runat="server" Font-Size="12pt" Height="8px" Target="_blank" Width="121px">強度檔案</asp:hyperlink><asp:hyperlink id="L3QCFILE3" style="Z-INDEX: 163; POSITION: absolute; TOP: 754px; LEFT: 147px"
					runat="server" Font-Size="12pt" Height="8px" NavigateUrl="" Target="_blank">往覆測試檔案</asp:hyperlink><asp:hyperlink id="L3QCFILE4" style="Z-INDEX: 162; POSITION: absolute; TOP: 751px; LEFT: 524px"
				...
				<asp:textbox ID="D3OTHER" style="Z-INDEX: 130; POSITION: absolute; TOP: 634px; LEFT: 147px" runat="server"
					Width="640px" Height="76px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  
					TextMode="MultiLine"  > </asp:textbox><asp:textbox ID="D3THCOL" style="Z-INDEX: 129; POSITION: absolute; TOP: 578px; LEFT: 147px" runat="server"
					Width="640px" Height="45px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"   TextMode="MultiLine"  > </asp:textbox><asp:textbox ID="D3CCOL" style="Z-INDEX: 128; POSITION: absolute; TOP: 547px; LEFT: 147px" runat="server"
					Width="640px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3ECOL" style="Z-INDEX: 127; POSITION: absolute; TOP: 518px; LEFT: 147px" runat="server"
					Width="640px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TACOL" style="Z-INDEX: 126; POSITION: absolute; TOP: 402px; LEFT: 147px" runat="server"
					Width="640px" Height="48px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"   TextMode="MultiLine"  > </asp:textbox><asp:textbox ID="D3DEVPRD" style="Z-INDEX: 125; POSITION: absolute; TOP: 372px; LEFT: 609px" runat="server"
					Width="178px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3DEVNO" style="Z-INDEX: 124; POSITION: absolute; TOP: 372px; LEFT: 378px" runat="server"
					Width="115px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TAWIDTH" style="Z-INDEX: 123; POSITION: absolute; TOP: 372px; LEFT: 147px"
					runat="server" Width="85px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox>
				<asp:image id="LSAMPLEFILE" style="Z-INDEX: 121; POSITION: absolute; TOP: 220px; LEFT: 21px"
					...
					Width="220px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3ITEM" style="Z-INDEX: 119; POSITION: absolute; TOP: 144px; LEFT: 356px" runat="server"
					Width="200px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3SIZENO" style="Z-INDEX: 118; POSITION: absolute; TOP: 144px; LEFT: 146px" runat="server"
					Width="200px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3TALINE" style="Z-INDEX: 103; POSITION: absolute; TOP: 460px; LEFT: 147px" runat="server"
					Width="640px" Height="48px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"   TextMode="MultiLine"  > </asp:textbox><asp:textbox ID="D3DATE" style="Z-INDEX: 164; POSITION: absolute; TOP: 91px; LEFT: 671px" runat="server"
					Width="115px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox><asp:textbox ID="D3APPBUYER" style="Z-INDEX: 104; POSITION: absolute; TOP: 91px; LEFT: 147px"
					runat="server" Width="390px" Height="20px" ForeColor="Blue" BorderStyle="Groove" BackColor="LightGray"  > </asp:textbox>&nbsp;
     ...
     <asp:Image ID="Image8" runat="server" ImageUrl="~/Images/SampleSheet_A.JPG" Style="z-index: 257;
            left: 256px; position: absolute; top: 1146px" />   
                </table>
            ...
            <!-- +++++++++++++++++++++++++++++++++++++++++++++
              ...
              <asp:View ID="View4" runat="server">
               ...
               <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/DevelopmentGentani_03.png" Style="z-index: 99;
                    left: 0px; position: absolute; top: 0px" />
        <asp:Label ID="D4CSTHLRUPUN" runat="server" Style="z-index: 204; left: 464px; position: absolute;
            top: 884px"></asp:Label>
        <asp:Label ID="D4THLRLOCOLNO" runat="server" Style="z-index: 148; left: 243px; position: absolute;
            top: 994px"></asp:Label>
        <asp:Label ID="D4THRRLOCOLNO" runat="server" Style="z-index: 146; left: 243px; position: absolute;
            top: 1040px"></asp:Label>

     <asp:Label ID="D4NO" runat="server" Style="z-index: 100; left: 21px; position: absolute;
            top: 92px" Width="150px"></asp:Label>
        ...
        <asp:Label ID="D4ITEM" runat="server" Style="z-index: 103; left: 390px; position: absolute;
            top: 92px"></asp:Label>
        <asp:Label ID="D4CODENO" runat="server" Style="z-index: 104; left: 464px; position: absolute;
            top: 92px"></asp:Label>
        <asp:Label ID="D4LINENO1" runat="server" Style="z-index: 104; left: 536px; position: absolute;
            top: 92px"></asp:Label>
        <asp:Label ID="D4MANUFTYPE" runat="server" Style="z-index: 105; left: 464px; position: absolute;
            top: 112px"></asp:Label>
        ...
        <asp:Label ID="D4THRLOITEM" runat="server" Style="z-index: 145; left: 320px; position: absolute;
            top: 1016px" Text=""></asp:Label>
        <asp:Label ID="D4THRRLOITEM" runat="server" Style="z-index: 145; left: 312px; position: absolute;
            top: 1040px"></asp:Label>
        <asp:Label ID="D4THRLOCOLNO" runat="server" Style="z-index: 146; left: 243px; position: absolute;
            top: 1016px" Text=""></asp:Label>
        <asp:Label ID="D4THLLOITEM" runat="server" Style="z-index: 147; left: 320px; position: absolute;
            top: 976px" Text=""></asp:Label>
        <asp:Label ID="D4THLRLOITEM" runat="server" Style="z-index: 147; left: 320px; position: absolute;
            top: 994px"></asp:Label>
        <asp:Label ID="D4THLLOCOLNO" runat="server" Style="z-index: 148; left: 243px; position: absolute;
            top: 976px" Text=""></asp:Label>
        <asp:Label ID="D4THLOITEM" runat="server" Style="z-index: 149; left: 320px; position: absolute;
            top: 952px" Text=""></asp:Label>
        <asp:Label ID="D4THLOCOLNO" runat="server" Style="z-index: 150; left: 243px; position: absolute;
            top: 952px" Text=""></asp:Label>
        <asp:Label ID="D4THRUPITEM" runat="server" Style="z-index: 151; left: 320px; position: absolute;
            top: 904px" Text=""></asp:Label>
        <asp:Label ID="D4THRRUPITEM" runat="server" Style="z-index: 151; left: 320px; position: absolute;
            top: 928px"></asp:Label>
        <asp:Label ID="D4THRUPCOLNO" runat="server" Style="z-index: 152; left: 243px; position: absolute;
            top: 904px" Text=""></asp:Label>
        <asp:Label ID="D4THRRUPCOLNO" runat="server" Style="z-index: 152; left: 243px; position: absolute;
            top: 928px"></asp:Label>
        <asp:Label ID="D4THLUPITEM" runat="server" Style="z-index: 153; left: 320px; position: absolute;
            top: 864px" Text=""></asp:Label>
        <asp:Label ID="D4THLRUPITEM" runat="server" Style="z-index: 153; left: 320px; position: absolute;
            top: 884px"></asp:Label>
        <asp:Label ID="D4THLUPCOLNO" runat="server" Style="z-index: 154; left: 243px; position: absolute;
            top: 862px" Text=""></asp:Label>
        <asp:Label ID="D4THLRUPCOLNO" runat="server" Style="z-index: 154; left: 243px; position: absolute;
            top: 880px"></asp:Label>
        ...
        <asp:Label ID="D4THRLOCOL" runat="server" Style="z-index: 157; left: 93px; position: absolute;
            top: 1016px" Text=""></asp:Label>
        <asp:Label ID="D4THRRLOCOL" runat="server" Style="z-index: 157; left: 93px; position: absolute;
            top: 1040px"></asp:Label>
        <asp:Label ID="D4THLLOCOL" runat="server" Style="z-index: 158; left: 93px; position: absolute;
            top: 976px" Text=""></asp:Label>
        <asp:Label ID="D4THLRLOCOL" runat="server" Style="z-index: 158; left: 93px; position: absolute;
            top: 994px"></asp:Label>
        ...
        <asp:Label ID="D4THRUPCOL" runat="server" Style="z-index: 160; left: 93px; position: absolute;
            top: 904px" Text=""></asp:Label>
        <asp:Label ID="D4THRRUPCOL" runat="server" Style="z-index: 160; left: 93px; position: absolute;
            top: 928px"></asp:Label>
        <asp:Label ID="D4THLUPCOL" runat="server" Style="z-index: 161; left: 93px; position: absolute;
            top: 862px" Text=""></asp:Label>
        <asp:Label ID="D4THLRUPCOL" runat="server" Style="z-index: 161; left: 93px; position: absolute;
            top: 880px"></asp:Label>
        ...
        <asp:Label ID="D4COTAUN" runat="server" Style="z-index: 170; left: 539px; position: absolute;
            top: 752px" Text=""></asp:Label>
        <asp:Label ID="D4O2SUM" runat="server" Style="z-index: 171; left: 696px; position: absolute;
            top: 1064px" Text=""></asp:Label>
        <asp:Label ID="D4O2THRLOUN" runat="server" Style="z-index: 172; left: 688px; position: absolute;
            top: 1016px" Text=""></asp:Label>
        <asp:Label ID="D4O2THRRLOUN" runat="server" Style="z-index: 172; left: 688px; position: absolute;
            top: 1040px"></asp:Label>
        <asp:Label ID="D4O2THLLOUN" runat="server" Style="z-index: 173; left: 688px; position: absolute;
            top: 976px" Text=""></asp:Label>
        <asp:Label ID="D4O2THLRLOUN" runat="server" Style="z-index: 173; left: 688px; position: absolute;
            top: 994px"></asp:Label>
        <asp:Label ID="D4O1SUM" runat="server" Style="z-index: 174; left: 616px; position: absolute;
            top: 1064px" Text=""></asp:Label>
        <asp:Label ID="D4O1THRLOUN" runat="server" Style="z-index: 175; left: 613px; position: absolute;
            top: 1016px" Text=""></asp:Label>
        <asp:Label ID="D4O1THRRLOUN" runat="server" Style="z-index: 175; left: 613px; position: absolute;
            top: 1040px"></asp:Label>
        <asp:Label ID="D4O1THLLOUN" runat="server" Style="z-index: 176; left: 613px; position: absolute;
            top: 976px" Text=""></asp:Label>
        <asp:Label ID="D4O1THLRLOUN" runat="server" Style="z-index: 176; left: 613px; position: absolute;
            top: 994px"></asp:Label>
        <asp:Label ID="D4COTHRLOUN" runat="server" Style="z-index: 177; left: 541px; position: absolute;
            top: 1016px"></asp:Label>
        <asp:Label ID="D4COTHRRLOUN" runat="server" Style="z-index: 177; left: 541px; position: absolute;
            top: 1040px"></asp:Label>
        <asp:Label ID="D4COUNIT" runat="server" Style="z-index: 178; left: 544px; position: absolute;
            top: 1064px"></asp:Label>
        <asp:Label ID="D4COTHLLOUN" runat="server" Style="z-index: 179; left: 541px; position: absolute;
            top: 976px" Width="120px"></asp:Label>
        <asp:Label ID="D4COTHLRLOUN" runat="server" Style="z-index: 179; left: 541px; position: absolute;
            top: 994px" Width="120px"></asp:Label>
        <asp:Label ID="D4O2THRUPUN" runat="server" Style="z-index: 180; left: 688px; position: absolute;
            top: 904px" Text=""></asp:Label>
        <asp:Label ID="D4O2THRRUPUN" runat="server" Style="z-index: 180; left: 688px; position: absolute;
            top: 928px"></asp:Label>
        <asp:Label ID="D4O1THRRUPUN" runat="server" Style="z-index: 180; left: 613px; position: absolute;
            top: 928px" Width="56px"></asp:Label>
        <asp:Label ID="D4O2THLUPUN" runat="server" Style="z-index: 181; left: 688px; position: absolute;
            top: 864px" Text=""></asp:Label>
        <asp:Label ID="D4O2THLRUPUN" runat="server" Style="z-index: 181; left: 688px; position: absolute;
            top: 884px"></asp:Label>
        <asp:Label ID="D4O1THRUPUN" runat="server" Style="z-index: 182; left: 613px; position: absolute;
            top: 904px" Text=""></asp:Label>
        &nbsp;
        <asp:Label ID="D4O1THLUPUN" runat="server" Style="z-index: 183; left: 613px; position: absolute;
            top: 864px" Text=""></asp:Label>
        <asp:Label ID="D4O1THLRUPUN" runat="server" Style="z-index: 183; left: 613px; position: absolute;
            top: 884px"></asp:Label>
        &nbsp;
        <asp:Label ID="D4COTHRUPUN" runat="server" Style="z-index: 184; left: 541px; position: absolute;
            top: 904px" Text=""></asp:Label>
        <asp:Label ID="D4COTHRRUPUN" runat="server" Style="z-index: 184; left: 541px; position: absolute;
            top: 928px"></asp:Label>
        <asp:Label ID="D4COTHLUPUN" runat="server" Style="z-index: 185; left: 541px; position: absolute;
            top: 864px" Text=""></asp:Label>
        <asp:Label ID="D4COTHLRUPUN" runat="server" Style="z-index: 185; left: 541px; position: absolute;
            top: 884px"></asp:Label>
        <asp:Label ID="D4O2CUN" runat="server" Style="z-index: 186; left: 688px; position: absolute;
            top: 818px" Text=""></asp:Label>
        <asp:Label ID="D4O2MONOUN" runat="server" Style="z-index: 187; left: 688px; position: absolute;
            top: 800px" Text=""></asp:Label>
        ...
        <asp:Label ID="D4COCUN" runat="server" Style="z-index: 190; left: 541px; position: absolute;
            top: 818px" Text=""></asp:Label>
        <asp:Label ID="D4O2EUN" runat="server" Style="z-index: 191; left: 688px; position: absolute;
            top: 774px" Text=""></asp:Label>
        ...
        <asp:Label ID="D4COEUN" runat="server" Style="z-index: 193; left: 540px; position: absolute;
            top: 774px" Text=""></asp:Label>
        <asp:Label ID="D4O2TAUN" runat="server" Style="z-index: 194; left: 688px; position: absolute;
            top: 752px" Text=""></asp:Label>
        <asp:Label ID="D4O1TAUN" runat="server" Style="z-index: 196; left: 611px; position: absolute;
            top: 752px" Text=""></asp:Label>
        <asp:Label ID="D4CSUNIT" runat="server" Style="z-index: 197; left: 472px; position: absolute;
            top: 1064px" Text=""></asp:Label>
        <asp:Label ID="D4CSTHRLOUN" runat="server" Style="z-index: 198; left: 467px; position: absolute;
            top: 1016px" Text=""></asp:Label>
        <asp:Label ID="D4CSTHRRLOUN" runat="server" Style="z-index: 198; left: 467px; position: absolute;
            top: 1040px"></asp:Label>
        <asp:Label ID="D4CSTHLLOUN" runat="server" Style="z-index: 199; left: 467px; position: absolute;
            top: 976px" Width="120px"></asp:Label>
        <asp:Label ID="D4CSTHLRLOUN" runat="server" Style="z-index: 199; left: 467px; position: absolute;
            top: 994px" Width="120px"></asp:Label>
        <asp:Label ID="D4CLSUM" runat="server" Style="z-index: 200; left: 400px; position: absolute;
            top: 1064px" Text=""></asp:Label>
        <asp:Label ID="D4CLTHRLOUN" runat="server" Style="z-index: 201; left: 392px; position: absolute;
            top: 1016px" Width="128px"></asp:Label>
        <asp:Label ID="D4CLTHRRLOUN" runat="server" Style="z-index: 201; left: 392px; position: absolute;
            top: 1040px" Width="128px"></asp:Label>
        <asp:Label ID="D4CLTHLLOUN" runat="server" Style="z-index: 202; left: 392px; position: absolute;
            top: 976px" Width="120px"></asp:Label>
        <asp:Label ID="D4CLTHLRLOUN" runat="server" Style="z-index: 202; left: 392px; position: absolute;
            top: 994px" Width="120px"></asp:Label>
        <asp:Label ID="D4CSTHRUPUN" runat="server" Style="z-index: 203; left: 467px; position: absolute;
            top: 904px" Text=""></asp:Label>
        <asp:Label ID="D4CSTHRRUPUN" runat="server" Style="z-index: 203; left: 467px; position: absolute;
            top: 928px"></asp:Label>
        <asp:Label ID="D4CSTHLUPUN" runat="server" Style="z-index: 204; left: 467px; position: absolute;
            top: 864px" Text=""></asp:Label>
        <asp:Label ID="D4CLTHRUPUN" runat="server" Style="z-index: 205; left: 392px; position: absolute;
            top: 904px" Text=""></asp:Label>
        <asp:Label ID="D4CLTHRRUPUN" runat="server" Style="z-index: 205; left: 392px; position: absolute;
            top: 928px"></asp:Label>
        <asp:Label ID="D4CLTHLUPUN" runat="server" Style="z-index: 206; left: 392px; position: absolute;
            top: 864px" Text=""></asp:Label>
        <asp:Label ID="D4CLTHLRUPUN" runat="server" Style="z-index: 206; left: 392px; position: absolute;
            top: 884px"></asp:Label>
        <asp:Label ID="D4CSCUN" runat="server" Style="z-index: 207; left: 467px; position: absolute;
            top: 818px" Text=""></asp:Label>
        <asp:Label ID="D4CSEUN" runat="server" Style="z-index: 208; left: 467px; position: absolute;
            top: 774px" Text=""></asp:Label>
        ...
        <asp:Label ID="D4CLEUN" runat="server" Style="z-index: 211; left: 391px; position: absolute;
            top: 774px" Text=""></asp:Label>
        <asp:Label ID="D4CSTAUN" runat="server" Style="z-index: 212; left: 467px; position: absolute;
            top: 752px" Text=""></asp:Label>
        ...
        <asp:TextBox ID="D4OTHER1" runat="server" Height="38px" Style="z-index: 318; left: 704px;
          ...
          <asp:Image ID="Image7" runat="server" ImageUrl="~/Images/GentaniSheet_A.JPG" Style="z-index: 257;
            left: 216px; position: absolute; top: 1100px" />   
              </table>
            ...
            <asp:GridView style="Z-INDEX: 136; LEFT: 10px; POSITION: absolute; top: 50px" id="GridView1" runat="server" Width="1000px" Height="100px" BorderStyle="Groove" BackColor="White" BorderColor="#CC9966" CellPadding="4" BorderWidth="1px" AutoGenerateColumns="False">
