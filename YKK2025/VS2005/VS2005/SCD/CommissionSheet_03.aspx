<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CommissionSheet_03.aspx.vb" Inherits="CommissionSheet_03" %>
...
<table border="0" style="width: 300px; height: 100px; position: relative;" cellpadding="0" cellspacing="0">
          ...
          <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DevelopmentCommission_03.jpg"
        ...
        <asp:DropDownList ID="DLEVEL" runat="server" BackColor="LightGray" ForeColor="Blue"
            Height="22px" Style="z-index: 266; left: 128px; position: absolute; top: 1196px"
            Width="266px">
            <asp:ListItem Value="3">3</asp:ListItem>
        </asp:DropDownList>
        <asp:DropDownList ID="DMAKEMAP" runat="server" BackColor="LightGray" ForeColor="Blue"
            Height="22px" Style="z-index: 266; left: 504px; position: absolute; top: 1170px"
            Width="266px">
            <asp:ListItem Value="3">3</asp:ListItem>
        </asp:DropDownList>
        <asp:TextBox ID="DMAPNO" runat="server" BackColor="LightGray" BorderStyle="None"
            ForeColor="Black" Height="20px" Style="z-index: 126; left: 126px;
...
<asp:TextBox ID="DQCLT" runat="server" Height="20px" Style="z-index: 318; left: 128px;
        ...
        <asp:HyperLink ID="LQCFILE2" runat="server" Font-Size="12pt" Height="8px" Style="z-index: 261;
            left: 152px; position: absolute; top: 1424px" Target="_blank" Width="62px">QC文件</asp:HyperLink>
        ...
        <asp:HyperLink ID="LQCFILE6" runat="server" Font-Size="12pt" Height="8px" Style="z-index: 261;
            left: 656px; position: absolute; top: 1424px" Target="_blank" Width="62px">QC文件</asp:HyperLink>
...
-->
     ...
     <asp:Label ID="D4NO" runat="server" Style="z-index: 100; left: 21px; position: absolute;
            top: 92px" Width="168px"></asp:Label>
        <asp:Label ID="D4LINO1" runat="server" Style="z-index: 100; left: 536px; position: absolute;
            top: 92px" Width="40px"></asp:Label>
