<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CommissionSheet_01.aspx.vb" Inherits="CommissionSheet_01" %>
...
<table border="0" style="width: 300px; height: 100px; position: relative;" cellpadding="0" cellspacing="0">
       ...
       <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/DevelopmentCommission_04.jpg"
        ...
        <asp:FileUpload ID="DGenFILE1" runat="server" BackColor="LightGray" Height="20px"
            Style="z-index: 121; left: 520px; position: absolute; top: 1368px; background-color: #c0ffff"
            Width="123px" />
        ...
        <asp:FileUpload ID="DMANUFAUTHORITYFILE" runat="server" BackColor="LightGray" Height="20px"
            ...
            Width="267px" /><asp:FileUpload ID="DFORCASTFILE" runat="server" BackColor="LightGray" Height="20px"
            Style="z-index: 121; left: 630px; position: absolute; top: 1334px; background-color: #c0ffff"
            Width="141px" />
        <asp:HyperLink ID="LMANUFAUTHORITYFILE" runat="server" Font-Size="12pt" Height="8px"
            NavigateUrl="" Style="z-index: 261; left: 504px; position: absolute; top: 1306px"
            Target="_blank" Width="104px">製造授權</asp:HyperLink>
        <asp:HyperLink ID="LFORCASTFILE" runat="server" Font-Size="12pt" Height="8px"
            Style="z-index: 261; left: 626px; position: absolute; top: 1336px" Target="_blank"
            Width="55px">報價單</asp:HyperLink>
...
<asp:TextBox ID="DQCLT" runat="server" Height="20px" Style="z-index: 318; left: 128px;
        ...
        <asp:FileUpload ID="DQCFILE1" runat="server" BackColor="LightGray" Height="20px"
            Style="z-index: 121; left: 16px; position: absolute; top: 1424px; background-color: #c0ffff"
            Width="123px" />
       ...
       <asp:HyperLink ID="HOP7" runat="server" Font-Size="10pt" Height="100px"
        ...
        <asp:FileUpload ID="DHINTFILE" runat="server" BackColor="LightGray" Height="20px"
            style="z-index: 260; left: 20px; width: 201px; position: absolute; top: 323px; height: 20px;"
            Width="644px" />
            
        <asp:Image ID="LHINTFILE" runat="server" BorderStyle="Groove" Height="145px" ImageUrl=""
        ...
        <asp:CheckBox ID="DOP40" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 550px" Font-Size="9pt" Width="71px" />
        <asp:CheckBox ID="DOP50" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 654px" Font-Size="9pt" Width="71px" />
        <asp:CheckBox ID="DOP60" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 758px" Font-Size="9pt" Width="71px" />
        <asp:CheckBox ID="DOP70" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 862px" Font-Size="9pt" Width="71px" />
        <asp:CheckBox ID="DOP80" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 966px" Font-Size="9pt" Width="71px" />
        <asp:CheckBox ID="DOP90" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 1070px" Font-Size="9pt" Width="71px" />
        <asp:CheckBox ID="DOP100" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 1174px" Font-Size="9pt" Width="71px" />
        <asp:CheckBox ID="DOP110" runat="server" style="z-index: 174; left: 102px; position: absolute; top: 1278px" Font-Size="9pt" Width="71px" />
            ...
            <!-- +++++++++++++++++++++++++++++++++++++++++++++
              ...
              <asp:View ID="View4" runat="server">
                <table border="0" style="width: 300px; height: 100px; position: relative;" cellpadding="0" cellspacing="0">
                    ...
                    left: 8px; position: absolute; top: 2px" />
     ...
     <asp:Label ID="D4NO" runat="server" Style="z-index: 100; left: 32px; position: absolute;
            top: 88px" Width="70px" Font-Size="Smaller"></asp:Label>
        ...
        <asp:Label ID="D4TCRITEM" runat="server" Style="z-index: 245; left: 672px; position: absolute;
            top: 344px" Font-Size="Smaller"></asp:Label>
        <asp:Label ID="D4TNRITEM1" runat="server" Style="z-index: 246; left: 592px; position: absolute;
            top: 360px" Font-Size="Smaller"></asp:Label>
        &nbsp;
        ...
        <asp:Label ID="D4TNLITEM1" runat="server" Style="z-index: 281; left: 264px; position: absolute;
            top: 360px" Height="1px" Font-Size="Smaller"></asp:Label>
        &nbsp;
        ...
        <img id="DDescSheet" runat="server" src="images/Sheet_Remark.jpg" style="z-index: 1;
            left: 22px; position: absolute; top: 1520px" />
        <asp:TextBox ID="DDecideDesc" runat="server" BackColor="Yellow" ForeColor="Blue"
            Height="56px" Style="z-index: 132; left: 68px; position: absolute; top: 1525px"
        ...
        <asp:Button ID="BSAVE" runat="server" Height="23px" Style="z-index: 128; left: 416px;
            position: absolute; top: 1600px" Text="儲存" Width="80px" OnClientClick="return ConfirmMe(this)" UseSubmitBehavior="false"/>
        <asp:Button ID="BNG2" runat="server" Height="23px" Style="z-index: 129; left: 507px;
            position: absolute; top: 1600px" Text="NG2" Width="80px" OnClientClick="return ConfirmMe(this)" UseSubmitBehavior="false"/>
        <asp:Button ID="BNG1" runat="server" Height="23px" Style="z-index: 130; left: 599px;
            position: absolute; top: 1600px" Text="NG1" Width="80px" OnClientClick="return ConfirmMe(this)" UseSubmitBehavior="false"/>
        <asp:Button ID="BOK" runat="server" Height="23px" Style="z-index: 131; left: 691px;
            position: absolute; top: 1600px" Text="OK" Width="80px" OnClientClick="return ConfirmMe(this)" UseSubmitBehavior="false"/>
        <!-- -->
        <asp:CheckBox ID="DReadHistory" runat="server" style="z-index: 174; left: 631px; position: absolute; top: 13px" Font-Size="9pt" Width="63px" />
        <asp:CheckBox ID="DModify" runat="server" style="z-index: 174; left: 631px; position: absolute; top: 13px" Font-Size="9pt" Width="63px" />
        <asp:TextBox ID="DPageIdx" runat="server" Height="16px" Style="z-index: 318; left: 713px;
            position: absolute; top: -100px;font-size:10px;background:transparent" Width="34px"   BorderStyle="None" BorderWidth="0px"></asp:TextBox>
        <asp:TextBox ID="DBEndTime" runat="server" Height="16px" Style="z-index: 318; left: 713px;
            position: absolute; top: -100px;font-size:10px;background:transparent" Width="34px"   BorderStyle="None" BorderWidth="0px"></asp:TextBox>
        <asp:TextBox ID="DSIGNMARK" runat="server" Height="16px" Style="z-index: 318; left: 120px;
            position: absolute; top: 18px;font-size:10px;background:transparent" Width="16px"   BorderStyle="None" BorderWidth="0px">◎</asp:TextBox>
        <!-- 處理說明及Button End -->
        <!-- +++++++++++++++++++++++++++++++++++++++++++++
             ++ 廠長用開發履歷 ADD-2011/10/05           ++ 
             +++++++++++++++++++++++++++++++++++++++++++++ -->
            <asp:GridView style="Z-INDEX: 136; LEFT: 10px; POSITION: absolute; top: 50px" id="GridView2" runat="server" Width="1000px" Height="100px" BorderStyle="Groove" BackColor="White" BorderColor="#CC9966" CellPadding="4" BorderWidth="1px" AutoGenerateColumns="False">
