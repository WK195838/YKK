<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CommissionSheet_04.aspx.vb" Inherits="CommissionSheet_04" %>
...
<body>
    ...
    <div>
        ...
        <asp:HyperLink ID="LBefOPList" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="BoardEdit.aspx"
            Style="z-index: 261; left: 360px; position: absolute; top: 8px" Target="_blank"
            Width="112px">核定履歷</asp:HyperLink>
        <asp:HyperLink ID="LSampleSheet" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="BoardEdit.aspx"
            Style="z-index: 261; left: 136px; position: absolute; top: 8px" Target="_blank"
            Width="112px">開發見本</asp:HyperLink>
        <asp:HyperLink ID="LManufactureSheet" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="BoardEdit.aspx"
            Style="z-index: 261; left: 24px; position: absolute; top: 8px" Target="_blank"
            Width="112px">製造委託書</asp:HyperLink>
        <asp:HyperLink ID="LGenFILE1" runat="server" Font-Size="12pt" Height="8px" Style="z-index: 261;
            left: 520px; position: absolute; top: 1368px" Target="_blank" Width="62px">QC文件</asp:HyperLink>
        &nbsp;
...
<asp:TextBox ID="DQCLT" runat="server" Height="20px" Style="z-index: 318; left: 128px;
        ...
        <asp:HyperLink ID="LGentaniSheet" runat="server" Font-Size="12pt" Height="8px" NavigateUrl="BoardEdit.aspx"
            Style="z-index: 261; left: 248px; position: absolute; top: 8px" Target="_blank"
            Width="112px">原單位</asp:HyperLink>
    </div>
    </form>
</body>
</html>
