<%@ Page Language="VB" AutoEventWireup="false" CodeFile="List_ItemRelation.aspx.vb" Inherits="List_ItemRelation" %>
...
<body>
    ...
    <div>
        <asp:TextBox ID="TextBox2" runat="server" BackColor="White" BorderStyle="None" ForeColor="Black"
            ...
            top: 11px; text-align: left" Width="40px">SIZE</asp:TextBox>
        <asp:DropDownList ID="DSize" runat="server" BackColor="Yellow" ForeColor="Blue" Height="24px"
        ...
        <asp:TextBox ID="TextBox3" runat="server" BackColor="White" BorderStyle="None" ForeColor="Black"
            Height="18px" ReadOnly="True" Style="z-index: 126; left: 243px; position: absolute;
            top: 11px; text-align: left" Width="40px">CHAIN</asp:TextBox>
        <asp:DropDownList ID="DChain" runat="server" BackColor="Yellow" ForeColor="Blue" Height="24px"
            Style="z-index: 120; left: 289px; position: absolute; top: 8px" Width="170px">
        </asp:DropDownList>

        <asp:TextBox ID="TextBox4" runat="server" BackColor="White" BorderStyle="None" ForeColor="Black"
            Height="18px" ReadOnly="True" Style="z-index: 126; left: 20px; position: absolute;
            top: 42px; text-align: left" Width="40px">供應商</asp:TextBox>
        <asp:DropDownList ID="DSup" runat="server" BackColor="Yellow" ForeColor="Blue" Height="24px"
            Style="z-index: 120; left: 67px; position: absolute; top: 39px" Width="170px">
        </asp:DropDownList>
        ...
        <asp:TextBox ID="TextBox1" runat="server" BackColor="White" BorderStyle="None" ForeColor="Black"
            ...
            top: 42px; text-align: left" Width="40px">色號</asp:TextBox>
        <asp:TextBox ID="DColor" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
            ...
            top: 39px; text-align: left" Width="166px"></asp:TextBox>
        
        
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
            BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Size="9pt"
            PageSize="50" Style="z-index: 114; left: 26px; position: absolute; top: 74px"
            Width="600px">
            <RowStyle BackColor="White" ForeColor="Blue" />
            <Columns>
                <asp:BoundField DataField="SIZENO" HeaderText="SIZE" />
                <asp:BoundField DataField="ITEM" HeaderText="CHAIN" />
                <asp:BoundField DataField="COL" HeaderText="供應商" />
        ...
        <asp:Button ID="BOK" runat="server" Height="25px" Style="z-index: 104; left: 470px;
            position: absolute; top: 37px" Text="GO" Width="62px" />
        <asp:ImageButton ID="BExcel" runat="server" Height="21px" ImageUrl="Images\msexcel.gif"
            Style="z-index: 122; left: 540px; position: absolute; top: 37px" Width="21px" />
