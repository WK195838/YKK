<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SBDCommissionNoPicker.aspx.vb" Inherits="SBDCommissionNoPicker" %>
...
<body>
    ...
    <div>
        <asp:TextBox ID="DKey" runat="server" BackColor="Yellow" BorderStyle="Groove" ForeColor="Blue"
            Height="20px" Style="z-index: 104; left: 34px; position: absolute; top: 8px" Width="192px">DKey</asp:TextBox>
