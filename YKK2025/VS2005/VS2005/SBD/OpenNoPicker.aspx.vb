...
Partial Class OpenNoPicker
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        If dtData.Rows.Count > 0 Then
            ...
            param &= "window.opener.document.getElementById('DSurfcolor').value = '" & dtData.Rows(0).Item("Color") & "'; "
            param &= "window.opener.document.getElementById('DSurfFormNo').value = '" & dtData.Rows(0).Item("FormNo") & "'; "
            param &= "window.opener.document.getElementById('DSurfFormSno').value = '" & dtData.Rows(0).Item("FormSno") & "'; "
