<%@ Page Language="vb" AutoEventWireup="false" Inherits="SBDAppendSpecSheet_01" aspCompat="True" CodeFile="SBDAppendSpecSheet_01.aspx.vb" %>
...
<body>
  	...
  	<form id="Form1" runat="server">
  	 <div>
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/SBD-AppendSpecSheet01.jpg" style="z-index: 100; left: 10px; position: absolute; top: 15px" />&nbsp;
           <asp:Image ID="LFinalSampleFile" runat="server" BorderStyle="Groove" Height="124px"
           ...
           &nbsp;
           <input id="DQCReqFile" runat="server" name="UploadFile" style="z-index: 122; left: 336px;
            width: 301px; position: absolute; top: 333px; height: 20px; background-color: #ffff00"
            type="file" visible="true" />
           &nbsp;
        <input id="DFinalSampleFile" runat="server" name="UploadFile" style="z-index: 121; left: 25px;
            width: 146px; position: absolute; top: 462px; height: 20px; background-color: #ffff00"
            type="file" visible="true" />
        <input id="DForcastFile" runat="server" name="UploadFile" style="z-index: 135; left: 461px;
            width: 174px; position: absolute; top: 504px; height: 20px; background-color: #ffff00"
            type="file" visible="true" />
          &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           ...
           &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp;&nbsp;
        <input id="DQAFile" runat="server" name="UploadFile" style="z-index: 136; left: 336px;
            width: 301px; position: absolute; top: 364px; height: 20px; background-color: #ffff00"
            type="file" visible="true" />
           &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          
        <input id="DContactFile" runat="server" name="UploadFile" style="z-index: 139; left: 460px;
            width: 174px; position: absolute; top: 534px; height: 20px; background-color: #ffff00"
            type="file" visible="true" />
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          &nbsp; &nbsp;&nbsp;&nbsp;
        <input id="BSAVE" runat="server" name="Button1" onclick="Button('SAVE');" style="z-index: 143;
            left: 312px; width: 80px; position: absolute; top: 1368px; height: 28px" type="button"
            value="儲存" />
        <input id="BNG2" runat="server" name="Button1" onclick="Button('NG2');" style="z-index: 142;
            left: 400px; width: 80px; position: absolute; top: 1368px; height: 28px" type="button"
            value="NG2" />
        <input id="BNG1" runat="server" name="Button1" onclick="Button('NG1');" style="z-index: 141;
            left: 488px; width: 80px; position: absolute; top: 1368px; height: 28px" type="button"
            value="NG1" />
        &nbsp;&nbsp;
        <input id="BOK" runat="server" name="BOK" onclick="Button('OK');" style="z-index: 140;
            left: 576px; width: 80px; position: absolute; top: 1368px; height: 28px" type="button"
            value="OK" />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp;&nbsp;
        <input id="BDate3" runat="server" style="z-index: 133; left: 432px; width: 20px;
            position: absolute; top: 426px" type="button" value="..." /><input id="BNo" runat="server" style="z-index: 134; left: 303px; width: 20px;
            position: absolute; top: 98px" type="button" value="..." />
           <input id="BSurfNo" runat="server" style="z-index: 132; left: 305px; width: 20px;
            position: absolute; top: 225px" type="button" value="..." />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <input id="DManufFlowFile" runat="server" name="UploadFile" style="z-index: 138; left: 147px;
            width: 179px; position: absolute; top: 500px; height: 20px; background-color: #ffff00"
            type="file" visible="true" />
           <input id="DOPManualFile" runat="server" name="UploadFile" style="z-index: 137; left: 147px;
            width: 180px; position: absolute; top: 531px; height: 20px; background-color: #ffff00"
            type="file" visible="true" />
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <asp:DropDownList ID="DQCResult" runat="server" BackColor="Yellow"
            ForeColor="Blue" Height="20px" Style="z-index: 108; left: 498px; position: absolute;
            top: 425px" Width="80px">
        </asp:DropDownList>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <input id="DQCDate" runat="server" style="z-index: 126; left: 336px; width: 96px;
        ...
        <asp:TextBox ID="DDivision" runat="server" BackColor="Yellow" BorderStyle="Groove"
            ForeColor="Blue" Height="24px" Style="z-index: 109; left: 152px; position: absolute;
            top: 129px" Width="171px"></asp:TextBox>
           &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp; &nbsp; &nbsp; &nbsp;
           &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <asp:TextBox ID="DQCRemark" runat="server" BackColor="Yellow" BorderStyle="Groove"
            ForeColor="Blue" Height="24px" Style="z-index: 110; left: 337px; position: absolute;
            top: 459px" Width="300px"></asp:TextBox>
        ...
        <asp:TextBox ID="DAppDate" runat="server" BackColor="Yellow" BorderStyle="Groove"
           ...
           &nbsp;
           <input id="DNo" runat="server" style="z-index: 128; left: 151px; width: 151px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
               position: absolute; top: 97px; background-color: yellow; border-bottom-style: groove"
               type="text" /><input id="DBuyer" runat="server" style="z-index: 129; left: 152px; width: 170px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
               position: absolute; top: 161px; background-color: yellow; border-bottom-style: groove"
               type="text" />
           <input id="DVendor" runat="server" style="z-index: 130; left: 460px; width: 170px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
               position: absolute; top: 158px; background-color: yellow; border-bottom-style: groove"
               type="text" /><input id="DSupplier" runat="server" style="z-index: 131; left: 150px; width: 170px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
               position: absolute; top: 193px; background-color: yellow; border-bottom-style: groove"
               type="text" /><input id="DSurfSupplier" runat="server" style="z-index: 123; left: 465px; width: 170px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
               position: absolute; top: 224px; background-color: yellow; border-bottom-style: groove"
               type="text" /><input id="DCap" runat="server" style="z-index: 127; left: 155px; width: 170px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
               position: absolute; top: 257px; background-color: yellow; border-bottom-style: groove"
               type="text" />
           <input id="DSchedule" runat="server" style="z-index: 124; left: 464px; width: 170px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
               position: absolute; top: 259px; background-color: yellow; border-bottom-style: groove"
               type="text" /><input id="DSurfSheetNo" runat="server" style="z-index: 125; left: 153px; width: 151px;
               color: blue; border-top-style: groove; border-right-style: groove; border-left-style: groove;
