...
Partial Class SBDSurfNoPicker
    ...
    Sub SetParameter()
        ...
        Response.Cookies("PGM").Value = "SBDSurfNoPicker.aspx"                                         '程式名
        '-----------------------------------------------------------------
        '-- 共用參數
        '-----------------------------------------------------------------
    ...
    Protected Sub DataList()
        ...
        SQL &= "'SBDSurfaceSheet_02.aspx?pFormNo=' + FormNo + '&pFormSno=' + str(FormSno, Len(FormSno)) As URL "
        SQL &= " from  F_SBDSufaceSheet "
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        If dtData.Rows.Count > 0 Then
            ...
            param &= "window.opener.document.getElementById('DSurfSheetNo').value = '" & dtData.Rows(0).Item("No") & "'; "
            param &= "window.opener.document.getElementById('DSurfSupplier').value = '" & dtData.Rows(0).Item("Supplier") & "'; "
            param &= "window.opener.document.getElementById('DCap').value = '" & dtData.Rows(0).Item("Cap") & "'; "
            param &= "window.opener.document.getElementById('DSchedule').value = '" & dtData.Rows(0).Item("Schedule") & "'; "
